...
_pktacc:                                     ; 0xf006a LB 0xc
    db  000h, 000h, 000h, 000h, 000h, 000h, 019h, 02bh, 05dh, 07dh, 02ch, 08ch
_softrst:                                    ; 0xf0076 LB 0xc
    db  000h, 000h, 000h, 000h, 000h, 000h, 001h, 02eh, 010h, 039h, 010h, 039h
_dskacc:                                     ; 0xf0082 LB 0x2e
    db  000h, 000h, 000h, 000h, 000h, 000h, 000h, 000h, 009h, 02ah, 0beh, 02ah, 000h, 000h, 000h, 000h
    db  0b7h, 07bh, 08ah, 07ch, 028h, 08bh, 0bch, 08bh, 000h, 000h, 000h, 000h, 000h, 000h, 05fh, 033h
    db  032h, 05fh, 000h, 0dah, 00fh, 000h, 000h, 001h, 0f3h, 000h, 000h, 000h, 000h, 000h

section CONST progbits vstart=0xb0 align=1 ; size=0xdb4 class=DATA group=DGROUP
    ...
    db   '%s: %d sectors from LBA 0x%llx @ %04x:%04x', 00ah, 000h
...
section CONST2 progbits vstart=0xe64 align=1 ; size=0x3fe class=DATA group=DGROUP
_bios_cvs_version_string:                    ; 0xf0e64 LB 0x16
    db  'VirtualBox 4.3.30_OSE', 000h
_bios_prefix_string:                         ; 0xf0e7a LB 0x8
    db  'BIOS: ', 000h, 000h
_isotag:                                     ; 0xf0e82 LB 0x6
    db  'CD001', 000h
_eltorito:                                   ; 0xf0e88 LB 0x18
    db  'EL TORITO SPECIFICATION', 000h
_drivetypes:                                 ; 0xf0ea0 LB 0x28
...
_scan_to_scanascii:                          ; 0xf0ec8 LB 0x37a
...
_panic_msg_keyb_buffer_full:                 ; 0xf1242 LB 0x20
    db  '%s: keyboard input buffer full', 00ah, 000h

  ; Padding 0x39e bytes at 0xf1262
  times 926 db 0

section _TEXT progbits vstart=0x1600 align=1 ; size=0x8556 class=CODE group=AUTO
...
_log_bios_start:                             ; 0xf1727 LB 0x20
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 ac 01
    push 00e64h                               ; 68 64 0e
...
bios_printf_:                                ; 0xf1922 LB 0x33d
    ...
    test dl, dl                               ; 84 d2
    je near 01c43h                            ; 0f 84 e8 02
    cmp dl, 025h                              ; 80 fa 25
    jne short 01968h                          ; 75 08
    mov bx, strict word 00001h                ; bb 01 00
    xor di, di                                ; 31 ff
    jmp near 01c3dh                           ; e9 d5 02
    test bx, bx                               ; 85 db
    je near 01c35h                            ; 0f 84 c7 02
    ...
    jmp near 01c31h                           ; e9 23 02
    cmp dl, 06ch                              ; 80 fa 6c
    jne near 01af0h                           ; 0f 85 db 00
    mov bx, word [bp+006h]                    ; 8b 5e 06
    cmp dl, byte [bx+001h]                    ; 3a 57 01
    jne near 01af0h                           ; 0f 85 d1 00
    ...
    cmp dl, 078h                              ; 80 fa 78
    je short 01a71h                           ; 74 05
    cmp dl, 058h                              ; 80 fa 58
    jne short 01ae2h                          ; 75 71
    test di, di                               ; 85 ff
    jne short 01a78h                          ; 75 03
    mov di, strict word 00010h                ; bf 10 00
    cmp dl, 078h                              ; 80 fa 78
    jne short 01a84h                          ; 75 07
    mov word [bp-00eh], strict word 00061h    ; c7 46 f2 61 00
    jmp short 01a89h                          ; eb 05
    mov word [bp-00eh], strict word 00041h    ; c7 46 f2 41 00
    lea ax, [di-001h]                         ; 8d 45 ff
    mov word [bp-00ch], ax                    ; 89 46 f4
    mov ax, word [bp-00ch]                    ; 8b 46 f4
    test ax, ax                               ; 85 c0
    jl near 01c31h                            ; 0f 8c 99 01
    ...
    call 09b46h                               ; e8 8b 80
    mov ax, dx                                ; 89 d0
    xor ah, dh                                ; 30 f4
    and AL, strict byte 00fh                  ; 24 0f
    cmp ax, strict word 00009h                ; 3d 09 00
    jnbe short 01acdh                         ; 77 07
    mov dx, ax                                ; 89 c2
    add dx, strict byte 00030h                ; 83 c2 30
    jmp short 01ad5h                          ; eb 08
    sub ax, strict word 0000ah                ; 2d 0a 00
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    add dx, ax                                ; 01 c2
    xor dh, dh                                ; 30 f6
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 01775h                               ; e8 98 fc
    dec word [bp-00ch]                        ; ff 4e f4
    jmp short 01a8fh                          ; eb ad
    push 000e6h                               ; 68 e6 00
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 38 fe
    add sp, strict byte 00004h                ; 83 c4 04
    jmp near 01c31h                           ; e9 41 01
    lea bx, [di-001h]                         ; 8d 5d ff
    cmp dl, 06ch                              ; 80 fa 6c
    jne near 01bb9h                           ; 0f 85 bf 00
    ...
    jne short 01b48h                          ; 75 2d
    test byte [bp-00fh], 080h                 ; f6 46 f1 80
    je short 01b36h                           ; 74 15
    ...
    mov dx, bx                                ; 89 da
    mov bx, ax                                ; 89 c3
    jmp short 01b3fh                          ; eb 09
    push strict byte 00000h                   ; 6a 00
    mov bx, word [bp-012h]                    ; 8b 5e ee
    mov dx, di                                ; 89 fa
    mov cx, ax                                ; 89 c1
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 0186fh                               ; e8 2a fd
    jmp near 01c31h                           ; e9 e9 00
    cmp dl, 075h                              ; 80 fa 75
    jne short 01b4fh                          ; 75 02
    jmp short 01b36h                          ; eb e7
    cmp dl, 078h                              ; 80 fa 78
    je short 01b5bh                           ; 74 07
    cmp dl, 058h                              ; 80 fa 58
    jne near 01c31h                           ; 0f 85 d6 00
    test di, di                               ; 85 ff
    jne short 01b62h                          ; 75 03
    mov di, strict word 00008h                ; bf 08 00
    cmp dl, 078h                              ; 80 fa 78
    jne short 01b6eh                          ; 75 07
    mov word [bp-00eh], strict word 00061h    ; c7 46 f2 61 00
    jmp short 01b73h                          ; eb 05
    mov word [bp-00eh], strict word 00041h    ; c7 46 f2 41 00
    lea ax, [di-001h]                         ; 8d 45 ff
    mov word [bp-00ch], ax                    ; 89 46 f4
    cmp word [bp-00ch], strict byte 00000h    ; 83 7e f4 00
    jl near 01c31h                            ; 0f 8c b0 00
    mov ax, word [bp-012h]                    ; 8b 46 ee
    ...
    cmp ax, strict word 00009h                ; 3d 09 00
    jnbe short 01ba4h                         ; 77 07
    mov dx, ax                                ; 89 c2
    add dx, strict byte 00030h                ; 83 c2 30
    jmp short 01bach                          ; eb 08
    sub ax, strict word 0000ah                ; 2d 0a 00
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    add dx, ax                                ; 01 c2
    xor dh, dh                                ; 30 f6
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 01775h                               ; e8 c1 fb
    dec word [bp-00ch]                        ; ff 4e f4
    jmp short 01b79h                          ; eb c0
    cmp dl, 064h                              ; 80 fa 64
    jne short 01bddh                          ; 75 1f
    test byte [bp-011h], 080h                 ; f6 46 ef 80
    je short 01bceh                           ; 74 0a
    mov dx, word [bp-012h]                    ; 8b 56 ee
    neg dx                                    ; f7 da
    mov cx, strict word 00001h                ; b9 01 00
    jmp short 01bd5h                          ; eb 07
    xor cx, cx                                ; 31 c9
    mov bx, di                                ; 89 fb
    mov dx, word [bp-012h]                    ; 8b 56 ee
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 017b0h                               ; e8 d5 fb
    jmp short 01c31h                          ; eb 54
    cmp dl, 073h                              ; 80 fa 73
    jne short 01befh                          ; 75 0d
    mov cx, ds                                ; 8c d9
    mov bx, word [bp-012h]                    ; 8b 5e ee
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 018e1h                               ; e8 f4 fc
    jmp short 01c31h                          ; eb 42
    cmp dl, 053h                              ; 80 fa 53
    jne short 01c15h                          ; 75 21
    mov ax, word [bp-012h]                    ; 8b 46 ee
    mov word [bp-010h], ax                    ; 89 46 f0
    mov ax, word [bp-014h]                    ; 8b 46 ec
    mov word [bp-014h], ax                    ; 89 46 ec
    ...
    mov bx, ax                                ; 89 c3
    mov cx, word [bp-010h]                    ; 8b 4e f0
    jmp short 01be7h                          ; eb d2
    cmp dl, 063h                              ; 80 fa 63
    jne short 01c26h                          ; 75 0c
    movzx dx, byte [bp-012h]                  ; 0f b6 56 ee
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 01775h                               ; e8 51 fb
    jmp short 01c31h                          ; eb 0b
    push 00107h                               ; 68 07 01
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 f4 fc
    add sp, strict byte 00004h                ; 83 c4 04
    xor bx, bx                                ; 31 db
    jmp short 01c3dh                          ; eb 08
    xor dh, dh                                ; 30 f6
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 01775h                               ; e8 38 fb
    inc word [bp+006h]                        ; ff 46 06
    jmp near 01950h                           ; e9 0d fd
    xor ax, ax                                ; 31 c0
    mov word [bp-016h], ax                    ; 89 46 ea
    mov word [bp-014h], ax                    ; 89 46 ec
    test byte [bp+004h], 001h                 ; f6 46 04 01
    je short 01c55h                           ; 74 04
    cli                                       ; fa
    hlt                                       ; f4
    jmp short 01c52h                          ; eb fd
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_ata_init:                                   ; 0xf1c5f LB 0xcd
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 b0 f9
    mov si, 00122h                            ; be 22 01
    mov dx, ax                                ; 89 c2
    xor al, al                                ; 30 c0
    jmp short 01c79h                          ; eb 04
    cmp AL, strict byte 004h                  ; 3c 04
    jnc short 01c9dh                          ; 73 24
    ...
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    jmp short 01c75h                          ; eb d8
    xor al, al                                ; 30 c0
    jmp short 01ca5h                          ; eb 04
    cmp AL, strict byte 008h                  ; 3c 08
    jnc short 01cf9h                          ; 73 54
    movzx bx, al                              ; 0f b6 d8
    ...
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    jmp short 01ca1h                          ; eb a8
    xor al, al                                ; 30 c0
    jmp short 01d01h                          ; eb 04
    cmp AL, strict byte 010h                  ; 3c 10
    jnc short 01d18h                          ; 73 17
    movzx bx, al                              ; 0f b6 d8
    mov es, dx                                ; 8e c2
    add bx, si                                ; 01 f3
...
ata_reset_:                                  ; 0xf1d2c LB 0xde
    ...
    je short 01de6h                           ; 74 4c
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    je short 01da5h                           ; 74 05
    mov ax, 000b0h                            ; b8 b0 00
    jmp short 01da8h                          ; eb 03
    ...
    jne short 01de6h                          ; 75 22
    cmp al, bl                                ; 38 d8
    jne short 01de6h                          ; 75 1e
    mov bx, strict word 0ffffh                ; bb ff ff
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 01de6h                          ; 76 16
    mov dx, cx                                ; 89 ca
    add dx, strict byte 00007h                ; 83 c2 07
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 080h                 ; a8 80
    je short 01de6h                           ; 74 0a
    mov ax, strict word 0ffffh                ; b8 ff ff
    dec ax                                    ; 48
    test ax, ax                               ; 85 c0
    jnbe short 01ddfh                         ; 77 fb
    jmp short 01dcbh                          ; eb e5
    mov bx, strict word 00010h                ; bb 10 00
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 01dfah                          ; 76 0c
    mov dx, cx                                ; 89 ca
    add dx, strict byte 00007h                ; 83 c2 07
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ata_cmd_data_in_:                            ; 0xf1e0a LB 0x2e7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 080h                 ; a8 80
    je short 01e9ch                           ; 74 0f
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov dx, strict word 00001h                ; ba 01 00
    jmp near 020e8h                           ; e9 4c 02
    ...
    test ax, ax                               ; 85 c0
    jnbe short 01f0eh                         ; 77 10
    jne short 01f6fh                          ; 75 6f
    test bx, bx                               ; 85 db
    jnbe short 01f0eh                         ; 77 0a
    jne short 01f6fh                          ; 75 69
    cmp dx, 01000h                            ; 81 fa 00 10
    jnbe short 01f0eh                         ; 77 02
    jne short 01f6fh                          ; 75 61
    mov ax, word [bp-010h]                    ; 8b 46 f0
    mov bx, word [bp-014h]                    ; 8b 5e ec
    mov cx, word [bp-012h]                    ; 8b 4e ee
    mov dx, di                                ; 89 fa
    mov si, strict word 00018h                ; be 18 00
    call 09b46h                               ; e8 27 7c
    xor dh, dh                                ; 30 f6
    ...
    je short 01fe6h                           ; 74 05
    mov ax, 000b0h                            ; b8 b0 00
    jmp short 01fe9h                          ; eb 03
    mov ax, 000a0h                            ; b8 a0 00
    ...
    mov dl, al                                ; 88 c2
    test AL, strict byte 080h                 ; a8 80
    jne short 0201ah                          ; 75 f1
    test AL, strict byte 001h                 ; a8 01
    je short 0203ch                           ; 74 0f
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov dx, strict word 00002h                ; ba 02 00
    jmp near 020e8h                           ; e9 ac 00
    test dl, 008h                             ; f6 c2 08
    jne short 02050h                          ; 75 0f
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov dx, strict word 00003h                ; ba 03 00
    jmp near 020e8h                           ; e9 98 00
    sti                                       ; fb
    mov ax, word [bp-00ch]                    ; 8b 46 f4
    cmp ax, 0f800h                            ; 3d 00 f8
    jc short 02069h                           ; 72 10
...
_ata_detect:                                 ; 0xf20f1 LB 0x65c
    ...
    jne near 0224fh                           ; 0f 85 ca 00
    cmp AL, strict byte 0aah                  ; 3c aa
    jne near 0224fh                           ; 0f 85 c4 00
    ...
    movzx ax, byte [bp-016h]                  ; 0f b6 46 ea
    call 01d2ch                               ; e8 86 fb
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    je short 021b1h                           ; 74 05
    mov ax, 000b0h                            ; b8 b0 00
    jmp short 021b4h                          ; eb 03
    mov ax, 000a0h                            ; b8 a0 00
    lea dx, [si+006h]                         ; 8d 54 06
    out DX, AL                                ; ee
    ...
    ; sub ah, ah                                ; 2a e4
    cmp bl, 001h                              ; 80 fb 01
    jne near 0224fh                           ; 0f 85 82 00
    cmp al, bl                                ; 38 d8
    jne near 0224fh                           ; 0f 85 7c 00
    ...
    jne short 0220eh                          ; 75 1b
    cmp cl, 0ebh                              ; 80 f9 eb
    jne short 0220eh                          ; 75 16
    movzx ax, byte [bp-016h]                  ; 0f b6 46 ea
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-034h]                         ; 8e 46 cc
    mov bx, word [bp-022h]                    ; 8b 5e de
    ...
    mov dx, es                                ; 8c c2
    call 01e0ah                               ; e8 6a fb
    test ax, ax                               ; 85 c0
    je short 022afh                           ; 74 0b
    push 00124h                               ; 68 24 01
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 76 f6
    add sp, strict byte 00004h                ; 83 c4 04
    ...
    jne short 0231bh                          ; 75 1e
    cmp si, strict byte 0ffffh                ; 83 fe ff
    jne short 0231bh                          ; 75 19
    ...
    jc short 0232eh                           ; 72 0c
    jbe short 02336h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 0233eh                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 0233ah                           ; 74 0e
    jmp short 0237bh                          ; eb 4d
    test al, al                               ; 84 c0
    jne short 0237bh                          ; 75 49
    mov BL, strict byte 01eh                  ; b3 1e
    jmp short 02340h                          ; eb 0a
    mov BL, strict byte 026h                  ; b3 26
    jmp short 02340h                          ; eb 06
    mov BL, strict byte 067h                  ; b3 67
    jmp short 02340h                          ; eb 02
    mov BL, strict byte 070h                  ; b3 70
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 13 f3
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    sal dx, 008h                              ; c1 e2 08
    movzx ax, bl                              ; 0f b6 c3
    call 0165ch                               ; e8 06 f3
    xor ah, ah                                ; 30 e4
    add ax, dx                                ; 01 d0
    ...
    call 05608h                               ; e8 7b 32
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 49 f5
    ...
    mov al, byte [bp-016h]                    ; 8a 46 ea
    cmp AL, strict byte 002h                  ; 3c 02
    jnc short 02489h                          ; 73 60
    test al, al                               ; 84 c0
    jne short 02432h                          ; 75 05
    mov di, strict word 0003dh                ; bf 3d 00
    jmp short 02435h                          ; eb 03
    ...
    xor al, al                                ; 30 c0
    xor ah, ah                                ; 30 e4
    jmp short 02473h                          ; eb 05
    cmp ah, 00fh                              ; 80 fc 0f
    jnc short 02481h                          ; 73 0e
    ...
    mov ax, word [bp-022h]                    ; 8b 46 de
    mov dx, es                                ; 8c c2
    call 01e0ah                               ; e8 27 f9
    test ax, ax                               ; 85 c0
    je short 024f2h                           ; 74 0b
    push 00174h                               ; 68 74 01
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 33 f4
    add sp, strict byte 00004h                ; 83 c4 04
    ...
    cmp AL, strict byte 003h                  ; 3c 03
    je short 02579h                           ; 74 31
    cmp AL, strict byte 002h                  ; 3c 02
    jne near 025dch                           ; 0f 85 8e 00
    movzx ax, byte [bp-016h]                  ; 0f b6 46 ea
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-034h]                         ; 8e 46 cc
    mov si, word [bp-022h]                    ; 8b 76 de
    ...
    jmp short 02597h                          ; eb 09
    dec byte [bp-00ch]                        ; fe 4e f4
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jbe short 025a4h                          ; 76 0d
    movzx cx, byte [bp-00ch]                  ; 0f b6 4e f4
    mov ax, strict word 00001h                ; b8 01 00
    sal ax, CL                                ; d3 e0
    test dx, ax                               ; 85 c2
    je short 0258eh                           ; 74 ea
    xor di, di                                ; 31 ff
    jmp short 025adh                          ; eb 05
    cmp di, strict byte 00014h                ; 83 ff 14
    jnl short 025c2h                          ; 7d 15
    mov si, di                                ; 89 fe
    add si, di                                ; 01 fe
    ...
    inc di                                    ; 47
    jmp short 025a8h                          ; eb e6
    mov byte [bp-03ch], 000h                  ; c6 46 c4 00
    mov di, strict word 00027h                ; bf 27 00
    jmp short 025d0h                          ; eb 05
    dec di                                    ; 4f
    test di, di                               ; 85 ff
    jle short 025dch                          ; 7e 0c
    cmp byte [bp+di-064h], 020h               ; 80 7b 9c 20
    jne short 025dch                          ; 75 06
    mov byte [bp+di-064h], 000h               ; c6 43 9c 00
    jmp short 025cbh                          ; eb ef
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    cmp AL, strict byte 003h                  ; 3c 03
    je short 0263fh                           ; 74 5c
    cmp AL, strict byte 002h                  ; 3c 02
    je short 025f0h                           ; 74 09
    cmp AL, strict byte 001h                  ; 3c 01
    je near 026a9h                            ; 0f 84 bc 00
    jmp near 026c8h                           ; e9 d8 00
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    je short 025fbh                           ; 74 05
    mov ax, 0019fh                            ; b8 9f 01
    jmp short 025feh                          ; eb 03
    ...
    push 001adh                               ; 68 ad 01
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 c7 f2
    add sp, strict byte 00008h                ; 83 c4 08
    xor di, di                                ; 31 ff
    movzx ax, byte [bp+di-064h]               ; 0f b6 43 9c
    inc di                                    ; 47
    test ax, ax                               ; 85 c0
    je short 02677h                           ; 74 0e
    push ax                                   ; 50
    push 001b8h                               ; 68 b8 01
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 b0 f2
    add sp, strict byte 00006h                ; 83 c4 06
    jmp short 02660h                          ; eb e9
    movzx ax, byte [bp-016h]                  ; 0f b6 46 ea
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-034h]                         ; 8e 46 cc
    mov bx, word [bp-022h]                    ; 8b 5e de
    ...
    jne short 02697h                          ; 75 0a
    movzx ax, byte [bp-00ch]                  ; 0f b6 46 f4
    push ax                                   ; 50
    push 001dbh                               ; 68 db 01
    jmp short 0269fh                          ; eb 08
    movzx ax, byte [bp-00ch]                  ; 0f b6 46 f4
    push ax                                   ; 50
    push 001f5h                               ; 68 f5 01
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 7e f2
    add sp, strict byte 00006h                ; 83 c4 06
    jmp short 026c8h                          ; eb 1f
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    ...
    je near 0214bh                            ; 0f 84 2e fa
    mov ax, 000b0h                            ; b8 b0 00
    jmp near 0214eh                           ; e9 2b fa
    ...
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 c8 ee
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
ata_cmd_data_out_:                           ; 0xf274d LB 0x2bc
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov byte [bp-008h], al                    ; 88 46 f8
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 027a5h                          ; 75 07
    mov word [bp-020h], 00080h                ; c7 46 e0 80 00
    jmp short 027aah                          ; eb 05
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 080h                 ; a8 80
    je short 027c6h                           ; 74 0f
    mov dx, word [bp-012h]                    ; 8b 56 ee
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov dx, strict word 00001h                ; ba 01 00
    jmp near 02a00h                           ; e9 3a 02
    ...
    mov dl, al                                ; 88 c2
    test AL, strict byte 080h                 ; a8 80
    jne short 02933h                          ; 75 f1
    test AL, strict byte 001h                 ; a8 01
    je short 02955h                           ; 74 0f
    mov dx, word [bp-012h]                    ; 8b 56 ee
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov dx, strict word 00002h                ; ba 02 00
    jmp near 02a00h                           ; e9 ab 00
    test dl, 008h                             ; f6 c2 08
    jne short 02969h                          ; 75 0f
    mov dx, word [bp-012h]                    ; 8b 56 ee
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov dx, strict word 00003h                ; ba 03 00
    jmp near 02a00h                           ; e9 97 00
    sti                                       ; fb
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    cmp ax, 0f800h                            ; 3d 00 f8
    jc short 02982h                           ; 72 10
    sub ax, 00800h                            ; 2d 00 08
    mov dx, word [bp-018h]                    ; 8b 56 e8
    add dx, 00080h                            ; 81 c2 80 00
    mov word [bp-00eh], ax                    ; 89 46 f2
    ...
    mov dl, al                                ; 88 c2
    test AL, strict byte 080h                 ; a8 80
    jne short 029b6h                          ; 75 f1
    cmp word [bp-01ah], strict byte 00000h    ; 83 7e e6 00
    jne short 029dfh                          ; 75 14
    and AL, strict byte 0e9h                  ; 24 e9
    cmp AL, strict byte 040h                  ; 3c 40
    je short 029f5h                           ; 74 24
    mov dx, word [bp-012h]                    ; 8b 56 ee
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov dx, strict word 00006h                ; ba 06 00
    jmp short 02a00h                          ; eb 21
    mov al, dl                                ; 88 d0
    and AL, strict byte 0c9h                  ; 24 c9
    cmp AL, strict byte 048h                  ; 3c 48
    je short 0296ah                           ; 74 83
    mov dx, word [bp-012h]                    ; 8b 56 ee
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov dx, strict word 00007h                ; ba 07 00
    jmp short 02a00h                          ; eb 0b
    mov dx, word [bp-012h]                    ; 8b 56 ee
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@ata_read_sectors:                           ; 0xf2a09 LB 0xb5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov ax, si                                ; 89 f0
    mov dx, es                                ; 8c c2
    call 01e0ah                               ; e8 c5 f3
    mov es, [bp-00ah]                         ; 8e 46 f6
    jmp short 02aafh                          ; eb 65
    xor bx, bx                                ; 31 db
    ...
    test di, di                               ; 85 ff
    jnbe short 02a86h                         ; 77 11
    jne short 02a92h                          ; 75 1b
    test bx, bx                               ; 85 db
    jnbe short 02a86h                         ; 77 0b
    jne short 02a92h                          ; 75 15
    cmp word [bp-006h], 01000h                ; 81 7e fa 00 10
    jnbe short 02a86h                         ; 77 02
    jne short 02a92h                          ; 75 0c
    mov bx, strict word 00024h                ; bb 24 00
    mov ax, si                                ; 89 f0
    mov dx, es                                ; 8c c2
    call 01e0ah                               ; e8 7a f3
    jmp short 02ab5h                          ; eb 23
    xor ah, ah                                ; 30 e4
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
...
@ata_write_sectors:                          ; 0xf2abe LB 0x5b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov cx, word [es:si+00eh]                 ; 26 8b 4c 0e
    cmp word [es:si+016h], strict byte 00000h ; 26 83 7c 16 00
    je short 02adeh                           ; 74 0c
    mov bx, strict word 00030h                ; bb 30 00
    mov ax, si                                ; 89 f0
    mov dx, es                                ; 8c c2
    call 0274dh                               ; e8 71 fc
    jmp short 02b10h                          ; eb 32
    xor ax, ax                                ; 31 c0
    xor bx, bx                                ; 31 db
    xor dx, dx                                ; 31 d2
    mov di, word [es:si]                      ; 26 8b 3c
    ...
    test dx, dx                               ; 85 d2
    jnbe short 02b0bh                         ; 77 0f
    jne short 02ad2h                          ; 75 d4
    test bx, bx                               ; 85 db
    jnbe short 02b0bh                         ; 77 09
    jne short 02ad2h                          ; 75 ce
    cmp ax, 01000h                            ; 3d 00 10
    jnbe short 02b0bh                         ; 77 02
    jne short 02ad2h                          ; 75 c7
    mov bx, strict word 00034h                ; bb 34 00
    jmp short 02ad5h                          ; eb c5
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
ata_cmd_packet_:                             ; 0xf2b19 LB 0x2e8
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 02b6bh                          ; 75 1f
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 8a ed
    push 00221h                               ; 68 21 02
    push 00230h                               ; 68 30 02
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 c0 ed
    add sp, strict byte 00006h                ; 83 c4 06
    mov dx, strict word 00001h                ; ba 01 00
    jmp near 02df6h                           ; e9 8b 02
    test byte [bp+004h], 001h                 ; f6 46 04 01
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 080h                 ; a8 80
    je short 02bdch                           ; 74 06
    mov dx, strict word 00002h                ; ba 02 00
    jmp near 02df6h                           ; e9 1a 02
    mov dx, word [bp-010h]                    ; 8b 56 f0
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 00ah                  ; b0 0a
    out DX, AL                                ; ee
    ...
    out DX, AL                                ; ee
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je short 02bfch                           ; 74 05
    mov ax, 000b0h                            ; b8 b0 00
    jmp short 02bffh                          ; eb 03
    mov ax, 000a0h                            ; b8 a0 00
    ...
    test AL, strict byte 001h                 ; a8 01
    je short 02c28h                           ; 74 0f
    mov dx, word [bp-010h]                    ; 8b 56 f0
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov dx, strict word 00003h                ; ba 03 00
    jmp near 02df6h                           ; e9 ce 01
    test dl, 008h                             ; f6 c2 08
    jne short 02c3ch                          ; 75 0f
    mov dx, word [bp-010h]                    ; 8b 56 f0
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov dx, strict word 00004h                ; ba 04 00
    jmp near 02df6h                           ; e9 ba 01
    sti                                       ; fb
    mov ax, di                                ; 89 f8
    ...
    jne short 02c65h                          ; 75 0b
    lea dx, [bx+007h]                         ; 8d 57 07
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    mov dl, al                                ; 88 c2
    jmp near 02dd7h                           ; e9 72 01
    lea dx, [bx+007h]                         ; 8d 57 07
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    mov dl, al                                ; 88 c2
    test AL, strict byte 080h                 ; a8 80
    jne short 02c65h                          ; 75 f4
    test AL, strict byte 088h                 ; a8 88
    je near 02dd7h                            ; 0f 84 60 01
    test AL, strict byte 001h                 ; a8 01
    ...
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    jmp short 02c22h                          ; eb 9c
    mov al, dl                                ; 88 d0
    and AL, strict byte 0c9h                  ; 24 c9
    cmp AL, strict byte 048h                  ; 3c 48
    je short 02c99h                           ; 74 0b
    mov dx, word [bp-010h]                    ; 8b 56 f0
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    jmp short 02c36h                          ; eb 9d
    ...
    mov ax, word [bp+004h]                    ; 8b 46 04
    cmp ax, cx                                ; 39 c8
    jbe short 02cd9h                          ; 76 0c
    mov ax, cx                                ; 89 c8
    sub word [bp+004h], cx                    ; 29 4e 04
    xor ax, cx                                ; 31 c8
    mov word [bp-014h], ax                    ; 89 46 ec
    jmp short 02ce3h                          ; eb 0a
    mov cx, ax                                ; 89 c1
    ...
    mov ax, word [bp-00ch]                    ; 8b 46 f4
    test ax, ax                               ; 85 c0
    je short 02db5h                           ; 74 2b
    mov cx, ax                                ; 89 c1
    push eax                                  ; 66 50
    in eax, DX                                ; 66 ed
    loop 02d8eh                               ; e2 fc
    pop eax                                   ; 66 58
    jmp short 02db5h                          ; eb 1f
    test cx, cx                               ; 85 c9
    je short 02d9fh                           ; 74 05
    mov dx, bx                                ; 89 da
    in ax, DX                                 ; ed
    loop 02d9ch                               ; e2 fd
    mov dx, bx                                ; 89 da
    ...
    jmp near 02c65h                           ; e9 8e fe
    mov al, dl                                ; 88 d0
    and AL, strict byte 0e9h                  ; 24 e9
    cmp AL, strict byte 040h                  ; 3c 40
    je short 02debh                           ; 74 0c
    mov dx, word [bp-010h]                    ; 8b 56 f0
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    jmp near 02c36h                           ; e9 4b fe
    mov dx, word [bp-010h]                    ; 8b 56 f0
    add dx, strict byte 00006h                ; 83 c2 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
...
ata_soft_reset_:                             ; 0xf2e01 LB 0x80
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    je short 02e43h                           ; 74 05
    mov ax, 000b0h                            ; b8 b0 00
    jmp short 02e46h                          ; eb 03
    mov ax, 000a0h                            ; b8 a0 00
    mov dx, cx                                ; 89 ca
    add dx, strict byte 00006h                ; 83 c2 06
    out DX, AL                                ; ee
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 080h                 ; a8 80
    jne short 02e54h                          ; 75 f4
    and AL, strict byte 0e9h                  ; 24 e9
    cmp AL, strict byte 040h                  ; 3c 40
    je short 02e71h                           ; 74 0b
    lea dx, [bx+006h]                         ; 8d 57 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 02e79h                          ; eb 08
    lea dx, [bx+006h]                         ; 8d 57 06
    mov AL, strict byte 008h                  ; b0 08
    out DX, AL                                ; ee
    xor ax, ax                                ; 31 c0
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_diskette_ret_status_:                    ; 0xf2e81 LB 0x18
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 7c e7
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop dx                                    ; 5a
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
set_diskette_current_cyl_:                   ; 0xf2e99 LB 0x2d
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bl, al                                ; 88 c3
    cmp AL, strict byte 001h                  ; 3c 01
    jbe short 02eaeh                          ; 76 0b
    push 00250h                               ; 68 50 02
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 77 ea
    add sp, strict byte 00004h                ; 83 c4 04
    movzx ax, dl                              ; 0f b6 c2
    movzx dx, bl                              ; 0f b6 d3
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_wait_for_interrupt_:                  ; 0xf2ec6 LB 0x21
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    cli                                       ; fa
    ...
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 2c e7
    test AL, strict byte 080h                 ; a8 80
    je short 02edch                           ; 74 04
    and AL, strict byte 080h                  ; 24 80
    jmp short 02ee1h                          ; eb 05
    sti                                       ; fb
    hlt                                       ; f4
    cli                                       ; fa
    jmp short 02ecbh                          ; eb ea
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop dx                                    ; 5a
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_wait_for_interrupt_or_timeout_:       ; 0xf2ee7 LB 0x46
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov ax, dx                                ; 89 d0
    call 01600h                               ; e8 0a e7
    test al, al                               ; 84 c0
    jne short 02effh                          ; 75 05
    sti                                       ; fb
    xor cl, cl                                ; 30 c9
    jmp short 02f23h                          ; eb 24
    mov dx, strict word 0003eh                ; ba 3e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 f8 e6
    mov cl, al                                ; 88 c1
    test AL, strict byte 080h                 ; a8 80
    je short 02f1eh                           ; 74 10
    and AL, strict byte 07fh                  ; 24 7f
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 0003eh                ; ba 3e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 f2 e6
    jmp short 02f23h                          ; eb 05
    sti                                       ; fb
    hlt                                       ; f4
    cli                                       ; fa
    jmp short 02eeeh                          ; eb cb
    mov al, cl                                ; 88 c8
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop dx                                    ; 5a
    pop cx                                    ; 59
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_reset_controller_:                    ; 0xf2f2d LB 0x2b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    cmp AL, strict byte 080h                  ; 3c 80
    jne short 02f45h                          ; 75 f4
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop dx                                    ; 5a
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_prepare_controller_:                  ; 0xf2f58 LB 0x81
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov dx, strict word 0003eh                ; ba 3e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 96 e6
    and AL, strict byte 07fh                  ; 24 7f
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 0003eh                ; ba 3e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 96 e6
    mov dx, 003f2h                            ; ba f2 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov byte [bp-008h], al                    ; 88 46 f8
    test cx, cx                               ; 85 c9
    je short 02f8bh                           ; 74 04
    mov AL, strict byte 020h                  ; b0 20
    jmp short 02f8dh                          ; eb 02
    ...
    mov dx, strict word 00040h                ; ba 40 00
    mov ax, dx                                ; 89 d0
    call 0160eh                               ; e8 6e e6
    mov dx, 0008bh                            ; ba 8b 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 57 e6
    ...
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 080h                  ; 3c 80
    jne short 02fb0h                          ; 75 f4
    cmp byte [bp-008h], 000h                  ; 80 7e f8 00
    jne short 02fd1h                          ; 75 0f
    call 02ec6h                               ; e8 01 ff
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 0003eh                ; ba 3e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 3d e6
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop dx                                    ; 5a
    pop cx                                    ; 59
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_media_known_:                         ; 0xf2fd9 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    mov dx, strict word 0003eh                ; ba 3e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 17 e6
    mov ah, al                                ; 88 c4
    test bx, bx                               ; 85 db
    je short 02ff1h                           ; 74 02
    shr al, 1                                 ; d0 e8
    and AL, strict byte 001h                  ; 24 01
    jne short 02ff9h                          ; 75 04
    xor ah, ah                                ; 30 e4
    jmp short 03015h                          ; eb 1c
    mov dx, 00090h                            ; ba 90 00
    test bx, bx                               ; 85 db
    je short 03003h                           ; 74 03
    mov dx, 00091h                            ; ba 91 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 f7 e5
    xor ah, ah                                ; 30 e4
    sar ax, 004h                              ; c1 f8 04
    and AL, strict byte 001h                  ; 24 01
    je short 02ff5h                           ; 74 e3
    mov ax, strict word 00001h                ; b8 01 00
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop dx                                    ; 5a
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_read_id_:                             ; 0xf301c LB 0x40
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_drive_recal_:                         ; 0xf305c LB 0x48
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    push dx                                   ; 52
    mov bx, ax                                ; 89 c3
    call 02f58h                               ; e8 f1 fe
    mov AL, strict byte 007h                  ; b0 07
    mov dx, 003f5h                            ; ba f5 03
    out DX, AL                                ; ee
    mov al, bl                                ; 88 d8
    out DX, AL                                ; ee
    call 02ec6h                               ; e8 53 fe
    test bx, bx                               ; 85 db
    je short 0307eh                           ; 74 07
    ...
    mov dx, strict word 0003eh                ; ba 3e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 7f e5
    xor bx, bx                                ; 31 db
    mov dx, cx                                ; 89 ca
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 75 e5
    mov ax, strict word 00001h                ; b8 01 00
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop dx                                    ; 5a
    pop cx                                    ; 59
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_media_sense_:                         ; 0xf30a4 LB 0xf0
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    push di                                   ; 57
    mov di, ax                                ; 89 c7
    call 0305ch                               ; e8 ab ff
    test ax, ax                               ; 85 c0
    jne short 030bah                          ; 75 05
    xor cx, cx                                ; 31 c9
    jmp near 03188h                           ; e9 ce 00
    mov ax, strict word 00010h                ; b8 10 00
    call 0165ch                               ; e8 9c e5
    test di, di                               ; 85 ff
    jne short 030cbh                          ; 75 07
    mov cl, al                                ; 88 c1
    ...
    mov dx, 0008bh                            ; ba 8b 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 e6 e4
    mov ax, di                                ; 89 f8
    call 0301ch                               ; e8 ef fe
    test ax, ax                               ; 85 c0
    jne short 03163h                          ; 75 32
    mov al, cl                                ; 88 c8
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 080h                  ; 3c 80
    je short 03163h                           ; 74 2a
    mov al, cl                                ; 88 c8
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 0c0h                  ; 3c c0
    je short 03150h                           ; 74 0f
    mov ah, cl                                ; 88 cc
    and ah, 03fh                              ; 80 e4 3f
    cmp AL, strict byte 040h                  ; 3c 40
    je short 0315ch                           ; 74 12
    test al, al                               ; 84 c0
    je short 03155h                           ; 74 07
    jmp short 0311ch                          ; eb cc
    and cl, 03fh                              ; 80 e1 3f
    jmp short 0311ch                          ; eb c7
    mov cl, ah                                ; 88 e1
    or cl, 040h                               ; 80 c9 40
    jmp short 0311ch                          ; eb c0
    mov cl, ah                                ; 88 e1
    or cl, 080h                               ; 80 c9 80
    jmp short 0311ch                          ; eb b9
    test di, di                               ; 85 ff
    db  00fh, 095h, 0c0h
    ; setne al                                  ; 0f 95 c0
    ...
    mov dx, 0008bh                            ; ba 8b 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 93 e4
    movzx bx, ch                              ; 0f b6 dd
    mov dx, di                                ; 89 fa
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 88 e4
    mov cx, si                                ; 89 f1
    mov ax, cx                                ; 89 c8
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
floppy_drive_exists_:                        ; 0xf3194 LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, ax                                ; 89 c2
    mov ax, strict word 00010h                ; b8 10 00
    call 0165ch                               ; e8 bc e4
    test dx, dx                               ; 85 d2
    jne short 031a9h                          ; 75 05
    shr al, 004h                              ; c0 e8 04
    jmp short 031abh                          ; eb 02
    and AL, strict byte 00fh                  ; 24 0f
    test al, al                               ; 84 c0
    db  00fh, 095h, 0c0h
    ; setne al                                  ; 0f 95 c0
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_int13_diskette_function:                    ; 0xf31b8 LB 0x729
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jc short 03211h                           ; 72 3a
    mov dx, word [bp+01ch]                    ; 8b 56 1c
    or dl, 001h                               ; 80 ca 01
    cmp bl, 008h                              ; 80 fb 08
    jbe near 03760h                           ; 0f 86 7c 05
    cmp bl, 016h                              ; 80 fb 16
    jc short 03207h                           ; 72 1e
    or si, 00100h                             ; 81 ce 00 01
    mov cx, si                                ; 89 f1
    cmp bl, 016h                              ; 80 fb 16
    jbe near 0389ch                           ; 0f 86 a6 06
    cmp bl, 018h                              ; 80 fb 18
    je near 038a1h                            ; 0f 84 a4 06
    cmp bl, 017h                              ; 80 fb 17
    je near 038a1h                            ; 0f 84 9d 06
    jmp near 038beh                           ; e9 b7 06
    cmp bl, 015h                              ; 80 fb 15
    je near 03856h                            ; 0f 84 48 06
    jmp near 038beh                           ; e9 ad 06
    cmp bl, 001h                              ; 80 fb 01
    jc short 0322bh                           ; 72 15
    jbe near 032a4h                           ; 0f 86 8a 00
    cmp bl, 005h                              ; 80 fb 05
    je near 035e6h                            ; 0f 84 c5 03
    cmp bl, 004h                              ; 80 fb 04
    jbe near 032c2h                           ; 0f 86 9a 00
    jmp near 038beh                           ; e9 93 06
    test bl, bl                               ; 84 db
    jne near 038beh                           ; 0f 85 8d 06
    mov al, byte [bp+00eh]                    ; 8a 46 0e
    mov byte [bp-00eh], al                    ; 88 46 f2
    cmp AL, strict byte 001h                  ; 3c 01
    jbe short 0324fh                          ; 76 14
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    mov ax, strict word 00001h                ; b8 01 00
    call 02e81h                               ; e8 35 fc
    jmp near 035c2h                           ; e9 73 03
    mov ax, strict word 00010h                ; b8 10 00
    call 0165ch                               ; e8 07 e4
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    jne short 03262h                          ; 75 07
    mov dl, al                                ; 88 c2
    shr dl, 004h                              ; c0 ea 04
    jmp short 03267h                          ; eb 05
    mov dl, al                                ; 88 c2
    and dl, 00fh                              ; 80 e2 0f
    test dl, dl                               ; 84 d2
    jne short 0327bh                          ; 75 10
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    mov word [bp+016h], ax                    ; 89 46 16
    mov ax, 00080h                            ; b8 80 00
    jmp short 03249h                          ; eb ce
    xor bx, bx                                ; 31 db
    mov dx, strict word 0003eh                ; ba 3e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 88 e3
    xor al, al                                ; 30 c0
    mov byte [bp+017h], al                    ; 88 46 17
    xor ah, ah                                ; 30 e4
    call 02e81h                               ; e8 f1 fb
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    movzx ax, byte [bp-00eh]                  ; 0f b6 46 f2
    xor dx, dx                                ; 31 d2
    call 02e99h                               ; e8 fc fb
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    ...
    xor ax, ax                                ; 31 c0
    call 01600h                               ; e8 50 e3
    movzx dx, al                              ; 0f b6 d0
    sal dx, 008h                              ; c1 e2 08
    or si, dx                                 ; 09 d6
    mov word [bp+016h], si                    ; 89 76 16
    test al, al                               ; 84 c0
    je short 0329dh                           ; 74 de
    jmp near 035c2h                           ; e9 00 03
    ...
    jnbe short 032f8h                         ; 77 10
    cmp dl, 001h                              ; 80 fa 01
    jnbe short 032f8h                         ; 77 0b
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    test al, al                               ; 84 c0
    je short 032f8h                           ; 74 04
    cmp AL, strict byte 048h                  ; 3c 48
    jbe short 03321h                          ; 76 29
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 de e5
    push 00275h                               ; 68 75 02
    push 0028dh                               ; 68 8d 02
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 14 e6
    add sp, strict byte 00006h                ; 83 c4 06
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 03392h                          ; eb 71
    movzx ax, byte [bp-00eh]                  ; 0f b6 46 f2
    call 03194h                               ; e8 6c fe
    test ax, ax                               ; 85 c0
    je near 03424h                            ; 0f 84 f6 00
    movzx dx, byte [bp-00eh]                  ; 0f b6 56 f2
    mov ax, dx                                ; 89 d0
    call 02fd9h                               ; e8 a2 fc
    test ax, ax                               ; 85 c0
    jne short 03354h                          ; 75 19
    mov ax, dx                                ; 89 d0
    call 030a4h                               ; e8 64 fd
    test ax, ax                               ; 85 c0
    jne short 03354h                          ; 75 10
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    mov word [bp+016h], ax                    ; 89 46 16
    mov ax, strict word 0000ch                ; b8 0c 00
    jmp short 03392h                          ; eb 3e
    cmp ch, 002h                              ; 80 fd 02
    jne near 034bbh                           ; 0f 85 60 01
    ...
    add dx, cx                                ; 01 ca
    cmp dx, bx                                ; 39 da
    jnc short 0339ch                          ; 73 18
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 009h                               ; 80 cc 09
    mov word [bp+016h], ax                    ; 89 46 16
    mov ax, strict word 00009h                ; b8 09 00
    call 02e81h                               ; e8 ec fa
    mov byte [bp+016h], 000h                  ; c6 46 16 00
    jmp near 035c2h                           ; e9 26 02
    ...
    mov AL, strict byte 0ffh                  ; b0 ff
    out DX, AL                                ; ee
    call 02ee7h                               ; e8 ca fa
    test al, al                               ; 84 c0
    jne short 03435h                          ; 75 14
    call 02f2dh                               ; e8 09 fb
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    mov word [bp+016h], ax                    ; 89 46 16
    mov ax, 00080h                            ; b8 80 00
    jmp near 03392h                           ; e9 5d ff
    mov dx, 003f4h                            ; ba f4 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 0c0h                  ; 3c c0
    je short 0344fh                           ; 74 0e
    push 00275h                               ; 68 75 02
    push 002a8h                               ; 68 a8 02
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 d6 e4
    add sp, strict byte 00006h                ; 83 c4 06
    xor si, si                                ; 31 f6
    jmp short 03458h                          ; eb 05
    cmp si, strict byte 00007h                ; 83 fe 07
    jnl short 03470h                          ; 7d 18
    mov dx, 003f5h                            ; ba f5 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 a1 e1
    inc si                                    ; 46
    jmp short 03453h                          ; eb e3
    test byte [bp-016h], 0c0h                 ; f6 46 ea c0
    je short 03487h                           ; 74 11
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 020h                               ; 80 cc 20
    mov word [bp+016h], ax                    ; 89 46 16
    mov ax, strict word 00020h                ; b8 20 00
    jmp near 03392h                           ; e9 0b ff
    movzx ax, byte [bp-00ch]                  ; 0f b6 46 f4
    ...
    movzx ax, byte [bp-00eh]                  ; 0f b6 46 f2
    call 02e99h                               ; e8 e9 f9
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp near 0329dh                           ; e9 e2 fd
    cmp ch, 003h                              ; 80 fd 03
    jne near 035d0h                           ; 0f 85 0e 01
    mov cx, word [bp+006h]                    ; 8b 4e 06
    ...
    mov AL, strict byte 0ffh                  ; b0 ff
    out DX, AL                                ; ee
    call 02ee7h                               ; e8 79 f9
    test al, al                               ; 84 c0
    je near 03421h                            ; 0f 84 ad fe
    mov dx, 003f4h                            ; ba f4 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 0c0h                  ; 3c c0
    je short 0358eh                           ; 74 0e
    push 00275h                               ; 68 75 02
    push 002a8h                               ; 68 a8 02
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 97 e3
    add sp, strict byte 00006h                ; 83 c4 06
    xor si, si                                ; 31 f6
    jmp short 03597h                          ; eb 05
    cmp si, strict byte 00007h                ; 83 fe 07
    jnl short 035afh                          ; 7d 18
    mov dx, 003f5h                            ; ba f5 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    lea dx, [si+042h]                         ; 8d 54 42
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 62 e0
    inc si                                    ; 46
    jmp short 03592h                          ; eb e3
    test byte [bp-016h], 0c0h                 ; f6 46 ea c0
    je near 034a5h                            ; 0f 84 ee fe
    test byte [bp-015h], 002h                 ; f6 46 eb 02
    je short 035c9h                           ; 74 0c
    mov word [bp+016h], 00300h                ; c7 46 16 00 03
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp near 0329dh                           ; e9 d4 fc
    mov word [bp+016h], 00100h                ; c7 46 16 00 01
    jmp short 035c2h                          ; eb f2
    movzx dx, byte [bp-008h]                  ; 0f b6 56 f8
    movzx ax, byte [bp-00eh]                  ; 0f b6 46 f2
    call 02e99h                               ; e8 be f8
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    jmp near 0329dh                           ; e9 b7 fc
    mov al, byte [bp+016h]                    ; 8a 46 16
    mov byte [bp-00ch], al                    ; 88 46 f4
    mov dx, word [bp+014h]                    ; 8b 56 14
    shr dx, 008h                              ; c1 ea 08
    ...
    cmp bl, 001h                              ; 80 fb 01
    jnbe short 0361ah                         ; 77 14
    cmp AL, strict byte 001h                  ; 3c 01
    jnbe short 0361ah                         ; 77 10
    cmp dl, 04fh                              ; 80 fa 4f
    jnbe short 0361ah                         ; 77 0b
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    test al, al                               ; 84 c0
    je short 0361ah                           ; 74 04
    cmp AL, strict byte 012h                  ; 3c 12
    jbe short 0362fh                          ; 76 15
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    mov ax, strict word 00001h                ; b8 01 00
    call 02e81h                               ; e8 56 f8
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    movzx ax, byte [bp-00eh]                  ; 0f b6 46 f2
    call 03194h                               ; e8 5e fb
    test ax, ax                               ; 85 c0
    je near 0326bh                            ; 0f 84 2f fc
    movzx dx, byte [bp-00eh]                  ; 0f b6 56 f2
    mov ax, dx                                ; 89 d0
    call 02fd9h                               ; e8 94 f9
    test ax, ax                               ; 85 c0
    jne short 03654h                          ; 75 0b
    mov ax, dx                                ; 89 d0
    call 030a4h                               ; e8 56 fa
    test ax, ax                               ; 85 c0
    je near 03344h                            ; 0f 84 f0 fc
    mov dx, word [bp+006h]                    ; 8b 56 06
    shr dx, 00ch                              ; c1 ea 0c
    mov ah, dl                                ; 88 d4
    mov cx, word [bp+006h]                    ; 8b 4e 06
    ...
    out DX, AL                                ; ee
    call 02ee7h                               ; e8 fe f7
    test al, al                               ; 84 c0
    jne short 036f3h                          ; 75 06
    call 02f2dh                               ; e8 3d f8
    jmp near 0326bh                           ; e9 78 fb
    mov dx, 003f4h                            ; ba f4 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 0c0h                  ; 3c c0
    je short 0370dh                           ; 74 0e
    push 00275h                               ; 68 75 02
    push 002a8h                               ; 68 a8 02
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 18 e2
    add sp, strict byte 00006h                ; 83 c4 06
    xor si, si                                ; 31 f6
    jmp short 03716h                          ; eb 05
    cmp si, strict byte 00007h                ; 83 fe 07
    jnl short 0372eh                          ; 7d 18
    mov dx, 003f5h                            ; ba f5 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    lea dx, [si+042h]                         ; 8d 54 42
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 e3 de
    inc si                                    ; 46
    jmp short 03711h                          ; eb e3
    test byte [bp-016h], 0c0h                 ; f6 46 ea c0
    je short 0374ah                           ; 74 16
    test byte [bp-015h], 002h                 ; f6 46 eb 02
    jne near 035bdh                           ; 0f 85 81 fe
    push 00275h                               ; 68 75 02
    push 002bch                               ; 68 bc 02
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 db e1
    add sp, strict byte 00006h                ; 83 c4 06
    xor al, al                                ; 30 c0
    mov byte [bp+017h], al                    ; 88 46 17
    xor ah, ah                                ; 30 e4
    call 02e81h                               ; e8 2d f7
    movzx ax, byte [bp-00eh]                  ; 0f b6 46 f2
    xor dx, dx                                ; 31 d2
    call 02e99h                               ; e8 3c f7
    jmp near 034b4h                           ; e9 54 fd
    mov byte [bp-00eh], ah                    ; 88 66 f2
    cmp ah, 001h                              ; 80 fc 01
    jbe short 03788h                          ; 76 20
    xor ax, ax                                ; 31 c0
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    jmp near 0329dh                           ; e9 15 fb
    mov ax, strict word 00010h                ; b8 10 00
    call 0165ch                               ; e8 ce de
    mov dl, al                                ; 88 c2
    xor cl, cl                                ; 30 c9
    test AL, strict byte 0f0h                 ; a8 f0
    je short 03798h                           ; 74 02
    mov CL, strict byte 001h                  ; b1 01
    test dl, 00fh                             ; f6 c2 0f
    je short 0379fh                           ; 74 02
    db  0feh, 0c1h
    ; inc cl                                    ; fe c1
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    jne short 037aah                          ; 75 05
    shr dl, 004h                              ; c0 ea 04
    jmp short 037adh                          ; eb 03
    and dl, 00fh                              ; 80 e2 0f
    ...
    jc short 037edh                           ; 72 15
    jbe short 03814h                          ; 76 3a
    cmp dl, 005h                              ; 80 fa 05
    jc short 0381bh                           ; 72 3c
    jbe short 03822h                          ; 76 41
    cmp dl, 00fh                              ; 80 fa 0f
    je short 03830h                           ; 74 4a
    cmp dl, 00eh                              ; 80 fa 0e
    je short 03829h                           ; 74 3e
    jmp short 03837h                          ; eb 4a
    cmp dl, 002h                              ; 80 fa 02
    je short 0380dh                           ; 74 1b
    cmp dl, 001h                              ; 80 fa 01
    je short 03806h                           ; 74 0f
    test dl, dl                               ; 84 d2
    jne short 03837h                          ; 75 3c
    mov word [bp+014h], strict word 00000h    ; c7 46 14 00 00
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp short 03845h                          ; eb 3f
    mov word [bp+014h], 02709h                ; c7 46 14 09 27
    jmp short 03845h                          ; eb 38
    mov word [bp+014h], 04f0fh                ; c7 46 14 0f 4f
    jmp short 03845h                          ; eb 31
    mov word [bp+014h], 04f09h                ; c7 46 14 09 4f
    jmp short 03845h                          ; eb 2a
    mov word [bp+014h], 04f12h                ; c7 46 14 12 4f
    jmp short 03845h                          ; eb 23
    mov word [bp+014h], 04f24h                ; c7 46 14 24 4f
    jmp short 03845h                          ; eb 1c
    mov word [bp+014h], 0fe3fh                ; c7 46 14 3f fe
    jmp short 03845h                          ; eb 15
    mov word [bp+014h], 0feffh                ; c7 46 14 ff fe
    jmp short 03845h                          ; eb 0e
    push 00275h                               ; 68 75 02
    push 002cdh                               ; 68 cd 02
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 e0 e0
    add sp, strict byte 00006h                ; 83 c4 06
    mov word [bp+006h], 0f000h                ; c7 46 06 00 f0
    movzx ax, dl                              ; 0f b6 c2
    call 038e1h                               ; e8 91 00
    mov word [bp+008h], ax                    ; 89 46 08
    jmp near 034b4h                           ; e9 5e fc
    mov byte [bp-00eh], ah                    ; 88 66 f2
    cmp ah, 001h                              ; 80 fc 01
    jbe short 03864h                          ; 76 06
    mov word [bp+016h], si                    ; 89 76 16
    jmp near 03782h                           ; e9 1e ff
    mov ax, strict word 00010h                ; b8 10 00
    call 0165ch                               ; e8 f2 dd
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    jne short 03877h                          ; 75 07
    mov dl, al                                ; 88 c2
    shr dl, 004h                              ; c0 ea 04
    jmp short 0387ch                          ; eb 05
    mov dl, al                                ; 88 c2
    and dl, 00fh                              ; 80 e2 0f
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov bx, word [bp+016h]                    ; 8b 5e 16
    xor bh, bh                                ; 30 ff
    test dl, dl                               ; 84 d2
    je short 03896h                           ; 74 0d
    cmp dl, 001h                              ; 80 fa 01
    jbe short 03893h                          ; 76 05
    or bh, 002h                               ; 80 cf 02
    jmp short 03896h                          ; eb 03
    or bh, 001h                               ; 80 cf 01
    mov word [bp+016h], bx                    ; 89 5e 16
    jmp near 0329dh                           ; e9 01 fa
    cmp ah, 001h                              ; 80 fc 01
    jbe short 038adh                          ; 76 0c
    mov word [bp+016h], si                    ; 89 76 16
    mov ax, strict word 00001h                ; b8 01 00
    call 02e81h                               ; e8 d7 f5
    jmp near 03782h                           ; e9 d5 fe
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 006h                               ; 80 cc 06
    mov word [bp+016h], ax                    ; 89 46 16
    mov ax, strict word 00006h                ; b8 06 00
    jmp near 03249h                           ; e9 8b f9
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 18 e0
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 00275h                               ; 68 75 02
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 47 e0
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 0323bh                           ; e9 5a f9
get_floppy_dpt_:                             ; 0xf38e1 LB 0x2f
    push bx                                   ; 53
    push dx                                   ; 52
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dl, al                                ; 88 c2
    xor ax, ax                                ; 31 c0
    jmp short 038f2h                          ; eb 06
    inc ax                                    ; 40
    cmp ax, strict word 00007h                ; 3d 07 00
    jnc short 03909h                          ; 73 17
    mov bx, ax                                ; 89 c3
    add bx, ax                                ; 01 c3
    cmp dl, byte [word bx+0005bh]             ; 3a 97 5b 00
    jne short 038ech                          ; 75 f0
    movzx ax, byte [word bx+0005ch]           ; 0f b6 87 5c 00
    imul ax, ax, strict byte 0000dh           ; 6b c0 0d
    add ax, strict word 00000h                ; 05 00 00
    jmp short 0390ch                          ; eb 03
    mov ax, strict word 00041h                ; b8 41 00
    pop bp                                    ; 5d
    pop dx                                    ; 5a
    pop bx                                    ; 5b
    retn                                      ; c3
dummy_soft_reset_:                           ; 0xf3910 LB 0x7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    xor ax, ax                                ; 31 c0
    pop bp                                    ; 5d
    retn                                      ; c3
_cdemu_init:                                 ; 0xf3917 LB 0x18
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 f9 dc
    xor bx, bx                                ; 31 db
    mov dx, 00366h                            ; ba 66 03
    call 0160eh                               ; e8 e3 dc
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
_cdemu_isactive:                             ; 0xf392f LB 0x16
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 e1 dc
    mov dx, 00366h                            ; ba 66 03
    call 01600h                               ; e8 bf dc
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
_cdemu_emulated_drive:                       ; 0xf3945 LB 0x16
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 cb dc
    mov dx, 00368h                            ; ba 68 03
    call 01600h                               ; e8 a9 dc
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
_int13_eltorito:                             ; 0xf395b LB 0x189
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    inc dx                                    ; 42
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 0160eh                               ; e8 36 dc
    mov es, di                                ; 8e c7
    movzx bx, byte [es:si+003h]               ; 26 0f b6 5c 03
    mov dx, word [bp+00ah]                    ; 8b 56 0a
    add dx, strict byte 00003h                ; 83 c2 03
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 0160eh                               ; e8 23 dc
    mov es, di                                ; 8e c7
    ...
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 2e de
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 002fch                               ; 68 fc 02
    push 00333h                               ; 68 33 03
    jmp near 0399eh                           ; e9 db fe
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 30 db
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 03aa1h                          ; eb bd
device_is_cdrom_:                            ; 0xf3ae4 LB 0x35
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 28 db
    cmp bl, 010h                              ; 80 fb 10
    jc short 03afdh                           ; 72 04
    xor ax, ax                                ; 31 c0
    jmp short 03b12h                          ; eb 15
    xor bh, bh                                ; 30 ff
    imul bx, bx, strict byte 0001ch           ; 6b db 1c
    mov es, ax                                ; 8e c0
    add bx, 00122h                            ; 81 c3 22 01
    cmp byte [es:bx+023h], 005h               ; 26 80 7f 23 05
    jne short 03af9h                          ; 75 ea
    mov ax, strict word 00001h                ; b8 01 00
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop dx                                    ; 5a
    pop bx                                    ; 5b
...
cdrom_boot_:                                 ; 0xf3b19 LB 0x416
    ...
    jmp short 03b4eh                          ; eb 09
    inc byte [bp-00ch]                        ; fe 46 f4
    cmp byte [bp-00ch], 010h                  ; 80 7e f4 10
    jnc short 03b59h                          ; 73 0b
    movzx ax, byte [bp-00ch]                  ; 0f b6 46 f4
    call 03ae4h                               ; e8 8f ff
    test ax, ax                               ; 85 c0
    je short 03b45h                           ; 74 ec
    cmp byte [bp-00ch], 010h                  ; 80 7e f4 10
    jc short 03b65h                           ; 72 06
    mov ax, strict word 00002h                ; b8 02 00
    jmp near 03ecch                           ; e9 67 03
    mov cx, strict word 0000ch                ; b9 0c 00
    xor bx, bx                                ; 31 db
    mov dx, ss                                ; 8c d2
    lea ax, [bp-026h]                         ; 8d 46 da
    call 09aaah                               ; e8 38 5f
    ...
    test ax, ax                               ; 85 c0
    jne short 03ba1h                          ; 75 c0
    test ax, ax                               ; 85 c0
    je short 03bebh                           ; 74 06
    mov ax, strict word 00003h                ; b8 03 00
    jmp near 03ecch                           ; e9 e1 02
    cmp byte [bp-00826h], 000h                ; 80 be da f7 00
    je short 03bf8h                           ; 74 06
    mov ax, strict word 00004h                ; b8 04 00
    jmp near 03ecch                           ; e9 d4 02
    xor di, di                                ; 31 ff
    jmp short 03c02h                          ; eb 06
    inc di                                    ; 47
    cmp di, strict byte 00005h                ; 83 ff 05
    jnc short 03c12h                          ; 73 10
    mov al, byte [bp+di-00825h]               ; 8a 83 db f7
    cmp al, byte [di+00e82h]                  ; 3a 85 82 0e
    je short 03bfch                           ; 74 f0
    mov ax, strict word 00005h                ; b8 05 00
    jmp near 03ecch                           ; e9 ba 02
    xor di, di                                ; 31 ff
    jmp short 03c1ch                          ; eb 06
    inc di                                    ; 47
    cmp di, strict byte 00017h                ; 83 ff 17
    jnc short 03c2ch                          ; 73 10
    mov al, byte [bp+di-0081fh]               ; 8a 83 e1 f7
    cmp al, byte [di+00e88h]                  ; 3a 85 88 0e
    je short 03c16h                           ; 74 f0
    mov ax, strict word 00006h                ; b8 06 00
    jmp near 03ecch                           ; e9 a0 02
    ...
    call word [word di+0006ah]                ; ff 95 6a 00
    test ax, ax                               ; 85 c0
    je short 03c89h                           ; 74 06
    mov ax, strict word 00007h                ; b8 07 00
    jmp near 03ecch                           ; e9 43 02
    cmp byte [bp-00826h], 001h                ; 80 be da f7 01
    je short 03c96h                           ; 74 06
    mov ax, strict word 00008h                ; b8 08 00
    jmp near 03ecch                           ; e9 36 02
    cmp byte [bp-00825h], 000h                ; 80 be db f7 00
    je short 03ca3h                           ; 74 06
    mov ax, strict word 00009h                ; b8 09 00
    jmp near 03ecch                           ; e9 29 02
    cmp byte [bp-00808h], 055h                ; 80 be f8 f7 55
    je short 03cb0h                           ; 74 06
    mov ax, strict word 0000ah                ; b8 0a 00
    jmp near 03ecch                           ; e9 1c 02
    cmp byte [bp-00807h], 0aah                ; 80 be f9 f7 aa
    jne short 03caah                          ; 75 f3
    cmp byte [bp-00806h], 088h                ; 80 be fa f7 88
    je short 03cc4h                           ; 74 06
    mov ax, strict word 0000bh                ; b8 0b 00
    jmp near 03ecch                           ; e9 08 02
    ...
    test di, di                               ; 85 ff
    je short 03d40h                           ; 74 06
    cmp di, 00400h                            ; 81 ff 00 04
    jbe short 03d46h                          ; 76 06
    mov ax, strict word 0000ch                ; b8 0c 00
    jmp near 03ecch                           ; e9 86 01
    ...
    test ax, ax                               ; 85 c0
    je short 03de4h                           ; 74 06
    mov ax, strict word 0000dh                ; b8 0d 00
    jmp near 03ecch                           ; e9 e8 00
    mov es, [bp-010h]                         ; 8e 46 f0
    mov al, byte [es:si+001h]                 ; 26 8a 44 01
    cmp AL, strict byte 002h                  ; 3c 02
    jc short 03dfch                           ; 72 0d
    jbe short 03e14h                          ; 76 23
    cmp AL, strict byte 004h                  ; 3c 04
    je short 03e2ah                           ; 74 35
    cmp AL, strict byte 003h                  ; 3c 03
    je short 03e1fh                           ; 74 26
    jmp near 03e75h                           ; e9 79 00
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 03e75h                          ; 75 75
    mov es, [bp-010h]                         ; 8e 46 f0
    ...
    je short 03eb3h                           ; 74 34
    cmp byte [es:si+002h], 000h               ; 26 80 7c 02 00
    jne short 03e9ch                          ; 75 16
    mov dx, strict word 00010h                ; ba 10 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 71 d7
    or AL, strict byte 041h                   ; 0c 41
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00010h                ; ba 10 00
    mov ax, strict word 00040h                ; b8 40 00
    jmp short 03eb0h                          ; eb 14
    mov dx, 00304h                            ; ba 04 03
    mov ax, word [bp-018h]                    ; 8b 46 e8
    call 01600h                               ; e8 5b d7
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, 00304h                            ; ba 04 03
    mov ax, word [bp-018h]                    ; 8b 46 e8
    call 0160eh                               ; e8 5b d7
    mov es, [bp-010h]                         ; 8e 46 f0
    cmp byte [es:si+001h], 000h               ; 26 80 7c 01 00
    je short 03ec1h                           ; 74 04
    ...
    db  010h, 00dh, 00ch, 00bh, 00ah, 009h, 008h, 005h, 004h, 003h, 002h, 001h, 000h, 0c7h, 042h, 0d5h
    db  03fh, 01fh, 040h, 047h, 040h, 014h, 040h, 047h, 040h, 014h, 040h, 01dh, 042h, 0fah, 03fh, 0c7h
    db  042h, 0c7h, 042h, 0fah, 03fh, 0fah, 03fh, 0fah, 03fh, 0fah, 03fh, 0fah, 03fh, 0beh, 042h, 0fah
    db  03fh, 0c7h, 042h, 0c7h, 042h, 0c7h, 042h, 0c7h, 042h, 0c7h, 042h, 0c7h, 042h, 0c7h, 042h, 0c7h
    db  042h, 0c7h, 042h, 0c7h, 042h, 0c7h, 042h, 0c7h, 042h
_int13_cdemu:                                ; 0xf3f2f LB 0x434
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 9f d6
    mov es, cx                                ; 8e c1
    cmp byte [es:di], 000h                    ; 26 80 3d 00
    je short 03f85h                           ; 74 0e
    movzx dx, byte [es:di+002h]               ; 26 0f b6 55 02
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    cmp dx, ax                                ; 39 c2
    je short 03faeh                           ; 74 29
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 51 d9
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 7a d9
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 042e7h                           ; e9 39 03
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    cmp ax, strict word 00050h                ; 3d 50 00
    jnbe near 042c7h                          ; 0f 87 0c 03
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 0001eh                ; b9 1e 00
    mov di, 03ed6h                            ; bf d6 3e
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di+03ef3h]               ; 2e 8b 85 f3 3e
    mov bx, word [bp+016h]                    ; 8b 5e 16
    xor bh, bh                                ; 30 ff
    jmp ax                                    ; ff e0
    movzx bx, byte [bp-006h]                  ; 0f b6 5e fa
    ...
    xor ah, ah                                ; 30 e4
    or ah, 003h                               ; 80 cc 03
    jmp near 042efh                           ; e9 d0 02
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 d8 d5
    mov cl, al                                ; 88 c1
    movzx ax, cl                              ; 0f b6 c1
    sal ax, 008h                              ; c1 e0 08
    or bx, ax                                 ; 09 c3
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 ce d5
    test cl, cl                               ; 84 c9
    je short 03ffeh                           ; 74 ba
    jmp near 04303h                           ; e9 bc 02
    ...
    test cx, cx                               ; 85 c9
    jne short 04094h                          ; 75 03
    jmp near 03ffah                           ; e9 66 ff
    cmp di, word [bp-010h]                    ; 3b 7e f0
    jc near 042e7h                            ; 0f 82 4c 02
    cmp ax, dx                                ; 39 d0
    jnc near 042e7h                           ; 0f 83 46 02
    cmp si, bx                                ; 39 de
    jnc near 042e7h                           ; 0f 83 40 02
    mov dx, word [bp+016h]                    ; 8b 56 16
    shr dx, 008h                              ; c1 ea 08
    cmp dx, strict byte 00004h                ; 83 fa 04
    jne short 040b5h                          ; 75 03
    jmp near 03ffah                           ; e9 45 ff
    ...
    xor dl, dl                                ; 30 d2
    xor cx, cx                                ; 31 c9
    call 09a79h                               ; e8 a6 59
    xor bx, bx                                ; 31 db
    add ax, si                                ; 01 f0
    adc dx, bx                                ; 11 da
    mov bx, di                                ; 89 fb
    xor cx, cx                                ; 31 c9
    call 09a79h                               ; e8 99 59
    mov bx, ax                                ; 89 c3
    mov ax, word [bp-010h]                    ; 8b 46 f0
    dec ax                                    ; 48
    xor cx, cx                                ; 31 c9
    ...
    test al, al                               ; 84 c0
    je near 03ffah                            ; 0f 84 13 fe
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 ef d6
    movzx ax, dl                              ; 0f b6 c2
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    ...
    mov word [bp+010h], ax                    ; 89 46 10
    cmp dl, 003h                              ; 80 fa 03
    je short 042a1h                           ; 74 1a
    cmp dl, 002h                              ; 80 fa 02
    je short 0429dh                           ; 74 11
    cmp dl, 001h                              ; 80 fa 01
    jne short 042a5h                          ; 75 14
    mov ax, word [bp+010h]                    ; 8b 46 10
    xor al, al                                ; 30 c0
    or AL, strict byte 002h                   ; 0c 02
    mov word [bp+010h], ax                    ; 89 46 10
    jmp short 042a5h                          ; eb 08
    or AL, strict byte 004h                   ; 0c 04
    jmp short 04298h                          ; eb f7
    or AL, strict byte 005h                   ; 0c 05
    jmp short 04298h                          ; eb f3
    mov es, [bp-008h]                         ; 8e 46 f8
    cmp byte [es:si+001h], 004h               ; 26 80 7c 01 04
    jnc near 03ffah                           ; 0f 83 49 fd
    mov word [bp+008h], 0efc7h                ; c7 46 08 c7 ef
    mov word [bp+006h], 0f000h                ; c7 46 06 00 f0
    jmp near 03ffah                           ; e9 3c fd
    or bh, 003h                               ; 80 cf 03
    mov word [bp+016h], bx                    ; 89 5e 16
    jmp near 03ffeh                           ; e9 37 fd
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 0f d6
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0034ch                               ; 68 4c 03
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 0b d3
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp near 0400dh                           ; e9 03 fd
    db  050h, 04eh, 049h, 048h, 047h, 046h, 045h, 044h, 043h, 042h, 041h, 018h, 016h, 015h, 014h, 011h
    db  010h, 00dh, 00ch, 00bh, 00ah, 009h, 008h, 005h, 004h, 003h, 002h, 001h, 000h, 0a8h, 048h, 024h
    db  046h, 010h, 044h, 0a8h, 048h, 005h, 044h, 0a8h, 048h, 005h, 044h, 0a8h, 048h, 024h, 046h, 0a8h
    db  048h, 0a8h, 048h, 024h, 046h, 024h, 046h, 024h, 046h, 024h, 046h, 024h, 046h, 03ah, 044h, 024h
    db  046h, 0a8h, 048h, 043h, 044h, 056h, 044h, 005h, 044h, 056h, 044h, 084h, 045h, 03eh, 046h, 056h
    db  044h, 065h, 046h, 061h, 048h, 069h, 048h, 0a8h, 048h
_int13_cdrom:                                ; 0xf4363 LB 0x562
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jc short 04397h                           ; 72 05
    cmp ax, 000f0h                            ; 3d f0 00
    jc short 043b5h                           ; 72 1e
    mov ax, word [bp+010h]                    ; 8b 46 10
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 73 d5
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 04885h                           ; e9 d0 04
    mov ax, word [bp+010h]                    ; 8b 46 10
    xor ah, ah                                ; 30 e4
    mov es, [bp-00ch]                         ; 8e 46 f4
    mov bx, si                                ; 89 f3
    ...
    jmp short 043aah                          ; eb cc
    mov ax, word [bp+018h]                    ; 8b 46 18
    shr ax, 008h                              ; c1 e8 08
    cmp ax, strict word 00050h                ; 3d 50 00
    jnbe near 048a8h                          ; 0f 87 bd 04
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 0001eh                ; b9 1e 00
    mov di, 0430ah                            ; bf 0a 43
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di+04327h]               ; 2e 8b 85 27 43
    ...
    xor ah, ah                                ; 30 e4
    or ah, 003h                               ; 80 cc 03
    jmp near 0488dh                           ; e9 7d 04
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 e7 d1
    mov cl, al                                ; 88 c1
    movzx ax, cl                              ; 0f b6 c1
    sal ax, 008h                              ; c1 e0 08
    or bx, ax                                 ; 09 c3
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 dd d1
    test cl, cl                               ; 84 c9
    je near 04628h                            ; 0f 84 f1 01
    jmp near 048a1h                           ; e9 67 04
    or bh, 002h                               ; 80 cf 02
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp near 04890h                           ; e9 4d 04
    mov word [bp+012h], 0aa55h                ; c7 46 12 55 aa
    or bh, 030h                               ; 80 cf 30
    mov word [bp+018h], bx                    ; 89 5e 18
    mov word [bp+016h], strict word 00007h    ; c7 46 16 07 00
    jmp near 04628h                           ; e9 d2 01
    ...
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 8a d4
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 04885h                           ; e9 e7 03
    les bx, [bp-014h]                         ; c4 5e ec
    mov ax, word [es:bx+008h]                 ; 26 8b 47 08
    mov word [bp-018h], ax                    ; 89 46 e8
    mov di, bx                                ; 89 df
    ...
    je near 04624h                            ; 0f 84 66 01
    cmp ax, strict word 00047h                ; 3d 47 00
    je near 04624h                            ; 0f 84 5f 01
    mov cx, strict word 0000ch                ; b9 0c 00
    xor bx, bx                                ; 31 db
    mov dx, ss                                ; 8c d2
    lea ax, [bp-02ch]                         ; 8d 46 d4
    call 09aaah                               ; e8 d8 55
    ...
    test dl, dl                               ; 84 d2
    je near 04624h                            ; 0f 84 cb 00
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 7d d3
    movzx ax, dl                              ; 0f b6 c2
    push ax                                   ; 50
    push word [bp-016h]                       ; ff 76 ea
    push 003dfh                               ; 68 df 03
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 ac d3
    add sp, strict byte 0000ah                ; 83 c4 0a
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    jmp near 0488dh                           ; e9 09 03
    cmp bx, strict byte 00002h                ; 83 fb 02
    jnbe near 04885h                          ; 0f 87 fa 02
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-00ch]                         ; 8e 46 f4
    mov di, si                                ; 89 f7
    ...
    cmp bx, strict byte 00002h                ; 83 fb 02
    je short 04615h                           ; 74 73
    cmp bx, strict byte 00001h                ; 83 fb 01
    je short 045e2h                           ; 74 3b
    test bx, bx                               ; 85 db
    jne near 04624h                           ; 0f 85 77 00
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 045c3h                          ; 75 12
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor ah, ah                                ; 30 e4
    or ah, 0b4h                               ; 80 cc b4
    ...
    or AL, strict byte 001h                   ; 0c 01
    mov word [bp+018h], ax                    ; 89 46 18
    jmp near 04624h                           ; e9 42 00
    test al, al                               ; 84 c0
    jne short 045f2h                          ; 75 0c
    or bh, 0b0h                               ; 80 cf b0
    mov word [bp+018h], bx                    ; 89 5e 18
    mov byte [bp+018h], al                    ; 88 46 18
    jmp near 04890h                           ; e9 9e 02
    movzx dx, byte [bp-008h]                  ; 0f b6 56 f8
    imul dx, dx, strict byte 0001ch           ; 6b d2 1c
    db  0feh, 0c8h
    ; dec al                                    ; fe c8
    ...
    test al, al                               ; 84 c0
    je short 04658h                           ; 74 06
    or bh, 0b1h                               ; 80 cf b1
    jmp near 0443dh                           ; e9 e5 fd
    je short 04624h                           ; 74 ca
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor ah, ah                                ; 30 e4
    or ah, 0b1h                               ; 80 cc b1
    jmp near 0488dh                           ; e9 28 02
    ...
    jc near 04885h                            ; 0f 82 04 02
    jc short 046d2h                           ; 72 4f
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-00ch]                         ; 8e 46 f4
    mov di, si                                ; 89 f7
    ...
    jmp short 04846h                          ; eb 05
    cmp ah, 040h                              ; 80 fc 40
    jnc short 04855h                          ; 73 0f
    ...
    db  0feh, 0c4h
    ; inc ah                                    ; fe c4
    jmp short 04841h                          ; eb ec
    neg al                                    ; f6 d8
    mov es, [bp-00ah]                         ; 8e 46 f6
    mov byte [es:bx+041h], al                 ; 26 88 47 41
    jmp near 04624h                           ; e9 c3 fd
    or bh, 006h                               ; 80 cf 06
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp short 048a1h                          ; eb 38
    cmp bx, strict byte 00006h                ; 83 fb 06
    je near 04624h                            ; 0f 84 b4 fd
    cmp bx, strict byte 00001h                ; 83 fb 01
    jc short 04885h                           ; 72 10
    jbe near 04624h                           ; 0f 86 ab fd
    cmp bx, strict byte 00003h                ; 83 fb 03
    jc short 04885h                           ; 72 07
    cmp bx, strict byte 00004h                ; 83 fb 04
    jbe near 04624h                           ; 0f 86 9f fd
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+018h], ax                    ; 89 46 18
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 6d cd
    or byte [bp+01eh], 001h                   ; 80 4e 1e 01
    jmp near 04637h                           ; e9 8f fd
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 2e d0
    mov ax, word [bp+018h]                    ; 8b 46 18
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 003dfh                               ; 68 df 03
    push 00333h                               ; 68 33 03
    push strict byte 00004h                   ; 6a 04
    jmp near 04495h                           ; e9 d0 fb
print_boot_device_:                          ; 0xf48c5 LB 0x4b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    test al, al                               ; 84 c0
    je short 048d2h                           ; 74 05
    mov dx, strict word 00002h                ; ba 02 00
    jmp short 048ech                          ; eb 1a
    test dl, dl                               ; 84 d2
    je short 048dbh                           ; 74 05
    mov dx, strict word 00003h                ; ba 03 00
    jmp short 048ech                          ; eb 11
    test bl, 080h                             ; f6 c3 80
    jne short 048e4h                          ; 75 04
    xor dh, dh                                ; 30 f6
    jmp short 048ech                          ; eb 08
    test bl, 080h                             ; f6 c3 80
    je short 0490ah                           ; 74 21
    mov dx, strict word 00001h                ; ba 01 00
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 ea cf
    imul dx, dx, strict byte 0000ah           ; 6b d2 0a
    add dx, 00ea0h                            ; 81 c2 a0 0e
    push dx                                   ; 52
    push 00494h                               ; 68 94 04
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 1b d0
    add sp, strict byte 00006h                ; 83 c4 06
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop cx                                    ; 59
    pop bp                                    ; 5d
    retn                                      ; c3
print_boot_failure_:                         ; 0xf4910 LB 0x93
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    mov dh, cl                                ; 88 ce
    ...
    movzx si, ah                              ; 0f b6 f4
    test al, al                               ; 84 c0
    je short 0493dh                           ; 74 1b
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 b4 cf
    push 00eb4h                               ; 68 b4 0e
    push 004a8h                               ; 68 a8 04
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 ea cf
    add sp, strict byte 00006h                ; 83 c4 06
    jmp short 04981h                          ; eb 44
    test dl, dl                               ; 84 d2
    je short 04951h                           ; 74 10
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 95 cf
    push 00ebeh                               ; 68 be 0e
    jmp short 04930h                          ; eb df
    test bl, 080h                             ; f6 c3 80
    je short 04967h                           ; 74 11
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 80 cf
    push si                                   ; 56
    push 00eaah                               ; 68 aa 0e
    jmp short 04976h                          ; eb 0f
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 6f cf
    push si                                   ; 56
    push 00ea0h                               ; 68 a0 0e
    push 004bdh                               ; 68 bd 04
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 a4 cf
    add sp, strict byte 00008h                ; 83 c4 08
    cmp byte [bp+004h], 001h                  ; 80 7e 04 01
    jne short 0499bh                          ; 75 14
    test dh, dh                               ; 84 f6
    jne short 04990h                          ; 75 05
    push 004d5h                               ; 68 d5 04
    jmp short 04993h                          ; eb 03
    push 004ffh                               ; 68 ff 04
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 8a cf
    add sp, strict byte 00004h                ; 83 c4 04
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn 00002h                               ; c2 02 00
print_cdromboot_failure_:                    ; 0xf49a3 LB 0x27
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 2b cf
    push dx                                   ; 52
    push 00534h                               ; 68 34 05
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 63 cf
    add sp, strict byte 00006h                ; 83 c4 06
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop dx                                    ; 5a
    pop cx                                    ; 59
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_int19_function:                             ; 0xf49ca LB 0x256
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    test al, al                               ; 84 c0
    je short 04a22h                           ; 74 0b
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, bx                                ; 89 d8
    call 01600h                               ; e8 e1 cb
    movzx si, al                              ; 0f b6 f0
    cmp byte [bp+004h], 001h                  ; 80 7e 04 01
    jne short 04a38h                          ; 75 10
    mov ax, strict word 0003ch                ; b8 3c 00
    call 0165ch                               ; e8 2e cc
    and AL, strict byte 0f0h                  ; 24 f0
    xor ah, ah                                ; 30 e4
    sar ax, 004h                              ; c1 f8 04
    call 0795dh                               ; e8 25 2f
    cmp byte [bp+004h], 002h                  ; 80 7e 04 02
    jne short 04a41h                          ; 75 03
    shr si, 004h                              ; c1 ee 04
    cmp byte [bp+004h], 003h                  ; 80 7e 04 03
    jne short 04a4ah                          ; 75 03
    shr si, 008h                              ; c1 ee 08
    cmp byte [bp+004h], 004h                  ; 80 7e 04 04
    jne short 04a53h                          ; 75 03
    shr si, 00ch                              ; c1 ee 0c
    cmp si, strict byte 00010h                ; 83 fe 10
    jnc short 04a5ch                          ; 73 04
    ...
    jmp near 04adch                           ; e9 55 ff
    cmp byte [bp-00ah], 000h                  ; 80 7e f6 00
    jne short 04bb3h                          ; 75 26
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 04bb3h                          ; 75 20
    ...
    test ax, ax                               ; 85 c0
    jne near 04adch                           ; 0f 85 29 ff
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    db  00fh, 094h, 0c1h
    ; sete cl                                   ; 0f 94 c1
    cmp byte [bp-00ah], 000h                  ; 80 7e f6 00
    je short 04bc2h                           ; 74 02
    mov CL, strict byte 001h                  ; b1 01
    xor dx, dx                                ; 31 d2
    mov ax, di                                ; 89 f8
    call 0161ch                               ; e8 53 ca
    mov bx, ax                                ; 89 c3
    mov dx, strict word 00002h                ; ba 02 00
    mov ax, di                                ; 89 f8
    call 0161ch                               ; e8 49 ca
    cmp bx, ax                                ; 39 c3
    je short 04be8h                           ; 74 11
    test cl, cl                               ; 84 c9
    jne short 04bfeh                          ; 75 23
    mov dx, 001feh                            ; ba fe 01
    mov ax, di                                ; 89 f8
    call 0161ch                               ; e8 39 ca
    cmp ax, 0aa55h                            ; 3d 55 aa
    je short 04bfeh                           ; 74 16
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    push ax                                   ; 50
    movzx bx, byte [bp-006h]                  ; 0f b6 5e fa
    movzx dx, byte [bp-00ch]                  ; 0f b6 56 f4
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    xor cx, cx                                ; 31 c9
    jmp near 04af0h                           ; e9 f2 fe
    movzx bx, byte [bp-006h]                  ; 0f b6 5e fa
    movzx dx, byte [bp-00ch]                  ; 0f b6 56 f4
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    call 048c5h                               ; e8 b8 fc
    movzx bx, byte [bp-006h]                  ; 0f b6 5e fa
    xor dx, dx                                ; 31 d2
    xor ax, ax                                ; 31 c0
    add ax, di                                ; 01 f8
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
keyboard_panic_:                             ; 0xf4c20 LB 0x13
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push ax                                   ; 50
    push 00574h                               ; 68 74 05
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 f6 cc
    add sp, strict byte 00006h                ; 83 c4 06
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
_keyboard_init:                              ; 0xf4c33 LB 0x26a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov AL, strict byte 0aah                  ; b0 aa
    ...
    test bx, bx                               ; 85 db
    jne short 04c5fh                          ; 75 05
    xor ax, ax                                ; 31 c0
    call 04c20h                               ; e8 c1 ff
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 04c79h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04c79h                          ; 76 08
    mov AL, strict byte 001h                  ; b0 01
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04c62h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04c83h                          ; 75 06
    mov ax, strict word 00001h                ; b8 01 00
    call 04c20h                               ; e8 9d ff
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, strict word 00055h                ; 3d 55 00
    je short 04c94h                           ; 74 06
    mov ax, 003dfh                            ; b8 df 03
    call 04c20h                               ; e8 8c ff
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 04cb4h                           ; 74 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04cb4h                          ; 76 08
    mov AL, strict byte 010h                  ; b0 10
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04c9dh                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04cbeh                          ; 75 06
    mov ax, strict word 0000ah                ; b8 0a 00
    call 04c20h                               ; e8 62 ff
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 04cd8h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04cd8h                          ; 76 08
    mov AL, strict byte 011h                  ; b0 11
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04cc1h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04ce2h                          ; 75 06
    mov ax, strict word 0000bh                ; b8 0b 00
    call 04c20h                               ; e8 3e ff
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test ax, ax                               ; 85 c0
    je short 04cf2h                           ; 74 06
    mov ax, 003e0h                            ; b8 e0 03
    call 04c20h                               ; e8 2e ff
    mov AL, strict byte 0ffh                  ; b0 ff
    mov dx, strict word 00060h                ; ba 60 00
    out DX, AL                                ; ee
    mov bx, strict word 0ffffh                ; bb ff ff
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 04d12h                           ; 74 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04d12h                          ; 76 08
    mov AL, strict byte 020h                  ; b0 20
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04cfbh                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04d1ch                          ; 75 06
    mov ax, strict word 00014h                ; b8 14 00
    call 04c20h                               ; e8 04 ff
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 04d36h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04d36h                          ; 76 08
    mov AL, strict byte 021h                  ; b0 21
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04d1fh                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04d40h                          ; 75 06
    mov ax, strict word 00015h                ; b8 15 00
    call 04c20h                               ; e8 e0 fe
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    je short 04d51h                           ; 74 06
    mov ax, 003e1h                            ; b8 e1 03
    call 04c20h                               ; e8 cf fe
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 04d63h                          ; 75 08
    mov AL, strict byte 031h                  ; b0 31
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04d51h                          ; eb ee
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000aah                            ; 3d aa 00
    je short 04d7ch                           ; 74 0e
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000aah                            ; 3d aa 00
    je short 04d7ch                           ; 74 06
    mov ax, 003e2h                            ; b8 e2 03
    call 04c20h                               ; e8 a4 fe
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 04d9ch                           ; 74 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04d9ch                          ; 76 08
    mov AL, strict byte 040h                  ; b0 40
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04d85h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04da6h                          ; 75 06
    mov ax, strict word 00028h                ; b8 28 00
    call 04c20h                               ; e8 7a fe
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 04dc0h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04dc0h                          ; 76 08
    mov AL, strict byte 041h                  ; b0 41
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04da9h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04dcah                          ; 75 06
    mov ax, strict word 00029h                ; b8 29 00
    call 04c20h                               ; e8 56 fe
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    je short 04ddbh                           ; 74 06
    mov ax, 003e3h                            ; b8 e3 03
    call 04c20h                               ; e8 45 fe
    ...
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04dfbh                          ; 76 08
    mov AL, strict byte 050h                  ; b0 50
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04de4h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04e05h                          ; 75 06
    mov ax, strict word 00032h                ; b8 32 00
    call 04c20h                               ; e8 1b fe
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 04e25h                           ; 74 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04e25h                          ; 76 08
    mov AL, strict byte 060h                  ; b0 60
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04e0eh                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04e2fh                          ; 75 06
    mov ax, strict word 0003ch                ; b8 3c 00
    call 04c20h                               ; e8 f1 fd
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 04e73h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 04e73h                          ; 76 08
    mov AL, strict byte 071h                  ; b0 71
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 04e5ch                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 04e7dh                          ; 75 06
    mov ax, strict word 00046h                ; b8 46 00
    call 04c20h                               ; e8 a3 fd
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    je short 04e8eh                           ; 74 06
    mov ax, 003e4h                            ; b8 e4 03
    call 04c20h                               ; e8 92 fd
    mov AL, strict byte 0a8h                  ; b0 a8
    mov dx, strict word 00064h                ; ba 64 00
    out DX, AL                                ; ee
    xor ax, ax                                ; 31 c0
    call 061f5h                               ; e8 5c 13
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
enqueue_key_:                                ; 0xf4e9d LB 0x93
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 69 c7
    mov di, ax                                ; 89 c7
    mov dx, strict word 0001ch                ; ba 1c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 5e c7
    mov si, ax                                ; 89 c6
    lea cx, [si+002h]                         ; 8d 4c 02
    cmp cx, strict byte 0003eh                ; 83 f9 3e
    jc short 04ecbh                           ; 72 03
    mov cx, strict word 0001eh                ; b9 1e 00
    cmp cx, di                                ; 39 f9
    jne short 04ed3h                          ; 75 04
    xor ax, ax                                ; 31 c0
    jmp short 04ef8h                          ; eb 25
    xor bh, bh                                ; 30 ff
    mov dx, si                                ; 89 f2
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 31 c7
    movzx bx, byte [bp-00ah]                  ; 0f b6 5e f6
    lea dx, [si+001h]                         ; 8d 54 01
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 24 c7
    mov bx, cx                                ; 89 cb
    mov dx, strict word 0001ch                ; ba 1c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0162ah                               ; e8 35 c7
    mov ax, strict word 00001h                ; b8 01 00
    ...
    push strict byte 00051h                   ; 6a 51
    db  0f7h
    dec di                                    ; 4f
    db  0c6h, 04fh, 0c6h, 04fh
    ; mov byte [bx-03ah], 04fh                  ; c6 4f c6 4f
    jns short 04f6ah                          ; 79 50
    lahf                                      ; 9f
    dec di                                    ; 4f
    jmp short 04f6eh                          ; eb 50
    cmp dl, byte [bx+di+05dh]                 ; 3a 51 5d
    push cx                                   ; 51
    cmp byte [bx+si-03ah], dl                 ; 38 50 c6
    dec di                                    ; 4f
    db  0c6h, 04fh, 0b2h, 050h
    ; mov byte [bx-04eh], 050h                  ; c6 4f b2 50
    mov ax, 01b4fh                            ; b8 4f 1b
    push cx                                   ; 51
    push si                                   ; 56
    push cx                                   ; 51
_int09_function:                             ; 0xf4f30 LB 0x35d
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov byte [bp-00ah], al                    ; 88 46 f6
    test al, al                               ; 84 c0
    jne short 04f5bh                          ; 75 19
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 94 c9
    push 00587h                               ; 68 87 05
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 cd c9
    add sp, strict byte 00004h                ; 83 c4 04
    jmp near 05286h                           ; e9 2b 03
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 9c c6
    mov byte [bp-00eh], al                    ; 88 46 f2
    mov bl, al                                ; 88 c3
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 8e c6
    mov byte [bp-010h], al                    ; 88 46 f0
    mov byte [bp-00ch], al                    ; 88 46 f4
    mov dx, 00096h                            ; ba 96 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 7f c6
    mov byte [bp-008h], al                    ; 88 46 f8
    mov byte [bp-006h], al                    ; 88 46 fa
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    push CS                                   ; 0e
    ...
    mov di, 04f01h                            ; bf 01 4f
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di+04f10h]               ; 2e 8b 85 10 4f
    jmp ax                                    ; ff e0
    ...
    jmp near 0512eh                           ; e9 76 01
    mov al, byte [bp-010h]                    ; 8a 46 f0
    and AL, strict byte 0bfh                  ; 24 bf
    mov byte [bp-00ch], al                    ; 88 46 f4
    movzx bx, al                              ; 0f b6 d8
    jmp near 0512eh                           ; e9 68 01
    test byte [bp-006h], 002h                 ; f6 46 fa 02
    jne near 05268h                           ; 0f 85 9a 02
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    and AL, strict byte 07fh                  ; 24 7f
    ...
    je short 04fe7h                           ; 74 06
    not al                                    ; f6 d0
    and bl, al                                ; 20 c3
    jmp short 04fe9h                          ; eb 02
    or bl, al                                 ; 08 c3
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 1a c6
    jmp near 05268h                           ; e9 71 02
    test byte [bp-008h], 001h                 ; f6 46 f8 01
    jne near 05268h                           ; 0f 85 69 02
    or bl, 004h                               ; 80 cb 04
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 01 c6
    mov al, byte [bp-008h]                    ; 8a 46 f8
    test AL, strict byte 002h                 ; a8 02
    je short 05021h                           ; 74 0d
    or AL, strict byte 004h                   ; 0c 04
    mov byte [bp-006h], al                    ; 88 46 fa
    movzx bx, al                              ; 0f b6 d8
    mov dx, 00096h                            ; ba 96 00
    jmp short 0502fh                          ; eb 0e
    mov al, byte [bp-010h]                    ; 8a 46 f0
    or AL, strict byte 001h                   ; 0c 01
    mov byte [bp-00ch], al                    ; 88 46 f4
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 d9 c5
    jmp near 05268h                           ; e9 30 02
    test byte [bp-008h], 001h                 ; f6 46 f8 01
    jne near 05268h                           ; 0f 85 28 02
    and bl, 0fbh                              ; 80 e3 fb
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 c0 c5
    mov al, byte [bp-008h]                    ; 8a 46 f8
    test AL, strict byte 002h                 ; a8 02
    je short 05062h                           ; 74 0d
    and AL, strict byte 0fbh                  ; 24 fb
    mov byte [bp-006h], al                    ; 88 46 fa
    movzx bx, al                              ; 0f b6 d8
    mov dx, 00096h                            ; ba 96 00
    jmp short 05070h                          ; eb 0e
    mov al, byte [bp-010h]                    ; 8a 46 f0
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 98 c5
    jmp near 05268h                           ; e9 ef 01
    or bl, 008h                               ; 80 cb 08
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 87 c5
    mov al, byte [bp-008h]                    ; 8a 46 f8
    test AL, strict byte 002h                 ; a8 02
    je short 0509bh                           ; 74 0d
    or AL, strict byte 008h                   ; 0c 08
    mov byte [bp-006h], al                    ; 88 46 fa
    movzx bx, al                              ; 0f b6 d8
    mov dx, 00096h                            ; ba 96 00
    jmp short 050a9h                          ; eb 0e
    mov al, byte [bp-010h]                    ; 8a 46 f0
    or AL, strict byte 002h                   ; 0c 02
    mov byte [bp-00ch], al                    ; 88 46 f4
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 5f c5
    jmp near 05268h                           ; e9 b6 01
    and bl, 0f7h                              ; 80 e3 f7
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 4e c5
    mov al, byte [bp-008h]                    ; 8a 46 f8
    test AL, strict byte 002h                 ; a8 02
    je short 050d4h                           ; 74 0d
    and AL, strict byte 0f7h                  ; 24 f7
    mov byte [bp-006h], al                    ; 88 46 fa
    movzx bx, al                              ; 0f b6 d8
    mov dx, 00096h                            ; ba 96 00
    jmp short 050e2h                          ; eb 0e
    mov al, byte [bp-010h]                    ; 8a 46 f0
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 26 c5
    jmp near 05268h                           ; e9 7d 01
    test byte [bp-008h], 003h                 ; f6 46 f8 03
    jne near 05268h                           ; 0f 85 75 01
    mov al, byte [bp-010h]                    ; 8a 46 f0
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 07 c5
    mov bl, byte [bp-00eh]                    ; 8a 5e f2
    xor bl, 020h                              ; 80 f3 20
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 f6 c4
    jmp near 05268h                           ; e9 4d 01
    test byte [bp-008h], 003h                 ; f6 46 f8 03
    jne near 05268h                           ; 0f 85 45 01
    mov al, byte [bp-010h]                    ; 8a 46 f0
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 d7 c4
    jmp near 05268h                           ; e9 2e 01
    mov al, byte [bp-010h]                    ; 8a 46 f0
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 c0 c4
    mov bl, byte [bp-00eh]                    ; 8a 5e f2
    xor bl, 010h                              ; 80 f3 10
    jmp short 0510dh                          ; eb b7
    mov al, byte [bp-010h]                    ; 8a 46 f0
    and AL, strict byte 0efh                  ; 24 ef
    jmp short 05128h                          ; eb cb
    mov al, bl                                ; 88 d8
    and AL, strict byte 00ch                  ; 24 0c
    cmp AL, strict byte 00ch                  ; 3c 0c
    jne short 0516ah                          ; 75 05
    jmp far 0f000h:0e05bh                     ; ea 5b e0 00 f0
    test byte [bp-00ah], 080h                 ; f6 46 f6 80
    jne near 05268h                           ; 0f 85 f6 00
    cmp byte [bp-00ah], 058h                  ; 80 7e f6 58
    jbe short 05196h                          ; 76 1e
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 5e c7
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    push ax                                   ; 50
    push 005a1h                               ; 68 a1 05
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 92 c7
    add sp, strict byte 00006h                ; 83 c4 06
    jmp near 05286h                           ; e9 f0 00
    test bl, 008h                             ; f6 c3 08
    je short 051adh                           ; 74 12
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    imul si, si, strict byte 0000ah           ; 6b f6 0a
    mov dl, byte [si+00eceh]                  ; 8a 94 ce 0e
    mov ax, word [si+00eceh]                  ; 8b 84 ce 0e
    jmp near 05239h                           ; e9 8c 00
    test bl, 004h                             ; f6 c3 04
    je short 051c4h                           ; 74 12
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    imul si, si, strict byte 0000ah           ; 6b f6 0a
    mov dl, byte [si+00ecch]                  ; 8a 94 cc 0e
    mov ax, word [si+00ecch]                  ; 8b 84 cc 0e
    jmp near 05239h                           ; e9 75 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 002h                  ; 24 02
    test al, al                               ; 84 c0
    jbe short 051e2h                          ; 76 15
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    cmp AL, strict byte 047h                  ; 3c 47
    jc short 051e2h                           ; 72 0e
    cmp AL, strict byte 053h                  ; 3c 53
    jnbe short 051e2h                         ; 77 0a
    mov DL, strict byte 0e0h                  ; b2 e0
    movzx si, al                              ; 0f b6 f0
    imul si, si, strict byte 0000ah           ; 6b f6 0a
    jmp short 05235h                          ; eb 53
    test bl, 003h                             ; f6 c3 03
    je short 05214h                           ; 74 2d
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    imul si, si, strict byte 0000ah           ; 6b f6 0a
    movzx ax, byte [si+00ed0h]                ; 0f b6 84 d0 0e
    movzx dx, bl                              ; 0f b6 d3
    test dx, ax                               ; 85 c2
    je short 05204h                           ; 74 0a
    mov dl, byte [si+00ec8h]                  ; 8a 94 c8 0e
    mov ax, word [si+00ec8h]                  ; 8b 84 c8 0e
    jmp short 0520ch                          ; eb 08
    mov dl, byte [si+00ecah]                  ; 8a 94 ca 0e
    mov ax, word [si+00ecah]                  ; 8b 84 ca 0e
    shr ax, 008h                              ; c1 e8 08
    mov byte [bp-00ah], al                    ; 88 46 f6
    jmp short 0523fh                          ; eb 2b
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    imul si, si, strict byte 0000ah           ; 6b f6 0a
    movzx ax, byte [si+00ed0h]                ; 0f b6 84 d0 0e
    movzx dx, bl                              ; 0f b6 d3
    test dx, ax                               ; 85 c2
    je short 05231h                           ; 74 0a
    mov dl, byte [si+00ecah]                  ; 8a 94 ca 0e
    mov ax, word [si+00ecah]                  ; 8b 84 ca 0e
    jmp short 05239h                          ; eb 08
    mov dl, byte [si+00ec8h]                  ; 8a 94 c8 0e
    mov ax, word [si+00ec8h]                  ; 8b 84 c8 0e
    shr ax, 008h                              ; c1 e8 08
    mov byte [bp-00ah], al                    ; 88 46 f6
    cmp byte [bp-00ah], 000h                  ; 80 7e f6 00
    jne short 0525fh                          ; 75 1a
    test dl, dl                               ; 84 d2
    jne short 0525fh                          ; 75 16
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 8d c6
    push 005d8h                               ; 68 d8 05
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 c6 c6
    add sp, strict byte 00004h                ; 83 c4 04
    xor dh, dh                                ; 30 f6
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    call 04e9dh                               ; e8 35 fc
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    and AL, strict byte 07fh                  ; 24 7f
    cmp AL, strict byte 01dh                  ; 3c 1d
    je short 05275h                           ; 74 04
    and byte [bp-006h], 0feh                  ; 80 66 fa fe
    and byte [bp-006h], 0fdh                  ; 80 66 fa fd
    movzx bx, byte [bp-006h]                  ; 0f b6 5e fa
    mov dx, 00096h                            ; ba 96 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 88 c3
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
dequeue_key_:                                ; 0xf528d LB 0x94
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 75 c3
    mov bx, ax                                ; 89 c3
    mov dx, strict word 0001ch                ; ba 1c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 6a c3
    cmp bx, ax                                ; 39 c3
    je short 052f3h                           ; 74 3d
    mov dx, bx                                ; 89 da
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 42 c3
    mov cl, al                                ; 88 c1
    ...
    cmp word [bp+004h], strict byte 00000h    ; 83 7e 04 00
    je short 052eeh                           ; 74 13
    inc bx                                    ; 43
    inc bx                                    ; 43
    cmp bx, strict byte 0003eh                ; 83 fb 3e
    jc short 052e5h                           ; 72 03
    mov bx, strict word 0001eh                ; bb 1e 00
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0162ah                               ; e8 3c c3
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 052f5h                          ; eb 02
    xor ax, ax                                ; 31 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    add byte [bx-02aabh], bh                  ; 00 bf 55 d5
    push bx                                   ; 53
    sbb AL, strict byte 054h                  ; 1c 54
    push 07854h                               ; 68 54 78
    push sp                                   ; 54
    mov byte [0ab54h], AL                     ; a2 54 ab
    push sp                                   ; 54
    sbb AL, strict byte 055h                  ; 1c 55
    dec bp                                    ; 4d
    push bp                                   ; 55
    jp short 05372h                           ; 7a 55
    mov AH, strict byte 055h                  ; b4 55
    db  002h
    push si                                   ; 56
_int16_function:                             ; 0xf5321 LB 0x2e7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push di                                   ; 57
    ...
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 cf c2
    mov cl, al                                ; 88 c1
    mov bh, al                                ; 88 c7
    mov dx, 00097h                            ; ba 97 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 c2 c2
    mov bl, al                                ; 88 c3
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 0536ch                          ; 75 08
    mov AL, strict byte 021h                  ; b0 21
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 0535ah                          ; eb ee
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    jne short 053b2h                          ; 75 3b
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 053a1h                          ; 75 08
    mov AL, strict byte 021h                  ; b0 21
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 0538fh                          ; eb ee
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov dx, 00097h                            ; ba 97 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 5c c2
    sti                                       ; fb
    mov ax, word [bp+012h]                    ; 8b 46 12
    shr ax, 008h                              ; c1 e8 08
    cmp ax, 000a2h                            ; 3d a2 00
    jnbe near 055bfh                          ; 0f 87 ff 01
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 0000ch                ; b9 0c 00
    mov di, 052feh                            ; bf fe 52
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di+05309h]               ; 2e 8b 85 09 53
    jmp ax                                    ; ff e0
    push strict byte 00001h                   ; 6a 01
    mov cx, ss                                ; 8c d1
    ...
    call 0528dh                               ; e8 a9 fe
    test ax, ax                               ; 85 c0
    jne short 053f3h                          ; 75 0b
    push 0060fh                               ; 68 0f 06
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 32 c5
    add sp, strict byte 00004h                ; 83 c4 04
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je short 053ffh                           ; 74 06
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    je short 05405h                           ; 74 06
    cmp byte [bp-008h], 0e0h                  ; 80 7e f8 e0
    jne short 05409h                          ; 75 04
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    movzx dx, byte [bp-006h]                  ; 0f b6 56 fa
    sal dx, 008h                              ; c1 e2 08
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    ...
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 0528dh                               ; e8 5d fe
    test ax, ax                               ; 85 c0
    jne short 0543bh                          ; 75 07
    or word [bp+01ch], strict byte 00040h     ; 83 4e 1c 40
    jmp near 05602h                           ; e9 c7 01
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je short 05447h                           ; 74 06
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    je short 0544dh                           ; 74 06
    cmp byte [bp-008h], 0e0h                  ; 80 7e f8 e0
    jne short 05451h                          ; 75 04
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    movzx dx, byte [bp-006h]                  ; 0f b6 56 fa
    sal dx, 008h                              ; c1 e2 08
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    ...
    jmp near 05602h                           ; e9 9a 01
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 8f c1
    mov dx, word [bp+012h]                    ; 8b 56 12
    mov dl, al                                ; 88 c2
    jmp short 05416h                          ; eb 9e
    mov al, byte [bp+010h]                    ; 8a 46 10
    movzx dx, al                              ; 0f b6 d0
    mov ax, word [bp+010h]                    ; 8b 46 10
    shr ax, 008h                              ; c1 e8 08
    xor ah, ah                                ; 30 e4
    call 04e9dh                               ; e8 14 fa
    test ax, ax                               ; 85 c0
    jne short 0549ah                          ; 75 0d
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor al, al                                ; 30 c0
    or AL, strict byte 001h                   ; 0c 01
    mov word [bp+012h], ax                    ; 89 46 12
    jmp near 05602h                           ; e9 68 01
    and word [bp+012h], 0ff00h                ; 81 66 12 00 ff
    jmp near 05602h                           ; e9 60 01
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor al, al                                ; 30 c0
    or AL, strict byte 030h                   ; 0c 30
    jmp short 05494h                          ; eb e9
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 054d2h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 054d2h                          ; 76 08
    mov dx, 00080h                            ; ba 80 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 054bbh                          ; eb e9
    test bx, bx                               ; 85 db
    jbe short 05516h                          ; 76 40
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    jne short 05516h                          ; 75 35
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 054fbh                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 054fbh                          ; 76 08
    mov dx, 00080h                            ; ba 80 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 054e4h                          ; eb e9
    test bx, bx                               ; 85 db
    jbe short 0550dh                          ; 76 0e
    shr cx, 008h                              ; c1 e9 08
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    jnbe short 054e1h                         ; 77 cb
    mov word [bp+00ch], cx                    ; 89 4e 0c
    jmp near 05602h                           ; e9 e6 00
    push strict byte 00001h                   ; 6a 01
    mov cx, ss                                ; 8c d1
    lea bx, [bp-008h]                         ; 8d 5e f8
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 0528dh                               ; e8 62 fd
    test ax, ax                               ; 85 c0
    jne short 0553ah                          ; 75 0b
    push 0060fh                               ; 68 0f 06
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 eb c3
    add sp, strict byte 00004h                ; 83 c4 04
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je near 05409h                            ; 0f 84 c7 fe
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    je near 05405h                            ; 0f 84 bb fe
    jmp near 05409h                           ; e9 bc fe
    or word [bp+01ch], 00200h                 ; 81 4e 1c 00 02
    push strict byte 00000h                   ; 6a 00
    mov cx, ss                                ; 8c d1
    lea bx, [bp-008h]                         ; 8d 5e f8
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 0528dh                               ; e8 2c fd
    test ax, ax                               ; 85 c0
    je near 05434h                            ; 0f 84 cd fe
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je near 05451h                            ; 0f 84 e2 fe
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    je near 0544dh                            ; 0f 84 d6 fe
    jmp near 05451h                           ; e9 d7 fe
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 7d c0
    mov dx, word [bp+012h]                    ; 8b 56 12
    mov dl, al                                ; 88 c2
    mov word [bp+012h], dx                    ; 89 56 12
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 6c c0
    mov bh, al                                ; 88 c7
    and bh, 073h                              ; 80 e7 73
    mov dx, 00096h                            ; ba 96 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 5e c0
    and AL, strict byte 00ch                  ; 24 0c
    or bh, al                                 ; 08 c7
    mov dx, word [bp+012h]                    ; 8b 56 12
    xor dh, dh                                ; 30 f6
    movzx ax, bh                              ; 0f b6 c7
    sal ax, 008h                              ; c1 e0 08
    jmp near 05414h                           ; e9 60 fe
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    jmp near 05494h                           ; e9 d5 fe
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 17 c3
    mov ax, word [bp+012h]                    ; 8b 46 12
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 00633h                               ; 68 33 06
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 49 c3
    add sp, strict byte 00006h                ; 83 c4 06
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 fa c2
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 23 c3
    add sp, strict byte 0000ch                ; 83 c4 0c
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop di                                    ; 5f
    pop bp                                    ; 5d
    retn                                      ; c3
set_geom_lba_:                               ; 0xf5608 LB 0xe5
    push bx                                   ; 53
    push cx                                   ; 51
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, word [bp+00ch]                    ; 8b 56 0c
    mov si, strict word 00020h                ; be 20 00
    call 09b46h                               ; e8 13 45
    test ax, ax                               ; 85 c0
    jne short 05643h                          ; 75 0c
    test bx, bx                               ; 85 db
    jne short 05643h                          ; 75 08
    test cx, cx                               ; 85 c9
    jne short 05643h                          ; 75 04
    test dx, dx                               ; 85 d2
    je short 0564ah                           ; 74 07
    mov bx, strict word 0ffffh                ; bb ff ff
    mov si, bx                                ; 89 de
    jmp short 05650h                          ; eb 06
    mov bx, word [bp+00ch]                    ; 8b 5e 0c
    mov si, word [bp+00eh]                    ; 8b 76 0e
    mov word [bp-004h], bx                    ; 89 5e fc
    xor bx, bx                                ; 31 db
    jmp short 0565ch                          ; eb 05
    cmp bx, strict byte 00004h                ; 83 fb 04
    jnl short 0567fh                          ; 7d 23
    mov ax, word [bp-006h]                    ; 8b 46 fa
    cmp si, ax                                ; 39 c6
    jc short 0566dh                           ; 72 0a
    jne short 05676h                          ; 75 11
    mov ax, word [bp-004h]                    ; 8b 46 fc
    cmp ax, word [bp-008h]                    ; 3b 46 f8
    jnbe short 05676h                         ; 77 09
    ...
    xchg sp, ax                               ; 94
    push di                                   ; 57
    mov dx, 0e757h                            ; ba 57 e7
    push di                                   ; 57
    out 057h, ax                              ; e7 57
    out 057h, ax                              ; e7 57
    in ax, 059h                               ; e5 59
    adc bx, word [bp+di+013h]                 ; 13 5b 13
    pop bx                                    ; 5b
    db  0feh
    pop cx                                    ; 59
    db 0f0h, 05ah
    ...
    db  013h
    pop bx                                    ; 5b
_int13_harddisk:                             ; 0xf56ed LB 0x484
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    push ax                                   ; 50
    push 0067eh                               ; 68 7e 06
    push 006bah                               ; 68 ba 06
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 d1 c1
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 05b2eh                           ; e9 d7 03
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    ...
    cmp dl, 010h                              ; 80 fa 10
    jc short 05780h                           ; 72 10
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0067eh                               ; 68 7e 06
    push 006e5h                               ; 68 e5 06
    jmp short 0574ch                          ; eb cc
    mov bx, word [bp+016h]                    ; 8b 5e 16
    shr bx, 008h                              ; c1 eb 08
    cmp bx, strict byte 00018h                ; 83 fb 18
    jnbe near 05b13h                          ; 0f 87 86 03
    add bx, bx                                ; 01 db
    jmp word [cs:bx+056bbh]                   ; 2e ff a7 bb 56
    cmp byte [bp-002h], 008h                  ; 80 7e fe 08
    jnc near 057a3h                           ; 0f 83 07 00
    movzx ax, byte [bp-002h]                  ; 0f b6 46 fe
    call 01d2ch                               ; e8 89 c5
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    xor bx, bx                                ; 31 db
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 5c be
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 2e be
    test cl, cl                               ; 84 c9
    je short 057a7h                           ; 74 c3
    jmp near 05b4ah                           ; e9 63 03
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    mov word [bp-00ah], ax                    ; 89 46 f6
    ...
    mov ax, word [bp-00ah]                    ; 8b 46 f6
    cmp ax, 00080h                            ; 3d 80 00
    jnbe short 05822h                         ; 77 04
    test ax, ax                               ; 85 c0
    jne short 05845h                          ; 75 23
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 b4 c0
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0067eh                               ; 68 7e 06
    push 00717h                               ; 68 17 07
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 e3 c0
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 05b2eh                           ; e9 e9 02
    movzx ax, byte [bp-002h]                  ; 0f b6 46 fe
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-004h]                         ; 8e 46 fc
    mov bx, si                                ; 89 f3
    ...
    mov word [bp-00ch], dx                    ; 89 56 f4
    cmp di, ax                                ; 39 c7
    jnc short 05872h                          ; 73 0c
    cmp cx, word [bp-008h]                    ; 3b 4e f8
    jbe short 05872h                          ; 76 07
    mov ax, word [bp-006h]                    ; 8b 46 fa
    cmp ax, dx                                ; 39 d0
    jbe short 058a0h                          ; 76 2e
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 64 c0
    ...
    push ax                                   ; 50
    push 0067eh                               ; 68 7e 06
    push 0073fh                               ; 68 3f 07
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 88 c0
    add sp, strict byte 00010h                ; 83 c4 10
    jmp near 05b2eh                           ; e9 8e 02
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    cmp ax, strict word 00004h                ; 3d 04 00
    jne short 058aeh                          ; 75 03
    jmp near 057a3h                           ; e9 f5 fe
    movzx ax, byte [bp-002h]                  ; 0f b6 46 fe
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-004h]                         ; 8e 46 fc
    mov bx, si                                ; 89 f3
    ...
    push 0067eh                               ; 68 7e 06
    push 00786h                               ; 68 86 07
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 09 c0
    add sp, strict byte 00010h                ; 83 c4 10
    mov es, [bp-004h]                         ; 8e 46 fc
    db  066h, 026h, 0c7h, 044h, 018h, 000h, 000h, 000h, 000h
    ; mov dword [es:si+018h], strict dword 000000000h ; 66 26 c7 44 18 00 00 00 00
    ...
    mov word [bp+016h], bx                    ; 89 5e 16
    test dl, dl                               ; 84 d2
    je near 057a3h                            ; 0f 84 ed fd
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 20 bf
    movzx ax, dl                              ; 0f b6 c2
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0067eh                               ; 68 7e 06
    push 007afh                               ; 68 af 07
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 4b bf
    add sp, strict byte 0000ah                ; 83 c4 0a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    jmp near 05b36h                           ; e9 51 01
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 f1 be
    push 007d0h                               ; 68 d0 07
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 2a bf
    add sp, strict byte 00004h                ; 83 c4 04
    jmp near 057a3h                           ; e9 a5 fd
    movzx ax, byte [bp-002h]                  ; 0f b6 46 fe
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-004h]                         ; 8e 46 fc
    mov bx, si                                ; 89 f3
    ...
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 040h                  ; 3c 40
    jne short 05a99h                          ; 75 03
    jmp near 057a3h                           ; e9 0a fd
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 0aah                               ; 80 cc aa
    jmp near 05b36h                           ; e9 92 00
    movzx ax, byte [bp-002h]                  ; 0f b6 46 fe
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-004h]                         ; 8e 46 fc
    add si, ax                                ; 01 c6
    ...
    xor cx, cx                                ; 31 c9
    call 09a79h                               ; e8 ab 3f
    mov bx, word [bp-006h]                    ; 8b 5e fa
    xor cx, cx                                ; 31 c9
    call 09a79h                               ; e8 a3 3f
    mov word [bp-010h], ax                    ; 89 46 f0
    mov word [bp-00eh], dx                    ; 89 56 f2
    mov word [bp+014h], dx                    ; 89 56 14
    mov word [bp+012h], ax                    ; 89 46 12
    ...
    or ah, 003h                               ; 80 cc 03
    mov word [bp+016h], ax                    ; 89 46 16
    jmp near 057a7h                           ; e9 b7 fc
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 e6 bd
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0067eh                               ; 68 7e 06
    push 007eah                               ; 68 ea 07
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 15 be
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 057a3h                           ; e9 90 fc
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 c3 bd
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0067eh                               ; 68 7e 06
    push 0081dh                               ; 68 1d 08
    jmp near 0583ah                           ; e9 0c fd
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 c4 ba
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp near 057b6h                           ; e9 65 fc
    xor bl, byte [si+04ah]                    ; 32 5c 4a
    pop sp                                    ; 5c
    dec dx                                    ; 4a
    pop sp                                    ; 5c
    dec dx                                    ; 4a
    ...
    db  036h, 060h
    ; ss pushaw                                 ; 36 60
    mov si, 04a5dh                            ; be 5d 4a
    pop sp                                    ; 5c
    db  0c7h, 05dh, 036h, 060h, 085h
    ; mov word [di+036h], 08560h                ; c7 5d 36 60 85
    pushaw                                    ; 60
    test word [bx+si-07bh], sp                ; 85 60 85
    pushaw                                    ; 60
    test word [bx+si+04dh], sp                ; 85 60 4d
    pushaw                                    ; 60
    test word [bx+si-07bh], sp                ; 85 60 85
    pushaw                                    ; 60
_int13_harddisk_ext:                         ; 0xf5b71 LB 0x52f
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 00026h                ; 83 ec 26
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 9c ba
    mov word [bp-018h], ax                    ; 89 46 e8
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 90 ba
    ...
    push word [bp+010h]                       ; ff 76 10
    push word [bp+016h]                       ; ff 76 16
    push 0084bh                               ; 68 4b 08
    push 0085eh                               ; 68 5e 08
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 6e bd
    add sp, strict byte 00014h                ; 83 c4 14
    xor bx, bx                                ; 31 db
    mov dx, 0008eh                            ; ba 8e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 4c ba
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    cmp ax, 00080h                            ; 3d 80 00
    jc short 05bd1h                           ; 72 05
    cmp ax, 00090h                            ; 3d 90 00
    jc short 05befh                           ; 72 1e
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    ...
    push 006bah                               ; 68 ba 06
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 39 bd
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 06063h                           ; e9 74 04
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    ...
    push 0084bh                               ; 68 4b 08
    push 006e5h                               ; 68 e5 06
    jmp short 05be4h                          ; eb ce
    mov bx, word [bp+016h]                    ; 8b 5e 16
    shr bx, 008h                              ; c1 eb 08
    sub bx, strict byte 00041h                ; 83 eb 41
    cmp bx, strict byte 0000fh                ; 83 fb 0f
    jnbe near 06085h                          ; 0f 87 5f 04
    add bx, bx                                ; 01 db
    mov dx, word [bp+016h]                    ; 8b 56 16
    xor dh, dh                                ; 30 f6
    jmp word [cs:bx+05b51h]                   ; 2e ff a7 51 5b
    ...
    cmp si, word [es:di+03ch]                 ; 26 3b 75 3c
    jnbe short 05ce1h                         ; 77 22
    jne short 05d04h                          ; 75 43
    mov bx, word [bp-00eh]                    ; 8b 5e f2
    cmp bx, word [es:di+03ah]                 ; 26 3b 5d 3a
    jnbe short 05ce1h                         ; 77 17
    mov bx, word [bp-00eh]                    ; 8b 5e f2
    cmp bx, word [es:di+03ah]                 ; 26 3b 5d 3a
    ...
    mov word [bp-010h], ax                    ; 89 46 f0
    les bx, [bp-01eh]                         ; c4 5e e2
    mov word [es:bx+002h], ax                 ; 26 89 47 02
    test dl, dl                               ; 84 d2
    je near 06036h                            ; 0f 84 a1 02
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 41 bb
    movzx ax, dl                              ; 0f b6 c2
    push ax                                   ; 50
    push di                                   ; 57
    push 0084bh                               ; 68 4b 08
    push 007afh                               ; 68 af 07
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 72 bb
    add sp, strict byte 0000ah                ; 83 c4 0a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    jmp near 0606bh                           ; e9 ad 02
    or dh, 0b2h                               ; 80 ce b2
    mov word [bp+016h], dx                    ; 89 56 16
    jmp near 0606eh                           ; e9 a7 02
    ...
    mov word [bp-012h], ax                    ; 89 46 ee
    cmp ax, strict word 0001ah                ; 3d 1a 00
    jc near 06063h                            ; 0f 82 7f 02
    jc near 05e7bh                            ; 0f 82 93 00
    movzx ax, byte [bp-002h]                  ; 0f b6 46 fe
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    les bx, [bp-008h]                         ; c4 5e f8
    add bx, ax                                ; 01 c3
    ...
    test al, al                               ; 84 c0
    jne short 05ed8h                          ; 75 04
    xor bx, bx                                ; 31 db
    jmp short 05edbh                          ; eb 03
    ...
    or bx, cx                                 ; 09 cb
    cmp AL, strict byte 003h                  ; 3c 03
    jne short 05efch                          ; 75 05
    mov ax, strict word 00003h                ; b8 03 00
    jmp short 05efeh                          ; eb 02
    xor ax, ax                                ; 31 c0
    or bx, ax                                 ; 09 c3
    mov ax, word [bp-01ah]                    ; 8b 46 e6
    ...
    jmp short 0601bh                          ; eb 05
    cmp bh, 040h                              ; 80 ff 40
    jnc short 0602dh                          ; 73 12
    movzx dx, bh                              ; 0f b6 d7
    add dx, word [bp+00ah]                    ; 03 56 0a
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 01600h                               ; e8 d9 b5
    add bl, al                                ; 00 c3
    db  0feh, 0c7h
    ; inc bh                                    ; fe c7
    jmp short 06016h                          ; eb e9
    neg bl                                    ; f6 db
    mov es, [bp-00ah]                         ; 8e 46 f6
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 c9 b5
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    cmp dx, strict byte 00006h                ; 83 fa 06
    je short 06036h                           ; 74 e4
    cmp dx, strict byte 00001h                ; 83 fa 01
    jc short 06063h                           ; 72 0c
    jbe short 06036h                          ; 76 dd
    cmp dx, strict byte 00003h                ; 83 fa 03
    jc short 06063h                           ; 72 05
    cmp dx, strict byte 00004h                ; 83 fa 04
    jbe short 06036h                          ; 76 d3
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 8f b5
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 06049h                          ; eb c4
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 51 b8
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0084bh                               ; 68 4b 08
    push 0081dh                               ; 68 1d 08
    jmp near 05cf9h                           ; e9 59 fc
_int14_function:                             ; 0xf60a0 LB 0x155
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sti                                       ; fb
    ...
    add dx, dx                                ; 01 d2
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 6c b5
    mov si, ax                                ; 89 c6
    mov bx, ax                                ; 89 c3
    mov dx, word [bp+00eh]                    ; 8b 56 0e
    add dx, strict byte 0007ch                ; 83 c2 7c
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 40 b5
    mov cl, al                                ; 88 c1
    cmp word [bp+00eh], strict byte 00004h    ; 83 7e 0e 04
    jnc near 061ebh                           ; 0f 83 21 01
    test si, si                               ; 85 f6
    jbe near 061ebh                           ; 0f 86 1b 01
    mov al, byte [bp+013h]                    ; 8a 46 13
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 060e8h                           ; 72 11
    jbe short 0613ch                          ; 76 63
    cmp AL, strict byte 003h                  ; 3c 03
    je near 061d4h                            ; 0f 84 f5 00
    cmp AL, strict byte 002h                  ; 3c 02
    je near 0618ah                            ; 0f 84 a5 00
    jmp near 061e5h                           ; e9 fd 00
    test al, al                               ; 84 c0
    jne near 061e5h                           ; 0f 85 f7 00
    ...
    out DX, AL                                ; ee
    jmp short 06111h                          ; eb d5
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 d7 b4
    mov si, ax                                ; 89 c6
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    je short 0616ch                           ; 74 17
    test cl, cl                               ; 84 c9
    je short 0616ch                           ; 74 13
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 ba b4
    cmp ax, si                                ; 39 f0
    je short 06147h                           ; 74 e1
    mov si, ax                                ; 89 c6
    db  0feh, 0c9h
    ; dec cl                                    ; fe c9
    jmp short 06147h                          ; eb db
    test cl, cl                               ; 84 c9
    je short 06176h                           ; 74 06
    mov al, byte [bp+012h]                    ; 8a 46 12
    mov dx, bx                                ; 89 da
    out DX, AL                                ; ee
    lea dx, [bx+005h]                         ; 8d 57 05
    ...
    mov byte [bp+013h], al                    ; 88 46 13
    test cl, cl                               ; 84 c9
    jne short 061c6h                          ; 75 43
    or AL, strict byte 080h                   ; 0c 80
    mov byte [bp+013h], al                    ; 88 46 13
    jmp short 061c6h                          ; eb 3c
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 89 b4
    mov si, ax                                ; 89 c6
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 061b6h                          ; 75 17
    test cl, cl                               ; 84 c9
    je short 061b6h                           ; 74 13
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 70 b4
    cmp ax, si                                ; 39 f0
    je short 06195h                           ; 74 e5
    mov si, ax                                ; 89 c6
    db  0feh, 0c9h
    ; dec cl                                    ; fe c9
    jmp short 06195h                          ; eb df
    test cl, cl                               ; 84 c9
    je short 061cch                           ; 74 12
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov dx, bx                                ; 89 da
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    mov byte [bp+012h], al                    ; 88 46 12
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp short 061efh                          ; eb 23
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 06185h                          ; eb b1
    lea dx, [si+005h]                         ; 8d 54 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 061c3h                          ; eb de
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 061efh                          ; eb 04
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
set_enable_a20_:                             ; 0xf61f5 LB 0x2c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov cl, al                                ; 88 c1
    test bx, bx                               ; 85 db
    je short 0620eh                           ; 74 05
    or AL, strict byte 002h                   ; 0c 02
    out DX, AL                                ; ee
    jmp short 06211h                          ; eb 03
    and AL, strict byte 0fdh                  ; 24 fd
    out DX, AL                                ; ee
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_e820_range_:                             ; 0xf6221 LB 0x8c
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov es, ax                                ; 8e c0
    ...
    db  000h, 04ch, 067h, 0ech, 062h, 0ffh, 062h, 094h, 063h, 09ah, 063h, 09fh, 063h, 0a4h, 063h, 046h
    db  064h, 0e3h, 065h, 009h, 066h, 08dh, 063h, 08dh, 063h, 0d6h, 066h, 0feh, 066h, 011h, 067h, 020h
    db  067h, 094h, 063h, 027h, 067h
_int15_function:                             ; 0xf62ad LB 0x4cd
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jnbe near 0674ch                          ; 0f 87 8b 04
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 00012h                ; b9 12 00
    mov di, 06278h                            ; bf 78 62
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov si, word [cs:di+06289h]               ; 2e 8b b5 89 62
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    ...
    jne near 0674ch                           ; 0f 85 54 04
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    jmp near 066f5h                           ; e9 f6 03
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 06314h                           ; 72 0e
    jbe short 06328h                          ; 76 20
    cmp ax, strict word 00003h                ; 3d 03 00
    je short 06355h                           ; 74 48
    cmp ax, strict word 00002h                ; 3d 02 00
    je short 06338h                           ; 74 26
    jmp short 06362h                          ; eb 4e
    test ax, ax                               ; 85 c0
    jne short 06362h                          ; 75 4a
    xor ax, ax                                ; 31 c0
    call 061f5h                               ; e8 d8 fe
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp near 0638dh                           ; e9 65 00
    mov ax, strict word 00001h                ; b8 01 00
    call 061f5h                               ; e8 c7 fe
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], dh                    ; 88 76 13
    jmp near 0638dh                           ; e9 55 00
    mov dx, 00092h                            ; ba 92 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    jmp near 0638dh                           ; e9 38 00
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], ah                    ; 88 66 13
    mov word [bp+00ch], ax                    ; 89 46 0c
    jmp near 0638dh                           ; e9 2b 00
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 74 b5
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 008ech                               ; 68 ec 08
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 a7 b5
    add sp, strict byte 00006h                ; 83 c4 06
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    ...
    retn                                      ; c3
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp near 06440h                           ; e9 a6 00
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp short 0638dh                          ; eb ee
    mov word [bp+018h], cx                    ; 89 4e 18
    jmp short 0638ah                          ; eb e6
    test byte [bp+012h], 0ffh                 ; f6 46 12 ff
    je short 06416h                           ; 74 6c
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 4d b2
    test AL, strict byte 001h                 ; a8 01
    jne near 066ech                           ; 0f 85 33 03
    mov bx, strict word 00001h                ; bb 01 00
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 49 b2
    mov bx, word [bp+014h]                    ; 8b 5e 14
    mov dx, 00098h                            ; ba 98 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0162ah                               ; e8 59 b2
    mov bx, word [bp+00ch]                    ; 8b 5e 0c
    mov dx, 0009ah                            ; ba 9a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0162ah                               ; e8 4d b2
    mov bx, word [bp+00eh]                    ; 8b 5e 0e
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0162ah                               ; e8 41 b2
    mov bx, word [bp+010h]                    ; 8b 5e 10
    mov dx, 0009eh                            ; ba 9e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0162ah                               ; e8 35 b2
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov dx, 000a1h                            ; ba a1 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    out DX, AL                                ; ee
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 54 b2
    or AL, strict byte 040h                   ; 0c 40
    movzx dx, al                              ; 0f b6 d0
    mov ax, strict word 0000bh                ; b8 0b 00
    call 01679h                               ; e8 66 b2
    jmp near 0638dh                           ; e9 77 ff
    cmp ax, strict word 00001h                ; 3d 01 00
    jne short 06434h                          ; 75 19
    xor bx, bx                                ; 31 db
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 e8 b1
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 2c b2
    and AL, strict byte 0bfh                  ; 24 bf
    jmp short 0640ah                          ; eb d6
    mov word [bp+018h], bx                    ; 89 5e 18
    mov ax, dx                                ; 89 d0
    xor ah, dh                                ; 30 f4
    xor dl, dl                                ; 30 d2
    ...
    or dx, ax                                 ; 09 c2
    mov word [bp+012h], dx                    ; 89 56 12
    jmp near 0638dh                           ; e9 47 ff
    cli                                       ; fa
    mov ax, strict word 00001h                ; b8 01 00
    call 061f5h                               ; e8 a8 fd
    mov di, ax                                ; 89 c7
    mov ax, word [bp+014h]                    ; 8b 46 14
    sal ax, 004h                              ; c1 e0 04
    mov cx, word [bp+006h]                    ; 8b 4e 06
    ...
    call 0162ah                               ; e8 af b1
    mov dx, word [bp+006h]                    ; 8b 56 06
    add dx, strict byte 0000ah                ; 83 c2 0a
    mov ax, word [bp+014h]                    ; 8b 46 14
    mov bx, cx                                ; 89 cb
    call 0162ah                               ; e8 a1 b1
    movzx bx, byte [bp-006h]                  ; 0f b6 5e fa
    mov dx, word [bp+006h]                    ; 8b 56 06
    add dx, strict byte 0000ch                ; 83 c2 0c
    mov ax, word [bp+014h]                    ; 8b 46 14
    call 0160eh                               ; e8 75 b1
    mov dx, word [bp+006h]                    ; 8b 56 06
    add dx, strict byte 0000dh                ; 83 c2 0d
    mov ax, word [bp+014h]                    ; 8b 46 14
    mov bx, 00093h                            ; bb 93 00
    call 0160eh                               ; e8 66 b1
    mov dx, word [bp+006h]                    ; 8b 56 06
    add dx, strict byte 0000eh                ; 83 c2 0e
    mov ax, word [bp+014h]                    ; 8b 46 14
    xor bx, bx                                ; 31 db
    ...
    mov ax, word [bp+014h]                    ; 8b 46 14
    mov bx, strict word 0ffffh                ; bb ff ff
    call 0162ah                               ; e8 65 b1
    mov dx, word [bp+006h]                    ; 8b 56 06
    add dx, strict byte 00022h                ; 83 c2 22
    mov ax, word [bp+014h]                    ; 8b 46 14
    xor bx, bx                                ; 31 db
    call 0162ah                               ; e8 57 b1
    mov dx, word [bp+006h]                    ; 8b 56 06
    ...
    call 0160eh                               ; e8 1d b1
    mov dx, word [bp+006h]                    ; 8b 56 06
    add dx, strict byte 00026h                ; 83 c2 26
    mov ax, word [bp+014h]                    ; 8b 46 14
    xor bx, bx                                ; 31 db
    call 0162ah                               ; e8 2b b1
    mov ax, ss                                ; 8c d0
    mov cx, ax                                ; 89 c1
    sal cx, 004h                              ; c1 e1 04
    ...
    push cx                                   ; 51
    retf                                      ; cb
    jmp near 0638dh                           ; e9 b7 fc
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 00 b2
    push 0092ch                               ; 68 2c 09
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 39 b2
    add sp, strict byte 00004h                ; 83 c4 04
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    mov word [bp+012h], ax                    ; 89 46 12
    jmp near 0638dh                           ; e9 8f fc
    mov word [bp+018h], cx                    ; 89 4e 18
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+00ch], 0e6f5h                ; c7 46 0c f5 e6
    mov word [bp+014h], 0f000h                ; c7 46 14 00 f0
    jmp near 0638dh                           ; e9 7c fc
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 02 af
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 065dch                           ; e9 bc fe
    push 0095bh                               ; 68 5b 09
    push strict byte 00008h                   ; 6a 08
    jmp short 066e6h                          ; eb bf
    test byte [bp+012h], 0ffh                 ; f6 46 12 ff
    jne short 0674ch                          ; 75 1f
    mov word [bp+012h], ax                    ; 89 46 12
    mov ax, word [bp+00ch]                    ; 8b 46 0c
    xor ah, ah                                ; 30 e4
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 06745h                           ; 72 0b
    cmp ax, strict word 00003h                ; 3d 03 00
    jnbe short 06745h                         ; 77 06
    mov word [bp+018h], cx                    ; 89 4e 18
    jmp near 0638dh                           ; e9 48 fc
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    jmp near 0638dh                           ; e9 41 fc
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 8a b1
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 00972h                               ; 68 72 09
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 bd b1
    add sp, strict byte 00008h                ; 83 c4 08
    jmp short 066ech                          ; eb 82
    and bp, word [bx+di+045h]                 ; 23 69 45
    imul bp, word [bx+si+069h], 0698ah        ; 69 68 69 8a 69
    stosb                                     ; aa
    imul cx, bx, 00a69h                       ; 69 cb 69 0a
    push strict byte 00036h                   ; 6a 36
    db  06ah
_int15_function32:                           ; 0xf677a LB 0x37e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sub sp, strict byte 00008h                ; 83 ec 08
    ...
    je near 06847h                            ; 0f 84 ad 00
    cmp dx, 000d0h                            ; 81 fa d0 00
    je short 067e2h                           ; 74 42
    cmp dx, 00086h                            ; 81 fa 86 00
    jne near 06ac8h                           ; 0f 85 20 03
    sti                                       ; fb
    ...
    db  066h, 00bh, 0c9h
    ; or ecx, ecx                               ; 66 0b c9
    je near 067dfh                            ; 0f 84 0e 00
    in AL, strict byte 061h                   ; e4 61
    and AL, strict byte 010h                  ; 24 10
    db  03ah, 0c4h
    ; cmp al, ah                                ; 3a c4
    je short 067d1h                           ; 74 f8
    db  08ah, 0e0h
    ; mov ah, al                                ; 8a e0
    dec ecx                                   ; 66 49
    jne short 067d1h                          ; 75 f2
    jmp near 06af2h                           ; e9 10 03
    cmp ax, strict word 0004fh                ; 3d 4f 00
    jne near 06ac8h                           ; 0f 85 df 02
    cmp word [bp+016h], 05052h                ; 81 7e 16 52 50
    jne near 06ac8h                           ; 0f 85 d6 02
    cmp word [bp+014h], 04f43h                ; 81 7e 14 43 4f
    jne near 06ac8h                           ; 0f 85 cd 02
    cmp word [bp+01eh], 04d4fh                ; 81 7e 1e 4f 4d
    jne near 06ac8h                           ; 0f 85 c4 02
    cmp word [bp+01ch], 04445h                ; 81 7e 1c 45 44
    jne near 06ac8h                           ; 0f 85 bb 02
    mov ax, word [bp+00ah]                    ; 8b 46 0a
    or ax, word [bp+008h]                     ; 0b 46 08
    jne near 06ac8h                           ; 0f 85 b1 02
    mov ax, word [bp+006h]                    ; 8b 46 06
    or ax, word [bp+004h]                     ; 0b 46 04
    jne near 06ac8h                           ; 0f 85 a7 02
    ...
    jmp near 06af2h                           ; e9 ab 02
    cmp ax, strict word 00020h                ; 3d 20 00
    je short 06856h                           ; 74 0a
    cmp ax, strict word 00001h                ; 3d 01 00
    je near 06a7dh                            ; 0f 84 2a 02
    jmp near 06ac8h                           ; e9 72 02
    cmp word [bp+01ah], 0534dh                ; 81 7e 1a 4d 53
    jne near 06ac8h                           ; 0f 85 69 02
    cmp word [bp+018h], 04150h                ; 81 7e 18 50 41
    jne near 06ac8h                           ; 0f 85 60 02
    mov ax, strict word 00035h                ; b8 35 00
    call 0165ch                               ; e8 ee ad
    movzx bx, al                              ; 0f b6 d8
    xor dx, dx                                ; 31 d2
    ...
    jc short 0689ch                           ; 72 06
    jne short 068c9h                          ; 75 31
    test bx, bx                               ; 85 db
    jnbe short 068c9h                         ; 77 2d
    mov ax, strict word 00031h                ; b8 31 00
    call 0165ch                               ; e8 ba ad
    movzx bx, al                              ; 0f b6 d8
    xor dx, dx                                ; 31 d2
    mov cx, strict word 00008h                ; b9 08 00
    sal bx, 1                                 ; d1 e3
    ...
    call 0165ch                               ; e8 5c ad
    mov byte [bp-004h], al                    ; 88 46 fc
    mov byte [bp-006h], al                    ; 88 46 fa
    mov ax, word [bp+014h]                    ; 8b 46 14
    cmp ax, strict word 00007h                ; 3d 07 00
    jnbe near 06ac8h                          ; 0f 87 b8 01
    mov si, ax                                ; 89 c6
    add si, ax                                ; 01 c6
    mov cx, bx                                ; 89 d9
    ...
    jmp word [cs:si+0676ah]                   ; 2e ff a4 6a 67
    push strict byte 00001h                   ; 6a 01
    ...
    xor bx, bx                                ; 31 db
    xor cx, cx                                ; 31 c9
    call 06221h                               ; e8 02 f8
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 06a2ch                          ; 75 07
    mov ax, word [bp-008h]                    ; 8b 46 f8
    test ax, ax                               ; 85 c0
    je short 06a2eh                           ; 74 02
    jmp short 069eeh                          ; eb c0
    mov word [bp+014h], ax                    ; 89 46 14
    mov word [bp+016h], ax                    ; 89 46 16
    jmp short 06a67h                          ; eb 31
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 06a42h                          ; 75 06
    cmp word [bp-008h], strict byte 00000h    ; 83 7e f8 00
    je short 06a67h                           ; 74 25
    push strict byte 00001h                   ; 6a 01
    mov al, byte [bp-006h]                    ; 8a 46 fa
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    ...
    jmp short 06af2h                          ; eb 75
    mov word [bp+028h], bx                    ; 89 5e 28
    mov ax, strict word 00031h                ; b8 31 00
    call 0165ch                               ; e8 d6 ab
    movzx dx, al                              ; 0f b6 d0
    sal dx, 008h                              ; c1 e2 08
    mov ax, strict word 00030h                ; b8 30 00
    ...
    jbe short 06aa4h                          ; 76 05
    mov word [bp+01ch], 03c00h                ; c7 46 1c 00 3c
    mov ax, strict word 00035h                ; b8 35 00
    call 0165ch                               ; e8 b2 ab
    movzx dx, al                              ; 0f b6 d0
    sal dx, 008h                              ; c1 e2 08
    mov ax, strict word 00034h                ; b8 34 00
    call 0165ch                               ; e8 a6 ab
    xor ah, ah                                ; 30 e4
    or dx, ax                                 ; 09 c2
    mov word [bp+018h], dx                    ; 89 56 18
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    ...
    mov word [bp+014h], dx                    ; 89 56 14
    jmp short 06af2h                          ; eb 2a
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 0e ae
    push word [bp+014h]                       ; ff 76 14
    push word [bp+020h]                       ; ff 76 20
    push 00972h                               ; 68 72 09
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 41 ae
    add sp, strict byte 00008h                ; 83 c4 08
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_inv_op_handler:                             ; 0xf6af8 LB 0x195
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 06b0eh                          ; 75 06
    inc word [bp+018h]                        ; ff 46 18
    jmp near 06c86h                           ; e9 78 01
    cmp word [es:bx], 0050fh                  ; 26 81 3f 0f 05
    jne near 06c82h                           ; 0f 85 6b 01
    ...
    loop 06b67h                               ; e2 fa
    cmp bx, dx                                ; 39 d3
    jne short 06b75h                          ; 75 04
    cmp di, ax                                ; 39 c7
    je short 06b7ah                           ; 74 05
    ...
    loop 06b8fh                               ; e2 fa
    cmp di, dx                                ; 39 d7
    jne short 06b9dh                          ; 75 04
    cmp bx, ax                                ; 39 c3
    je short 06ba1h                           ; 74 04
    ...
    je near 06c3fh                            ; 0f 84 02 00
    mov es, ax                                ; 8e c0
    test cx, strict word 00002h               ; f7 c1 02 00
    je near 06c67h                            ; 0f 84 20 00
    ...
    iret                                      ; cf
    jmp short 06c86h                          ; eb 04
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 06c83h                          ; eb fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
init_rtc_:                                   ; 0xf6c8d LB 0x28
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, strict word 0000ah                ; b8 0a 00
    call 01679h                               ; e8 df a9
    mov dx, strict word 00002h                ; ba 02 00
    mov ax, strict word 0000bh                ; b8 0b 00
    call 01679h                               ; e8 d6 a9
    mov ax, strict word 0000ch                ; b8 0c 00
    call 0165ch                               ; e8 b3 a9
    mov ax, strict word 0000dh                ; b8 0d 00
    call 0165ch                               ; e8 ad a9
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop dx                                    ; 5a
    pop bp                                    ; 5d
    retn                                      ; c3
rtc_updating_:                               ; 0xf6cb5 LB 0x21
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, 061a8h                            ; ba a8 61
    dec dx                                    ; 4a
    je short 06ccdh                           ; 74 0e
    mov ax, strict word 0000ah                ; b8 0a 00
    call 0165ch                               ; e8 97 a9
    test AL, strict byte 080h                 ; a8 80
    jne short 06cbch                          ; 75 f3
    xor ax, ax                                ; 31 c0
    jmp short 06cd0h                          ; eb 03
    mov ax, strict word 00001h                ; b8 01 00
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop dx                                    ; 5a
    pop bp                                    ; 5d
    retn                                      ; c3
_int70_function:                             ; 0xf6cd6 LB 0xbe
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push ax                                   ; 50
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 7b a9
    mov dl, al                                ; 88 c2
    mov byte [bp-004h], al                    ; 88 46 fc
    mov ax, strict word 0000ch                ; b8 0c 00
    call 0165ch                               ; e8 70 a9
    mov dh, al                                ; 88 c6
    test dl, 060h                             ; f6 c2 60
    je near 06d7bh                            ; 0f 84 86 00
    test AL, strict byte 020h                 ; a8 20
    je short 06cfdh                           ; 74 04
    sti                                       ; fb
    int 04ah                                  ; cd 4a
    cli                                       ; fa
    test dh, 040h                             ; f6 c6 40
    je near 06d7bh                            ; 0f 84 77 00
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 f3 a8
    test al, al                               ; 84 c0
    je short 06d7bh                           ; 74 6a
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01638h                               ; e8 1e a9
    test dx, dx                               ; 85 d2
    jne short 06d67h                          ; 75 49
    cmp ax, 003d1h                            ; 3d d1 03
    jnc short 06d67h                          ; 73 44
    mov dx, 00098h                            ; ba 98 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 f0 a8
    mov si, ax                                ; 89 c6
    mov dx, 0009ah                            ; ba 9a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 e5 a8
    mov cx, ax                                ; 89 c1
    xor bx, bx                                ; 31 db
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 ca a8
    mov al, byte [bp-004h]                    ; 8a 46 fc
    and AL, strict byte 037h                  ; 24 37
    movzx dx, al                              ; 0f b6 d0
    mov ax, strict word 0000bh                ; b8 0b 00
    call 01679h                               ; e8 27 a9
    mov dx, cx                                ; 89 ca
    mov ax, si                                ; 89 f0
    call 01600h                               ; e8 a7 a8
    or AL, strict byte 080h                   ; 0c 80
    movzx bx, al                              ; 0f b6 d8
    mov dx, cx                                ; 89 ca
    mov ax, si                                ; 89 f0
    call 0160eh                               ; e8 a9 a8
    jmp short 06d7bh                          ; eb 14
    mov bx, ax                                ; 89 c3
    ...
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0164ah                               ; e8 cf a8
    call 0e03bh                               ; e8 bd 72
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
    ...
    stc                                       ; f9
    insw                                      ; 6d
    sub bp, word [bp+07ah]                    ; 2b 6e 7a
    outsb                                     ; 6e
    mov DL, strict byte 06eh                  ; b2 6e
    cmc                                       ; f5
    outsb                                     ; 6e
    dec sp                                    ; 4c
    outsw                                     ; 6f
_int1a_function:                             ; 0xf6d94 LB 0x1c8
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sti                                       ; fb
    mov al, byte [bp+013h]                    ; 8a 46 13
    cmp AL, strict byte 007h                  ; 3c 07
    jnbe near 06dd0h                          ; 0f 87 2f 00
    movzx bx, al                              ; 0f b6 d8
    add bx, bx                                ; 01 db
    jmp word [cs:bx+06d84h]                   ; 2e ff a7 84 6d
    cli                                       ; fa
    ...
    sti                                       ; fb
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp short 06dd0h                          ; eb d7
    call 06cb5h                               ; e8 b9 fe
    test ax, ax                               ; 85 c0
    je short 06e02h                           ; 74 02
    jmp short 06dd0h                          ; eb ce
    xor ax, ax                                ; 31 c0
    call 0165ch                               ; e8 55 a8
    mov byte [bp+00fh], al                    ; 88 46 0f
    mov ax, strict word 00002h                ; b8 02 00
    call 0165ch                               ; e8 4c a8
    mov byte [bp+010h], al                    ; 88 46 10
    mov ax, strict word 00004h                ; b8 04 00
    call 0165ch                               ; e8 43 a8
    mov bl, al                                ; 88 c3
    mov byte [bp+011h], al                    ; 88 46 11
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 38 a8
    and AL, strict byte 001h                  ; 24 01
    mov byte [bp+00eh], al                    ; 88 46 0e
    jmp short 06e70h                          ; eb 45
    call 06cb5h                               ; e8 87 fe
    test ax, ax                               ; 85 c0
    je short 06e35h                           ; 74 03
    call 06c8dh                               ; e8 58 fe
    movzx dx, byte [bp+00fh]                  ; 0f b6 56 0f
    xor ax, ax                                ; 31 c0
    call 01679h                               ; e8 3b a8
    ...
    movzx dx, bl                              ; 0f b6 d3
    mov ax, strict word 0000bh                ; b8 0b 00
    call 01679h                               ; e8 09 a8
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov byte [bp+012h], bl                    ; 88 5e 12
    jmp near 06dd0h                           ; e9 56 ff
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    call 06cb5h                               ; e8 34 fe
    test ax, ax                               ; 85 c0
    je short 06e88h                           ; 74 03
    jmp near 06dd0h                           ; e9 48 ff
    mov ax, strict word 00009h                ; b8 09 00
    call 0165ch                               ; e8 ce a7
    mov byte [bp+010h], al                    ; 88 46 10
    mov ax, strict word 00008h                ; b8 08 00
    call 0165ch                               ; e8 c5 a7
    mov byte [bp+00fh], al                    ; 88 46 0f
    mov ax, strict word 00007h                ; b8 07 00
    call 0165ch                               ; e8 bc a7
    mov byte [bp+00eh], al                    ; 88 46 0e
    mov ax, strict word 00032h                ; b8 32 00
    call 0165ch                               ; e8 b3 a7
    mov byte [bp+011h], al                    ; 88 46 11
    mov byte [bp+012h], al                    ; 88 46 12
    jmp near 06dd0h                           ; e9 1e ff
    call 06cb5h                               ; e8 00 fe
    test ax, ax                               ; 85 c0
    je short 06ebfh                           ; 74 06
    call 06c8dh                               ; e8 d1 fd
    jmp near 06dd0h                           ; e9 11 ff
    movzx dx, byte [bp+010h]                  ; 0f b6 56 10
    mov ax, strict word 00009h                ; b8 09 00
    call 01679h                               ; e8 b0 a7
    movzx dx, byte [bp+00fh]                  ; 0f b6 56 0f
    mov ax, strict word 00008h                ; b8 08 00
    call 01679h                               ; e8 a6 a7
    movzx dx, byte [bp+00eh]                  ; 0f b6 56 0e
    mov ax, strict word 00007h                ; b8 07 00
    call 01679h                               ; e8 9c a7
    movzx dx, byte [bp+011h]                  ; 0f b6 56 11
    mov ax, strict word 00032h                ; b8 32 00
    call 01679h                               ; e8 92 a7
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 6f a7
    mov bl, al                                ; 88 c3
    and bl, 07fh                              ; 80 e3 7f
    jmp near 06e67h                           ; e9 72 ff
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 61 a7
    mov bl, al                                ; 88 c3
    mov word [bp+012h], strict word 00000h    ; c7 46 12 00 00
    test AL, strict byte 020h                 ; a8 20
    je short 06f09h                           ; 74 03
    jmp near 06dd0h                           ; e9 c7 fe
    call 06cb5h                               ; e8 a9 fd
    test ax, ax                               ; 85 c0
    je short 06f13h                           ; 74 03
    call 06c8dh                               ; e8 7a fd
    movzx dx, byte [bp+00fh]                  ; 0f b6 56 0f
    mov ax, strict word 00001h                ; b8 01 00
    call 01679h                               ; e8 5c a7
    movzx dx, byte [bp+010h]                  ; 0f b6 56 10
    mov ax, strict word 00003h                ; b8 03 00
    call 01679h                               ; e8 52 a7
    movzx dx, byte [bp+011h]                  ; 0f b6 56 11
    mov ax, strict word 00005h                ; b8 05 00
    call 01679h                               ; e8 48 a7
    mov dx, 000a1h                            ; ba a1 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    movzx dx, al                              ; 0f b6 d0
    mov ax, strict word 0000bh                ; b8 0b 00
    call 01679h                               ; e8 30 a7
    jmp near 06dd0h                           ; e9 84 fe
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 0a a7
    mov bl, al                                ; 88 c3
    and AL, strict byte 057h                  ; 24 57
    movzx dx, al                              ; 0f b6 d0
    jmp near 06e6ah                           ; e9 0e ff
send_to_mouse_ctrl_:                         ; 0xf6f5c LB 0x34
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 06f7bh                           ; 74 0e
    push 009ach                               ; 68 ac 09
    push 01242h                               ; 68 42 12
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 aa a9
    add sp, strict byte 00006h                ; 83 c4 06
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
get_mouse_data_:                             ; 0xf6f90 LB 0x3b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    je short 06fb1h                           ; 74 07
    test cx, cx                               ; 85 c9
    je short 06fb1h                           ; 74 03
    dec cx                                    ; 49
    jmp short 06f9ch                          ; eb eb
    test cx, cx                               ; 85 c9
    jne short 06fb9h                          ; 75 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 06fc4h                          ; eb 0b
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_kbd_command_byte_:                       ; 0xf6fcb LB 0x32
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 06feah                           ; 74 0e
    push 009b6h                               ; 68 b6 09
    push 01242h                               ; 68 42 12
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 3b a9
    add sp, strict byte 00006h                ; 83 c4 06
    mov AL, strict byte 060h                  ; b0 60
    mov dx, strict word 00064h                ; ba 64 00
    out DX, AL                                ; ee
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_int74_function:                             ; 0xf6ffd LB 0xca
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 00008h                ; 83 ec 08
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 10 a6
    mov cx, ax                                ; 89 c1
    mov word [bp+004h], strict word 00000h    ; c7 46 04 00 00
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    ...
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 cf a5
    mov byte [bp-006h], al                    ; 88 46 fa
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 c4 a5
    mov byte [bp-008h], al                    ; 88 46 f8
    test AL, strict byte 080h                 ; a8 80
    je short 070b3h                           ; 74 70
    mov al, byte [bp-008h]                    ; 8a 46 f8
    and AL, strict byte 007h                  ; 24 07
    mov byte [bp-002h], al                    ; 88 46 fe
    mov al, byte [bp-006h]                    ; 8a 46 fa
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    or si, word [bx+di-07fh]                  ; 0b 71 81
    jno short 070c0h                          ; 71 04
    jc short 07053h                           ; 72 95
    jc short 070c3h                           ; 72 03
    jnc short 07119h                          ; 73 57
    jno short 070efh                          ; 71 2b
    jnc short 070b6h                          ; 73 f0
    db  073h
_int15_function_mouse:                       ; 0xf70c7 LB 0x38b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sub sp, strict byte 00006h                ; 83 ec 06
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 45 a5
    mov cx, ax                                ; 89 c1
    cmp byte [bp+012h], 007h                  ; 80 7e 12 07
    jbe short 070eah                          ; 76 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    jmp near 0744ch                           ; e9 62 03
    mov ax, strict word 00065h                ; b8 65 00
    call 06fcbh                               ; e8 db fe
    and word [bp+018h], strict byte 0fffeh    ; 83 66 18 fe
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov al, byte [bp+012h]                    ; 8a 46 12
    cmp AL, strict byte 007h                  ; 3c 07
    jnbe near 07433h                          ; 0f 87 32 03
    movzx si, al                              ; 0f b6 f0
    add si, si                                ; 01 f6
    jmp word [cs:si+070b7h]                   ; 2e ff a4 b7 70
    cmp byte [bp+00dh], 001h                  ; 80 7e 0d 01
    jnbe near 0743eh                          ; 0f 87 2b 03
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 e5 a4
    test AL, strict byte 080h                 ; a8 80
    jne short 0712ah                          ; 75 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 005h                  ; c6 46 13 05
    jmp near 07446h                           ; e9 1c 03
    cmp byte [bp+00dh], 000h                  ; 80 7e 0d 00
    db  00fh, 094h, 0c0h
    ; sete al                                   ; 0f 94 c0
    add AL, strict byte 0f4h                  ; 04 f4
    xor ah, ah                                ; 30 e4
    call 06f5ch                               ; e8 24 fe
    test al, al                               ; 84 c0
    jne near 073cch                           ; 0f 85 8e 02
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f90h                               ; e8 4a fe
    test al, al                               ; 84 c0
    je near 07446h                            ; 0f 84 fa 02
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    jne near 073cch                           ; 0f 85 78 02
    jmp near 07446h                           ; e9 ef 02
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 07162h                           ; 72 04
    cmp AL, strict byte 008h                  ; 3c 08
    jbe short 07165h                          ; 76 03
    jmp near 072f8h                           ; e9 93 01
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 93 a4
    ...
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 0160eh                               ; e8 8d a4
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 77 a4
    and AL, strict byte 0f8h                  ; 24 f8
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 0160eh                               ; e8 78 a4
    mov ax, 000ffh                            ; b8 ff 00
    call 06f5ch                               ; e8 c0 fd
    test al, al                               ; 84 c0
    jne near 073cch                           ; 0f 85 2a 02
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 06f90h                               ; e8 e6 fd
    mov cl, al                                ; 88 c1
    cmp byte [bp-004h], 0feh                  ; 80 7e fc fe
    jne short 071bdh                          ; 75 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 004h                  ; c6 46 13 04
    jmp near 07446h                           ; e9 89 02
    cmp byte [bp-004h], 0fah                  ; 80 7e fc fa
    je short 071d3h                           ; 74 10
    movzx ax, byte [bp-004h]                  ; 0f b6 46 fc
    push ax                                   ; 50
    push 009c1h                               ; 68 c1 09
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 52 a7
    add sp, strict byte 00006h                ; 83 c4 06
    test cl, cl                               ; 84 c9
    jne near 073cch                           ; 0f 85 f3 01
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f90h                               ; e8 af fd
    test al, al                               ; 84 c0
    jne near 073cch                           ; 0f 85 e5 01
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f90h                               ; e8 a1 fd
    test al, al                               ; 84 c0
    jne near 073cch                           ; 0f 85 d7 01
    mov al, byte [bp-008h]                    ; 8a 46 f8
    mov byte [bp+00ch], al                    ; 88 46 0c
    mov al, byte [bp-006h]                    ; 8a 46 fa
    mov byte [bp+00dh], al                    ; 88 46 0d
    jmp near 07446h                           ; e9 42 02
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    cmp AL, strict byte 003h                  ; 3c 03
    jc short 0721bh                           ; 72 10
    jbe short 07239h                          ; 76 2c
    cmp AL, strict byte 006h                  ; 3c 06
    je short 0724bh                           ; 74 3a
    cmp AL, strict byte 005h                  ; 3c 05
    je short 07245h                           ; 74 30
    cmp AL, strict byte 004h                  ; 3c 04
    je short 0723fh                           ; 74 26
    jmp short 07251h                          ; eb 36
    cmp AL, strict byte 002h                  ; 3c 02
    je short 07233h                           ; 74 14
    cmp AL, strict byte 001h                  ; 3c 01
    je short 0722dh                           ; 74 0a
    test al, al                               ; 84 c0
    jne short 07251h                          ; 75 2a
    mov byte [bp-008h], 00ah                  ; c6 46 f8 0a
    jmp short 07255h                          ; eb 28
    mov byte [bp-008h], 014h                  ; c6 46 f8 14
    jmp short 07255h                          ; eb 22
    mov byte [bp-008h], 028h                  ; c6 46 f8 28
    jmp short 07255h                          ; eb 1c
    mov byte [bp-008h], 03ch                  ; c6 46 f8 3c
    jmp short 07255h                          ; eb 16
    mov byte [bp-008h], 050h                  ; c6 46 f8 50
    jmp short 07255h                          ; eb 10
    mov byte [bp-008h], 064h                  ; c6 46 f8 64
    jmp short 07255h                          ; eb 0a
    mov byte [bp-008h], 0c8h                  ; c6 46 f8 c8
    jmp short 07255h                          ; eb 04
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    cmp byte [bp-008h], 000h                  ; 80 7e f8 00
    jbe short 0728ah                          ; 76 2f
    mov ax, 000f3h                            ; b8 f3 00
    call 06f5ch                               ; e8 fb fc
    test al, al                               ; 84 c0
    jne short 0727fh                          ; 75 1a
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f90h                               ; e8 23 fd
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    call 06f5ch                               ; e8 e8 fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f90h                               ; e8 14 fd
    jmp near 07446h                           ; e9 c7 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 07446h                           ; e9 bc 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 002h                  ; c6 46 13 02
    jmp near 07446h                           ; e9 b1 01
    cmp byte [bp+00dh], 004h                  ; 80 7e 0d 04
    jnc short 072f8h                          ; 73 5d
    mov ax, 000e8h                            ; b8 e8 00
    call 06f5ch                               ; e8 bb fc
    test al, al                               ; 84 c0
    jne short 072edh                          ; 75 48
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f90h                               ; e8 e3 fc
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je short 072c3h                           ; 74 10
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    push ax                                   ; 50
    push 009ech                               ; 68 ec 09
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 62 a6
    add sp, strict byte 00006h                ; 83 c4 06
    movzx ax, byte [bp+00dh]                  ; 0f b6 46 0d
    call 06f5ch                               ; e8 92 fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f90h                               ; e8 be fc
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je near 07446h                            ; 0f 84 6c 01
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    push ax                                   ; 50
    push 009ech                               ; 68 ec 09
    push strict byte 00007h                   ; 6a 07
    ...
    add sp, strict byte 00006h                ; 83 c4 06
    jmp near 07446h                           ; e9 59 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 07446h                           ; e9 4e 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 002h                  ; c6 46 13 02
    jmp near 07446h                           ; e9 43 01
    mov ax, 000f2h                            ; b8 f2 00
    call 06f5ch                               ; e8 53 fc
    test al, al                               ; 84 c0
    jne short 07320h                          ; 75 13
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f90h                               ; e8 7b fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f90h                               ; e8 73 fc
    jmp near 071fbh                           ; e9 db fe
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 07446h                           ; e9 1b 01
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    test al, al                               ; 84 c0
    jbe short 07339h                          ; 76 07
    cmp AL, strict byte 002h                  ; 3c 02
    jbe short 073a2h                          ; 76 6c
    jmp near 073d6h                           ; e9 9d 00
    mov ax, 000e9h                            ; b8 e9 00
    call 06f5ch                               ; e8 1d fc
    test al, al                               ; 84 c0
    jne near 073cch                           ; 0f 85 87 00
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f90h                               ; e8 43 fc
    mov cl, al                                ; 88 c1
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je short 07365h                           ; 74 10
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    push ax                                   ; 50
    push 009ech                               ; 68 ec 09
    push strict byte 00007h                   ; 6a 07
    ...
    add sp, strict byte 00006h                ; 83 c4 06
    test cl, cl                               ; 84 c9
    jne short 073cch                          ; 75 63
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f90h                               ; e8 1f fc
    test al, al                               ; 84 c0
    jne short 073cch                          ; 75 57
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f90h                               ; e8 13 fc
    test al, al                               ; 84 c0
    jne short 073cch                          ; 75 4b
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 06f90h                               ; e8 07 fc
    test al, al                               ; 84 c0
    jne short 073cch                          ; 75 3f
    mov al, byte [bp-008h]                    ; 8a 46 f8
    mov byte [bp+00ch], al                    ; 88 46 0c
    mov al, byte [bp-006h]                    ; 8a 46 fa
    mov byte [bp+010h], al                    ; 88 46 10
    mov al, byte [bp-004h]                    ; 8a 46 fc
    mov byte [bp+00eh], al                    ; 88 46 0e
    jmp near 07446h                           ; e9 a4 00
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 073abh                          ; 75 05
    mov ax, 000e6h                            ; b8 e6 00
    jmp short 073aeh                          ; eb 03
    mov ax, 000e7h                            ; b8 e7 00
    call 06f5ch                               ; e8 ab fb
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    jne short 073c6h                          ; 75 0f
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f90h                               ; e8 d1 fb
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    db  00fh, 095h, 0c1h
    ; setne cl                                  ; 0f 95 c1
    test cl, cl                               ; 84 c9
    je near 07446h                            ; 0f 84 7a 00
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp short 07446h                          ; eb 70
    movzx ax, byte [bp+00dh]                  ; 0f b6 46 0d
    push ax                                   ; 50
    push 00a18h                               ; 68 18 0a
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 3f a5
    add sp, strict byte 00006h                ; 83 c4 06
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    jmp short 07446h                          ; eb 56
    mov si, word [bp+00ch]                    ; 8b 76 0c
    mov bx, si                                ; 89 f3
    mov dx, strict word 00022h                ; ba 22 00
    mov ax, cx                                ; 89 c8
    call 0162ah                               ; e8 2d a2
    mov bx, word [bp+014h]                    ; 8b 5e 14
    mov dx, strict word 00024h                ; ba 24 00
    mov ax, cx                                ; 89 c8
    call 0162ah                               ; e8 22 a2
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 f0 a1
    mov ah, al                                ; 88 c4
    test si, si                               ; 85 f6
    jne short 07424h                          ; 75 0e
    cmp word [bp+014h], strict byte 00000h    ; 83 7e 14 00
    jne short 07424h                          ; 75 08
    test AL, strict byte 080h                 ; a8 80
    je short 07426h                           ; 74 06
    and AL, strict byte 07fh                  ; 24 7f
    jmp short 07426h                          ; eb 02
    or AL, strict byte 080h                   ; 0c 80
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 0160eh                               ; e8 dd a1
    jmp short 07446h                          ; eb 13
    push 00a32h                               ; 68 32 0a
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 e7 a4
    add sp, strict byte 00004h                ; 83 c4 04
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    mov ax, strict word 00047h                ; b8 47 00
    call 06fcbh                               ; e8 7f fb
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
_int17_function:                             ; 0xf7452 LB 0xb3
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push ax                                   ; 50
    ...
    add dx, strict byte 00008h                ; 83 c2 08
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 b6 a1
    mov bx, ax                                ; 89 c3
    mov si, ax                                ; 89 c6
    cmp byte [bp+013h], 003h                  ; 80 7e 13 03
    jnc near 074fbh                           ; 0f 83 89 00
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    cmp ax, strict word 00003h                ; 3d 03 00
    jnc near 074fbh                           ; 0f 83 7f 00
    test bx, bx                               ; 85 db
    jbe near 074fbh                           ; 0f 86 79 00
    mov dx, ax                                ; 89 c2
    add dx, strict byte 00078h                ; 83 c2 78
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 73 a1
    movzx cx, al                              ; 0f b6 c8
    sal cx, 008h                              ; c1 e1 08
    cmp byte [bp+013h], 000h                  ; 80 7e 13 00
    jne short 074c6h                          ; 75 2d
    mov al, byte [bp+012h]                    ; 8a 46 12
    mov dx, bx                                ; 89 da
    out DX, AL                                ; ee
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 040h                 ; a8 40
    je short 074c6h                           ; 74 07
    test cx, cx                               ; 85 c9
    je short 074c6h                           ; 74 03
    dec cx                                    ; 49
    jmp short 074b5h                          ; eb ef
    cmp byte [bp+013h], 001h                  ; 80 7e 13 01
    jne short 074e2h                          ; 75 16
    lea dx, [si+002h]                         ; 8d 54 02
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov byte [bp+013h], al                    ; 88 46 13
    test cx, cx                               ; 85 c9
    jne short 074f5h                          ; 75 04
    or byte [bp+013h], 001h                   ; 80 4e 13 01
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp short 074ffh                          ; eb 04
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
wait_:                                       ; 0xf7505 LB 0xb2
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 01638h                               ; e8 10 a1
    mov word [bp-00eh], ax                    ; 89 46 f2
    mov bx, dx                                ; 89 d3
    hlt                                       ; f4
    mov dx, 0046ch                            ; ba 6c 04
    xor ax, ax                                ; 31 c0
    call 01638h                               ; e8 02 a1
    mov word [bp-012h], ax                    ; 89 46 ee
    mov di, dx                                ; 89 d7
    cmp dx, bx                                ; 39 da
    jnbe short 07546h                         ; 77 07
    jne short 0754dh                          ; 75 0c
    cmp ax, word [bp-00eh]                    ; 3b 46 f2
    jbe short 0754dh                          ; 76 07
    sub ax, word [bp-00eh]                    ; 2b 46 f2
    sbb dx, bx                                ; 19 da
    jmp short 07558h                          ; eb 0b
    cmp dx, bx                                ; 39 da
    jc short 07558h                           ; 72 07
    jne short 0755ch                          ; 75 09
    cmp ax, word [bp-00eh]                    ; 3b 46 f2
    jnc short 0755ch                          ; 73 04
    sub si, ax                                ; 29 c6
    sbb cx, dx                                ; 19 d1
    mov ax, word [bp-012h]                    ; 8b 46 ee
    mov word [bp-00eh], ax                    ; 89 46 f2
    ...
    int 016h                                  ; cd 16
    je near 07572h                            ; 0f 84 05 00
    mov AL, strict byte 001h                  ; b0 01
    jmp near 07574h                           ; e9 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    test al, al                               ; 84 c0
    je short 0759ch                           ; 74 24
    db  033h, 0c0h
    ; xor ax, ax                                ; 33 c0
    int 016h                                  ; cd 16
    xchg ah, al                               ; 86 c4
    ...
    movzx ax, dl                              ; 0f b6 c2
    push ax                                   ; 50
    push 00a54h                               ; 68 54 0a
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 93 a3
    add sp, strict byte 00006h                ; 83 c4 06
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    je short 0759ch                           ; 74 04
    mov al, dl                                ; 88 d0
    jmp short 075aeh                          ; eb 12
    test cx, cx                               ; 85 c9
    jnle short 0752dh                         ; 7f 8d
    jne short 075a6h                          ; 75 04
    test si, si                               ; 85 f6
    jnbe short 0752dh                         ; 77 87
    mov ax, word [bp-010h]                    ; 8b 46 f0
    push ax                                   ; 50
    popfw                                     ; 9d
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
read_logo_byte_:                             ; 0xf75b7 LB 0x16
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    xor ah, ah                                ; 30 e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
read_logo_word_:                             ; 0xf75cd LB 0x14
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    xor ah, ah                                ; 30 e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
print_detected_harddisks_:                   ; 0xf75e1 LB 0x130
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 28 a0
    mov si, ax                                ; 89 c6
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    xor cl, cl                                ; 30 c9
    xor ch, ch                                ; 30 ed
    mov dx, 00304h                            ; ba 04 03
    call 01600h                               ; e8 fc 9f
    mov byte [bp-00eh], al                    ; 88 46 f2
    xor bl, bl                                ; 30 db
    cmp bl, byte [bp-00eh]                    ; 3a 5e f2
    jnc near 076e3h                           ; 0f 83 d3 00
    movzx dx, bl                              ; 0f b6 d3
    add dx, 00305h                            ; 81 c2 05 03
    mov ax, si                                ; 89 f0
    call 01600h                               ; e8 e4 9f
    mov bh, al                                ; 88 c7
    cmp AL, strict byte 00ch                  ; 3c 0c
    jc short 07646h                           ; 72 24
    test cl, cl                               ; 84 c9
    jne short 07633h                          ; 75 0d
    push 00a65h                               ; 68 65 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 f4 a2
    add sp, strict byte 00004h                ; 83 c4 04
    mov CL, strict byte 001h                  ; b1 01
    movzx ax, bl                              ; 0f b6 c3
    inc ax                                    ; 40
    ...
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 e2 a2
    add sp, strict byte 00006h                ; 83 c4 06
    jmp near 076deh                           ; e9 98 00
    cmp AL, strict byte 008h                  ; 3c 08
    jc short 0765dh                           ; 72 13
    test ch, ch                               ; 84 ed
    jne short 0765bh                          ; 75 0d
    push 00a8dh                               ; 68 8d 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 cc a2
    add sp, strict byte 00004h                ; 83 c4 04
    mov CH, strict byte 001h                  ; b5 01
    jmp short 07633h                          ; eb d6
    cmp AL, strict byte 004h                  ; 3c 04
    jnc short 07678h                          ; 73 17
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07678h                          ; 75 11
    push 00aa2h                               ; 68 a2 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 b3 a2
    add sp, strict byte 00004h                ; 83 c4 04
    mov byte [bp-00ch], 001h                  ; c6 46 f4 01
    jmp short 0768eh                          ; eb 16
    cmp bh, 004h                              ; 80 ff 04
    jc short 0768eh                           ; 72 11
    test cl, cl                               ; 84 c9
    jne short 0768eh                          ; 75 0d
    push 00ab4h                               ; 68 b4 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 99 a2
    add sp, strict byte 00004h                ; 83 c4 04
    mov CL, strict byte 001h                  ; b1 01
    movzx ax, bl                              ; 0f b6 c3
    inc ax                                    ; 40
    ...
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 87 a2
    add sp, strict byte 00006h                ; 83 c4 06
    cmp bh, 004h                              ; 80 ff 04
    jc short 076a6h                           ; 72 03
    ...
    sar ax, 1                                 ; d1 f8
    test ax, ax                               ; 85 c0
    je short 076b7h                           ; 74 05
    push 00ad2h                               ; 68 d2 0a
    jmp short 076bah                          ; eb 03
    push 00addh                               ; 68 dd 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 63 a2
    add sp, strict byte 00004h                ; 83 c4 04
    movzx ax, bh                              ; 0f b6 c7
    ...
    idiv di                                   ; f7 ff
    test dx, dx                               ; 85 d2
    je short 076d4h                           ; 74 05
    push 00ae6h                               ; 68 e6 0a
    jmp short 076d7h                          ; eb 03
    push 00aech                               ; 68 ec 0a
    push di                                   ; 57
    call 01922h                               ; e8 47 a2
    add sp, strict byte 00004h                ; 83 c4 04
    db  0feh, 0c3h
    ; inc bl                                    ; fe c3
    jmp near 07609h                           ; e9 26 ff
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 076fch                          ; 75 13
    test cl, cl                               ; 84 c9
    jne short 076fch                          ; 75 0f
    test ch, ch                               ; 84 ed
    jne short 076fch                          ; 75 0b
    push 00af3h                               ; 68 f3 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 29 a2
    add sp, strict byte 00004h                ; 83 c4 04
    push 00b07h                               ; 68 07 0b
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 1e a2
    add sp, strict byte 00004h                ; 83 c4 04
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
get_boot_drive_:                             ; 0xf7711 LB 0x28
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 fb 9e
    mov dx, 00304h                            ; ba 04 03
    call 01600h                               ; e8 d9 9e
    sub bl, 002h                              ; 80 eb 02
    cmp bl, al                                ; 38 c3
    jc short 07730h                           ; 72 02
...
show_logo_:                                  ; 0xf7739 LB 0x224
    ...
    out strict byte 040h, AL                  ; e6 40
    movzx ax, dl                              ; 0f b6 c2
    call 075cdh                               ; e8 68 fe
    cmp ax, 066bbh                            ; 3d bb 66
    jne near 0783dh                           ; 0f 85 d1 00
    push SS                                   ; 16
    pop ES                                    ; 07
    ...
    cmp ax, strict word 0004fh                ; 3d 4f 00
    jne near 0783dh                           ; 0f 85 bd 00
    mov al, dl                                ; 88 d0
    add AL, strict byte 004h                  ; 04 04
    xor ah, ah                                ; 30 e4
    call 075b7h                               ; e8 2e fe
    mov ch, al                                ; 88 c5
    mov byte [bp-00ch], al                    ; 88 46 f4
    mov al, dl                                ; 88 d0
    add AL, strict byte 005h                  ; 04 05
    xor ah, ah                                ; 30 e4
    call 075b7h                               ; e8 20 fe
    mov dh, al                                ; 88 c6
    mov byte [bp-010h], al                    ; 88 46 f0
    mov al, dl                                ; 88 d0
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 075cdh                               ; e8 28 fe
    mov bx, ax                                ; 89 c3
    mov word [bp-014h], ax                    ; 89 46 ec
    mov al, dl                                ; 88 d0
    add AL, strict byte 006h                  ; 04 06
    xor ah, ah                                ; 30 e4
    call 075b7h                               ; e8 04 fe
    mov byte [bp-012h], al                    ; 88 46 ee
    test ch, ch                               ; 84 ed
    jne short 077c4h                          ; 75 0a
    test dh, dh                               ; 84 f6
    jne short 077c4h                          ; 75 06
    test bx, bx                               ; 85 db
    je near 0783dh                            ; 0f 84 79 00
    mov bx, 00142h                            ; bb 42 01
    mov ax, 04f02h                            ; b8 02 4f
    int 010h                                  ; cd 10
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    je short 077f5h                           ; 74 23
    xor bx, bx                                ; 31 db
    jmp short 077dch                          ; eb 06
    inc bx                                    ; 43
    cmp bx, strict byte 00010h                ; 83 fb 10
    jnbe short 077fch                         ; 77 20
    mov ax, bx                                ; 89 d8
    or ah, 002h                               ; 80 cc 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00001h                ; b8 01 00
    call 07505h                               ; e8 18 fd
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 077d6h                          ; 75 e5
    mov CL, strict byte 001h                  ; b1 01
    jmp short 077fch                          ; eb 07
    mov ax, 00210h                            ; b8 10 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    test cl, cl                               ; 84 c9
    jne short 07812h                          ; 75 12
    mov ax, word [bp-014h]                    ; 8b 46 ec
    shr ax, 004h                              ; c1 e8 04
    mov dx, strict word 00001h                ; ba 01 00
    call 07505h                               ; e8 f9 fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07812h                          ; 75 02
    mov CL, strict byte 001h                  ; b1 01
    cmp byte [bp-010h], 000h                  ; 80 7e f0 00
    je short 0783dh                           ; 74 25
    test cl, cl                               ; 84 c9
    jne short 0783dh                          ; 75 21
    mov bx, strict word 00010h                ; bb 10 00
    jmp short 07826h                          ; eb 05
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 0783dh                          ; 76 17
    mov ax, bx                                ; 89 d8
    or ah, 002h                               ; 80 cc 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00001h                ; b8 01 00
    call 07505h                               ; e8 ce fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07821h                          ; 75 e6
    mov CL, strict byte 001h                  ; b1 01
    xor bx, bx                                ; 31 db
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, si                                ; 89 f0
    call 0160eh                               ; e8 c7 9d
    mov AL, strict byte 003h                  ; b0 03
    mov AH, strict byte 000h                  ; b4 00
    int 010h                                  ; cd 10
    cmp byte [bp-012h], 000h                  ; 80 7e ee 00
    je near 0793eh                            ; 0f 84 e9 00
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 0788bh                          ; 75 30
    cmp byte [bp-010h], 000h                  ; 80 7e f0 00
    jne short 0788bh                          ; 75 2a
    cmp word [bp-014h], strict byte 00000h    ; 83 7e ec 00
    jne short 0788bh                          ; 75 24
    cmp byte [bp-012h], 002h                  ; 80 7e ee 02
    jne short 07878h                          ; 75 0b
    push 00b09h                               ; 68 09 0b
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 ad a0
    add sp, strict byte 00004h                ; 83 c4 04
    test cl, cl                               ; 84 c9
    jne short 0788bh                          ; 75 0f
    mov dx, strict word 00001h                ; ba 01 00
    mov ax, 000c0h                            ; b8 c0 00
    call 07505h                               ; e8 80 fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 0788bh                          ; 75 02
    mov CL, strict byte 001h                  ; b1 01
    test cl, cl                               ; 84 c9
    je near 0793eh                            ; 0f 84 ad 00
    mov byte [bp-00eh], 000h                  ; c6 46 f2 00
    mov ax, 00100h                            ; b8 00 01
    ...
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 68 a0
    add sp, strict byte 00004h                ; 83 c4 04
    call 075e1h                               ; e8 21 fd
    push 00b6fh                               ; 68 6f 0b
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 5a a0
    add sp, strict byte 00004h                ; 83 c4 04
    mov dx, strict word 00001h                ; ba 01 00
    mov ax, strict word 00040h                ; b8 40 00
    call 07505h                               ; e8 31 fc
    mov bl, al                                ; 88 c3
    test al, al                               ; 84 c0
    je short 078cbh                           ; 74 f1
    cmp AL, strict byte 030h                  ; 3c 30
    je short 0792ch                           ; 74 4e
    cmp bl, 002h                              ; 80 fb 02
    jc short 07905h                           ; 72 22
    cmp bl, 009h                              ; 80 fb 09
    jnbe short 07905h                         ; 77 1d
    movzx ax, bl                              ; 0f b6 c3
    call 07711h                               ; e8 23 fe
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 078f4h                          ; 75 02
    jmp short 078cbh                          ; eb d7
    movzx bx, al                              ; 0f b6 d8
    mov dx, 0037ch                            ; ba 7c 03
    mov ax, si                                ; 89 f0
    call 0160eh                               ; e8 0f 9d
    mov byte [bp-00eh], 002h                  ; c6 46 f2 02
    jmp short 0792ch                          ; eb 27
    cmp bl, 02eh                              ; 80 fb 2e
    je short 0791ah                           ; 74 10
    cmp bl, 026h                              ; 80 fb 26
    je short 07920h                           ; 74 11
    cmp bl, 021h                              ; 80 fb 21
    jne short 07926h                          ; 75 12
    mov byte [bp-00eh], 001h                  ; c6 46 f2 01
    jmp short 0792ch                          ; eb 12
    mov byte [bp-00eh], 003h                  ; c6 46 f2 03
    jmp short 0792ch                          ; eb 0c
    mov byte [bp-00eh], 004h                  ; c6 46 f2 04
    jmp short 0792ch                          ; eb 06
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    je short 078cbh                           ; 74 9f
    movzx bx, byte [bp-00eh]                  ; 0f b6 5e f2
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, si                                ; 89 f0
    call 0160eh                               ; e8 d6 9c
    mov AL, strict byte 003h                  ; b0 03
    mov AH, strict byte 000h                  ; b4 00
    int 010h                                  ; cd 10
    mov AL, strict byte 034h                  ; b0 34
...
delay_boot_:                                 ; 0xf795d LB 0x67
    ...
    out strict byte 040h, AL                  ; e6 40
    push dx                                   ; 52
    push 00bb9h                               ; 68 b9 0b
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 a5 9f
    add sp, strict byte 00006h                ; 83 c4 06
    mov bx, dx                                ; 89 d3
    test bx, bx                               ; 85 db
    jbe short 0799dh                          ; 76 17
    push bx                                   ; 53
    push 00bd7h                               ; 68 d7 0b
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 93 9f
    add sp, strict byte 00006h                ; 83 c4 06
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00040h                ; b8 40 00
    call 07505h                               ; e8 6b fb
    dec bx                                    ; 4b
    jmp short 07982h                          ; eb e5
    push 00b07h                               ; 68 07 0b
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 7d 9f
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 034h                  ; b0 34
    out strict byte 043h, AL                  ; e6 43
    db  033h, 0c0h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
scsi_cmd_data_in_:                           ; 0xf79c4 LB 0xc7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    or ax, cx                                 ; 09 c8
    or ax, dx                                 ; 09 d0
    je short 07a0bh                           ; 74 04
    xor cx, cx                                ; 31 c9
    jmp short 07a0fh                          ; eb 04
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 07a31h                          ; eb ea
    mov dx, si                                ; 89 f2
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 07a47h                          ; 75 f7
    lea dx, [si+001h]                         ; 8d 54 01
    cmp word [bp+00ch], strict byte 00000h    ; 83 7e 0c 00
    jne short 07a5fh                          ; 75 06
    cmp bx, 08000h                            ; 81 fb 00 80
    jbe short 07a79h                          ; 76 1a
    ...
    pop bp                                    ; 5d
    retn 0000ah                               ; c2 0a 00
scsi_cmd_data_out_:                          ; 0xf7a8b LB 0xc9
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    or ax, cx                                 ; 09 c8
    or ax, dx                                 ; 09 d0
    je short 07ad2h                           ; 74 04
    xor cx, cx                                ; 31 c9
    jmp short 07ad6h                          ; eb 04
    movzx cx, byte [bp+004h]                  ; 0f b6 4e 04
    mov al, byte [bp-006h]                    ; 8a 46 fa
    mov dx, di                                ; 89 fa
    out DX, AL                                ; ee
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 07af8h                          ; eb ea
    lea dx, [di+001h]                         ; 8d 55 01
    cmp word [bp+00ch], strict byte 00000h    ; 83 7e 0c 00
    jne short 07b1dh                          ; 75 06
    cmp bx, 08000h                            ; 81 fb 00 80
    jbe short 07b38h                          ; 76 1b
    mov cx, 08000h                            ; b9 00 80
...
swap_64_:                                    ; 0xf7b54 LB 0x63
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@scsi_read_sectors:                          ; 0xf7bb7 LB 0xd3
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 004h                  ; 3c 04
    jbe short 07be2h                          ; 76 10
    movzx ax, byte [bp-006h]                  ; 0f b6 46 fa
    push ax                                   ; 50
    push 00bdch                               ; 68 dc 0b
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 43 9d
    add sp, strict byte 00006h                ; 83 c4 06
    mov es, [bp+006h]                         ; 8e 46 06
    mov di, word [es:si+00eh]                 ; 26 8b 7c 0e
    ...
    call 079c4h                               ; e8 61 fd
    mov ah, al                                ; 88 c4
    test al, al                               ; 84 c0
    jne short 07c7eh                          ; 75 15
    mov es, [bp+006h]                         ; 8e 46 06
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@scsi_write_sectors:                         ; 0xf7c8a LB 0xd3
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 004h                  ; 3c 04
    jbe short 07cb5h                          ; 76 10
    movzx ax, byte [bp-006h]                  ; 0f b6 46 fa
    push ax                                   ; 50
    push 00c0ah                               ; 68 0a 0c
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 70 9c
    add sp, strict byte 00006h                ; 83 c4 06
    mov es, [bp+006h]                         ; 8e 46 06
    mov di, word [es:si+00eh]                 ; 26 8b 7c 0e
    ...
    mov cx, ss                                ; 8c d1
    lea bx, [bp-01ah]                         ; 8d 5e e6
    call 07a8bh                               ; e8 55 fd
    mov ah, al                                ; 88 c4
    test al, al                               ; 84 c0
    jne short 07d51h                          ; 75 15
    mov es, [bp+006h]                         ; 8e 46 06
    mov word [es:si+018h], di                 ; 26 89 7c 18
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    mov word [es:si+01ah], dx                 ; 26 89 54 1a
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
scsi_cmd_packet_:                            ; 0xf7d5d LB 0x166
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 a3 98
    mov si, 00122h                            ; be 22 01
    mov word [bp-00eh], ax                    ; 89 46 f2
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 07da4h                          ; 75 1f
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 51 9b
    push 00c39h                               ; 68 39 0c
    push 00c49h                               ; 68 49 0c
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 87 9b
    add sp, strict byte 00006h                ; 83 c4 06
    mov dx, strict word 00001h                ; ba 01 00
    jmp near 07eb8h                           ; e9 14 01
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 07e1dh                          ; eb ea
    mov dx, bx                                ; 89 da
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 07e33h                          ; 75 f7
    test AL, strict byte 002h                 ; a8 02
    je short 07e4eh                           ; 74 0e
    lea dx, [bx+003h]                         ; 8d 57 03
    xor al, al                                ; 30 c0
    out DX, AL                                ; ee
    in AL, DX                                 ; ec
    ...
    ; sub ah, ah                                ; 2a e4
    mov dx, strict word 00003h                ; ba 03 00
    jmp short 07eb8h                          ; eb 6a
    mov ax, word [bp+004h]                    ; 8b 46 04
    test ax, ax                               ; 85 c0
    je short 07e5dh                           ; 74 08
    lea dx, [bx+001h]                         ; 8d 57 01
    mov cx, ax                                ; 89 c1
    in AL, DX                                 ; ec
    loop 07e5ah                               ; e2 fd
    ...
    cmp word [bp+008h], strict byte 00000h    ; 83 7e 08 00
    jne short 07e7eh                          ; 75 07
    cmp word [bp+006h], 08000h                ; 81 7e 06 00 80
    jbe short 07e9bh                          ; 76 1d
    mov dx, ax                                ; 89 c2
    mov cx, 08000h                            ; b9 00 80
    les di, [bp+00ch]                         ; c4 7e 0c
    rep insb                                  ; f3 6c
    ...
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
scsi_enumerate_attached_devices_:            ; 0xf7ec3 LB 0x489
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    call 079c4h                               ; e8 9c fa
    test al, al                               ; 84 c0
    je short 07f3ah                           ; 74 0e
    push 00c69h                               ; 68 69 0c
    push 00ca2h                               ; 68 a2 0c
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 eb 99
    add sp, strict byte 00006h                ; 83 c4 06
    ...
    test dx, dx                               ; 85 d2
    jne short 07f9eh                          ; 75 06
    cmp bx, 00200h                            ; 81 fb 00 02
    je short 07fbeh                           ; 74 20
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 38 99
    push dx                                   ; 52
    push word [bp-034h]                       ; ff 76 cc
    push word [bp-018h]                       ; ff 76 e8
    push 00cc1h                               ; 68 c1 0c
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 6a 99
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 082d1h                           ; e9 13 03
    mov es, [bp-020h]                         ; 8e 46 e0
    mov al, byte [es:di+0022ch]               ; 26 8a 85 2c 02
    mov byte [bp-00ch], al                    ; 88 46 f4
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 07fd9h                           ; 72 0c
    jbe short 07fe1h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 07fe9h                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 07fe5h                           ; 74 0e
    jmp short 08032h                          ; eb 59
    test al, al                               ; 84 c0
    jne short 08032h                          ; 75 55
    mov BL, strict byte 090h                  ; b3 90
    jmp short 07febh                          ; eb 0a
    mov BL, strict byte 098h                  ; b3 98
    jmp short 07febh                          ; eb 06
    mov BL, strict byte 0a0h                  ; b3 a0
    jmp short 07febh                          ; eb 02
    mov BL, strict byte 0a8h                  ; b3 a8
    mov al, bl                                ; 88 d8
    add AL, strict byte 007h                  ; 04 07
    movzx cx, al                              ; 0f b6 c8
    mov ax, cx                                ; 89 c8
    call 0165ch                               ; e8 65 96
    test al, al                               ; 84 c0
    je short 08032h                           ; 74 37
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 58 96
    movzx dx, al                              ; 0f b6 d0
    sal dx, 008h                              ; c1 e2 08
    movzx ax, bl                              ; 0f b6 c3
    call 0165ch                               ; e8 4c 96
    xor ah, ah                                ; 30 e4
    add ax, dx                                ; 01 d0
    cwd                                       ; 99
    mov si, ax                                ; 89 c6
    ...
    mov ax, word [bp-026h]                    ; 8b 46 da
    test ax, ax                               ; 85 c0
    jnbe short 0806dh                         ; 77 16
    jne near 080e2h                           ; 0f 85 87 00
    cmp word [bp-010h], strict byte 00000h    ; 83 7e f0 00
    jnbe short 0806dh                         ; 77 0c
    jne near 080e2h                           ; 0f 85 7d 00
    cmp word [bp-012h], strict byte 00040h    ; 83 7e ee 40
    jnbe short 0806dh                         ; 77 02
    jne short 080e2h                          ; 75 75
    ...
    mov ax, word [bp-01eh]                    ; 8b 46 e2
    adc ax, bx                                ; 11 d8
    jmp short 08121h                          ; eb 3f
    test ax, ax                               ; 85 c0
    jnbe short 080f8h                         ; 77 12
    jne short 08104h                          ; 75 1c
    cmp word [bp-010h], strict byte 00000h    ; 83 7e f0 00
    jnbe short 080f8h                         ; 77 0a
    jne short 08104h                          ; 75 14
    cmp word [bp-012h], strict byte 00020h    ; 83 7e ee 20
    jnbe short 080f8h                         ; 77 02
    jne short 08104h                          ; 75 0c
    mov word [bp-014h], 00080h                ; c7 46 ec 80 00
    mov word [bp-032h], strict word 00020h    ; c7 46 ce 20 00
    jmp short 0811dh                          ; eb 19
    ...
    movzx ax, byte [bp-00ch]                  ; 0f b6 46 f4
    push ax                                   ; 50
    push 00cefh                               ; 68 ef 0c
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 53 97
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 e1 93
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 e1 93
    inc byte [bp-00ch]                        ; fe 46 f4
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    mov es, [bp-020h]                         ; 8e 46 e0
    mov byte [es:di+0022ch], al               ; 26 88 85 2c 02
    jmp near 082d1h                           ; e9 93 00
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 98 96
    push word [bp-018h]                       ; ff 76 e8
    movzx ax, byte [bp-00ch]                  ; 0f b6 46 f4
    push ax                                   ; 50
    push 00d1dh                               ; 68 1d 0d
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 c9 96
    add sp, strict byte 00008h                ; 83 c4 08
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    add AL, strict byte 008h                  ; 04 08
    mov byte [bp-00eh], al                    ; 88 46 f2
    ...
    lea bx, [bp-046h]                         ; 8d 5e ba
    mov ax, word [bp-00248h]                  ; 8b 86 b8 fd
    call 079c4h                               ; e8 b9 f6
    test al, al                               ; 84 c0
    je short 0831dh                           ; 74 0e
    push 00c69h                               ; 68 69 0c
    push 00c89h                               ; 68 89 0c
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 08 96
    add sp, strict byte 00006h                ; 83 c4 06
    test byte [bp-00246h], 0e0h               ; f6 86 ba fd e0
    jne short 0832dh                          ; 75 09
    test byte [bp-00246h], 01fh               ; f6 86 ba fd 1f
    je near 07ee7h                            ; 0f 84 ba fb
    test byte [bp-00246h], 0e0h               ; f6 86 ba fd e0
    jne short 082d1h                          ; 75 9d
    mov al, byte [bp-00246h]                  ; 8a 86 ba fd
    and AL, strict byte 01fh                  ; 24 1f
    cmp AL, strict byte 005h                  ; 3c 05
    je near 0823eh                            ; 0f 84 fe fe
    jmp short 082d1h                          ; eb 8f
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop dx                                    ; 5a
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_scsi_init:                                  ; 0xf834c LB 0x66
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 c4 92
    ...
    ; sub ah, ah                                ; 2a e4
    cmp AL, strict byte 055h                  ; 3c 55
    jne short 083aeh                          ; 75 0c
    xor al, al                                ; 30 c0
    mov dx, 0043bh                            ; ba 3b 04
    out DX, AL                                ; ee
    mov ax, 00438h                            ; b8 38 04
    call 07ec3h                               ; e8 15 fb
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
high_bits_save_:                             ; 0xf83b2 LB 0x17
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
high_bits_restore_:                          ; 0xf83c9 LB 0x17
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_set_bits_:                         ; 0xf83e0 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_clear_bits_:                       ; 0xf8423 LB 0x47
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_is_bit_set_:                       ; 0xf846a LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xchg dx, ax                               ; 92
    test dx, di                               ; 85 fa
    jne short 08496h                          ; 75 04
    test ax, bx                               ; 85 d8
    je short 0849ah                           ; 74 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 0849ch                          ; eb 02
    xor al, al                                ; 30 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_extract_bits_:                     ; 0xf84a3 LB 0x1b
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov si, bx                                ; 89 de
    ...
    pop si                                    ; 5e
    retn 00002h                               ; c2 02 00
ahci_addr_to_phys_:                          ; 0xf84be LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
ahci_port_cmd_sync_:                         ; 0xf84dc LB 0xd5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov dx, si                                ; 89 f2
    mov ax, di                                ; 89 f8
    call 0846ah                               ; e8 e2 fe
    test al, al                               ; 84 c0
    je short 0856bh                           ; 74 df
    mov bx, strict word 00001h                ; bb 01 00
    xor cx, cx                                ; 31 c9
    mov dx, si                                ; 89 f2
    mov ax, di                                ; 89 f8
    call 083e0h                               ; e8 48 fe
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    add dx, 00118h                            ; 81 c2 18 01
    mov bx, strict word 00001h                ; bb 01 00
    xor cx, cx                                ; 31 c9
    mov ax, di                                ; 89 f8
    call 08423h                               ; e8 7a fe
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop cx                                    ; 59
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_cmd_data_:                              ; 0xf85b1 LB 0x22d
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    cmp ax, dx                                ; 39 d0
    jnc short 08798h                          ; 73 03
    inc ax                                    ; 40
    jmp short 08788h                          ; eb f0
    mov al, byte [bp-008h]                    ; 8a 46 f8
    cmp AL, strict byte 035h                  ; 3c 35
    jne short 087a5h                          ; 75 06
    mov byte [bp-008h], 040h                  ; c6 46 f8 40
    jmp short 087b9h                          ; eb 14
    ...
    jmp short 087b9h                          ; eb 04
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    or byte [bp-008h], 005h                   ; 80 4e f8 05
    movzx bx, byte [bp-008h]                  ; 0f b6 5e f8
    mov ax, word [bp-012h]                    ; 8b 46 ee
    mov dx, word [bp-010h]                    ; 8b 56 f0
    call 084dch                               ; e8 12 fd
    mov ax, word [bp-012h]                    ; 8b 46 ee
    add ax, 0026ah                            ; 05 6a 02
    mov dx, word [bp-010h]                    ; 8b 56 f0
    call 09a0ch                               ; e8 36 12
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop cx                                    ; 59
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_deinit_current_:                   ; 0xf87de LB 0x144
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_init_:                             ; 0xf8922 LB 0x206
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, 0c011h                            ; bb 11 c0
    xor cx, cx                                ; 31 c9
    call 0846ah                               ; e8 ff fa
    cmp AL, strict byte 001h                  ; 3c 01
    je short 08950h                           ; 74 e1
    mov cx, strict word 00020h                ; b9 20 00
    xor bx, bx                                ; 31 db
    mov ax, si                                ; 89 f0
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09aaah                               ; e8 2e 11
    lea ax, [si+00080h]                       ; 8d 84 80 00
    mov cx, strict word 00040h                ; b9 40 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09aaah                               ; e8 1f 11
    mov ax, si                                ; 89 f0
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@ahci_read_sectors:                          ; 0xf8b28 LB 0x94
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ax, ax                                ; 31 c0
    call 08922h                               ; e8 b1 fd
    mov bx, strict word 00025h                ; bb 25 00
    mov ax, di                                ; 89 f8
    mov dx, word [bp+006h]                    ; 8b 56 06
    call 085b1h                               ; e8 35 fa
    mov es, [bp+006h]                         ; 8e 46 06
    mov bx, di                                ; 89 fb
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@ahci_write_sectors:                         ; 0xf8bbc LB 0x70
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    mov si, word [bp+004h]                    ; 8b 76 04
...
ahci_cmd_packet_:                            ; 0xf8c2c LB 0x17c
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 d5 89
    mov si, 00122h                            ; be 22 01
    mov word [bp-008h], ax                    ; 89 46 f8
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 08c72h                          ; 75 1f
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 83 8c
    push 00d7ch                               ; 68 7c 0d
    push 00d8ch                               ; 68 8c 0d
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 b9 8c
    add sp, strict byte 00006h                ; 83 c4 06
    mov ax, strict word 00001h                ; b8 01 00
    jmp near 08d9fh                           ; e9 2d 01
    test byte [bp+004h], 001h                 ; f6 46 04 01
    jne short 08c6ch                          ; 75 f4
    mov ax, word [bp+006h]                    ; 8b 46 06
    ...
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    call 083c9h                               ; e8 3e f6
    les bx, [bp-00eh]                         ; c4 5e f2
    mov ax, word [es:bx+006h]                 ; 26 8b 47 06
    or ax, word [es:bx+004h]                  ; 26 0b 47 04
    jne short 08d9dh                          ; 75 05
    mov ax, strict word 00004h                ; b8 04 00
    ...
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
ahci_port_detect_device_:                    ; 0xf8da8 LB 0x492
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, di                                ; 89 fb
    call 08922h                               ; e8 60 fb
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 51 88
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 084a3h                               ; e8 2e f6
    test ax, ax                               ; 85 c0
    je near 09232h                            ; 0f 84 b7 03
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    sal ax, 007h                              ; c1 e0 07
    mov word [bp-01ah], ax                    ; 89 46 e6
    add ax, 00128h                            ; 05 28 01
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 084a3h                               ; e8 e2 f5
    cmp ax, strict word 00001h                ; 3d 01 00
    je short 08e7bh                           ; 74 b5
    push strict byte 00000h                   ; 6a 00
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    mov ax, word [bp-020h]                    ; 8b 46 e0
    mov dx, di                                ; 89 fa
    call 084a3h                               ; e8 ce f5
    cmp ax, strict word 00003h                ; 3d 03 00
    jne near 09232h                           ; 0f 85 56 03
    mov ax, word [bp-01ah]                    ; 8b 46 e6
    ...
    test dx, dx                               ; 85 d2
    jne near 09185h                           ; 0f 85 10 02
    cmp ax, 00101h                            ; 3d 01 01
    jne near 09185h                           ; 0f 85 09 02
    les bx, [bp-010h]                         ; c4 5e f0
    ...
    jne short 0900bh                          ; 75 1e
    cmp di, strict byte 0ffffh                ; 83 ff ff
    jne short 0900bh                          ; 75 19
    ...
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 09084h                           ; 72 0c
    jbe short 0908ch                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 09094h                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 09090h                           ; 74 0e
    jmp short 090ddh                          ; eb 59
    test al, al                               ; 84 c0
    jne short 090ddh                          ; 75 55
    mov DL, strict byte 040h                  ; b2 40
    jmp short 09096h                          ; eb 0a
    mov DL, strict byte 048h                  ; b2 48
    jmp short 09096h                          ; eb 06
    mov DL, strict byte 050h                  ; b2 50
    jmp short 09096h                          ; eb 02
    mov DL, strict byte 058h                  ; b2 58
    mov al, dl                                ; 88 d0
    add AL, strict byte 007h                  ; 04 07
    movzx bx, al                              ; 0f b6 d8
    mov ax, bx                                ; 89 d8
    call 0165ch                               ; e8 ba 85
    test al, al                               ; 84 c0
    je short 090ddh                           ; 74 37
    mov al, dl                                ; 88 d0
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 ad 85
    xor ah, ah                                ; 30 e4
    mov si, ax                                ; 89 c6
    sal si, 008h                              ; c1 e6 08
    movzx ax, dl                              ; 0f b6 c2
    call 0165ch                               ; e8 a0 85
    xor ah, ah                                ; 30 e4
    add ax, si                                ; 01 f0
    mov word [bp-028h], ax                    ; 89 46 d8
    mov al, dl                                ; 88 d0
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 90 85
    xor ah, ah                                ; 30 e4
    mov word [bp-02ah], ax                    ; 89 46 d6
    mov ax, bx                                ; 89 d8
    call 0165ch                               ; e8 86 85
    xor ah, ah                                ; 30 e4
    mov word [bp-026h], ax                    ; 89 46 da
    jmp short 090efh                          ; eb 12
    push word [bp-014h]                       ; ff 76 ec
    push word [bp-018h]                       ; ff 76 e8
    push word [bp-016h]                       ; ff 76 ea
    push di                                   ; 57
    ...
    call 05608h                               ; e8 19 c5
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 e7 87
    push word [bp-014h]                       ; ff 76 ec
    push word [bp-018h]                       ; ff 76 e8
    push word [bp-016h]                       ; ff 76 ea
    push di                                   ; 57
    ...
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    push ax                                   ; 50
    push 00dach                               ; 68 ac 0d
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 f7 87
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 8c 84
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 8c 84
    jmp near 09224h                           ; e9 9f 00
    cmp dx, 0eb14h                            ; 81 fa 14 eb
    jne near 09224h                           ; 0f 85 97 00
    cmp ax, 00101h                            ; 3d 01 01
    jne near 09224h                           ; 0f 85 90 00
    les bx, [bp-010h]                         ; c4 5e f0
    db  066h, 026h, 0c7h, 047h, 004h, 000h, 000h, 000h, 000h
    ; mov dword [es:bx+004h], strict dword 000000000h ; 66 26 c7 47 04 00 00 00 00
    db  066h, 026h, 0c7h, 007h, 000h, 000h, 000h, 000h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_mem_alloc_:                             ; 0xf923a LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 0161ch                               ; e8 d2 83
    test ax, ax                               ; 85 c0
    je short 09273h                           ; 74 25
    dec ax                                    ; 48
    mov bx, ax                                ; 89 c3
    xor dx, dx                                ; 31 d2
    mov cx, strict word 0000ah                ; b9 0a 00
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_hba_init_:                              ; 0xf927d LB 0x125
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    shr eax, 010h                             ; 66 c1 e8 10
    xchg dx, ax                               ; 92
    call 0923ah                               ; e8 82 ff
    mov di, ax                                ; 89 c7
    test ax, ax                               ; 85 c0
    je near 09381h                            ; 0f 84 c1 00
    mov es, [bp-010h]                         ; 8e 46 f0
    ...
    xor cx, cx                                ; 31 c9
    call 084a3h                               ; e8 69 f1
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    mov byte [bp-00eh], al                    ; 88 46 f2
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    jmp short 0934eh                          ; eb 09
    inc byte [bp-00ch]                        ; fe 46 f4
    cmp byte [bp-00ch], 020h                  ; 80 7e f4 20
    jnc short 0937fh                          ; 73 31
    movzx cx, byte [bp-00ch]                  ; 0f b6 4e f4
    mov ax, strict word 00001h                ; b8 01 00
    xor dx, dx                                ; 31 d2
    jcxz 0935fh                               ; e3 06
    ...
    mov dx, strict word 0000ch                ; ba 0c 00
    mov ax, si                                ; 89 f0
    call 0846ah                               ; e8 ff f0
    test al, al                               ; 84 c0
    je short 09345h                           ; 74 d6
    movzx bx, byte [bp-00ch]                  ; 0f b6 5e f4
    xor ax, ax                                ; 31 c0
    mov dx, di                                ; 89 fa
    call 08da8h                               ; e8 2e fa
    dec byte [bp-00eh]                        ; fe 4e f2
    jne short 09345h                          ; 75 c6
    xor ax, ax                                ; 31 c0
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    db  00bh, 005h, 004h, 003h, 002h, 001h, 000h, 071h, 094h, 04fh, 094h, 055h, 094h, 05bh, 094h, 061h
    db  094h, 067h, 094h, 06dh, 094h, 071h, 094h
_ahci_init:                                  ; 0xf93a2 LB 0xfe
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00001h                ; ba 01 00
    call 098c0h                               ; e8 0d 05
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 0ffffh                ; 3d ff ff
    je near 09499h                            ; 0f 84 dd 00
    xor al, al                                ; 30 c0
    shr ax, 008h                              ; c1 e8 08
    mov byte [bp-00ah], al                    ; 88 46 f6
    mov byte [bp-008h], dl                    ; 88 56 f8
    ...
    xor ah, ah                                ; 30 e4
    mov bx, strict word 00034h                ; bb 34 00
    call 098ebh                               ; e8 1a 05
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    je short 093fah                           ; 74 23
    movzx bx, cl                              ; 0f b6 d9
    movzx di, byte [bp-008h]                  ; 0f b6 7e f8
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 098ebh                               ; e8 02 05
    cmp AL, strict byte 012h                  ; 3c 12
    je short 093fah                           ; 74 0d
    mov al, cl                                ; 88 c8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    jmp short 093ceh                          ; eb d4
    test cl, cl                               ; 84 c9
    je near 09499h                            ; 0f 84 99 00
    ...
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 098ebh                               ; e8 d6 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne near 09499h                           ; 0f 85 7e 00
    mov byte [bp-006h], 000h                  ; c6 46 fa 00
    mov al, cl                                ; 88 c8
    add AL, strict byte 002h                  ; 04 02
    movzx bx, al                              ; 0f b6 d8
    ...
    mov al, byte [bp-006h]                    ; 8a 46 fa
    test al, al                               ; 84 c0
    je short 09499h                           ; 74 19
    movzx bx, al                              ; 0f b6 d8
    movzx dx, byte [bp-008h]                  ; 0f b6 56 f8
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    call 09931h                               ; e8 a3 04
    test AL, strict byte 001h                 ; a8 01
    je short 09499h                           ; 74 07
    and AL, strict byte 0f0h                  ; 24 f0
    add ax, si                                ; 01 f0
    call 0927dh                               ; e8 e4 fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
apm_out_str_:                                ; 0xf94a0 LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    cmp byte [bx], 000h                       ; 80 3f 00
    je short 094b5h                           ; 74 0a
    ...
    cld                                       ; fc
    xchg sp, ax                               ; 94
    enter 00e95h, 095h                        ; c8 95 0e 95
    sub word [di-06a38h], dx                  ; 29 95 c8 95
    push sp                                   ; 54
    xchg bp, ax                               ; 95
    enter 05995h, 095h                        ; c8 95 59 95
    popfw                                     ; 9d
    xchg bp, ax                               ; 95
    popfw                                     ; 9d
    xchg bp, ax                               ; 95
...
_apm_function:                               ; 0xf94d9 LB 0xf5
    ...
    jnbe near 0959dh                          ; 0f 87 b0 00
    mov bx, ax                                ; 89 c3
    add bx, ax                                ; 01 c3
    mov dx, word [bp+018h]                    ; 8b 56 18
    or dl, 001h                               ; 80 ca 01
    jmp word [cs:bx-06b45h]                   ; 2e ff a7 bb 94
    ...
    jmp near 095c8h                           ; e9 74 00
    sti                                       ; fb
    hlt                                       ; f4
    jmp near 095c8h                           ; e9 6f 00
    cmp word [bp+010h], strict byte 00003h    ; 83 7e 10 03
    je short 0957eh                           ; 74 1f
    cmp word [bp+010h], strict byte 00002h    ; 83 7e 10 02
    je short 09576h                           ; 74 11
    cmp word [bp+010h], strict byte 00001h    ; 83 7e 10 01
    jne short 09586h                          ; 75 1b
    mov dx, 08900h                            ; ba 00 89
    mov ax, 00de6h                            ; b8 e6 0d
    call 094a0h                               ; e8 2c ff
    jmp short 095c8h                          ; eb 52
    mov dx, 08900h                            ; ba 00 89
    mov ax, 00deeh                            ; b8 ee 0d
    jmp short 09571h                          ; eb f3
    mov dx, 08900h                            ; ba 00 89
    mov ax, 00df6h                            ; b8 f6 0d
    jmp short 09571h                          ; eb eb
    or ah, 00ah                               ; 80 cc 0a
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 095c8h                          ; eb 37
    mov word [bp+012h], 00102h                ; c7 46 12 02 01
    jmp short 095c8h                          ; eb 30
    or ah, 080h                               ; 80 cc 80
    jmp short 09589h                          ; eb ec
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 39 83
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 00dffh                               ; 68 ff 0d
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 6c 83
    add sp, strict byte 00008h                ; 83 c4 08
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_select_reg_:                           ; 0xf95ce LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_find_device_:                          ; 0xf95f2 LB 0xf7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 0963ah                          ; 75 2d
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, bx                                ; 89 d8
    call 095ceh                               ; e8 b9 ff
    ...
    jne short 096ach                          ; 75 08
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    cmp ax, word [bp-012h]                    ; 3b 46 ee
    je short 096b2h                           ; 74 06
    cmp word [bp-010h], strict byte 00000h    ; 83 7e f0 00
    je short 096b8h                           ; 74 06
    dec si                                    ; 4e
    cmp si, strict byte 0ffffh                ; 83 fe ff
    je short 096cah                           ; 74 12
    add bx, word [bp-00ah]                    ; 03 5e f6
    mov dx, bx                                ; 89 da
    shr dx, 008h                              ; c1 ea 08
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    cmp dx, ax                                ; 39 c2
    jbe near 09608h                           ; 0f 86 3e ff
    cmp si, strict byte 0ffffh                ; 83 fe ff
    jne short 096d3h                          ; 75 04
    mov ax, bx                                ; 89 d8
    jmp short 096d6h                          ; eb 03
    mov ax, strict word 0ffffh                ; b8 ff ff
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    clc                                       ; f8
    xchg di, ax                               ; 97
    or ax, 02098h                             ; 0d 98 20
    cbw                                       ; 98
    db  033h
    cbw                                       ; 98
_pci16_function:                             ; 0xf96e9 LB 0x1d7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ah, ah                                ; 30 e4
    cmp bx, strict byte 00003h                ; 83 fb 03
    jc short 09722h                           ; 72 1a
    jbe short 0977ah                          ; 76 70
    cmp bx, strict byte 0000eh                ; 83 fb 0e
    je near 09847h                            ; 0f 84 36 01
    cmp bx, strict byte 00008h                ; 83 fb 08
    jc near 0988ch                            ; 0f 82 74 01
    cmp bx, strict byte 0000dh                ; 83 fb 0d
    jbe near 0979fh                           ; 0f 86 80 00
    jmp near 0988ch                           ; e9 6a 01
    cmp bx, strict byte 00002h                ; 83 fb 02
    je short 0974ah                           ; 74 23
    cmp bx, strict byte 00001h                ; 83 fb 01
    jne near 0988ch                           ; 0f 85 5e 01
    ...
    jmp near 098b9h                           ; e9 6f 01
    cmp word [bp+018h], strict byte 0ffffh    ; 83 7e 18 ff
    jne short 09756h                          ; 75 06
    or ah, 083h                               ; 80 cc 83
    jmp near 098b2h                           ; e9 5c 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov dx, word [bp+01ch]                    ; 8b 56 1c
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor cx, cx                                ; 31 c9
    call 095f2h                               ; e8 8e fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09774h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 098b2h                           ; e9 3e 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 098b9h                           ; e9 3f 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    mov dx, word [bp+01eh]                    ; 8b 56 1e
    mov cx, strict word 00001h                ; b9 01 00
    call 095f2h                               ; e8 69 fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09799h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 098b2h                           ; e9 19 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 098b9h                           ; e9 1a 01
    cmp word [bp+004h], 00100h                ; 81 7e 04 00 01
    jc short 097ach                           ; 72 06
    or ah, 087h                               ; 80 cc 87
    jmp near 098b2h                           ; e9 06 01
    mov dx, word [bp+004h]                    ; 8b 56 04
    mov ax, word [bp+014h]                    ; 8b 46 14
    call 095ceh                               ; e8 19 fe
    mov bx, word [bp+020h]                    ; 8b 5e 20
    xor bh, bh                                ; 30 ff
    sub bx, strict byte 00008h                ; 83 eb 08
    cmp bx, strict byte 00005h                ; 83 fb 05
    jnbe near 098b9h                          ; 0f 87 f5 00
    add bx, bx                                ; 01 db
    jmp word [cs:bx-06923h]                   ; 2e ff a7 dd 96
    ...
    les bx, [bp-008h]                         ; c4 5e f8
    mov word [es:bx], ax                      ; 26 89 07
    jmp short 098b9h                          ; eb 2d
    mov bx, 00e7ah                            ; bb 7a 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 4a 80
    mov ax, word [bp+014h]                    ; 8b 46 14
    push ax                                   ; 50
    mov ax, word [bp+020h]                    ; 8b 46 20
    push ax                                   ; 50
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_find_classcode_:                         ; 0xf98c0 LB 0x2b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_byte_:                       ; 0xf98eb LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_word_:                       ; 0xf990f LB 0x22
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_dword_:                      ; 0xf9931 LB 0x27
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
vds_is_present_:                             ; 0xf9958 LB 0x1d
    push bx                                   ; 53
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_real_to_lin_:                            ; 0xf9975 LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_build_sg_list_:                          ; 0xf9993 LB 0x79
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    call 09958h                               ; e8 93 ff
    test ax, ax                               ; 85 c0
    je short 099dch                           ; 74 13
    mov es, si                                ; 8e c6
    mov ax, 08105h                            ; b8 05 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 099d9h                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    jmp short 09a03h                          ; eb 27
    mov es, si                                ; 8e c6
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
vds_free_sg_list_:                           ; 0xf9a0c LB 0x34
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push di                                   ; 57
    mov bx, ax                                ; 89 c3
    call 09958h                               ; e8 42 ff
    test ax, ax                               ; 85 c0
    je short 09a2dh                           ; 74 13
    mov di, bx                                ; 89 df
    mov es, dx                                ; 8e c2
    mov ax, 08106h                            ; b8 06 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 09a2ch                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    mov es, dx                                ; 8e c2
...
_fmemcpy_:                                   ; 0xf9ab7 LB 0x33
    ...
    wait                                      ; 9b
    add bl, byte [bp+di-064fah]               ; 02 9b 06 9b
    push ES                                   ; 06
    wait                                      ; 9b
    push ES                                   ; 06
    wait                                      ; 9b
    or byte [bp+di-064f8h], bl                ; 08 9b 08 9b
    or bl, byte [bp+di-064f2h]                ; 0a 9b 0e 9b
    push CS                                   ; 0e
    wait                                      ; 9b
    adc byte [bp+di-064ebh], bl               ; 10 9b 15 9b
    pop SS                                    ; 17
    wait                                      ; 9b
apm_worker:                                  ; 0xf9aea LB 0x3a
    sti                                       ; fb
    push ax                                   ; 50
    db  032h, 0e4h
    ; xor ah, ah                                ; 32 e4
    ...
    jnc short 09b20h                          ; 73 25
    jmp word [cs:bp-06530h]                   ; 2e ff a6 d0 9a
    jmp short 09b1eh                          ; eb 1c
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 09b1eh                          ; eb 18
    jmp short 09b1eh                          ; eb 16
    jmp short 09b20h                          ; eb 16
    mov AH, strict byte 080h                  ; b4 80
    jmp short 09b22h                          ; eb 14
    jmp short 09b20h                          ; eb 10
    mov ax, 00102h                            ; b8 02 01
    jmp short 09b1eh                          ; eb 09
    jmp short 09b1eh                          ; eb 07
    mov BL, strict byte 000h                  ; b3 00
    mov cx, strict word 00000h                ; b9 00 00
    jmp short 09b1eh                          ; eb 00
    clc                                       ; f8
    retn                                      ; c3
    mov AH, strict byte 009h                  ; b4 09
    stc                                       ; f9
    retn                                      ; c3
apm_pm16_entry:                              ; 0xf9b24 LB 0x12
    ...
    mov ds, bp                                ; 8e dd
    call 09aeah                               ; e8 b8 ff
    pop bp                                    ; 5d
    pop DS                                    ; 1f
    retf                                      ; cb
    times 0x1 db 0
__U8LS:                                      ; 0xf9b36 LB 0x10
    test si, si                               ; 85 f6
    je short 09b45h                           ; 74 0b
    sal dx, 1                                 ; d1 e2
    rcl cx, 1                                 ; d1 d1
    rcl bx, 1                                 ; d1 d3
    rcl ax, 1                                 ; d1 d0
    dec si                                    ; 4e
    jne short 09b3ah                          ; 75 f5
    retn                                      ; c3
__U8RS:                                      ; 0xf9b46 LB 0x10
    test si, si                               ; 85 f6
    je short 09b55h                           ; 74 0b
    shr ax, 1                                 ; d1 e8
    rcr bx, 1                                 ; d1 db
    rcr cx, 1                                 ; d1 d9
    rcr dx, 1                                 ; d1 da
    dec si                                    ; 4e
    jne short 09b4ah                          ; 75 f5
    retn                                      ; c3

  ; Padding 0x3eaa bytes at 0xf9b56
  times 16042 db 0
...
hard_drive_post:                             ; 0xfe2d2 LB 0x12c
    ...
    pop DS                                    ; 1f
    cld                                       ; fc
    call 01c5fh                               ; e8 3e 39
    call 020f1h                               ; e8 cd 3d
    call 093a2h                               ; e8 7b b0
    call 0834ch                               ; e8 22 a0
...
int13_relocated:                             ; 0xfec5b LB 0x55
    ...
    jmp near 0395bh                           ; e9 ea 4c
    push ES                                   ; 06
    push ax                                   ; 50
    push bx                                   ; 53
    push cx                                   ; 51
    push dx                                   ; 52
    call 0392fh                               ; e8 b6 4c
    cmp AL, strict byte 000h                  ; 3c 00
    je short 0ecabh                           ; 74 2e
    call 03945h                               ; e8 c5 4c
    pop dx                                    ; 5a
    push dx                                   ; 52
    db  03ah, 0c2h
    ; cmp al, dl                                ; 3a c2
...
int13_disk:                                  ; 0xfecdc LB 0xd
    ...
    call 056edh                               ; e8 09 6a
    jmp short 0ece9h                          ; eb 03
    call 05b71h                               ; e8 88 6e
...
font8x8:                                     ; 0xffa6e LB 0x421
    ...
    db  080h, 0fch, 0b1h, 075h, 00fh, 006h, 01eh, 00eh, 01fh, 0fch, 066h, 060h, 0e8h, 06ch, 098h, 066h
    db  061h, 01fh, 007h, 0cfh, 006h, 01eh, 060h, 00eh, 01fh, 0fch, 0e8h, 009h, 06fh, 061h, 01fh, 007h
    db  0cfh
