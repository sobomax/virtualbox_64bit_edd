...
_pktacc:                                     ; 0xf006a LB 0xc
    db  000h, 000h, 000h, 000h, 000h, 000h, 019h, 02bh, 0c8h, 07ch, 097h, 08bh
...
_dskacc:                                     ; 0xf0082 LB 0x2e
    ...
    db  022h, 07bh, 0f5h, 07bh, 093h, 08ah, 027h, 08bh, 000h, 000h, 000h, 000h, 000h, 000h, 05fh, 033h
    db  032h, 05fh, 000h, 0dah, 00fh, 000h, 000h, 001h, 0f3h, 000h, 000h, 000h, 000h, 000h

section CONST progbits vstart=0xb0 align=1 ; size=0xcf6 class=DATA group=DGROUP
...
section CONST2 progbits vstart=0xda6 align=1 ; size=0x3fe class=DATA group=DGROUP
_bios_cvs_version_string:                    ; 0xf0da6 LB 0x16
    db  'VirtualBox 4.3.30_OSE', 000h
_bios_prefix_string:                         ; 0xf0dbc LB 0x8
    db  'BIOS: ', 000h, 000h
_isotag:                                     ; 0xf0dc4 LB 0x6
    db  'CD001', 000h
_eltorito:                                   ; 0xf0dca LB 0x18
    db  'EL TORITO SPECIFICATION', 000h
_drivetypes:                                 ; 0xf0de2 LB 0x28
...
_scan_to_scanascii:                          ; 0xf0e0a LB 0x37a
...
_panic_msg_keyb_buffer_full:                 ; 0xf1184 LB 0x20
    db  '%s: keyboard input buffer full', 00ah, 000h

  ; Padding 0x45c bytes at 0xf11a4
  times 1116 db 0

section _TEXT progbits vstart=0x1600 align=1 ; size=0x84c6 class=CODE group=AUTO
...
cdrom_boot_:                                 ; 0xf3b19 LB 0x416
    ...
    cmp al, byte [di+00dcah]                  ; 3a 85 ca 0d
...
_int13_cdemu:                                ; 0xf3f2f LB 0x434
    ...
    xor dl, dl                                ; 30 d2
    xor cx, cx                                ; 31 c9
    call 099e9h                               ; e8 16 59
    xor bx, bx                                ; 31 db
    add ax, si                                ; 01 f0
    adc dx, bx                                ; 11 da
    mov bx, di                                ; 89 fb
    xor cx, cx                                ; 31 c9
    call 099e9h                               ; e8 09 59
    mov bx, ax                                ; 89 c3
    mov ax, word [bp-010h]                    ; 8b 46 f0
    dec ax                                    ; 48
    xor cx, cx                                ; 31 c9
...
_int09_function:                             ; 0xf4f30 LB 0x35d
    ...
    mov dl, byte [si+00e10h]                  ; 8a 94 10 0e
    mov ax, word [si+00e10h]                  ; 8b 84 10 0e
    ...
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    imul si, si, strict byte 0000ah           ; 6b f6 0a
    movzx ax, byte [si+00e12h]                ; 0f b6 84 12 0e
    movzx dx, bl                              ; 0f b6 d3
    test dx, ax                               ; 85 c2
...
set_geom_lba_:                               ; 0xf5608 LB 0xe5
    ...
    xor cx, cx                                ; 31 c9
    call 099e9h                               ; e8 5d 43
    mov bx, ax                                ; 89 c3
    mov cx, dx                                ; 89 d1
    mov ax, word [bp-004h]                    ; 8b 46 fc
    mov dx, si                                ; 89 f2
    call 099b0h                               ; e8 18 43
    ...
    jnbe short 05714h                         ; 77 57
    popfw                                     ; 9d
    push di                                   ; 57
    retf 0ca57h                               ; ca 57 ca
    push di                                   ; 57
    retf 0ab57h                               ; ca 57 ab
    pop cx                                    ; 59
    fstp dword [bp+si-027h]                   ; d9 5a d9
    pop dx                                    ; 5a
    les bx, [bx+di-04ah]                      ; c4 59 b6
    pop dx                                    ; 5a
    fstp dword [bp+si-027h]                   ; d9 5a d9
    pop dx                                    ; 5a
    mov DH, strict byte 05ah                  ; b6 5a
    mov DH, strict byte 05ah                  ; b6 5a
    fstp dword [bp+si-027h]                   ; d9 5a d9
    pop dx                                    ; 5a
    cmp bl, byte [bp+si-04ah]                 ; 3a 5a b6
    pop dx                                    ; 5a
    fstp dword [bp+si-027h]                   ; d9 5a d9
    pop dx                                    ; 5a
    mov DH, strict byte 05ah                  ; b6 5a
    ...
    db  0d9h
    pop dx                                    ; 5a
_int13_harddisk:                             ; 0xf56ed LB 0x44a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 00010h                ; 83 ec 10
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 20 bf
    mov si, 00122h                            ; be 22 01
    ...
    jc short 0571ch                           ; 72 05
    cmp ax, 00090h                            ; 3d 90 00
    jc short 0573ah                           ; 72 1e
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 ee c1
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 05af4h                           ; e9 ba 03
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 4b be
    test cl, cl                               ; 84 c9
    je short 0578ah                           ; 74 c3
    jmp near 05b10h                           ; e9 46 03
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    mov word [bp-00ch], ax                    ; 89 46 f4
    ...
    mov ax, word [bp-00ch]                    ; 8b 46 f4
    cmp ax, 00080h                            ; 3d 80 00
    jnbe short 05805h                         ; 77 04
    test ax, ax                               ; 85 c0
    jne short 05828h                          ; 75 23
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 d1 c0
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0067eh                               ; 68 7e 06
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 00 c1
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 05af4h                           ; e9 cc 02
    movzx ax, byte [bp-002h]                  ; 0f b6 46 fe
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-004h]                         ; 8e 46 fc
    mov bx, si                                ; 89 f3
    ...
    mov word [bp-00ah], dx                    ; 89 56 f6
    cmp di, ax                                ; 39 c7
    jnc short 05855h                          ; 73 0c
    cmp cx, word [bp-008h]                    ; 3b 4e f8
    jbe short 05855h                          ; 76 07
    mov ax, word [bp-006h]                    ; 8b 46 fa
    cmp ax, dx                                ; 39 d0
    jbe short 05883h                          ; 76 2e
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 81 c0
    ...
    mov word [bp+016h], bx                    ; 89 5e 16
    test dl, dl                               ; 84 d2
    je near 05786h                            ; 0f 84 0a fe
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 5a bf
    movzx ax, dl                              ; 0f b6 c2
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 85 bf
    add sp, strict byte 0000ah                ; 83 c4 0a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    jmp near 05afch                           ; e9 51 01
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 2b bf
    push 0077ah                               ; 68 7a 07
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 64 bf
    add sp, strict byte 00004h                ; 83 c4 04
    jmp near 05786h                           ; e9 c2 fd
    movzx ax, byte [bp-002h]                  ; 0f b6 46 fe
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-004h]                         ; 8e 46 fc
    mov bx, si                                ; 89 f3
    ...
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 040h                  ; 3c 40
    jne short 05a5fh                          ; 75 03
    jmp near 05786h                           ; e9 27 fd
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 0aah                               ; 80 cc aa
    jmp near 05afch                           ; e9 92 00
    movzx ax, byte [bp-002h]                  ; 0f b6 46 fe
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-004h]                         ; 8e 46 fc
    add si, ax                                ; 01 c6
    ...
    xor cx, cx                                ; 31 c9
    call 099e9h                               ; e8 55 3f
    mov bx, word [bp-006h]                    ; 8b 5e fa
    xor cx, cx                                ; 31 c9
    call 099e9h                               ; e8 4d 3f
    mov word [bp-010h], ax                    ; 89 46 f0
    mov word [bp-00eh], dx                    ; 89 56 f2
    mov word [bp+014h], dx                    ; 89 56 14
    mov word [bp+012h], ax                    ; 89 46 12
    ...
    or ah, 003h                               ; 80 cc 03
    mov word [bp+016h], ax                    ; 89 46 16
    jmp near 0578ah                           ; e9 d4 fc
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 20 be
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0067eh                               ; 68 7e 06
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 4f be
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 05786h                           ; e9 ad fc
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 fd bd
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0067eh                               ; 68 7e 06
    push 007c7h                               ; 68 c7 07
    jmp near 0581dh                           ; e9 29 fd
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 fe ba
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp near 05799h                           ; e9 82 fc
    aad 05bh                                  ; d5 5b
    in ax, DX                                 ; ed
    pop bx                                    ; 5b
    in ax, DX                                 ; ed
    ...
    in ax, DX                                 ; ed
    pop bx                                    ; 5b
    rcr word [bx+042h], 05dh                  ; c1 5f 42 5d
    in ax, DX                                 ; ed
    pop bx                                    ; 5b
    dec ax                                    ; 48
    pop bp                                    ; 5d
    rcr word [bx+010h], 060h                  ; c1 5f 10 60
    adc byte [bx+si+010h], ah                 ; 10 60 10
    pushaw                                    ; 60
    adc byte [bx+si-028h], ah                 ; 10 60 d8
    pop di                                    ; 5f
    adc byte [bx+si+010h], ah                 ; 10 60 10
    pushaw                                    ; 60
_int13_harddisk_ext:                         ; 0xf5b37 LB 0x4f4
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 ca ba
    mov word [bp-008h], 00122h                ; c7 46 f8 22 01
    mov word [bp-006h], ax                    ; 89 46 fa
    xor bx, bx                                ; 31 db
    mov dx, 0008eh                            ; ba 8e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 a9 ba
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    cmp ax, 00080h                            ; 3d 80 00
    jc short 05b74h                           ; 72 05
    cmp ax, 00090h                            ; 3d 90 00
    jc short 05b92h                           ; 72 1e
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, word [bp+016h]                    ; 8b 46 16
    ...
    push 0068dh                               ; 68 8d 06
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 96 bd
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 05feeh                           ; e9 5c 04
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    ...
    push 007f5h                               ; 68 f5 07
    push 006b8h                               ; 68 b8 06
    jmp short 05b87h                          ; eb ce
    mov bx, word [bp+016h]                    ; 8b 5e 16
    shr bx, 008h                              ; c1 eb 08
    sub bx, strict byte 00041h                ; 83 eb 41
    cmp bx, strict byte 0000fh                ; 83 fb 0f
    jnbe near 06010h                          ; 0f 87 47 04
    add bx, bx                                ; 01 db
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    jmp word [cs:bx+05b17h]                   ; 2e ff a7 17 5b
    ...
    jnbe short 05c67h                         ; 77 22
    jne short 05c8ah                          ; 75 43
    mov si, word [bp-00eh]                    ; 8b 76 f2
    cmp si, word [es:di+03ah]                 ; 26 3b 75 3a
    jnbe short 05c67h                         ; 77 17
    mov si, word [bp-00eh]                    ; 8b 76 f2
    cmp si, word [es:di+03ah]                 ; 26 3b 75 3a
    jne short 05c8ah                          ; 75 31
    cmp cx, word [es:di+038h]                 ; 26 3b 4d 38
    jnbe short 05c67h                         ; 77 08
    jne short 05c8ah                          ; 75 29
    cmp dx, word [es:di+036h]                 ; 26 3b 55 36
    jc short 05c8ah                           ; 72 23
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 6f bc
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 007f5h                               ; 68 f5 07
    ...
    mov word [es:bx+002h], ax                 ; 26 89 47 02
    test dl, dl                               ; 84 d2
    je near 05fc1h                            ; 0f 84 a8 02
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 bd bb
    movzx ax, dl                              ; 0f b6 c2
    push ax                                   ; 50
    push di                                   ; 57
    push 007f5h                               ; 68 f5 07
    push 00759h                               ; 68 59 07
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 ee bb
    add sp, strict byte 0000ah                ; 83 c4 0a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    jmp near 05ff6h                           ; e9 b4 02
    or ah, 0b2h                               ; 80 cc b2
    jmp near 05ff6h                           ; e9 ae 02
    ...
    mov word [bp-010h], ax                    ; 89 46 f0
    cmp ax, strict word 0001ah                ; 3d 1a 00
    jc near 05feeh                            ; 0f 82 89 02
    jc near 05e04h                            ; 0f 82 9b 00
    ...
    test al, al                               ; 84 c0
    jne short 05e63h                          ; 75 04
    xor bx, bx                                ; 31 db
    jmp short 05e66h                          ; eb 03
    ...
    or bx, cx                                 ; 09 cb
    cmp AL, strict byte 003h                  ; 3c 03
    jne short 05e87h                          ; 75 05
    mov ax, strict word 00003h                ; b8 03 00
    jmp short 05e89h                          ; eb 02
    xor ax, ax                                ; 31 c0
    or bx, ax                                 ; 09 c3
    mov ax, word [bp-01eh]                    ; 8b 46 e2
    les si, [bp-008h]                         ; c4 76 f8
    ...
    jmp short 05fa6h                          ; eb 05
    cmp bh, 040h                              ; 80 ff 40
    jnc short 05fb8h                          ; 73 12
    movzx dx, bh                              ; 0f b6 d7
    add dx, word [bp+00ah]                    ; 03 56 0a
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 01600h                               ; e8 4e b6
    add bl, al                                ; 00 c3
    db  0feh, 0c7h
    ; inc bh                                    ; fe c7
    jmp short 05fa1h                          ; eb e9
    neg bl                                    ; f6 db
    mov es, [bp-00ah]                         ; 8e 46 f6
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 3e b6
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    cmp ax, strict word 00006h                ; 3d 06 00
    je short 05fc1h                           ; 74 e4
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 05feeh                           ; 72 0c
    jbe short 05fc1h                          ; 76 dd
    cmp ax, strict word 00003h                ; 3d 03 00
    jc short 05feeh                           ; 72 05
    cmp ax, strict word 00004h                ; 3d 04 00
    jbe short 05fc1h                          ; 76 d3
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 04 b6
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 05fd4h                          ; eb c4
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 c6 b8
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 007f5h                               ; 68 f5 07
    push 007c7h                               ; 68 c7 07
    jmp near 05c7fh                           ; e9 54 fc
_int14_function:                             ; 0xf602b LB 0x155
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sti                                       ; fb
    ...
    add dx, dx                                ; 01 d2
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 e1 b5
    mov si, ax                                ; 89 c6
    mov bx, ax                                ; 89 c3
    mov dx, word [bp+00eh]                    ; 8b 56 0e
    add dx, strict byte 0007ch                ; 83 c2 7c
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 b5 b5
    mov cl, al                                ; 88 c1
    cmp word [bp+00eh], strict byte 00004h    ; 83 7e 0e 04
    jnc near 06176h                           ; 0f 83 21 01
    test si, si                               ; 85 f6
    jbe near 06176h                           ; 0f 86 1b 01
    mov al, byte [bp+013h]                    ; 8a 46 13
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 06073h                           ; 72 11
    jbe short 060c7h                          ; 76 63
    cmp AL, strict byte 003h                  ; 3c 03
    je near 0615fh                            ; 0f 84 f5 00
    cmp AL, strict byte 002h                  ; 3c 02
    je near 06115h                            ; 0f 84 a5 00
    jmp near 06170h                           ; e9 fd 00
    test al, al                               ; 84 c0
    jne near 06170h                           ; 0f 85 f7 00
    ...
    out DX, AL                                ; ee
    jmp short 0609ch                          ; eb d5
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 4c b5
    mov si, ax                                ; 89 c6
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    je short 060f7h                           ; 74 17
    test cl, cl                               ; 84 c9
    je short 060f7h                           ; 74 13
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 2f b5
    cmp ax, si                                ; 39 f0
    je short 060d2h                           ; 74 e1
    mov si, ax                                ; 89 c6
    db  0feh, 0c9h
    ; dec cl                                    ; fe c9
    jmp short 060d2h                          ; eb db
    test cl, cl                               ; 84 c9
    je short 06101h                           ; 74 06
    mov al, byte [bp+012h]                    ; 8a 46 12
    mov dx, bx                                ; 89 da
    out DX, AL                                ; ee
    lea dx, [bx+005h]                         ; 8d 57 05
    ...
    mov byte [bp+013h], al                    ; 88 46 13
    test cl, cl                               ; 84 c9
    jne short 06151h                          ; 75 43
    or AL, strict byte 080h                   ; 0c 80
    mov byte [bp+013h], al                    ; 88 46 13
    jmp short 06151h                          ; eb 3c
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 fe b4
    mov si, ax                                ; 89 c6
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 06141h                          ; 75 17
    test cl, cl                               ; 84 c9
    je short 06141h                           ; 74 13
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 e5 b4
    cmp ax, si                                ; 39 f0
    je short 06120h                           ; 74 e5
    mov si, ax                                ; 89 c6
    db  0feh, 0c9h
    ; dec cl                                    ; fe c9
    jmp short 06120h                          ; eb df
    test cl, cl                               ; 84 c9
    je short 06157h                           ; 74 12
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov dx, bx                                ; 89 da
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    mov byte [bp+012h], al                    ; 88 46 12
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp short 0617ah                          ; eb 23
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 06110h                          ; eb b1
    lea dx, [si+005h]                         ; 8d 54 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 0614eh                          ; eb de
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 0617ah                          ; eb 04
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
set_enable_a20_:                             ; 0xf6180 LB 0x2c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_e820_range_:                             ; 0xf61ac LB 0x8c
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov es, ax                                ; 8e c0
    ...
    db  000h, 0d7h, 066h, 077h, 062h, 08ah, 062h, 01fh, 063h, 025h, 063h, 02ah, 063h, 02fh, 063h, 0d1h
    db  063h, 06eh, 065h, 094h, 065h, 018h, 063h, 018h, 063h, 061h, 066h, 089h, 066h, 09ch, 066h, 0abh
    db  066h, 01fh, 063h, 0b2h, 066h
_int15_function:                             ; 0xf6238 LB 0x4cd
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jnbe near 066d7h                          ; 0f 87 8b 04
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 00012h                ; b9 12 00
    mov di, 06203h                            ; bf 03 62
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov si, word [cs:di+06214h]               ; 2e 8b b5 14 62
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    ...
    jne near 066d7h                           ; 0f 85 54 04
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    jmp near 06680h                           ; e9 f6 03
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 0629fh                           ; 72 0e
    jbe short 062b3h                          ; 76 20
    cmp ax, strict word 00003h                ; 3d 03 00
    je short 062e0h                           ; 74 48
    cmp ax, strict word 00002h                ; 3d 02 00
    je short 062c3h                           ; 74 26
    jmp short 062edh                          ; eb 4e
    test ax, ax                               ; 85 c0
    jne short 062edh                          ; 75 4a
    xor ax, ax                                ; 31 c0
    call 06180h                               ; e8 d8 fe
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp near 06318h                           ; e9 65 00
    mov ax, strict word 00001h                ; b8 01 00
    call 06180h                               ; e8 c7 fe
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], dh                    ; 88 76 13
    jmp near 06318h                           ; e9 55 00
    mov dx, 00092h                            ; ba 92 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    jmp near 06318h                           ; e9 38 00
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], ah                    ; 88 66 13
    mov word [bp+00ch], ax                    ; 89 46 0c
    jmp near 06318h                           ; e9 2b 00
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 e9 b5
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 0082eh                               ; 68 2e 08
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 1c b6
    add sp, strict byte 00006h                ; 83 c4 06
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    ...
    retn                                      ; c3
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp near 063cbh                           ; e9 a6 00
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp short 06318h                          ; eb ee
    mov word [bp+018h], cx                    ; 89 4e 18
    jmp short 06315h                          ; eb e6
    test byte [bp+012h], 0ffh                 ; f6 46 12 ff
    je short 063a1h                           ; 74 6c
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 c2 b2
    test AL, strict byte 001h                 ; a8 01
    jne near 06677h                           ; 0f 85 33 03
    mov bx, strict word 00001h                ; bb 01 00
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 be b2
    ...
    out DX, AL                                ; ee
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 c9 b2
    or AL, strict byte 040h                   ; 0c 40
    movzx dx, al                              ; 0f b6 d0
    mov ax, strict word 0000bh                ; b8 0b 00
    call 01679h                               ; e8 db b2
    jmp near 06318h                           ; e9 77 ff
    cmp ax, strict word 00001h                ; 3d 01 00
    jne short 063bfh                          ; 75 19
    xor bx, bx                                ; 31 db
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 5d b2
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 a1 b2
    and AL, strict byte 0bfh                  ; 24 bf
    jmp short 06395h                          ; eb d6
    mov word [bp+018h], bx                    ; 89 5e 18
    mov ax, dx                                ; 89 d0
    xor ah, dh                                ; 30 f4
    xor dl, dl                                ; 30 d2
    ...
    or dx, ax                                 ; 09 c2
    mov word [bp+012h], dx                    ; 89 56 12
    jmp near 06318h                           ; e9 47 ff
    cli                                       ; fa
    mov ax, strict word 00001h                ; b8 01 00
    call 06180h                               ; e8 a8 fd
    mov di, ax                                ; 89 c7
    mov ax, word [bp+014h]                    ; 8b 46 14
    sal ax, 004h                              ; c1 e0 04
    mov cx, word [bp+006h]                    ; 8b 4e 06
    ...
    push cx                                   ; 51
    retf                                      ; cb
    jmp near 06318h                           ; e9 b7 fc
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 75 b2
    push 0086eh                               ; 68 6e 08
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 ae b2
    add sp, strict byte 00004h                ; 83 c4 04
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    mov word [bp+012h], ax                    ; 89 46 12
    jmp near 06318h                           ; e9 8f fc
    mov word [bp+018h], cx                    ; 89 4e 18
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+00ch], 0e6f5h                ; c7 46 0c f5 e6
    mov word [bp+014h], 0f000h                ; c7 46 14 00 f0
    jmp near 06318h                           ; e9 7c fc
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 77 af
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 06567h                           ; e9 bc fe
    push 0089dh                               ; 68 9d 08
    push strict byte 00008h                   ; 6a 08
    jmp short 06671h                          ; eb bf
    test byte [bp+012h], 0ffh                 ; f6 46 12 ff
    jne short 066d7h                          ; 75 1f
    mov word [bp+012h], ax                    ; 89 46 12
    mov ax, word [bp+00ch]                    ; 8b 46 0c
    xor ah, ah                                ; 30 e4
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 066d0h                           ; 72 0b
    cmp ax, strict word 00003h                ; 3d 03 00
    jnbe short 066d0h                         ; 77 06
    mov word [bp+018h], cx                    ; 89 4e 18
    jmp near 06318h                           ; e9 48 fc
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    jmp near 06318h                           ; e9 41 fc
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 ff b1
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 008b4h                               ; 68 b4 08
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 32 b2
    add sp, strict byte 00008h                ; 83 c4 08
    jmp short 06677h                          ; eb 82
    scasb                                     ; ae
    push 068d0h                               ; 68 d0 68
    rep push 06915h                           ; f3 68 15 69
    xor ax, 05669h                            ; 35 69 56
    db  069h
    xchg bp, ax                               ; 95
    db  069h
    db  0c1h
    db  069h
_int15_function32:                           ; 0xf6705 LB 0x37e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sub sp, strict byte 00008h                ; 83 ec 08
    ...
    je near 067d2h                            ; 0f 84 ad 00
    cmp dx, 000d0h                            ; 81 fa d0 00
    je short 0676dh                           ; 74 42
    cmp dx, 00086h                            ; 81 fa 86 00
    jne near 06a53h                           ; 0f 85 20 03
    sti                                       ; fb
    ...
    db  066h, 00bh, 0c9h
    ; or ecx, ecx                               ; 66 0b c9
    je near 0676ah                            ; 0f 84 0e 00
    in AL, strict byte 061h                   ; e4 61
    and AL, strict byte 010h                  ; 24 10
    db  03ah, 0c4h
    ; cmp al, ah                                ; 3a c4
    je short 0675ch                           ; 74 f8
    db  08ah, 0e0h
    ; mov ah, al                                ; 8a e0
    dec ecx                                   ; 66 49
    jne short 0675ch                          ; 75 f2
    jmp near 06a7dh                           ; e9 10 03
    cmp ax, strict word 0004fh                ; 3d 4f 00
    jne near 06a53h                           ; 0f 85 df 02
    cmp word [bp+016h], 05052h                ; 81 7e 16 52 50
    jne near 06a53h                           ; 0f 85 d6 02
    cmp word [bp+014h], 04f43h                ; 81 7e 14 43 4f
    jne near 06a53h                           ; 0f 85 cd 02
    cmp word [bp+01eh], 04d4fh                ; 81 7e 1e 4f 4d
    jne near 06a53h                           ; 0f 85 c4 02
    cmp word [bp+01ch], 04445h                ; 81 7e 1c 45 44
    jne near 06a53h                           ; 0f 85 bb 02
    mov ax, word [bp+00ah]                    ; 8b 46 0a
    or ax, word [bp+008h]                     ; 0b 46 08
    jne near 06a53h                           ; 0f 85 b1 02
    mov ax, word [bp+006h]                    ; 8b 46 06
    or ax, word [bp+004h]                     ; 0b 46 04
    jne near 06a53h                           ; 0f 85 a7 02
    ...
    jmp near 06a7dh                           ; e9 ab 02
    cmp ax, strict word 00020h                ; 3d 20 00
    je short 067e1h                           ; 74 0a
    cmp ax, strict word 00001h                ; 3d 01 00
    je near 06a08h                            ; 0f 84 2a 02
    jmp near 06a53h                           ; e9 72 02
    cmp word [bp+01ah], 0534dh                ; 81 7e 1a 4d 53
    jne near 06a53h                           ; 0f 85 69 02
    cmp word [bp+018h], 04150h                ; 81 7e 18 50 41
    jne near 06a53h                           ; 0f 85 60 02
    ...
    jc short 06827h                           ; 72 06
    jne short 06854h                          ; 75 31
    test bx, bx                               ; 85 db
    jnbe short 06854h                         ; 77 2d
    mov ax, strict word 00031h                ; b8 31 00
    ...
    jmp word [cs:si+066f5h]                   ; 2e ff a4 f5 66
    push strict byte 00001h                   ; 6a 01
    ...
    xor bx, bx                                ; 31 db
    xor cx, cx                                ; 31 c9
    call 061ach                               ; e8 02 f8
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 069b7h                          ; 75 07
    mov ax, word [bp-008h]                    ; 8b 46 f8
    test ax, ax                               ; 85 c0
    je short 069b9h                           ; 74 02
    jmp short 06979h                          ; eb c0
    mov word [bp+014h], ax                    ; 89 46 14
    mov word [bp+016h], ax                    ; 89 46 16
    jmp short 069f2h                          ; eb 31
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 069cdh                          ; 75 06
    cmp word [bp-008h], strict byte 00000h    ; 83 7e f8 00
    je short 069f2h                           ; 74 25
    push strict byte 00001h                   ; 6a 01
    mov al, byte [bp-006h]                    ; 8a 46 fa
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    ...
    sal dx, 008h                              ; c1 e2 08
    mov ax, strict word 00030h                ; b8 30 00
    call 0165ch                               ; e8 3f ac
    xor ah, ah                                ; 30 e4
    or dx, ax                                 ; 09 c2
    mov word [bp+01ch], dx                    ; 89 56 1c
    cmp dx, 03c00h                            ; 81 fa 00 3c
    jbe short 06a2fh                          ; 76 05
    ...
    mov word [bp+014h], dx                    ; 89 56 14
    jmp short 06a7dh                          ; eb 2a
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 83 ae
    push word [bp+014h]                       ; ff 76 14
    push word [bp+020h]                       ; ff 76 20
    push 008b4h                               ; 68 b4 08
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 b6 ae
    add sp, strict byte 00008h                ; 83 c4 08
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_inv_op_handler:                             ; 0xf6a83 LB 0x195
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 06a99h                          ; 75 06
    inc word [bp+018h]                        ; ff 46 18
    jmp near 06c11h                           ; e9 78 01
    cmp word [es:bx], 0050fh                  ; 26 81 3f 0f 05
    jne near 06c0dh                           ; 0f 85 6b 01
    ...
    loop 06af2h                               ; e2 fa
    cmp bx, dx                                ; 39 d3
    jne short 06b00h                          ; 75 04
    cmp di, ax                                ; 39 c7
    je short 06b05h                           ; 74 05
    ...
    loop 06b1ah                               ; e2 fa
    cmp di, dx                                ; 39 d7
    jne short 06b28h                          ; 75 04
    cmp bx, ax                                ; 39 c3
    je short 06b2ch                           ; 74 04
    ...
    je near 06bcah                            ; 0f 84 02 00
    mov es, ax                                ; 8e c0
    test cx, strict word 00002h               ; f7 c1 02 00
    je near 06bf2h                            ; 0f 84 20 00
    ...
    iret                                      ; cf
    jmp short 06c11h                          ; eb 04
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 06c0eh                          ; eb fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
init_rtc_:                                   ; 0xf6c18 LB 0x28
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, strict word 0000ah                ; b8 0a 00
    call 01679h                               ; e8 54 aa
    mov dx, strict word 00002h                ; ba 02 00
    mov ax, strict word 0000bh                ; b8 0b 00
    call 01679h                               ; e8 4b aa
    mov ax, strict word 0000ch                ; b8 0c 00
    call 0165ch                               ; e8 28 aa
    mov ax, strict word 0000dh                ; b8 0d 00
    call 0165ch                               ; e8 22 aa
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop dx                                    ; 5a
    pop bp                                    ; 5d
    retn                                      ; c3
rtc_updating_:                               ; 0xf6c40 LB 0x21
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, 061a8h                            ; ba a8 61
    dec dx                                    ; 4a
    je short 06c58h                           ; 74 0e
    mov ax, strict word 0000ah                ; b8 0a 00
    call 0165ch                               ; e8 0c aa
    test AL, strict byte 080h                 ; a8 80
    jne short 06c47h                          ; 75 f3
    xor ax, ax                                ; 31 c0
    jmp short 06c5bh                          ; eb 03
    mov ax, strict word 00001h                ; b8 01 00
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop dx                                    ; 5a
    pop bp                                    ; 5d
    retn                                      ; c3
_int70_function:                             ; 0xf6c61 LB 0xbe
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push ax                                   ; 50
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 f0 a9
    mov dl, al                                ; 88 c2
    mov byte [bp-004h], al                    ; 88 46 fc
    mov ax, strict word 0000ch                ; b8 0c 00
    call 0165ch                               ; e8 e5 a9
    mov dh, al                                ; 88 c6
    test dl, 060h                             ; f6 c2 60
    je near 06d06h                            ; 0f 84 86 00
    test AL, strict byte 020h                 ; a8 20
    je short 06c88h                           ; 74 04
    sti                                       ; fb
    int 04ah                                  ; cd 4a
    cli                                       ; fa
    test dh, 040h                             ; f6 c6 40
    je near 06d06h                            ; 0f 84 77 00
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 68 a9
    test al, al                               ; 84 c0
    je short 06d06h                           ; 74 6a
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01638h                               ; e8 93 a9
    test dx, dx                               ; 85 d2
    jne short 06cf2h                          ; 75 49
    cmp ax, 003d1h                            ; 3d d1 03
    jnc short 06cf2h                          ; 73 44
    mov dx, 00098h                            ; ba 98 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 65 a9
    mov si, ax                                ; 89 c6
    mov dx, 0009ah                            ; ba 9a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 5a a9
    mov cx, ax                                ; 89 c1
    xor bx, bx                                ; 31 db
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 3f a9
    mov al, byte [bp-004h]                    ; 8a 46 fc
    and AL, strict byte 037h                  ; 24 37
    movzx dx, al                              ; 0f b6 d0
    mov ax, strict word 0000bh                ; b8 0b 00
    call 01679h                               ; e8 9c a9
    mov dx, cx                                ; 89 ca
    mov ax, si                                ; 89 f0
    call 01600h                               ; e8 1c a9
    or AL, strict byte 080h                   ; 0c 80
    movzx bx, al                              ; 0f b6 d8
    mov dx, cx                                ; 89 ca
    mov ax, si                                ; 89 f0
    call 0160eh                               ; e8 1e a9
    jmp short 06d06h                          ; eb 14
    mov bx, ax                                ; 89 c3
    ...
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0164ah                               ; e8 44 a9
    call 0e03bh                               ; e8 32 73
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
    ...
    pop di                                    ; 5f
    insw                                      ; 6d
    test byte [di-04ah], ch                   ; 84 6d b6
    insw                                      ; 6d
    add ax, 03d6eh                            ; 05 6e 3d
    outsb                                     ; 6e
    sub byte [bp-029h], 06eh                  ; 80 6e d7 6e
_int1a_function:                             ; 0xf6d1f LB 0x1c8
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sti                                       ; fb
    mov al, byte [bp+013h]                    ; 8a 46 13
    cmp AL, strict byte 007h                  ; 3c 07
    jnbe near 06d5bh                          ; 0f 87 2f 00
    movzx bx, al                              ; 0f b6 d8
    add bx, bx                                ; 01 db
    jmp word [cs:bx+06d0fh]                   ; 2e ff a7 0f 6d
    cli                                       ; fa
    ...
    sti                                       ; fb
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp short 06d5bh                          ; eb d7
    call 06c40h                               ; e8 b9 fe
    test ax, ax                               ; 85 c0
    je short 06d8dh                           ; 74 02
    jmp short 06d5bh                          ; eb ce
    xor ax, ax                                ; 31 c0
    call 0165ch                               ; e8 ca a8
    mov byte [bp+00fh], al                    ; 88 46 0f
    mov ax, strict word 00002h                ; b8 02 00
    call 0165ch                               ; e8 c1 a8
    mov byte [bp+010h], al                    ; 88 46 10
    mov ax, strict word 00004h                ; b8 04 00
    call 0165ch                               ; e8 b8 a8
    mov bl, al                                ; 88 c3
    mov byte [bp+011h], al                    ; 88 46 11
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 ad a8
    and AL, strict byte 001h                  ; 24 01
    mov byte [bp+00eh], al                    ; 88 46 0e
    jmp short 06dfbh                          ; eb 45
    call 06c40h                               ; e8 87 fe
    test ax, ax                               ; 85 c0
    je short 06dc0h                           ; 74 03
    call 06c18h                               ; e8 58 fe
    movzx dx, byte [bp+00fh]                  ; 0f b6 56 0f
    xor ax, ax                                ; 31 c0
    call 01679h                               ; e8 b0 a8
    movzx dx, byte [bp+010h]                  ; 0f b6 56 10
    mov ax, strict word 00002h                ; b8 02 00
    call 01679h                               ; e8 a6 a8
    movzx dx, byte [bp+011h]                  ; 0f b6 56 11
    mov ax, strict word 00004h                ; b8 04 00
    call 01679h                               ; e8 9c a8
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 79 a8
    mov bl, al                                ; 88 c3
    ...
    jmp near 06d5bh                           ; e9 56 ff
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    call 06c40h                               ; e8 34 fe
    test ax, ax                               ; 85 c0
    je short 06e13h                           ; 74 03
    jmp near 06d5bh                           ; e9 48 ff
    mov ax, strict word 00009h                ; b8 09 00
    call 0165ch                               ; e8 43 a8
    mov byte [bp+010h], al                    ; 88 46 10
    mov ax, strict word 00008h                ; b8 08 00
    call 0165ch                               ; e8 3a a8
    mov byte [bp+00fh], al                    ; 88 46 0f
    mov ax, strict word 00007h                ; b8 07 00
    call 0165ch                               ; e8 31 a8
    mov byte [bp+00eh], al                    ; 88 46 0e
    mov ax, strict word 00032h                ; b8 32 00
    call 0165ch                               ; e8 28 a8
    mov byte [bp+011h], al                    ; 88 46 11
    mov byte [bp+012h], al                    ; 88 46 12
    jmp near 06d5bh                           ; e9 1e ff
    call 06c40h                               ; e8 00 fe
    test ax, ax                               ; 85 c0
    je short 06e4ah                           ; 74 06
    call 06c18h                               ; e8 d1 fd
    jmp near 06d5bh                           ; e9 11 ff
    movzx dx, byte [bp+010h]                  ; 0f b6 56 10
    mov ax, strict word 00009h                ; b8 09 00
    call 01679h                               ; e8 25 a8
    movzx dx, byte [bp+00fh]                  ; 0f b6 56 0f
    mov ax, strict word 00008h                ; b8 08 00
    call 01679h                               ; e8 1b a8
    movzx dx, byte [bp+00eh]                  ; 0f b6 56 0e
    mov ax, strict word 00007h                ; b8 07 00
    call 01679h                               ; e8 11 a8
    movzx dx, byte [bp+011h]                  ; 0f b6 56 11
    mov ax, strict word 00032h                ; b8 32 00
    call 01679h                               ; e8 07 a8
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 e4 a7
    mov bl, al                                ; 88 c3
    and bl, 07fh                              ; 80 e3 7f
    jmp near 06df2h                           ; e9 72 ff
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 d6 a7
    mov bl, al                                ; 88 c3
    mov word [bp+012h], strict word 00000h    ; c7 46 12 00 00
    test AL, strict byte 020h                 ; a8 20
    je short 06e94h                           ; 74 03
    jmp near 06d5bh                           ; e9 c7 fe
    call 06c40h                               ; e8 a9 fd
    test ax, ax                               ; 85 c0
    je short 06e9eh                           ; 74 03
    call 06c18h                               ; e8 7a fd
    movzx dx, byte [bp+00fh]                  ; 0f b6 56 0f
    mov ax, strict word 00001h                ; b8 01 00
    call 01679h                               ; e8 d1 a7
    movzx dx, byte [bp+010h]                  ; 0f b6 56 10
    mov ax, strict word 00003h                ; b8 03 00
    call 01679h                               ; e8 c7 a7
    movzx dx, byte [bp+011h]                  ; 0f b6 56 11
    mov ax, strict word 00005h                ; b8 05 00
    call 01679h                               ; e8 bd a7
    mov dx, 000a1h                            ; ba a1 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    movzx dx, al                              ; 0f b6 d0
    mov ax, strict word 0000bh                ; b8 0b 00
    call 01679h                               ; e8 a5 a7
    jmp near 06d5bh                           ; e9 84 fe
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 7f a7
    mov bl, al                                ; 88 c3
    and AL, strict byte 057h                  ; 24 57
    movzx dx, al                              ; 0f b6 d0
    jmp near 06df5h                           ; e9 0e ff
send_to_mouse_ctrl_:                         ; 0xf6ee7 LB 0x34
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 06f06h                           ; 74 0e
    push 008eeh                               ; 68 ee 08
    push 01184h                               ; 68 84 11
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 1f aa
    add sp, strict byte 00006h                ; 83 c4 06
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
get_mouse_data_:                             ; 0xf6f1b LB 0x3b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    je short 06f3ch                           ; 74 07
    test cx, cx                               ; 85 c9
    je short 06f3ch                           ; 74 03
    dec cx                                    ; 49
    jmp short 06f27h                          ; eb eb
    test cx, cx                               ; 85 c9
    jne short 06f44h                          ; 75 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 06f4fh                          ; eb 0b
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_kbd_command_byte_:                       ; 0xf6f56 LB 0x32
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 06f75h                           ; 74 0e
    push 008f8h                               ; 68 f8 08
    push 01184h                               ; 68 84 11
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 b0 a9
    add sp, strict byte 00006h                ; 83 c4 06
    mov AL, strict byte 060h                  ; b0 60
    mov dx, strict word 00064h                ; ba 64 00
    out DX, AL                                ; ee
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_int74_function:                             ; 0xf6f88 LB 0xca
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 00008h                ; 83 ec 08
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 85 a6
    mov cx, ax                                ; 89 c1
    mov word [bp+004h], strict word 00000h    ; c7 46 04 00 00
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    ...
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 39 a6
    mov byte [bp-008h], al                    ; 88 46 f8
    test AL, strict byte 080h                 ; a8 80
    je short 0703eh                           ; 74 70
    mov al, byte [bp-008h]                    ; 8a 46 f8
    and AL, strict byte 007h                  ; 24 07
    mov byte [bp-002h], al                    ; 88 46 fe
    mov al, byte [bp-006h]                    ; 8a 46 fa
    ...
    je short 07032h                           ; 74 0a
    mov word [bp+004h], strict word 00001h    ; c7 46 04 01 00
    jmp short 07032h                          ; eb 03
    inc byte [bp-006h]                        ; fe 46 fa
    movzx bx, byte [bp-006h]                  ; 0f b6 5e fa
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 0160eh                               ; e8 d0 a5
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    xchg si, ax                               ; 96
    jo short 07051h                           ; 70 0c
    jno short 06fd6h                          ; 71 8f
    jno short 07069h                          ; 71 20
    jc short 06fd9h                           ; 72 8e
    jc short 0702fh                           ; 72 e2
    jo short 07005h                           ; 70 b6
    jc short 070cch                           ; 72 7b
    db  073h
_int15_function_mouse:                       ; 0xf7052 LB 0x38b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sub sp, strict byte 00006h                ; 83 ec 06
    ...
    jmp near 073d1h                           ; e9 1c 03
    cmp byte [bp+00dh], 000h                  ; 80 7e 0d 00
    db  00fh, 094h, 0c0h
    ; sete al                                   ; 0f 94 c0
    add AL, strict byte 0f4h                  ; 04 f4
    xor ah, ah                                ; 30 e4
    call 06ee7h                               ; e8 24 fe
    test al, al                               ; 84 c0
    jne near 07357h                           ; 0f 85 8e 02
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f1bh                               ; e8 4a fe
    test al, al                               ; 84 c0
    je near 073d1h                            ; 0f 84 fa 02
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    jne near 07357h                           ; 0f 85 78 02
    jmp near 073d1h                           ; e9 ef 02
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 070edh                           ; 72 04
    cmp AL, strict byte 008h                  ; 3c 08
    jbe short 070f0h                          ; 76 03
    jmp near 07283h                           ; e9 93 01
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 08 a5
    ...
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 0160eh                               ; e8 ed a4
    mov ax, 000ffh                            ; b8 ff 00
    call 06ee7h                               ; e8 c0 fd
    test al, al                               ; 84 c0
    jne near 07357h                           ; 0f 85 2a 02
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 06f1bh                               ; e8 e6 fd
    mov cl, al                                ; 88 c1
    cmp byte [bp-004h], 0feh                  ; 80 7e fc fe
    jne short 07148h                          ; 75 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 004h                  ; c6 46 13 04
    jmp near 073d1h                           ; e9 89 02
    cmp byte [bp-004h], 0fah                  ; 80 7e fc fa
    je short 0715eh                           ; 74 10
    movzx ax, byte [bp-004h]                  ; 0f b6 46 fc
    push ax                                   ; 50
    push 00903h                               ; 68 03 09
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 c7 a7
    add sp, strict byte 00006h                ; 83 c4 06
    test cl, cl                               ; 84 c9
    jne near 07357h                           ; 0f 85 f3 01
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f1bh                               ; e8 af fd
    test al, al                               ; 84 c0
    jne near 07357h                           ; 0f 85 e5 01
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f1bh                               ; e8 a1 fd
    test al, al                               ; 84 c0
    jne near 07357h                           ; 0f 85 d7 01
    mov al, byte [bp-008h]                    ; 8a 46 f8
    mov byte [bp+00ch], al                    ; 88 46 0c
    mov al, byte [bp-006h]                    ; 8a 46 fa
    mov byte [bp+00dh], al                    ; 88 46 0d
    jmp near 073d1h                           ; e9 42 02
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    cmp AL, strict byte 003h                  ; 3c 03
    jc short 071a6h                           ; 72 10
    jbe short 071c4h                          ; 76 2c
    cmp AL, strict byte 006h                  ; 3c 06
    je short 071d6h                           ; 74 3a
    cmp AL, strict byte 005h                  ; 3c 05
    je short 071d0h                           ; 74 30
    cmp AL, strict byte 004h                  ; 3c 04
    je short 071cah                           ; 74 26
    jmp short 071dch                          ; eb 36
    cmp AL, strict byte 002h                  ; 3c 02
    je short 071beh                           ; 74 14
    cmp AL, strict byte 001h                  ; 3c 01
    je short 071b8h                           ; 74 0a
    test al, al                               ; 84 c0
    jne short 071dch                          ; 75 2a
    mov byte [bp-008h], 00ah                  ; c6 46 f8 0a
    jmp short 071e0h                          ; eb 28
    mov byte [bp-008h], 014h                  ; c6 46 f8 14
    jmp short 071e0h                          ; eb 22
    mov byte [bp-008h], 028h                  ; c6 46 f8 28
    jmp short 071e0h                          ; eb 1c
    mov byte [bp-008h], 03ch                  ; c6 46 f8 3c
    jmp short 071e0h                          ; eb 16
    mov byte [bp-008h], 050h                  ; c6 46 f8 50
    jmp short 071e0h                          ; eb 10
    mov byte [bp-008h], 064h                  ; c6 46 f8 64
    jmp short 071e0h                          ; eb 0a
    mov byte [bp-008h], 0c8h                  ; c6 46 f8 c8
    jmp short 071e0h                          ; eb 04
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    cmp byte [bp-008h], 000h                  ; 80 7e f8 00
    jbe short 07215h                          ; 76 2f
    mov ax, 000f3h                            ; b8 f3 00
    call 06ee7h                               ; e8 fb fc
    test al, al                               ; 84 c0
    jne short 0720ah                          ; 75 1a
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f1bh                               ; e8 23 fd
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    call 06ee7h                               ; e8 e8 fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f1bh                               ; e8 14 fd
    jmp near 073d1h                           ; e9 c7 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 073d1h                           ; e9 bc 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 002h                  ; c6 46 13 02
    jmp near 073d1h                           ; e9 b1 01
    cmp byte [bp+00dh], 004h                  ; 80 7e 0d 04
    jnc short 07283h                          ; 73 5d
    mov ax, 000e8h                            ; b8 e8 00
    call 06ee7h                               ; e8 bb fc
    test al, al                               ; 84 c0
    jne short 07278h                          ; 75 48
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f1bh                               ; e8 e3 fc
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je short 0724eh                           ; 74 10
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    push ax                                   ; 50
    push 0092eh                               ; 68 2e 09
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 d7 a6
    add sp, strict byte 00006h                ; 83 c4 06
    movzx ax, byte [bp+00dh]                  ; 0f b6 46 0d
    call 06ee7h                               ; e8 92 fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f1bh                               ; e8 be fc
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je near 073d1h                            ; 0f 84 6c 01
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    push ax                                   ; 50
    push 0092eh                               ; 68 2e 09
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 b0 a6
    add sp, strict byte 00006h                ; 83 c4 06
    jmp near 073d1h                           ; e9 59 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 073d1h                           ; e9 4e 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 002h                  ; c6 46 13 02
    jmp near 073d1h                           ; e9 43 01
    mov ax, 000f2h                            ; b8 f2 00
    call 06ee7h                               ; e8 53 fc
    test al, al                               ; 84 c0
    jne short 072abh                          ; 75 13
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f1bh                               ; e8 7b fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f1bh                               ; e8 73 fc
    jmp near 07186h                           ; e9 db fe
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 073d1h                           ; e9 1b 01
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    test al, al                               ; 84 c0
    jbe short 072c4h                          ; 76 07
    cmp AL, strict byte 002h                  ; 3c 02
    jbe short 0732dh                          ; 76 6c
    jmp near 07361h                           ; e9 9d 00
    mov ax, 000e9h                            ; b8 e9 00
    call 06ee7h                               ; e8 1d fc
    test al, al                               ; 84 c0
    jne near 07357h                           ; 0f 85 87 00
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f1bh                               ; e8 43 fc
    mov cl, al                                ; 88 c1
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je short 072f0h                           ; 74 10
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    push ax                                   ; 50
    push 0092eh                               ; 68 2e 09
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 35 a6
    add sp, strict byte 00006h                ; 83 c4 06
    test cl, cl                               ; 84 c9
    jne short 07357h                          ; 75 63
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f1bh                               ; e8 1f fc
    test al, al                               ; 84 c0
    jne short 07357h                          ; 75 57
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f1bh                               ; e8 13 fc
    test al, al                               ; 84 c0
    jne short 07357h                          ; 75 4b
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 06f1bh                               ; e8 07 fc
    test al, al                               ; 84 c0
    jne short 07357h                          ; 75 3f
    mov al, byte [bp-008h]                    ; 8a 46 f8
    mov byte [bp+00ch], al                    ; 88 46 0c
    mov al, byte [bp-006h]                    ; 8a 46 fa
    mov byte [bp+010h], al                    ; 88 46 10
    mov al, byte [bp-004h]                    ; 8a 46 fc
    mov byte [bp+00eh], al                    ; 88 46 0e
    jmp near 073d1h                           ; e9 a4 00
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 07336h                          ; 75 05
    mov ax, 000e6h                            ; b8 e6 00
    jmp short 07339h                          ; eb 03
    mov ax, 000e7h                            ; b8 e7 00
    call 06ee7h                               ; e8 ab fb
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    jne short 07351h                          ; 75 0f
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f1bh                               ; e8 d1 fb
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    db  00fh, 095h, 0c1h
    ; setne cl                                  ; 0f 95 c1
    test cl, cl                               ; 84 c9
    je near 073d1h                            ; 0f 84 7a 00
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp short 073d1h                          ; eb 70
    movzx ax, byte [bp+00dh]                  ; 0f b6 46 0d
    push ax                                   ; 50
    push 0095ah                               ; 68 5a 09
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 b4 a5
    add sp, strict byte 00006h                ; 83 c4 06
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    jmp short 073d1h                          ; eb 56
    mov si, word [bp+00ch]                    ; 8b 76 0c
    mov bx, si                                ; 89 f3
    mov dx, strict word 00022h                ; ba 22 00
    mov ax, cx                                ; 89 c8
    call 0162ah                               ; e8 a2 a2
    mov bx, word [bp+014h]                    ; 8b 5e 14
    mov dx, strict word 00024h                ; ba 24 00
    mov ax, cx                                ; 89 c8
    call 0162ah                               ; e8 97 a2
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 65 a2
    mov ah, al                                ; 88 c4
    test si, si                               ; 85 f6
    jne short 073afh                          ; 75 0e
    cmp word [bp+014h], strict byte 00000h    ; 83 7e 14 00
    jne short 073afh                          ; 75 08
    test AL, strict byte 080h                 ; a8 80
    je short 073b1h                           ; 74 06
    and AL, strict byte 07fh                  ; 24 7f
    jmp short 073b1h                          ; eb 02
    or AL, strict byte 080h                   ; 0c 80
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 0160eh                               ; e8 52 a2
    jmp short 073d1h                          ; eb 13
    push 00974h                               ; 68 74 09
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 5c a5
    add sp, strict byte 00004h                ; 83 c4 04
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    mov ax, strict word 00047h                ; b8 47 00
    call 06f56h                               ; e8 7f fb
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
_int17_function:                             ; 0xf73dd LB 0xb3
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push ax                                   ; 50
    ...
    add dx, strict byte 00008h                ; 83 c2 08
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 2b a2
    mov bx, ax                                ; 89 c3
    mov si, ax                                ; 89 c6
    cmp byte [bp+013h], 003h                  ; 80 7e 13 03
    jnc near 07486h                           ; 0f 83 89 00
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    cmp ax, strict word 00003h                ; 3d 03 00
    jnc near 07486h                           ; 0f 83 7f 00
    test bx, bx                               ; 85 db
    jbe near 07486h                           ; 0f 86 79 00
    mov dx, ax                                ; 89 c2
    add dx, strict byte 00078h                ; 83 c2 78
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 e8 a1
    movzx cx, al                              ; 0f b6 c8
    sal cx, 008h                              ; c1 e1 08
    cmp byte [bp+013h], 000h                  ; 80 7e 13 00
    jne short 07451h                          ; 75 2d
    mov al, byte [bp+012h]                    ; 8a 46 12
    mov dx, bx                                ; 89 da
    out DX, AL                                ; ee
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 040h                 ; a8 40
    je short 07451h                           ; 74 07
    test cx, cx                               ; 85 c9
    je short 07451h                           ; 74 03
    dec cx                                    ; 49
    jmp short 07440h                          ; eb ef
    cmp byte [bp+013h], 001h                  ; 80 7e 13 01
    jne short 0746dh                          ; 75 16
    lea dx, [si+002h]                         ; 8d 54 02
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov byte [bp+013h], al                    ; 88 46 13
    test cx, cx                               ; 85 c9
    jne short 07480h                          ; 75 04
    or byte [bp+013h], 001h                   ; 80 4e 13 01
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp short 0748ah                          ; eb 04
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
wait_:                                       ; 0xf7490 LB 0xb2
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 01638h                               ; e8 85 a1
    mov word [bp-00eh], ax                    ; 89 46 f2
    mov bx, dx                                ; 89 d3
    hlt                                       ; f4
    mov dx, 0046ch                            ; ba 6c 04
    xor ax, ax                                ; 31 c0
    call 01638h                               ; e8 77 a1
    mov word [bp-012h], ax                    ; 89 46 ee
    mov di, dx                                ; 89 d7
    cmp dx, bx                                ; 39 da
    jnbe short 074d1h                         ; 77 07
    jne short 074d8h                          ; 75 0c
    cmp ax, word [bp-00eh]                    ; 3b 46 f2
    jbe short 074d8h                          ; 76 07
    sub ax, word [bp-00eh]                    ; 2b 46 f2
    sbb dx, bx                                ; 19 da
    jmp short 074e3h                          ; eb 0b
    cmp dx, bx                                ; 39 da
    jc short 074e3h                           ; 72 07
    jne short 074e7h                          ; 75 09
    cmp ax, word [bp-00eh]                    ; 3b 46 f2
    jnc short 074e7h                          ; 73 04
    sub si, ax                                ; 29 c6
    sbb cx, dx                                ; 19 d1
    mov ax, word [bp-012h]                    ; 8b 46 ee
    mov word [bp-00eh], ax                    ; 89 46 f2
    ...
    int 016h                                  ; cd 16
    je near 074fdh                            ; 0f 84 05 00
    mov AL, strict byte 001h                  ; b0 01
    jmp near 074ffh                           ; e9 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    test al, al                               ; 84 c0
    je short 07527h                           ; 74 24
    db  033h, 0c0h
    ; xor ax, ax                                ; 33 c0
    int 016h                                  ; cd 16
    xchg ah, al                               ; 86 c4
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 08 a4
    add sp, strict byte 00006h                ; 83 c4 06
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    je short 07527h                           ; 74 04
    mov al, dl                                ; 88 d0
    jmp short 07539h                          ; eb 12
    test cx, cx                               ; 85 c9
    jnle short 074b8h                         ; 7f 8d
    jne short 07531h                          ; 75 04
    test si, si                               ; 85 f6
    jnbe short 074b8h                         ; 77 87
    mov ax, word [bp-010h]                    ; 8b 46 f0
    push ax                                   ; 50
    popfw                                     ; 9d
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
read_logo_byte_:                             ; 0xf7542 LB 0x16
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    xor ah, ah                                ; 30 e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
read_logo_word_:                             ; 0xf7558 LB 0x14
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    xor ah, ah                                ; 30 e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
print_detected_harddisks_:                   ; 0xf756c LB 0x130
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 9d a0
    mov si, ax                                ; 89 c6
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    xor cl, cl                                ; 30 c9
    xor ch, ch                                ; 30 ed
    mov dx, 00304h                            ; ba 04 03
    call 01600h                               ; e8 71 a0
    mov byte [bp-00eh], al                    ; 88 46 f2
    xor bl, bl                                ; 30 db
    cmp bl, byte [bp-00eh]                    ; 3a 5e f2
    jnc near 0766eh                           ; 0f 83 d3 00
    movzx dx, bl                              ; 0f b6 d3
    add dx, 00305h                            ; 81 c2 05 03
    mov ax, si                                ; 89 f0
    call 01600h                               ; e8 59 a0
    mov bh, al                                ; 88 c7
    cmp AL, strict byte 00ch                  ; 3c 0c
    jc short 075d1h                           ; 72 24
    test cl, cl                               ; 84 c9
    jne short 075beh                          ; 75 0d
    push 009a7h                               ; 68 a7 09
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 69 a3
    add sp, strict byte 00004h                ; 83 c4 04
    mov CL, strict byte 001h                  ; b1 01
    movzx ax, bl                              ; 0f b6 c3
    inc ax                                    ; 40
    ...
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 57 a3
    add sp, strict byte 00006h                ; 83 c4 06
    jmp near 07669h                           ; e9 98 00
    cmp AL, strict byte 008h                  ; 3c 08
    jc short 075e8h                           ; 72 13
    test ch, ch                               ; 84 ed
    jne short 075e6h                          ; 75 0d
    push 009cfh                               ; 68 cf 09
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 41 a3
    add sp, strict byte 00004h                ; 83 c4 04
    mov CH, strict byte 001h                  ; b5 01
    jmp short 075beh                          ; eb d6
    cmp AL, strict byte 004h                  ; 3c 04
    jnc short 07603h                          ; 73 17
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07603h                          ; 75 11
    push 009e4h                               ; 68 e4 09
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 28 a3
    add sp, strict byte 00004h                ; 83 c4 04
    mov byte [bp-00ch], 001h                  ; c6 46 f4 01
    jmp short 07619h                          ; eb 16
    cmp bh, 004h                              ; 80 ff 04
    jc short 07619h                           ; 72 11
    test cl, cl                               ; 84 c9
    jne short 07619h                          ; 75 0d
    push 009f6h                               ; 68 f6 09
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 0e a3
    add sp, strict byte 00004h                ; 83 c4 04
    mov CL, strict byte 001h                  ; b1 01
    movzx ax, bl                              ; 0f b6 c3
    inc ax                                    ; 40
    ...
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 fc a2
    add sp, strict byte 00006h                ; 83 c4 06
    cmp bh, 004h                              ; 80 ff 04
    jc short 07631h                           ; 72 03
    ...
    sar ax, 1                                 ; d1 f8
    test ax, ax                               ; 85 c0
    je short 07642h                           ; 74 05
    push 00a14h                               ; 68 14 0a
    jmp short 07645h                          ; eb 03
    push 00a1fh                               ; 68 1f 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 d8 a2
    add sp, strict byte 00004h                ; 83 c4 04
    movzx ax, bh                              ; 0f b6 c7
    ...
    idiv di                                   ; f7 ff
    test dx, dx                               ; 85 d2
    je short 0765fh                           ; 74 05
    push 00a28h                               ; 68 28 0a
    jmp short 07662h                          ; eb 03
    push 00a2eh                               ; 68 2e 0a
    push di                                   ; 57
    call 01922h                               ; e8 bc a2
    add sp, strict byte 00004h                ; 83 c4 04
    db  0feh, 0c3h
    ; inc bl                                    ; fe c3
    jmp near 07594h                           ; e9 26 ff
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07687h                          ; 75 13
    test cl, cl                               ; 84 c9
    jne short 07687h                          ; 75 0f
    test ch, ch                               ; 84 ed
    jne short 07687h                          ; 75 0b
    push 00a35h                               ; 68 35 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 9e a2
    add sp, strict byte 00004h                ; 83 c4 04
    push 00a49h                               ; 68 49 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 93 a2
    add sp, strict byte 00004h                ; 83 c4 04
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
get_boot_drive_:                             ; 0xf769c LB 0x28
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 70 9f
    mov dx, 00304h                            ; ba 04 03
    call 01600h                               ; e8 4e 9f
    sub bl, 002h                              ; 80 eb 02
    cmp bl, al                                ; 38 c3
    jc short 076bbh                           ; 72 02
...
show_logo_:                                  ; 0xf76c4 LB 0x224
    ...
    out strict byte 040h, AL                  ; e6 40
    movzx ax, dl                              ; 0f b6 c2
    call 07558h                               ; e8 68 fe
    cmp ax, 066bbh                            ; 3d bb 66
    jne near 077c8h                           ; 0f 85 d1 00
    push SS                                   ; 16
    pop ES                                    ; 07
    ...
    cmp ax, strict word 0004fh                ; 3d 4f 00
    jne near 077c8h                           ; 0f 85 bd 00
    mov al, dl                                ; 88 d0
    add AL, strict byte 004h                  ; 04 04
    xor ah, ah                                ; 30 e4
    call 07542h                               ; e8 2e fe
    mov ch, al                                ; 88 c5
    mov byte [bp-00ch], al                    ; 88 46 f4
    mov al, dl                                ; 88 d0
    add AL, strict byte 005h                  ; 04 05
    xor ah, ah                                ; 30 e4
    call 07542h                               ; e8 20 fe
    mov dh, al                                ; 88 c6
    mov byte [bp-010h], al                    ; 88 46 f0
    mov al, dl                                ; 88 d0
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 07558h                               ; e8 28 fe
    mov bx, ax                                ; 89 c3
    mov word [bp-014h], ax                    ; 89 46 ec
    mov al, dl                                ; 88 d0
    add AL, strict byte 006h                  ; 04 06
    xor ah, ah                                ; 30 e4
    call 07542h                               ; e8 04 fe
    mov byte [bp-012h], al                    ; 88 46 ee
    test ch, ch                               ; 84 ed
    jne short 0774fh                          ; 75 0a
    test dh, dh                               ; 84 f6
    jne short 0774fh                          ; 75 06
    test bx, bx                               ; 85 db
    je near 077c8h                            ; 0f 84 79 00
    mov bx, 00142h                            ; bb 42 01
    mov ax, 04f02h                            ; b8 02 4f
    int 010h                                  ; cd 10
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    je short 07780h                           ; 74 23
    xor bx, bx                                ; 31 db
    jmp short 07767h                          ; eb 06
    inc bx                                    ; 43
    cmp bx, strict byte 00010h                ; 83 fb 10
    jnbe short 07787h                         ; 77 20
    mov ax, bx                                ; 89 d8
    or ah, 002h                               ; 80 cc 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00001h                ; b8 01 00
    call 07490h                               ; e8 18 fd
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07761h                          ; 75 e5
    mov CL, strict byte 001h                  ; b1 01
    jmp short 07787h                          ; eb 07
    mov ax, 00210h                            ; b8 10 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    test cl, cl                               ; 84 c9
    jne short 0779dh                          ; 75 12
    mov ax, word [bp-014h]                    ; 8b 46 ec
    shr ax, 004h                              ; c1 e8 04
    mov dx, strict word 00001h                ; ba 01 00
    call 07490h                               ; e8 f9 fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 0779dh                          ; 75 02
    mov CL, strict byte 001h                  ; b1 01
    cmp byte [bp-010h], 000h                  ; 80 7e f0 00
    je short 077c8h                           ; 74 25
    test cl, cl                               ; 84 c9
    jne short 077c8h                          ; 75 21
    mov bx, strict word 00010h                ; bb 10 00
    jmp short 077b1h                          ; eb 05
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 077c8h                          ; 76 17
    mov ax, bx                                ; 89 d8
    or ah, 002h                               ; 80 cc 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00001h                ; b8 01 00
    call 07490h                               ; e8 ce fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 077ach                          ; 75 e6
    mov CL, strict byte 001h                  ; b1 01
    xor bx, bx                                ; 31 db
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, si                                ; 89 f0
    call 0160eh                               ; e8 3c 9e
    mov AL, strict byte 003h                  ; b0 03
    mov AH, strict byte 000h                  ; b4 00
    int 010h                                  ; cd 10
    cmp byte [bp-012h], 000h                  ; 80 7e ee 00
    je near 078c9h                            ; 0f 84 e9 00
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07816h                          ; 75 30
    cmp byte [bp-010h], 000h                  ; 80 7e f0 00
    jne short 07816h                          ; 75 2a
    cmp word [bp-014h], strict byte 00000h    ; 83 7e ec 00
    jne short 07816h                          ; 75 24
    cmp byte [bp-012h], 002h                  ; 80 7e ee 02
    jne short 07803h                          ; 75 0b
    push 00a4bh                               ; 68 4b 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 22 a1
    add sp, strict byte 00004h                ; 83 c4 04
    test cl, cl                               ; 84 c9
    jne short 07816h                          ; 75 0f
    mov dx, strict word 00001h                ; ba 01 00
    mov ax, 000c0h                            ; b8 c0 00
    call 07490h                               ; e8 80 fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07816h                          ; 75 02
    mov CL, strict byte 001h                  ; b1 01
    test cl, cl                               ; 84 c9
    je near 078c9h                            ; 0f 84 ad 00
    mov byte [bp-00eh], 000h                  ; c6 46 f2 00
    mov ax, 00100h                            ; b8 00 01
    ...
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 dd a0
    add sp, strict byte 00004h                ; 83 c4 04
    call 0756ch                               ; e8 21 fd
    push 00ab1h                               ; 68 b1 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 cf a0
    add sp, strict byte 00004h                ; 83 c4 04
    mov dx, strict word 00001h                ; ba 01 00
    mov ax, strict word 00040h                ; b8 40 00
    call 07490h                               ; e8 31 fc
    mov bl, al                                ; 88 c3
    test al, al                               ; 84 c0
    je short 07856h                           ; 74 f1
    cmp AL, strict byte 030h                  ; 3c 30
    je short 078b7h                           ; 74 4e
    cmp bl, 002h                              ; 80 fb 02
    jc short 07890h                           ; 72 22
    cmp bl, 009h                              ; 80 fb 09
    jnbe short 07890h                         ; 77 1d
    movzx ax, bl                              ; 0f b6 c3
    call 0769ch                               ; e8 23 fe
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 0787fh                          ; 75 02
    jmp short 07856h                          ; eb d7
    movzx bx, al                              ; 0f b6 d8
    mov dx, 0037ch                            ; ba 7c 03
    mov ax, si                                ; 89 f0
    call 0160eh                               ; e8 84 9d
    mov byte [bp-00eh], 002h                  ; c6 46 f2 02
    jmp short 078b7h                          ; eb 27
    cmp bl, 02eh                              ; 80 fb 2e
    je short 078a5h                           ; 74 10
    cmp bl, 026h                              ; 80 fb 26
    je short 078abh                           ; 74 11
    cmp bl, 021h                              ; 80 fb 21
    jne short 078b1h                          ; 75 12
    mov byte [bp-00eh], 001h                  ; c6 46 f2 01
    jmp short 078b7h                          ; eb 12
    mov byte [bp-00eh], 003h                  ; c6 46 f2 03
    jmp short 078b7h                          ; eb 0c
    mov byte [bp-00eh], 004h                  ; c6 46 f2 04
    jmp short 078b7h                          ; eb 06
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    je short 07856h                           ; 74 9f
    movzx bx, byte [bp-00eh]                  ; 0f b6 5e f2
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, si                                ; 89 f0
    call 0160eh                               ; e8 4b 9d
    mov AL, strict byte 003h                  ; b0 03
    mov AH, strict byte 000h                  ; b4 00
    int 010h                                  ; cd 10
    mov AL, strict byte 034h                  ; b0 34
...
delay_boot_:                                 ; 0xf78e8 LB 0x67
    ...
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 1a a0
    add sp, strict byte 00006h                ; 83 c4 06
    mov bx, dx                                ; 89 d3
    test bx, bx                               ; 85 db
    jbe short 07928h                          ; 76 17
    push bx                                   ; 53
    push 00b19h                               ; 68 19 0b
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 08 a0
    add sp, strict byte 00006h                ; 83 c4 06
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00040h                ; b8 40 00
    call 07490h                               ; e8 6b fb
    dec bx                                    ; 4b
    jmp short 0790dh                          ; eb e5
    push 00a49h                               ; 68 49 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 f2 9f
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 034h                  ; b0 34
    out strict byte 043h, AL                  ; e6 43
    db  033h, 0c0h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
scsi_cmd_data_in_:                           ; 0xf794f LB 0xb7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 079ach                          ; eb ea
    mov dx, si                                ; 89 f2
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 079c2h                          ; 75 f7
    lea dx, [si+001h]                         ; 8d 54 01
    cmp word [bp+00ch], strict byte 00000h    ; 83 7e 0c 00
    jne short 079dah                          ; 75 06
    cmp bx, 08000h                            ; 81 fb 00 80
    jbe short 079f4h                          ; 76 1a
    ...
    pop bp                                    ; 5d
    retn 0000ah                               ; c2 0a 00
scsi_cmd_data_out_:                          ; 0xf7a06 LB 0xb9
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 07a63h                          ; eb ea
    lea dx, [di+001h]                         ; 8d 55 01
    cmp word [bp+00ch], strict byte 00000h    ; 83 7e 0c 00
    jne short 07a88h                          ; 75 06
    cmp bx, 08000h                            ; 81 fb 00 80
    jbe short 07aa3h                          ; 76 1b
    mov cx, 08000h                            ; b9 00 80
...
swap_64_:                                    ; 0xf7abf LB 0x63
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@scsi_read_sectors:                          ; 0xf7b22 LB 0xd3
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 004h                  ; 3c 04
    jbe short 07b4dh                          ; 76 10
    movzx ax, byte [bp-006h]                  ; 0f b6 46 fa
    push ax                                   ; 50
    push 00b1eh                               ; 68 1e 0b
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 d8 9d
    add sp, strict byte 00006h                ; 83 c4 06
    mov es, [bp+006h]                         ; 8e 46 06
    mov di, word [es:si+00eh]                 ; 26 8b 7c 0e
    ...
    call 0794fh                               ; e8 81 fd
    mov ah, al                                ; 88 c4
    test al, al                               ; 84 c0
    jne short 07be9h                          ; 75 15
    mov es, [bp+006h]                         ; 8e 46 06
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@scsi_write_sectors:                         ; 0xf7bf5 LB 0xd3
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 004h                  ; 3c 04
    jbe short 07c20h                          ; 76 10
    movzx ax, byte [bp-006h]                  ; 0f b6 46 fa
    push ax                                   ; 50
    push 00b4ch                               ; 68 4c 0b
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 05 9d
    add sp, strict byte 00006h                ; 83 c4 06
    mov es, [bp+006h]                         ; 8e 46 06
    mov di, word [es:si+00eh]                 ; 26 8b 7c 0e
    ...
    mov cx, ss                                ; 8c d1
    lea bx, [bp-01ah]                         ; 8d 5e e6
    call 07a06h                               ; e8 65 fd
    mov ah, al                                ; 88 c4
    test al, al                               ; 84 c0
    jne short 07cbch                          ; 75 15
    mov es, [bp+006h]                         ; 8e 46 06
    mov word [es:si+018h], di                 ; 26 89 7c 18
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    mov word [es:si+01ah], dx                 ; 26 89 54 1a
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
scsi_cmd_packet_:                            ; 0xf7cc8 LB 0x166
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 38 99
    mov si, 00122h                            ; be 22 01
    mov word [bp-00eh], ax                    ; 89 46 f2
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 07d0fh                          ; 75 1f
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 e6 9b
    push 00b7bh                               ; 68 7b 0b
    push 00b8bh                               ; 68 8b 0b
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 1c 9c
    add sp, strict byte 00006h                ; 83 c4 06
    mov dx, strict word 00001h                ; ba 01 00
    jmp near 07e23h                           ; e9 14 01
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 07d88h                          ; eb ea
    mov dx, bx                                ; 89 da
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 07d9eh                          ; 75 f7
    test AL, strict byte 002h                 ; a8 02
    je short 07db9h                           ; 74 0e
    lea dx, [bx+003h]                         ; 8d 57 03
    xor al, al                                ; 30 c0
    out DX, AL                                ; ee
    in AL, DX                                 ; ec
    ...
    ; sub ah, ah                                ; 2a e4
    mov dx, strict word 00003h                ; ba 03 00
    jmp short 07e23h                          ; eb 6a
    mov ax, word [bp+004h]                    ; 8b 46 04
    test ax, ax                               ; 85 c0
    je short 07dc8h                           ; 74 08
    lea dx, [bx+001h]                         ; 8d 57 01
    mov cx, ax                                ; 89 c1
    in AL, DX                                 ; ec
    loop 07dc5h                               ; e2 fd
    ...
    cmp word [bp+008h], strict byte 00000h    ; 83 7e 08 00
    jne short 07de9h                          ; 75 07
    cmp word [bp+006h], 08000h                ; 81 7e 06 00 80
    jbe short 07e06h                          ; 76 1d
    mov dx, ax                                ; 89 c2
    mov cx, 08000h                            ; b9 00 80
    les di, [bp+00ch]                         ; c4 7e 0c
    rep insb                                  ; f3 6c
    ...
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
scsi_enumerate_attached_devices_:            ; 0xf7e2e LB 0x489
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    call 0794fh                               ; e8 bc fa
    test al, al                               ; 84 c0
    je short 07ea5h                           ; 74 0e
    push 00babh                               ; 68 ab 0b
    push 00be4h                               ; 68 e4 0b
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 80 9a
    add sp, strict byte 00006h                ; 83 c4 06
    ...
    test dx, dx                               ; 85 d2
    jne short 07f09h                          ; 75 06
    cmp bx, 00200h                            ; 81 fb 00 02
    je short 07f29h                           ; 74 20
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 cd 99
    push dx                                   ; 52
    push word [bp-034h]                       ; ff 76 cc
    push word [bp-018h]                       ; ff 76 e8
    push 00c03h                               ; 68 03 0c
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 ff 99
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 0823ch                           ; e9 13 03
    mov es, [bp-020h]                         ; 8e 46 e0
    mov al, byte [es:di+0022ch]               ; 26 8a 85 2c 02
    mov byte [bp-00ch], al                    ; 88 46 f4
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 07f44h                           ; 72 0c
    jbe short 07f4ch                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 07f54h                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 07f50h                           ; 74 0e
    jmp short 07f9dh                          ; eb 59
    test al, al                               ; 84 c0
    jne short 07f9dh                          ; 75 55
    mov BL, strict byte 090h                  ; b3 90
    jmp short 07f56h                          ; eb 0a
    mov BL, strict byte 098h                  ; b3 98
    jmp short 07f56h                          ; eb 06
    ...
    movzx cx, al                              ; 0f b6 c8
    mov ax, cx                                ; 89 c8
    call 0165ch                               ; e8 fa 96
    test al, al                               ; 84 c0
    je short 07f9dh                           ; 74 37
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    ...
    mov ax, word [bp-026h]                    ; 8b 46 da
    test ax, ax                               ; 85 c0
    jnbe short 07fd8h                         ; 77 16
    jne near 0804dh                           ; 0f 85 87 00
    cmp word [bp-010h], strict byte 00000h    ; 83 7e f0 00
    jnbe short 07fd8h                         ; 77 0c
    jne near 0804dh                           ; 0f 85 7d 00
    cmp word [bp-012h], strict byte 00040h    ; 83 7e ee 40
    jnbe short 07fd8h                         ; 77 02
    jne short 0804dh                          ; 75 75
    ...
    mov ax, word [bp-01eh]                    ; 8b 46 e2
    adc ax, bx                                ; 11 d8
    jmp short 0808ch                          ; eb 3f
    test ax, ax                               ; 85 c0
    jnbe short 08063h                         ; 77 12
    jne short 0806fh                          ; 75 1c
    cmp word [bp-010h], strict byte 00000h    ; 83 7e f0 00
    jnbe short 08063h                         ; 77 0a
    jne short 0806fh                          ; 75 14
    cmp word [bp-012h], strict byte 00020h    ; 83 7e ee 20
    jnbe short 08063h                         ; 77 02
    jne short 0806fh                          ; 75 0c
    mov word [bp-014h], 00080h                ; c7 46 ec 80 00
    mov word [bp-032h], strict word 00020h    ; c7 46 ce 20 00
    jmp short 08088h                          ; eb 19
    ...
    movzx ax, byte [bp-00ch]                  ; 0f b6 46 f4
    push ax                                   ; 50
    push 00c31h                               ; 68 31 0c
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 e8 97
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 76 94
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 76 94
    inc byte [bp-00ch]                        ; fe 46 f4
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    mov es, [bp-020h]                         ; 8e 46 e0
    mov byte [es:di+0022ch], al               ; 26 88 85 2c 02
    jmp near 0823ch                           ; e9 93 00
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 2d 97
    push word [bp-018h]                       ; ff 76 e8
    movzx ax, byte [bp-00ch]                  ; 0f b6 46 f4
    push ax                                   ; 50
    push 00c5fh                               ; 68 5f 0c
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 5e 97
    add sp, strict byte 00008h                ; 83 c4 08
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    add AL, strict byte 008h                  ; 04 08
    mov byte [bp-00eh], al                    ; 88 46 f2
    ...
    lea bx, [bp-046h]                         ; 8d 5e ba
    mov ax, word [bp-00248h]                  ; 8b 86 b8 fd
    call 0794fh                               ; e8 d9 f6
    test al, al                               ; 84 c0
    je short 08288h                           ; 74 0e
    push 00babh                               ; 68 ab 0b
    push 00bcbh                               ; 68 cb 0b
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 9d 96
    add sp, strict byte 00006h                ; 83 c4 06
    test byte [bp-00246h], 0e0h               ; f6 86 ba fd e0
    jne short 08298h                          ; 75 09
    test byte [bp-00246h], 01fh               ; f6 86 ba fd 1f
    je near 07e52h                            ; 0f 84 ba fb
    test byte [bp-00246h], 0e0h               ; f6 86 ba fd e0
    jne short 0823ch                          ; 75 9d
    mov al, byte [bp-00246h]                  ; 8a 86 ba fd
    and AL, strict byte 01fh                  ; 24 1f
    cmp AL, strict byte 005h                  ; 3c 05
    je near 081a9h                            ; 0f 84 fe fe
    jmp short 0823ch                          ; eb 8f
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop dx                                    ; 5a
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_scsi_init:                                  ; 0xf82b7 LB 0x66
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 59 93
    ...
    ; sub ah, ah                                ; 2a e4
    cmp AL, strict byte 055h                  ; 3c 55
    jne short 08319h                          ; 75 0c
    xor al, al                                ; 30 c0
    mov dx, 0043bh                            ; ba 3b 04
    out DX, AL                                ; ee
    mov ax, 00438h                            ; b8 38 04
    call 07e2eh                               ; e8 15 fb
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
high_bits_save_:                             ; 0xf831d LB 0x17
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
high_bits_restore_:                          ; 0xf8334 LB 0x17
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_set_bits_:                         ; 0xf834b LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_clear_bits_:                       ; 0xf838e LB 0x47
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_is_bit_set_:                       ; 0xf83d5 LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xchg dx, ax                               ; 92
    test dx, di                               ; 85 fa
    jne short 08401h                          ; 75 04
    test ax, bx                               ; 85 d8
    je short 08405h                           ; 74 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 08407h                          ; eb 02
    xor al, al                                ; 30 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_extract_bits_:                     ; 0xf840e LB 0x1b
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov si, bx                                ; 89 de
    ...
    pop si                                    ; 5e
    retn 00002h                               ; c2 02 00
ahci_addr_to_phys_:                          ; 0xf8429 LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
ahci_port_cmd_sync_:                         ; 0xf8447 LB 0xd5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov dx, si                                ; 89 f2
    mov ax, di                                ; 89 f8
    call 083d5h                               ; e8 e2 fe
    test al, al                               ; 84 c0
    je short 084d6h                           ; 74 df
    mov bx, strict word 00001h                ; bb 01 00
    xor cx, cx                                ; 31 c9
    mov dx, si                                ; 89 f2
    mov ax, di                                ; 89 f8
    call 0834bh                               ; e8 48 fe
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    add dx, 00118h                            ; 81 c2 18 01
    mov bx, strict word 00001h                ; bb 01 00
    xor cx, cx                                ; 31 c9
    mov ax, di                                ; 89 f8
    call 0838eh                               ; e8 7a fe
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop cx                                    ; 59
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_cmd_data_:                              ; 0xf851c LB 0x22d
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_deinit_current_:                   ; 0xf8749 LB 0x144
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_init_:                             ; 0xf888d LB 0x206
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, 0c011h                            ; bb 11 c0
    xor cx, cx                                ; 31 c9
    call 083d5h                               ; e8 ff fa
    cmp AL, strict byte 001h                  ; 3c 01
    je short 088bbh                           ; 74 e1
    mov cx, strict word 00020h                ; b9 20 00
    xor bx, bx                                ; 31 db
    mov ax, si                                ; 89 f0
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09a1ah                               ; e8 33 11
    lea ax, [si+00080h]                       ; 8d 84 80 00
    mov cx, strict word 00040h                ; b9 40 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09a1ah                               ; e8 24 11
    mov ax, si                                ; 89 f0
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@ahci_read_sectors:                          ; 0xf8a93 LB 0x94
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jbe short 08ab7h                          ; 76 0f
    push di                                   ; 57
    push 00c7ah                               ; 68 7a 0c
    push 00c8ch                               ; 68 8c 0c
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 6e 8e
    add sp, strict byte 00008h                ; 83 c4 08
    les bx, [bp+004h]                         ; c4 5e 04
    mov dx, word [es:bx+00232h]               ; 26 8b 97 32 02
    xor ax, ax                                ; 31 c0
    call 0831dh                               ; e8 59 f8
    mov es, [bp+006h]                         ; 8e 46 06
    add di, bx                                ; 01 df
    ...
    xor ax, ax                                ; 31 c0
    call 0888dh                               ; e8 b1 fd
    mov bx, strict word 00025h                ; bb 25 00
    mov ax, di                                ; 89 f8
    mov dx, word [bp+006h]                    ; 8b 56 06
    call 0851ch                               ; e8 35 fa
    mov es, [bp+006h]                         ; 8e 46 06
    mov bx, di                                ; 89 fb
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@ahci_write_sectors:                         ; 0xf8b27 LB 0x70
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    mov si, word [bp+004h]                    ; 8b 76 04
...
ahci_cmd_packet_:                            ; 0xf8b97 LB 0x17c
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 6a 8a
    mov si, 00122h                            ; be 22 01
    mov word [bp-008h], ax                    ; 89 46 f8
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 08bddh                          ; 75 1f
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 18 8d
    push 00cbeh                               ; 68 be 0c
    push 00cceh                               ; 68 ce 0c
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 4e 8d
    add sp, strict byte 00006h                ; 83 c4 06
    mov ax, strict word 00001h                ; b8 01 00
    jmp near 08d0ah                           ; e9 2d 01
    test byte [bp+004h], 001h                 ; f6 46 04 01
    jne short 08bd7h                          ; 75 f4
    mov ax, word [bp+006h]                    ; 8b 46 06
    ...
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    call 08334h                               ; e8 3e f6
    les bx, [bp-00eh]                         ; c4 5e f2
    mov ax, word [es:bx+006h]                 ; 26 8b 47 06
    or ax, word [es:bx+004h]                  ; 26 0b 47 04
    jne short 08d08h                          ; 75 05
    mov ax, strict word 00004h                ; b8 04 00
    jmp short 08d0ah                          ; eb 02
    xor ax, ax                                ; 31 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
ahci_port_detect_device_:                    ; 0xf8d13 LB 0x492
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, di                                ; 89 fb
    call 0888dh                               ; e8 60 fb
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 e6 88
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 0840eh                               ; e8 2e f6
    test ax, ax                               ; 85 c0
    je near 0919dh                            ; 0f 84 b7 03
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    sal ax, 007h                              ; c1 e0 07
    mov word [bp-01ah], ax                    ; 89 46 e6
    add ax, 00128h                            ; 05 28 01
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 0840eh                               ; e8 e2 f5
    cmp ax, strict word 00001h                ; 3d 01 00
    je short 08de6h                           ; 74 b5
    push strict byte 00000h                   ; 6a 00
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    mov ax, word [bp-020h]                    ; 8b 46 e0
    mov dx, di                                ; 89 fa
    call 0840eh                               ; e8 ce f5
    cmp ax, strict word 00003h                ; 3d 03 00
    jne near 0919dh                           ; 0f 85 56 03
    mov ax, word [bp-01ah]                    ; 8b 46 e6
    ...
    test dx, dx                               ; 85 d2
    jne near 090f0h                           ; 0f 85 10 02
    cmp ax, 00101h                            ; 3d 01 01
    jne near 090f0h                           ; 0f 85 09 02
    les bx, [bp-010h]                         ; c4 5e f0
    ...
    jne short 08f76h                          ; 75 1e
    cmp di, strict byte 0ffffh                ; 83 ff ff
    jne short 08f76h                          ; 75 19
    ...
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 08fefh                           ; 72 0c
    jbe short 08ff7h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 08fffh                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 08ffbh                           ; 74 0e
    jmp short 09048h                          ; eb 59
    test al, al                               ; 84 c0
    jne short 09048h                          ; 75 55
    mov DL, strict byte 040h                  ; b2 40
    jmp short 09001h                          ; eb 0a
    mov DL, strict byte 048h                  ; b2 48
    jmp short 09001h                          ; eb 06
    mov DL, strict byte 050h                  ; b2 50
    jmp short 09001h                          ; eb 02
    mov DL, strict byte 058h                  ; b2 58
    mov al, dl                                ; 88 d0
    add AL, strict byte 007h                  ; 04 07
    movzx bx, al                              ; 0f b6 d8
    mov ax, bx                                ; 89 d8
    call 0165ch                               ; e8 4f 86
    test al, al                               ; 84 c0
    je short 09048h                           ; 74 37
    mov al, dl                                ; 88 d0
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 42 86
    xor ah, ah                                ; 30 e4
    mov si, ax                                ; 89 c6
    sal si, 008h                              ; c1 e6 08
    movzx ax, dl                              ; 0f b6 c2
    call 0165ch                               ; e8 35 86
    xor ah, ah                                ; 30 e4
    add ax, si                                ; 01 f0
    mov word [bp-028h], ax                    ; 89 46 d8
    mov al, dl                                ; 88 d0
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 25 86
    xor ah, ah                                ; 30 e4
    mov word [bp-02ah], ax                    ; 89 46 d6
    mov ax, bx                                ; 89 d8
    call 0165ch                               ; e8 1b 86
    xor ah, ah                                ; 30 e4
    mov word [bp-026h], ax                    ; 89 46 da
    jmp short 0905ah                          ; eb 12
    push word [bp-014h]                       ; ff 76 ec
    push word [bp-018h]                       ; ff 76 e8
    push word [bp-016h]                       ; ff 76 ea
    push di                                   ; 57
    ...
    call 05608h                               ; e8 ae c5
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 7c 88
    push word [bp-014h]                       ; ff 76 ec
    push word [bp-018h]                       ; ff 76 e8
    push word [bp-016h]                       ; ff 76 ea
    push di                                   ; 57
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 21 85
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 21 85
    jmp near 0918fh                           ; e9 9f 00
    cmp dx, 0eb14h                            ; 81 fa 14 eb
    jne near 0918fh                           ; 0f 85 97 00
    cmp ax, 00101h                            ; 3d 01 01
    jne near 0918fh                           ; 0f 85 90 00
    les bx, [bp-010h]                         ; c4 5e f0
    db  066h, 026h, 0c7h, 047h, 004h, 000h, 000h, 000h, 000h
    ; mov dword [es:bx+004h], strict dword 000000000h ; 66 26 c7 47 04 00 00 00 00
    db  066h, 026h, 0c7h, 007h, 000h, 000h, 000h, 000h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_mem_alloc_:                             ; 0xf91a5 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 0161ch                               ; e8 67 84
    test ax, ax                               ; 85 c0
    je short 091deh                           ; 74 25
    dec ax                                    ; 48
    mov bx, ax                                ; 89 c3
    xor dx, dx                                ; 31 d2
    mov cx, strict word 0000ah                ; b9 0a 00
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_hba_init_:                              ; 0xf91e8 LB 0x125
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    shr eax, 010h                             ; 66 c1 e8 10
    xchg dx, ax                               ; 92
    call 091a5h                               ; e8 82 ff
    mov di, ax                                ; 89 c7
    test ax, ax                               ; 85 c0
    je near 092ech                            ; 0f 84 c1 00
    mov es, [bp-010h]                         ; 8e 46 f0
    ...
    xor cx, cx                                ; 31 c9
    call 0840eh                               ; e8 69 f1
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    mov byte [bp-00eh], al                    ; 88 46 f2
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    jmp short 092b9h                          ; eb 09
    inc byte [bp-00ch]                        ; fe 46 f4
    cmp byte [bp-00ch], 020h                  ; 80 7e f4 20
    jnc short 092eah                          ; 73 31
    movzx cx, byte [bp-00ch]                  ; 0f b6 4e f4
    mov ax, strict word 00001h                ; b8 01 00
    xor dx, dx                                ; 31 d2
    jcxz 092cah                               ; e3 06
    ...
    mov dx, strict word 0000ch                ; ba 0c 00
    mov ax, si                                ; 89 f0
    call 083d5h                               ; e8 ff f0
    test al, al                               ; 84 c0
    je short 092b0h                           ; 74 d6
    movzx bx, byte [bp-00ch]                  ; 0f b6 5e f4
    xor ax, ax                                ; 31 c0
    mov dx, di                                ; 89 fa
    call 08d13h                               ; e8 2e fa
    dec byte [bp-00eh]                        ; fe 4e f2
    jne short 092b0h                          ; 75 c6
    xor ax, ax                                ; 31 c0
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    db  00bh, 005h, 004h, 003h, 002h, 001h, 000h, 0dch, 093h, 0bah, 093h, 0c0h, 093h, 0c6h, 093h, 0cch
    db  093h, 0d2h, 093h, 0d8h, 093h, 0dch, 093h
_ahci_init:                                  ; 0xf930d LB 0xfe
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00001h                ; ba 01 00
    call 0982bh                               ; e8 0d 05
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 0ffffh                ; 3d ff ff
    je near 09404h                            ; 0f 84 dd 00
    xor al, al                                ; 30 c0
    shr ax, 008h                              ; c1 e8 08
    mov byte [bp-00ah], al                    ; 88 46 f6
    mov byte [bp-008h], dl                    ; 88 56 f8
    ...
    xor ah, ah                                ; 30 e4
    mov bx, strict word 00034h                ; bb 34 00
    call 09856h                               ; e8 1a 05
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    je short 09365h                           ; 74 23
    movzx bx, cl                              ; 0f b6 d9
    movzx di, byte [bp-008h]                  ; 0f b6 7e f8
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 09856h                               ; e8 02 05
    cmp AL, strict byte 012h                  ; 3c 12
    je short 09365h                           ; 74 0d
    mov al, cl                                ; 88 c8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    jmp short 09339h                          ; eb d4
    test cl, cl                               ; 84 c9
    je near 09404h                            ; 0f 84 99 00
    ...
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 09856h                               ; e8 d6 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne near 09404h                           ; 0f 85 7e 00
    mov byte [bp-006h], 000h                  ; c6 46 fa 00
    mov al, cl                                ; 88 c8
    add AL, strict byte 002h                  ; 04 02
    movzx bx, al                              ; 0f b6 d8
    ...
    mov al, byte [bp-006h]                    ; 8a 46 fa
    test al, al                               ; 84 c0
    je short 09404h                           ; 74 19
    movzx bx, al                              ; 0f b6 d8
    movzx dx, byte [bp-008h]                  ; 0f b6 56 f8
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    call 0989ch                               ; e8 a3 04
    test AL, strict byte 001h                 ; a8 01
    je short 09404h                           ; 74 07
    and AL, strict byte 0f0h                  ; 24 f0
    add ax, si                                ; 01 f0
    call 091e8h                               ; e8 e4 fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
apm_out_str_:                                ; 0xf940b LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    cmp byte [bx], 000h                       ; 80 3f 00
    je short 09420h                           ; 74 0a
    ...
    db 067h
    xchg sp, ax                               ; 94
    xor dx, word [di-06b87h]                  ; 33 95 79 94
    xchg sp, ax                               ; 94
    xchg sp, ax                               ; 94
    xor dx, word [di-06b41h]                  ; 33 95 bf 94
    xor dx, word [di-06b3ch]                  ; 33 95 c4 94
    or byte [di-06af8h], dl                   ; 08 95 08 95
    or byte [di-06afdh], dl                   ; 08 95 03 95
    or byte [di-06af8h], dl                   ; 08 95 08 95
    cld                                       ; fc
    xchg sp, ax                               ; 94
_apm_function:                               ; 0xf9444 LB 0xf5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    ...
    jnbe near 09508h                          ; 0f 87 b0 00
    mov bx, ax                                ; 89 c3
    add bx, ax                                ; 01 c3
    mov dx, word [bp+018h]                    ; 8b 56 18
    or dl, 001h                               ; 80 ca 01
    jmp word [cs:bx-06bdah]                   ; 2e ff a7 26 94
    ...
    jmp near 09533h                           ; e9 74 00
    sti                                       ; fb
    hlt                                       ; f4
    jmp near 09533h                           ; e9 6f 00
    cmp word [bp+010h], strict byte 00003h    ; 83 7e 10 03
    je short 094e9h                           ; 74 1f
    cmp word [bp+010h], strict byte 00002h    ; 83 7e 10 02
    je short 094e1h                           ; 74 11
    cmp word [bp+010h], strict byte 00001h    ; 83 7e 10 01
    jne short 094f1h                          ; 75 1b
    mov dx, 08900h                            ; ba 00 89
    mov ax, 00d28h                            ; b8 28 0d
    call 0940bh                               ; e8 2c ff
    jmp short 09533h                          ; eb 52
    mov dx, 08900h                            ; ba 00 89
    mov ax, 00d30h                            ; b8 30 0d
    jmp short 094dch                          ; eb f3
    mov dx, 08900h                            ; ba 00 89
    mov ax, 00d38h                            ; b8 38 0d
    jmp short 094dch                          ; eb eb
    or ah, 00ah                               ; 80 cc 0a
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 09533h                          ; eb 37
    mov word [bp+012h], 00102h                ; c7 46 12 02 01
    jmp short 09533h                          ; eb 30
    or ah, 080h                               ; 80 cc 80
    jmp short 094f4h                          ; eb ec
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 ce 83
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 00d41h                               ; 68 41 0d
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 01 84
    add sp, strict byte 00008h                ; 83 c4 08
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_select_reg_:                           ; 0xf9539 LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_find_device_:                          ; 0xf955d LB 0xf7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 095a5h                          ; 75 2d
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, bx                                ; 89 d8
    call 09539h                               ; e8 b9 ff
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 09593h                          ; 75 06
    add bx, strict byte 00008h                ; 83 c3 08
    jmp near 09626h                           ; e9 93 00
    test byte [bp-006h], 080h                 ; f6 46 fa 80
    je short 095a0h                           ; 74 07
    mov word [bp-00ah], strict word 00001h    ; c7 46 f6 01 00
    jmp short 095a5h                          ; eb 05
    mov word [bp-00ah], strict word 00008h    ; c7 46 f6 08 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 007h                  ; 24 07
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 095cdh                          ; 75 1f
    mov ax, bx                                ; 89 d8
    shr ax, 008h                              ; c1 e8 08
    test ax, ax                               ; 85 c0
    jne short 095cdh                          ; 75 16
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, bx                                ; 89 d8
    call 09539h                               ; e8 7a ff
    mov dx, 00cfeh                            ; ba fe 0c
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp al, byte [bp-008h]                    ; 3a 46 f8
    jbe short 095cdh                          ; 76 03
    mov byte [bp-008h], al                    ; 88 46 f8
    test di, di                               ; 85 ff
    je short 095d6h                           ; 74 05
    mov dx, strict word 00008h                ; ba 08 00
    jmp short 095d8h                          ; eb 02
    xor dx, dx                                ; 31 d2
    mov ax, bx                                ; 89 d8
    call 09539h                               ; e8 5c ff
    ...
    jne short 09617h                          ; 75 08
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    cmp ax, word [bp-012h]                    ; 3b 46 ee
    je short 0961dh                           ; 74 06
    cmp word [bp-010h], strict byte 00000h    ; 83 7e f0 00
    je short 09623h                           ; 74 06
    dec si                                    ; 4e
    cmp si, strict byte 0ffffh                ; 83 fe ff
    je short 09635h                           ; 74 12
    add bx, word [bp-00ah]                    ; 03 5e f6
    mov dx, bx                                ; 89 da
    shr dx, 008h                              ; c1 ea 08
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    cmp dx, ax                                ; 39 c2
    jbe near 09573h                           ; 0f 86 3e ff
    cmp si, strict byte 0ffffh                ; 83 fe ff
    jne short 0963eh                          ; 75 04
    mov ax, bx                                ; 89 d8
    jmp short 09641h                          ; eb 03
    mov ax, strict word 0ffffh                ; b8 ff ff
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    push ax                                   ; 50
    xchg di, ax                               ; 97
    arpl word [bx-06888h], dx                 ; 63 97 78 97
    mov dx, word [bx-06862h]                  ; 8b 97 9e 97
_pci16_function:                             ; 0xf9654 LB 0x1d7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ah, ah                                ; 30 e4
    cmp bx, strict byte 00003h                ; 83 fb 03
    jc short 0968dh                           ; 72 1a
    jbe short 096e5h                          ; 76 70
    cmp bx, strict byte 0000eh                ; 83 fb 0e
    je near 097b2h                            ; 0f 84 36 01
    cmp bx, strict byte 00008h                ; 83 fb 08
    jc near 097f7h                            ; 0f 82 74 01
    cmp bx, strict byte 0000dh                ; 83 fb 0d
    jbe near 0970ah                           ; 0f 86 80 00
    jmp near 097f7h                           ; e9 6a 01
    cmp bx, strict byte 00002h                ; 83 fb 02
    je short 096b5h                           ; 74 23
    cmp bx, strict byte 00001h                ; 83 fb 01
    jne near 097f7h                           ; 0f 85 5e 01
    ...
    jmp near 09824h                           ; e9 6f 01
    cmp word [bp+018h], strict byte 0ffffh    ; 83 7e 18 ff
    jne short 096c1h                          ; 75 06
    or ah, 083h                               ; 80 cc 83
    jmp near 0981dh                           ; e9 5c 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov dx, word [bp+01ch]                    ; 8b 56 1c
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor cx, cx                                ; 31 c9
    call 0955dh                               ; e8 8e fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 096dfh                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 0981dh                           ; e9 3e 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09824h                           ; e9 3f 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    mov dx, word [bp+01eh]                    ; 8b 56 1e
    mov cx, strict word 00001h                ; b9 01 00
    call 0955dh                               ; e8 69 fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09704h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 0981dh                           ; e9 19 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09824h                           ; e9 1a 01
    cmp word [bp+004h], 00100h                ; 81 7e 04 00 01
    jc short 09717h                           ; 72 06
    or ah, 087h                               ; 80 cc 87
    jmp near 0981dh                           ; e9 06 01
    mov dx, word [bp+004h]                    ; 8b 56 04
    mov ax, word [bp+014h]                    ; 8b 46 14
    call 09539h                               ; e8 19 fe
    mov bx, word [bp+020h]                    ; 8b 5e 20
    xor bh, bh                                ; 30 ff
    sub bx, strict byte 00008h                ; 83 eb 08
    cmp bx, strict byte 00005h                ; 83 fb 05
    jnbe near 09824h                          ; 0f 87 f5 00
    add bx, bx                                ; 01 db
    jmp word [cs:bx-069b8h]                   ; 2e ff a7 48 96
    ...
    les bx, [bp-008h]                         ; c4 5e f8
    mov word [es:bx], ax                      ; 26 89 07
    jmp short 09824h                          ; eb 2d
    mov bx, 00dbch                            ; bb bc 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 df 80
    mov ax, word [bp+014h]                    ; 8b 46 14
    push ax                                   ; 50
    mov ax, word [bp+020h]                    ; 8b 46 20
    push ax                                   ; 50
    push 00d74h                               ; 68 74 0d
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 10 81
    add sp, strict byte 00008h                ; 83 c4 08
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 081h                               ; 80 cc 81
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_find_classcode_:                         ; 0xf982b LB 0x2b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_byte_:                       ; 0xf9856 LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_word_:                       ; 0xf987a LB 0x22
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_dword_:                      ; 0xf989c LB 0x27
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
vds_is_present_:                             ; 0xf98c3 LB 0x1d
    push bx                                   ; 53
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_real_to_lin_:                            ; 0xf98e0 LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_build_sg_list_:                          ; 0xf98fe LB 0x79
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    call 098c3h                               ; e8 93 ff
    test ax, ax                               ; 85 c0
    je short 09947h                           ; 74 13
    mov es, si                                ; 8e c6
    mov ax, 08105h                            ; b8 05 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 09944h                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    jmp short 0996eh                          ; eb 27
    mov es, si                                ; 8e c6
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
vds_free_sg_list_:                           ; 0xf9977 LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push di                                   ; 57
    mov bx, ax                                ; 89 c3
    call 098c3h                               ; e8 42 ff
    test ax, ax                               ; 85 c0
    je short 09998h                           ; 74 13
    mov di, bx                                ; 89 df
    mov es, dx                                ; 8e c2
    mov ax, 08106h                            ; b8 06 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 09997h                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    mov es, dx                                ; 8e c2
...
_fmemcpy_:                                   ; 0xf9a27 LB 0x33
    ...
    leave                                     ; c9
    retn                                      ; c3
    add byte [bx+si-066h], dh                 ; 00 70 9a
    jc short 099deh                           ; 72 9a
    jbe short 099e0h                          ; 76 9a
    jbe short 099e2h                          ; 76 9a
    jbe short 099e4h                          ; 76 9a
    js short 099e6h                           ; 78 9a
    js short 099e8h                           ; 78 9a
    jp short 099eah                           ; 7a 9a
    jle short 099ech                          ; 7e 9a
    jle short 099eeh                          ; 7e 9a
    sbb byte [bp+si-0657bh], 087h             ; 80 9a 85 9a 87
    db  09ah
apm_worker:                                  ; 0xf9a5a LB 0x3a
    sti                                       ; fb
    push ax                                   ; 50
    db  032h, 0e4h
    ; xor ah, ah                                ; 32 e4
    ...
    jnc short 09a90h                          ; 73 25
    jmp word [cs:bp-065c0h]                   ; 2e ff a6 40 9a
    jmp short 09a8eh                          ; eb 1c
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 09a8eh                          ; eb 18
    jmp short 09a8eh                          ; eb 16
    jmp short 09a90h                          ; eb 16
    mov AH, strict byte 080h                  ; b4 80
    jmp short 09a92h                          ; eb 14
    jmp short 09a90h                          ; eb 10
    mov ax, 00102h                            ; b8 02 01
    jmp short 09a8eh                          ; eb 09
    jmp short 09a8eh                          ; eb 07
    mov BL, strict byte 000h                  ; b3 00
    mov cx, strict word 00000h                ; b9 00 00
    jmp short 09a8eh                          ; eb 00
    clc                                       ; f8
    retn                                      ; c3
    mov AH, strict byte 009h                  ; b4 09
    stc                                       ; f9
    retn                                      ; c3
apm_pm16_entry:                              ; 0xf9a94 LB 0x12
    ...
    mov ds, bp                                ; 8e dd
    call 09a5ah                               ; e8 b8 ff
    pop bp                                    ; 5d
    pop DS                                    ; 1f
    retf                                      ; cb
    times 0x1 db 0
__U8LS:                                      ; 0xf9aa6 LB 0x10
    test si, si                               ; 85 f6
    je short 09ab5h                           ; 74 0b
    sal dx, 1                                 ; d1 e2
    rcl cx, 1                                 ; d1 d1
    rcl bx, 1                                 ; d1 d3
    rcl ax, 1                                 ; d1 d0
    dec si                                    ; 4e
    jne short 09aaah                          ; 75 f5
    retn                                      ; c3
__U8RS:                                      ; 0xf9ab6 LB 0x10
    test si, si                               ; 85 f6
    je short 09ac5h                           ; 74 0b
    shr ax, 1                                 ; d1 e8
    rcr bx, 1                                 ; d1 db
    rcr cx, 1                                 ; d1 d9
    rcr dx, 1                                 ; d1 da
    dec si                                    ; 4e
    jne short 09abah                          ; 75 f5
    retn                                      ; c3

  ; Padding 0x3f3a bytes at 0xf9ac6
  times 16186 db 0
...
hard_drive_post:                             ; 0xfe2d2 LB 0x12c
    ...
    call 0930dh                               ; e8 e6 af
    call 082b7h                               ; e8 8d 9f
...
font8x8:                                     ; 0xffa6e LB 0x421
    ...
    db  080h, 0fch, 0b1h, 075h, 00fh, 006h, 01eh, 00eh, 01fh, 0fch, 066h, 060h, 0e8h, 0d7h, 097h, 066h
    db  061h, 01fh, 007h, 0cfh, 006h, 01eh, 060h, 00eh, 01fh, 0fch, 0e8h, 094h, 06eh, 061h, 01fh, 007h
    db  0cfh
...
cpu_reset:                                   ; 0xffff0 LB 0x10
    jmp far 0f000h:0e05bh                     ; ea 5b e0 00 f0
    db  030h, 036h, 02fh, 032h, 033h, 02fh, 039h, 039h, 000h, 0fch, 0a7h
