...
_pktacc:                                     ; 0xf006a LB 0xc
    db  000h, 000h, 000h, 000h, 000h, 000h, 00dh, 02bh, 036h, 07dh, 01ah, 08ch
...
_dskacc:                                     ; 0xf0082 LB 0x2e
    ...
    db  090h, 07bh, 063h, 07ch, 016h, 08bh, 0aah, 08bh, 000h, 000h, 000h, 000h, 000h, 000h, 05fh, 033h
    db  032h, 05fh, 000h, 0dah, 00fh, 000h, 000h, 001h, 0f3h, 000h, 000h, 000h, 000h, 000h

section CONST progbits vstart=0xb0 align=1 ; size=0xd9a class=DATA group=DGROUP
    ...
    db   '%s: DATA_OUT not supported yet', 00ah, 000h
    db   'AHCI %d-P#%d: PCHS=%u/%u/%u LCHS=%u/%u/%u 0x%llx sectors %llx', 00ah, 000h
    db   000h
    db   'Standby', 000h
    db   'Suspend', 000h
    db   'Shutdown', 000h
...
section CONST2 progbits vstart=0xe4a align=1 ; size=0x3fe class=DATA group=DGROUP
_bios_cvs_version_string:                    ; 0xf0e4a LB 0x16
    db  'VirtualBox 4.3.30_OSE', 000h
_bios_prefix_string:                         ; 0xf0e60 LB 0x8
    db  'BIOS: ', 000h, 000h
_isotag:                                     ; 0xf0e68 LB 0x6
    db  'CD001', 000h
_eltorito:                                   ; 0xf0e6e LB 0x18
    db  'EL TORITO SPECIFICATION', 000h
_drivetypes:                                 ; 0xf0e86 LB 0x28
...
_scan_to_scanascii:                          ; 0xf0eae LB 0x37a
...
_panic_msg_keyb_buffer_full:                 ; 0xf1228 LB 0x20
    db  '%s: keyboard input buffer full', 00ah, 000h

  ; Padding 0x3b8 bytes at 0xf1248
  times 952 db 0
...
_log_bios_start:                             ; 0xf1727 LB 0x20
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 ac 01
    push 00e4ah                               ; 68 4a 0e
...
cdrom_boot_:                                 ; 0xf3b0d LB 0x416
    ...
    cmp al, byte [di+00e6eh]                  ; 3a 85 6e 0e
...
_int13_cdemu:                                ; 0xf3f23 LB 0x434
    ...
    xor dl, dl                                ; 30 d2
    xor cx, cx                                ; 31 c9
    call 09a79h                               ; e8 b2 59
    xor bx, bx                                ; 31 db
    add ax, si                                ; 01 f0
    adc dx, bx                                ; 11 da
    mov bx, di                                ; 89 fb
    xor cx, cx                                ; 31 c9
    call 09a79h                               ; e8 a5 59
    mov bx, ax                                ; 89 c3
    mov ax, word [bp-010h]                    ; 8b 46 f0
    dec ax                                    ; 48
    xor cx, cx                                ; 31 c9
...
_int09_function:                             ; 0xf4f24 LB 0x35d
    ...
    mov dl, byte [si+00eb4h]                  ; 8a 94 b4 0e
    mov ax, word [si+00eb4h]                  ; 8b 84 b4 0e
    ...
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    imul si, si, strict byte 0000ah           ; 6b f6 0a
    movzx ax, byte [si+00eb6h]                ; 0f b6 84 b6 0e
    movzx dx, bl                              ; 0f b6 d3
    test dx, ax                               ; 85 c2
...
set_geom_lba_:                               ; 0xf55fc LB 0xe5
    ...
    xor cx, cx                                ; 31 c9
    call 09a79h                               ; e8 f9 43
    mov bx, ax                                ; 89 c3
    mov cx, dx                                ; 89 d1
    mov ax, word [bp-004h]                    ; 8b 46 fc
    mov dx, si                                ; 89 f2
    call 09a40h                               ; e8 b4 43
...
_int13_harddisk:                             ; 0xf56e1 LB 0x484
    ...
    xor cx, cx                                ; 31 c9
    call 09a79h                               ; e8 b7 3f
    mov bx, word [bp-006h]                    ; 8b 5e fa
    xor cx, cx                                ; 31 c9
    call 09a79h                               ; e8 af 3f
    mov word [bp-010h], ax                    ; 89 46 f0
    mov word [bp-00eh], dx                    ; 89 56 f2
    mov word [bp+014h], dx                    ; 89 56 14
    mov word [bp+012h], ax                    ; 89 46 12
    ...
    das                                       ; 2f
    pushaw                                    ; 60
    mov BH, strict byte 05dh                  ; b7 5d
    db  03eh, 05ch
    ; ds pop sp                                 ; 3e 5c
    rcr byte [di+02fh], 060h                  ; c0 5d 2f 60
    jle short 05bb9h                          ; 7e 60
    jle short 05bbbh                          ; 7e 60
    jle short 05bbdh                          ; 7e 60
    jle short 05bbfh                          ; 7e 60
    inc si                                    ; 46
    pushaw                                    ; 60
    jle short 05bc3h                          ; 7e 60
    jle short 05bc5h                          ; 7e 60
_int13_harddisk_ext:                         ; 0xf5b65 LB 0x534
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 0002ah                ; 83 ec 2a
    mov dx, strict word 0000eh                ; ba 0e 00
    ...
    jnbe short 05cddh                         ; 77 18
    jne short 05d00h                          ; 75 39
    cmp si, word [es:di+03ah]                 ; 26 3b 75 3a
    jnbe short 05cddh                         ; 77 10
    jne short 05d00h                          ; 75 31
    cmp cx, word [es:di+038h]                 ; 26 3b 4d 38
    jnbe short 05cddh                         ; 77 08
    jne short 05d00h                          ; 75 29
    cmp dx, word [es:di+036h]                 ; 26 3b 55 36
    jc short 05d00h                           ; 72 23
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 f9 bb
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0082bh                               ; 68 2b 08
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 28 bc
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 0605ch                           ; e9 5c 03
    mov di, word [bp+016h]                    ; 8b 7e 16
    shr di, 008h                              ; c1 ef 08
    cmp di, strict byte 00044h                ; 83 ff 44
    je near 0602fh                            ; 0f 84 22 03
    cmp di, strict byte 00047h                ; 83 ff 47
    je near 0602fh                            ; 0f 84 1b 03
    les bx, [bp-00ah]                         ; c4 5e f6
    ...
    mov word [es:bx+002h], ax                 ; 26 89 47 02
    test dl, dl                               ; 84 d2
    je near 0602fh                            ; 0f 84 a1 02
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 48 bb
    movzx ax, dl                              ; 0f b6 c2
    push ax                                   ; 50
    push di                                   ; 57
    push 0082bh                               ; 68 2b 08
    push 0078fh                               ; 68 8f 07
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 79 bb
    add sp, strict byte 0000ah                ; 83 c4 0a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    jmp near 06064h                           ; e9 ad 02
    or dh, 0b2h                               ; 80 ce b2
    mov word [bp+016h], dx                    ; 89 56 16
    jmp near 06067h                           ; e9 a7 02
    ...
    mov word [bp-014h], ax                    ; 89 46 ec
    cmp ax, strict word 0001ah                ; 3d 1a 00
    jc near 0605ch                            ; 0f 82 7f 02
    jc near 05e74h                            ; 0f 82 93 00
    movzx ax, byte [bp-006h]                  ; 0f b6 46 fa
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    les bx, [bp-00ah]                         ; c4 5e f6
    add bx, ax                                ; 01 c3
    ...
    test al, al                               ; 84 c0
    jne short 05ed1h                          ; 75 04
    xor bx, bx                                ; 31 db
    jmp short 05ed4h                          ; eb 03
    ...
    or bx, cx                                 ; 09 cb
    cmp AL, strict byte 003h                  ; 3c 03
    jne short 05ef5h                          ; 75 05
    mov ax, strict word 00003h                ; b8 03 00
    jmp short 05ef7h                          ; eb 02
    xor ax, ax                                ; 31 c0
    or bx, ax                                 ; 09 c3
    mov ax, word [bp-01ch]                    ; 8b 46 e4
    ...
    jmp short 06014h                          ; eb 05
    cmp bh, 040h                              ; 80 ff 40
    jnc short 06026h                          ; 73 12
    movzx dx, bh                              ; 0f b6 d7
    add dx, word [bp+00ah]                    ; 03 56 0a
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 01600h                               ; e8 e0 b5
    add bl, al                                ; 00 c3
    db  0feh, 0c7h
    ; inc bh                                    ; fe c7
    jmp short 0600fh                          ; eb e9
    neg bl                                    ; f6 db
    mov es, [bp-00ch]                         ; 8e 46 f4
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 d0 b5
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    cmp dx, strict byte 00006h                ; 83 fa 06
    je short 0602fh                           ; 74 e4
    cmp dx, strict byte 00001h                ; 83 fa 01
    jc short 0605ch                           ; 72 0c
    jbe short 0602fh                          ; 76 dd
    cmp dx, strict byte 00003h                ; 83 fa 03
    jc short 0605ch                           ; 72 05
    cmp dx, strict byte 00004h                ; 83 fa 04
    jbe short 0602fh                          ; 76 d3
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 96 b5
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 06042h                          ; eb c4
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 58 b8
    mov ax, word [bp+016h]                    ; 8b 46 16
    shr ax, 008h                              ; c1 e8 08
    push ax                                   ; 50
    push 0082bh                               ; 68 2b 08
    push 007fdh                               ; 68 fd 07
    jmp near 05cf5h                           ; e9 5c fc
_int14_function:                             ; 0xf6099 LB 0x155
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sti                                       ; fb
    ...
    add dx, dx                                ; 01 d2
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 73 b5
    mov si, ax                                ; 89 c6
    mov bx, ax                                ; 89 c3
    mov dx, word [bp+00eh]                    ; 8b 56 0e
    add dx, strict byte 0007ch                ; 83 c2 7c
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 47 b5
    mov cl, al                                ; 88 c1
    cmp word [bp+00eh], strict byte 00004h    ; 83 7e 0e 04
    jnc near 061e4h                           ; 0f 83 21 01
    test si, si                               ; 85 f6
    jbe near 061e4h                           ; 0f 86 1b 01
    mov al, byte [bp+013h]                    ; 8a 46 13
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 060e1h                           ; 72 11
    jbe short 06135h                          ; 76 63
    cmp AL, strict byte 003h                  ; 3c 03
    je near 061cdh                            ; 0f 84 f5 00
    cmp AL, strict byte 002h                  ; 3c 02
    je near 06183h                            ; 0f 84 a5 00
    jmp near 061deh                           ; e9 fd 00
    test al, al                               ; 84 c0
    jne near 061deh                           ; 0f 85 f7 00
    ...
    out DX, AL                                ; ee
    jmp short 0610ah                          ; eb d5
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 de b4
    mov si, ax                                ; 89 c6
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    je short 06165h                           ; 74 17
    test cl, cl                               ; 84 c9
    je short 06165h                           ; 74 13
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 c1 b4
    cmp ax, si                                ; 39 f0
    je short 06140h                           ; 74 e1
    mov si, ax                                ; 89 c6
    db  0feh, 0c9h
    ; dec cl                                    ; fe c9
    jmp short 06140h                          ; eb db
    test cl, cl                               ; 84 c9
    je short 0616fh                           ; 74 06
    mov al, byte [bp+012h]                    ; 8a 46 12
    mov dx, bx                                ; 89 da
    out DX, AL                                ; ee
    lea dx, [bx+005h]                         ; 8d 57 05
    ...
    mov byte [bp+013h], al                    ; 88 46 13
    test cl, cl                               ; 84 c9
    jne short 061bfh                          ; 75 43
    or AL, strict byte 080h                   ; 0c 80
    mov byte [bp+013h], al                    ; 88 46 13
    jmp short 061bfh                          ; eb 3c
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 90 b4
    mov si, ax                                ; 89 c6
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 061afh                          ; 75 17
    test cl, cl                               ; 84 c9
    je short 061afh                           ; 74 13
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 77 b4
    cmp ax, si                                ; 39 f0
    je short 0618eh                           ; 74 e5
    mov si, ax                                ; 89 c6
    db  0feh, 0c9h
    ; dec cl                                    ; fe c9
    jmp short 0618eh                          ; eb df
    test cl, cl                               ; 84 c9
    je short 061c5h                           ; 74 12
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov dx, bx                                ; 89 da
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    mov byte [bp+012h], al                    ; 88 46 12
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp short 061e8h                          ; eb 23
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 0617eh                          ; eb b1
    lea dx, [si+005h]                         ; 8d 54 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 061bch                          ; eb de
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 061e8h                          ; eb 04
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
set_enable_a20_:                             ; 0xf61ee LB 0x2c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov cl, al                                ; 88 c1
    test bx, bx                               ; 85 db
    je short 06207h                           ; 74 05
    or AL, strict byte 002h                   ; 0c 02
    out DX, AL                                ; ee
    jmp short 0620ah                          ; eb 03
    and AL, strict byte 0fdh                  ; 24 fd
    out DX, AL                                ; ee
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_e820_range_:                             ; 0xf621a LB 0x8c
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov es, ax                                ; 8e c0
    ...
    db  000h, 045h, 067h, 0e5h, 062h, 0f8h, 062h, 08dh, 063h, 093h, 063h, 098h, 063h, 09dh, 063h, 03fh
    db  064h, 0dch, 065h, 002h, 066h, 086h, 063h, 086h, 063h, 0cfh, 066h, 0f7h, 066h, 00ah, 067h, 019h
    db  067h, 08dh, 063h, 020h, 067h
_int15_function:                             ; 0xf62a6 LB 0x4cd
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jnbe near 06745h                          ; 0f 87 8b 04
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 00012h                ; b9 12 00
    mov di, 06271h                            ; bf 71 62
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov si, word [cs:di+06282h]               ; 2e 8b b5 82 62
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    ...
    jne near 06745h                           ; 0f 85 54 04
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    jmp near 066eeh                           ; e9 f6 03
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 0630dh                           ; 72 0e
    jbe short 06321h                          ; 76 20
    cmp ax, strict word 00003h                ; 3d 03 00
    je short 0634eh                           ; 74 48
    cmp ax, strict word 00002h                ; 3d 02 00
    je short 06331h                           ; 74 26
    jmp short 0635bh                          ; eb 4e
    test ax, ax                               ; 85 c0
    jne short 0635bh                          ; 75 4a
    xor ax, ax                                ; 31 c0
    call 061eeh                               ; e8 d8 fe
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp near 06386h                           ; e9 65 00
    mov ax, strict word 00001h                ; b8 01 00
    call 061eeh                               ; e8 c7 fe
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], dh                    ; 88 76 13
    jmp near 06386h                           ; e9 55 00
    mov dx, 00092h                            ; ba 92 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    jmp near 06386h                           ; e9 38 00
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], ah                    ; 88 66 13
    mov word [bp+00ch], ax                    ; 89 46 0c
    jmp near 06386h                           ; e9 2b 00
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 7b b5
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    push 008cch                               ; 68 cc 08
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 ae b5
    add sp, strict byte 00006h                ; 83 c4 06
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    ...
    retn                                      ; c3
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp near 06439h                           ; e9 a6 00
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp short 06386h                          ; eb ee
    mov word [bp+018h], cx                    ; 89 4e 18
    jmp short 06383h                          ; eb e6
    test byte [bp+012h], 0ffh                 ; f6 46 12 ff
    je short 0640fh                           ; 74 6c
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 54 b2
    test AL, strict byte 001h                 ; a8 01
    jne near 066e5h                           ; 0f 85 33 03
    mov bx, strict word 00001h                ; bb 01 00
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 50 b2
    mov bx, word [bp+014h]                    ; 8b 5e 14
    mov dx, 00098h                            ; ba 98 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0162ah                               ; e8 60 b2
    mov bx, word [bp+00ch]                    ; 8b 5e 0c
    ...
    mov ax, strict word 00040h                ; b8 40 00
    call 0162ah                               ; e8 48 b2
    mov bx, word [bp+010h]                    ; 8b 5e 10
    mov dx, 0009eh                            ; ba 9e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0162ah                               ; e8 3c b2
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov dx, 000a1h                            ; ba a1 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    out DX, AL                                ; ee
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 5b b2
    or AL, strict byte 040h                   ; 0c 40
    movzx dx, al                              ; 0f b6 d0
    mov ax, strict word 0000bh                ; b8 0b 00
    call 01679h                               ; e8 6d b2
    jmp near 06386h                           ; e9 77 ff
    cmp ax, strict word 00001h                ; 3d 01 00
    jne short 0642dh                          ; 75 19
    xor bx, bx                                ; 31 db
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 ef b1
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 33 b2
    and AL, strict byte 0bfh                  ; 24 bf
    jmp short 06403h                          ; eb d6
    mov word [bp+018h], bx                    ; 89 5e 18
    mov ax, dx                                ; 89 d0
    xor ah, dh                                ; 30 f4
    xor dl, dl                                ; 30 d2
    ...
    or dx, ax                                 ; 09 c2
    mov word [bp+012h], dx                    ; 89 56 12
    jmp near 06386h                           ; e9 47 ff
    cli                                       ; fa
    mov ax, strict word 00001h                ; b8 01 00
    call 061eeh                               ; e8 a8 fd
    mov di, ax                                ; 89 c7
    mov ax, word [bp+014h]                    ; 8b 46 14
    sal ax, 004h                              ; c1 e0 04
    mov cx, word [bp+006h]                    ; 8b 4e 06
    ...
    push cx                                   ; 51
    retf                                      ; cb
    jmp near 06386h                           ; e9 b7 fc
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 07 b2
    push 0090ch                               ; 68 0c 09
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 40 b2
    add sp, strict byte 00004h                ; 83 c4 04
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    mov word [bp+012h], ax                    ; 89 46 12
    jmp near 06386h                           ; e9 8f fc
    mov word [bp+018h], cx                    ; 89 4e 18
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+00ch], 0e6f5h                ; c7 46 0c f5 e6
    mov word [bp+014h], 0f000h                ; c7 46 14 00 f0
    jmp near 06386h                           ; e9 7c fc
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 09 af
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 065d5h                           ; e9 bc fe
    push 0093bh                               ; 68 3b 09
    push strict byte 00008h                   ; 6a 08
    jmp short 066dfh                          ; eb bf
    test byte [bp+012h], 0ffh                 ; f6 46 12 ff
    jne short 06745h                          ; 75 1f
    mov word [bp+012h], ax                    ; 89 46 12
    mov ax, word [bp+00ch]                    ; 8b 46 0c
    xor ah, ah                                ; 30 e4
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 0673eh                           ; 72 0b
    cmp ax, strict word 00003h                ; 3d 03 00
    jnbe short 0673eh                         ; 77 06
    mov word [bp+018h], cx                    ; 89 4e 18
    jmp near 06386h                           ; e9 48 fc
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    jmp near 06386h                           ; e9 41 fc
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 91 b1
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 00952h                               ; 68 52 09
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 c4 b1
    add sp, strict byte 00008h                ; 83 c4 08
    jmp short 066e5h                          ; eb 82
    sbb AL, strict byte 069h                  ; 1c 69
    imul sp, word [ds:bx+di+069h], 06983h     ; 3e 69 61 69 83 69
    mov word [0c469h], ax                     ; a3 69 c4
    imul ax, word [bp+di], 02f6ah             ; 69 03 6a 2f
    db  06ah
_int15_function32:                           ; 0xf6773 LB 0x37e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sub sp, strict byte 00008h                ; 83 ec 08
    ...
    je near 06840h                            ; 0f 84 ad 00
    cmp dx, 000d0h                            ; 81 fa d0 00
    je short 067dbh                           ; 74 42
    cmp dx, 00086h                            ; 81 fa 86 00
    jne near 06ac1h                           ; 0f 85 20 03
    sti                                       ; fb
    ...
    db  066h, 00bh, 0c9h
    ; or ecx, ecx                               ; 66 0b c9
    je near 067d8h                            ; 0f 84 0e 00
    in AL, strict byte 061h                   ; e4 61
    and AL, strict byte 010h                  ; 24 10
    db  03ah, 0c4h
    ; cmp al, ah                                ; 3a c4
    je short 067cah                           ; 74 f8
    db  08ah, 0e0h
    ; mov ah, al                                ; 8a e0
    dec ecx                                   ; 66 49
    jne short 067cah                          ; 75 f2
    jmp near 06aebh                           ; e9 10 03
    cmp ax, strict word 0004fh                ; 3d 4f 00
    jne near 06ac1h                           ; 0f 85 df 02
    cmp word [bp+016h], 05052h                ; 81 7e 16 52 50
    jne near 06ac1h                           ; 0f 85 d6 02
    cmp word [bp+014h], 04f43h                ; 81 7e 14 43 4f
    jne near 06ac1h                           ; 0f 85 cd 02
    cmp word [bp+01eh], 04d4fh                ; 81 7e 1e 4f 4d
    jne near 06ac1h                           ; 0f 85 c4 02
    cmp word [bp+01ch], 04445h                ; 81 7e 1c 45 44
    jne near 06ac1h                           ; 0f 85 bb 02
    mov ax, word [bp+00ah]                    ; 8b 46 0a
    or ax, word [bp+008h]                     ; 0b 46 08
    jne near 06ac1h                           ; 0f 85 b1 02
    mov ax, word [bp+006h]                    ; 8b 46 06
    or ax, word [bp+004h]                     ; 0b 46 04
    jne near 06ac1h                           ; 0f 85 a7 02
    ...
    jmp near 06aebh                           ; e9 ab 02
    cmp ax, strict word 00020h                ; 3d 20 00
    je short 0684fh                           ; 74 0a
    cmp ax, strict word 00001h                ; 3d 01 00
    je near 06a76h                            ; 0f 84 2a 02
    jmp near 06ac1h                           ; e9 72 02
    cmp word [bp+01ah], 0534dh                ; 81 7e 1a 4d 53
    jne near 06ac1h                           ; 0f 85 69 02
    cmp word [bp+018h], 04150h                ; 81 7e 18 50 41
    jne near 06ac1h                           ; 0f 85 60 02
    mov ax, strict word 00035h                ; b8 35 00
    call 0165ch                               ; e8 f5 ad
    movzx bx, al                              ; 0f b6 d8
    xor dx, dx                                ; 31 d2
    ...
    jc short 06895h                           ; 72 06
    jne short 068c2h                          ; 75 31
    test bx, bx                               ; 85 db
    jnbe short 068c2h                         ; 77 2d
    mov ax, strict word 00031h                ; b8 31 00
    call 0165ch                               ; e8 c1 ad
    movzx bx, al                              ; 0f b6 d8
    xor dx, dx                                ; 31 d2
    mov cx, strict word 00008h                ; b9 08 00
    sal bx, 1                                 ; d1 e3
    ...
    jmp word [cs:si+06763h]                   ; 2e ff a4 63 67
    push strict byte 00001h                   ; 6a 01
    ...
    xor bx, bx                                ; 31 db
    xor cx, cx                                ; 31 c9
    call 0621ah                               ; e8 02 f8
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 06a25h                          ; 75 07
    mov ax, word [bp-008h]                    ; 8b 46 f8
    test ax, ax                               ; 85 c0
    je short 06a27h                           ; 74 02
    jmp short 069e7h                          ; eb c0
    mov word [bp+014h], ax                    ; 89 46 14
    mov word [bp+016h], ax                    ; 89 46 16
    jmp short 06a60h                          ; eb 31
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 06a3bh                          ; 75 06
    cmp word [bp-008h], strict byte 00000h    ; 83 7e f8 00
    je short 06a60h                           ; 74 25
    push strict byte 00001h                   ; 6a 01
    mov al, byte [bp-006h]                    ; 8a 46 fa
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    ...
    jmp short 06aebh                          ; eb 75
    mov word [bp+028h], bx                    ; 89 5e 28
    mov ax, strict word 00031h                ; b8 31 00
    call 0165ch                               ; e8 dd ab
    movzx dx, al                              ; 0f b6 d0
    sal dx, 008h                              ; c1 e2 08
    mov ax, strict word 00030h                ; b8 30 00
    call 0165ch                               ; e8 d1 ab
    xor ah, ah                                ; 30 e4
    or dx, ax                                 ; 09 c2
    mov word [bp+01ch], dx                    ; 89 56 1c
    cmp dx, 03c00h                            ; 81 fa 00 3c
    jbe short 06a9dh                          ; 76 05
    mov word [bp+01ch], 03c00h                ; c7 46 1c 00 3c
    mov ax, strict word 00035h                ; b8 35 00
    call 0165ch                               ; e8 b9 ab
    movzx dx, al                              ; 0f b6 d0
    sal dx, 008h                              ; c1 e2 08
    mov ax, strict word 00034h                ; b8 34 00
    call 0165ch                               ; e8 ad ab
    xor ah, ah                                ; 30 e4
    or dx, ax                                 ; 09 c2
    mov word [bp+018h], dx                    ; 89 56 18
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    ...
    mov word [bp+014h], dx                    ; 89 56 14
    jmp short 06aebh                          ; eb 2a
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 15 ae
    push word [bp+014h]                       ; ff 76 14
    push word [bp+020h]                       ; ff 76 20
    push 00952h                               ; 68 52 09
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 48 ae
    add sp, strict byte 00008h                ; 83 c4 08
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_inv_op_handler:                             ; 0xf6af1 LB 0x195
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 06b07h                          ; 75 06
    inc word [bp+018h]                        ; ff 46 18
    jmp near 06c7fh                           ; e9 78 01
    cmp word [es:bx], 0050fh                  ; 26 81 3f 0f 05
    jne near 06c7bh                           ; 0f 85 6b 01
    ...
    loop 06b60h                               ; e2 fa
    cmp bx, dx                                ; 39 d3
    jne short 06b6eh                          ; 75 04
    cmp di, ax                                ; 39 c7
    je short 06b73h                           ; 74 05
    ...
    loop 06b88h                               ; e2 fa
    cmp di, dx                                ; 39 d7
    jne short 06b96h                          ; 75 04
    cmp bx, ax                                ; 39 c3
    je short 06b9ah                           ; 74 04
    ...
    je near 06c38h                            ; 0f 84 02 00
    mov es, ax                                ; 8e c0
    test cx, strict word 00002h               ; f7 c1 02 00
    je near 06c60h                            ; 0f 84 20 00
    ...
    iret                                      ; cf
    jmp short 06c7fh                          ; eb 04
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 06c7ch                          ; eb fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
init_rtc_:                                   ; 0xf6c86 LB 0x28
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, strict word 0000ah                ; b8 0a 00
    call 01679h                               ; e8 e6 a9
    mov dx, strict word 00002h                ; ba 02 00
    mov ax, strict word 0000bh                ; b8 0b 00
    call 01679h                               ; e8 dd a9
    mov ax, strict word 0000ch                ; b8 0c 00
    call 0165ch                               ; e8 ba a9
    mov ax, strict word 0000dh                ; b8 0d 00
    call 0165ch                               ; e8 b4 a9
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop dx                                    ; 5a
    pop bp                                    ; 5d
    retn                                      ; c3
rtc_updating_:                               ; 0xf6cae LB 0x21
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, 061a8h                            ; ba a8 61
    dec dx                                    ; 4a
    je short 06cc6h                           ; 74 0e
    mov ax, strict word 0000ah                ; b8 0a 00
    call 0165ch                               ; e8 9e a9
    test AL, strict byte 080h                 ; a8 80
    jne short 06cb5h                          ; 75 f3
    xor ax, ax                                ; 31 c0
    jmp short 06cc9h                          ; eb 03
    mov ax, strict word 00001h                ; b8 01 00
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop dx                                    ; 5a
    pop bp                                    ; 5d
    retn                                      ; c3
_int70_function:                             ; 0xf6ccf LB 0xbe
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push ax                                   ; 50
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 82 a9
    mov dl, al                                ; 88 c2
    mov byte [bp-004h], al                    ; 88 46 fc
    mov ax, strict word 0000ch                ; b8 0c 00
    call 0165ch                               ; e8 77 a9
    mov dh, al                                ; 88 c6
    test dl, 060h                             ; f6 c2 60
    je near 06d74h                            ; 0f 84 86 00
    test AL, strict byte 020h                 ; a8 20
    je short 06cf6h                           ; 74 04
    sti                                       ; fb
    int 04ah                                  ; cd 4a
    cli                                       ; fa
    test dh, 040h                             ; f6 c6 40
    je near 06d74h                            ; 0f 84 77 00
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 fa a8
    test al, al                               ; 84 c0
    je short 06d74h                           ; 74 6a
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01638h                               ; e8 25 a9
    test dx, dx                               ; 85 d2
    jne short 06d60h                          ; 75 49
    cmp ax, 003d1h                            ; 3d d1 03
    jnc short 06d60h                          ; 73 44
    mov dx, 00098h                            ; ba 98 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 f7 a8
    mov si, ax                                ; 89 c6
    mov dx, 0009ah                            ; ba 9a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 ec a8
    mov cx, ax                                ; 89 c1
    xor bx, bx                                ; 31 db
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 d1 a8
    mov al, byte [bp-004h]                    ; 8a 46 fc
    ...
    mov dx, cx                                ; 89 ca
    mov ax, si                                ; 89 f0
    call 0160eh                               ; e8 b0 a8
    jmp short 06d74h                          ; eb 14
    mov bx, ax                                ; 89 c3
    ...
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0164ah                               ; e8 d6 a8
    call 0e03bh                               ; e8 c4 72
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
    ...
    int 06dh                                  ; cd 6d
    repne insw                                ; f2 6d
    and AL, strict byte 06eh                  ; 24 6e
    jnc short 06df5h                          ; 73 6e
    stosw                                     ; ab
    outsb                                     ; 6e
    out DX, AL                                ; ee
    outsb                                     ; 6e
    inc bp                                    ; 45
    outsw                                     ; 6f
_int1a_function:                             ; 0xf6d8d LB 0x1c8
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sti                                       ; fb
    mov al, byte [bp+013h]                    ; 8a 46 13
    cmp AL, strict byte 007h                  ; 3c 07
    jnbe near 06dc9h                          ; 0f 87 2f 00
    movzx bx, al                              ; 0f b6 d8
    add bx, bx                                ; 01 db
    jmp word [cs:bx+06d7dh]                   ; 2e ff a7 7d 6d
    cli                                       ; fa
    ...
    sti                                       ; fb
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp short 06dc9h                          ; eb d7
    call 06caeh                               ; e8 b9 fe
    test ax, ax                               ; 85 c0
    je short 06dfbh                           ; 74 02
    jmp short 06dc9h                          ; eb ce
    xor ax, ax                                ; 31 c0
    call 0165ch                               ; e8 5c a8
    mov byte [bp+00fh], al                    ; 88 46 0f
    mov ax, strict word 00002h                ; b8 02 00
    call 0165ch                               ; e8 53 a8
    mov byte [bp+010h], al                    ; 88 46 10
    mov ax, strict word 00004h                ; b8 04 00
    call 0165ch                               ; e8 4a a8
    mov bl, al                                ; 88 c3
    ...
    jmp short 06e69h                          ; eb 45
    call 06caeh                               ; e8 87 fe
    test ax, ax                               ; 85 c0
    je short 06e2eh                           ; 74 03
    call 06c86h                               ; e8 58 fe
    movzx dx, byte [bp+00fh]                  ; 0f b6 56 0f
    xor ax, ax                                ; 31 c0
    call 01679h                               ; e8 42 a8
    movzx dx, byte [bp+010h]                  ; 0f b6 56 10
    mov ax, strict word 00002h                ; b8 02 00
    call 01679h                               ; e8 38 a8
    movzx dx, byte [bp+011h]                  ; 0f b6 56 11
    mov ax, strict word 00004h                ; b8 04 00
    call 01679h                               ; e8 2e a8
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 0b a8
    mov bl, al                                ; 88 c3
    ...
    movzx dx, bl                              ; 0f b6 d3
    mov ax, strict word 0000bh                ; b8 0b 00
    call 01679h                               ; e8 10 a8
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov byte [bp+012h], bl                    ; 88 5e 12
    jmp near 06dc9h                           ; e9 56 ff
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    call 06caeh                               ; e8 34 fe
    test ax, ax                               ; 85 c0
    je short 06e81h                           ; 74 03
    jmp near 06dc9h                           ; e9 48 ff
    mov ax, strict word 00009h                ; b8 09 00
    call 0165ch                               ; e8 d5 a7
    mov byte [bp+010h], al                    ; 88 46 10
    mov ax, strict word 00008h                ; b8 08 00
    call 0165ch                               ; e8 cc a7
    mov byte [bp+00fh], al                    ; 88 46 0f
    mov ax, strict word 00007h                ; b8 07 00
    call 0165ch                               ; e8 c3 a7
    mov byte [bp+00eh], al                    ; 88 46 0e
    mov ax, strict word 00032h                ; b8 32 00
    call 0165ch                               ; e8 ba a7
    mov byte [bp+011h], al                    ; 88 46 11
    mov byte [bp+012h], al                    ; 88 46 12
    jmp near 06dc9h                           ; e9 1e ff
    call 06caeh                               ; e8 00 fe
    test ax, ax                               ; 85 c0
    je short 06eb8h                           ; 74 06
    call 06c86h                               ; e8 d1 fd
    jmp near 06dc9h                           ; e9 11 ff
    movzx dx, byte [bp+010h]                  ; 0f b6 56 10
    mov ax, strict word 00009h                ; b8 09 00
    call 01679h                               ; e8 b7 a7
    movzx dx, byte [bp+00fh]                  ; 0f b6 56 0f
    mov ax, strict word 00008h                ; b8 08 00
    call 01679h                               ; e8 ad a7
    movzx dx, byte [bp+00eh]                  ; 0f b6 56 0e
    mov ax, strict word 00007h                ; b8 07 00
    call 01679h                               ; e8 a3 a7
    movzx dx, byte [bp+011h]                  ; 0f b6 56 11
    mov ax, strict word 00032h                ; b8 32 00
    call 01679h                               ; e8 99 a7
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 76 a7
    mov bl, al                                ; 88 c3
    and bl, 07fh                              ; 80 e3 7f
    jmp near 06e60h                           ; e9 72 ff
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 68 a7
    mov bl, al                                ; 88 c3
    mov word [bp+012h], strict word 00000h    ; c7 46 12 00 00
    test AL, strict byte 020h                 ; a8 20
    je short 06f02h                           ; 74 03
    jmp near 06dc9h                           ; e9 c7 fe
    call 06caeh                               ; e8 a9 fd
    test ax, ax                               ; 85 c0
    je short 06f0ch                           ; 74 03
    call 06c86h                               ; e8 7a fd
    movzx dx, byte [bp+00fh]                  ; 0f b6 56 0f
    mov ax, strict word 00001h                ; b8 01 00
    call 01679h                               ; e8 63 a7
    movzx dx, byte [bp+010h]                  ; 0f b6 56 10
    mov ax, strict word 00003h                ; b8 03 00
    call 01679h                               ; e8 59 a7
    movzx dx, byte [bp+011h]                  ; 0f b6 56 11
    mov ax, strict word 00005h                ; b8 05 00
    call 01679h                               ; e8 4f a7
    mov dx, 000a1h                            ; ba a1 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    movzx dx, al                              ; 0f b6 d0
    mov ax, strict word 0000bh                ; b8 0b 00
    call 01679h                               ; e8 37 a7
    jmp near 06dc9h                           ; e9 84 fe
    mov ax, strict word 0000bh                ; b8 0b 00
    call 0165ch                               ; e8 11 a7
    mov bl, al                                ; 88 c3
    and AL, strict byte 057h                  ; 24 57
    movzx dx, al                              ; 0f b6 d0
    jmp near 06e63h                           ; e9 0e ff
send_to_mouse_ctrl_:                         ; 0xf6f55 LB 0x34
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 06f74h                           ; 74 0e
    push 0098ch                               ; 68 8c 09
    push 01228h                               ; 68 28 12
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 b1 a9
    add sp, strict byte 00006h                ; 83 c4 06
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
get_mouse_data_:                             ; 0xf6f89 LB 0x3b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    je short 06faah                           ; 74 07
    test cx, cx                               ; 85 c9
    je short 06faah                           ; 74 03
    dec cx                                    ; 49
    jmp short 06f95h                          ; eb eb
    test cx, cx                               ; 85 c9
    jne short 06fb2h                          ; 75 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 06fbdh                          ; eb 0b
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_kbd_command_byte_:                       ; 0xf6fc4 LB 0x32
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 06fe3h                           ; 74 0e
    push 00996h                               ; 68 96 09
    push 01228h                               ; 68 28 12
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 42 a9
    add sp, strict byte 00006h                ; 83 c4 06
    mov AL, strict byte 060h                  ; b0 60
    mov dx, strict word 00064h                ; ba 64 00
    out DX, AL                                ; ee
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_int74_function:                             ; 0xf6ff6 LB 0xca
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 00008h                ; 83 ec 08
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 17 a6
    mov cx, ax                                ; 89 c1
    mov word [bp+004h], strict word 00000h    ; c7 46 04 00 00
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    ...
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 d6 a5
    mov byte [bp-006h], al                    ; 88 46 fa
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 cb a5
    mov byte [bp-008h], al                    ; 88 46 f8
    test AL, strict byte 080h                 ; a8 80
    je short 070ach                           ; 74 70
    mov al, byte [bp-008h]                    ; 8a 46 f8
    and AL, strict byte 007h                  ; 24 07
    mov byte [bp-002h], al                    ; 88 46 fe
    mov al, byte [bp-006h]                    ; 8a 46 fa
    ...
    je short 070a0h                           ; 74 0a
    mov word [bp+004h], strict word 00001h    ; c7 46 04 01 00
    jmp short 070a0h                          ; eb 03
    inc byte [bp-006h]                        ; fe 46 fa
    movzx bx, byte [bp-006h]                  ; 0f b6 5e fa
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 0160eh                               ; e8 62 a5
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    add AL, strict byte 071h                  ; 04 71
    jp short 07125h                           ; 7a 71
    std                                       ; fd
    jno short 07045h                          ; 71 8e
    jc short 070b5h                           ; 72 fc
    jc short 0710bh                           ; 72 50
    jno short 070e1h                          ; 71 24
    jnc short 070a8h                          ; 73 e9
    db  073h
_int15_function_mouse:                       ; 0xf70c0 LB 0x38b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sub sp, strict byte 00006h                ; 83 ec 06
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 4c a5
    mov cx, ax                                ; 89 c1
    cmp byte [bp+012h], 007h                  ; 80 7e 12 07
    jbe short 070e3h                          ; 76 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    jmp near 07445h                           ; e9 62 03
    mov ax, strict word 00065h                ; b8 65 00
    call 06fc4h                               ; e8 db fe
    and word [bp+018h], strict byte 0fffeh    ; 83 66 18 fe
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov al, byte [bp+012h]                    ; 8a 46 12
    cmp AL, strict byte 007h                  ; 3c 07
    jnbe near 0742ch                          ; 0f 87 32 03
    movzx si, al                              ; 0f b6 f0
    add si, si                                ; 01 f6
    jmp word [cs:si+070b0h]                   ; 2e ff a4 b0 70
    cmp byte [bp+00dh], 001h                  ; 80 7e 0d 01
    jnbe near 07437h                          ; 0f 87 2b 03
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 ec a4
    test AL, strict byte 080h                 ; a8 80
    jne short 07123h                          ; 75 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 005h                  ; c6 46 13 05
    jmp near 0743fh                           ; e9 1c 03
    cmp byte [bp+00dh], 000h                  ; 80 7e 0d 00
    db  00fh, 094h, 0c0h
    ; sete al                                   ; 0f 94 c0
    add AL, strict byte 0f4h                  ; 04 f4
    xor ah, ah                                ; 30 e4
    call 06f55h                               ; e8 24 fe
    test al, al                               ; 84 c0
    jne near 073c5h                           ; 0f 85 8e 02
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f89h                               ; e8 4a fe
    test al, al                               ; 84 c0
    je near 0743fh                            ; 0f 84 fa 02
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    jne near 073c5h                           ; 0f 85 78 02
    jmp near 0743fh                           ; e9 ef 02
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 0715bh                           ; 72 04
    cmp AL, strict byte 008h                  ; 3c 08
    jbe short 0715eh                          ; 76 03
    jmp near 072f1h                           ; e9 93 01
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 9a a4
    ...
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 0160eh                               ; e8 94 a4
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 7e a4
    and AL, strict byte 0f8h                  ; 24 f8
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 0160eh                               ; e8 7f a4
    mov ax, 000ffh                            ; b8 ff 00
    call 06f55h                               ; e8 c0 fd
    test al, al                               ; 84 c0
    jne near 073c5h                           ; 0f 85 2a 02
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 06f89h                               ; e8 e6 fd
    mov cl, al                                ; 88 c1
    cmp byte [bp-004h], 0feh                  ; 80 7e fc fe
    jne short 071b6h                          ; 75 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 004h                  ; c6 46 13 04
    jmp near 0743fh                           ; e9 89 02
    cmp byte [bp-004h], 0fah                  ; 80 7e fc fa
    je short 071cch                           ; 74 10
    ...
    add sp, strict byte 00006h                ; 83 c4 06
    test cl, cl                               ; 84 c9
    jne near 073c5h                           ; 0f 85 f3 01
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f89h                               ; e8 af fd
    test al, al                               ; 84 c0
    jne near 073c5h                           ; 0f 85 e5 01
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f89h                               ; e8 a1 fd
    test al, al                               ; 84 c0
    jne near 073c5h                           ; 0f 85 d7 01
    mov al, byte [bp-008h]                    ; 8a 46 f8
    mov byte [bp+00ch], al                    ; 88 46 0c
    mov al, byte [bp-006h]                    ; 8a 46 fa
    mov byte [bp+00dh], al                    ; 88 46 0d
    jmp near 0743fh                           ; e9 42 02
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    cmp AL, strict byte 003h                  ; 3c 03
    jc short 07214h                           ; 72 10
    jbe short 07232h                          ; 76 2c
    cmp AL, strict byte 006h                  ; 3c 06
    je short 07244h                           ; 74 3a
    cmp AL, strict byte 005h                  ; 3c 05
    je short 0723eh                           ; 74 30
    cmp AL, strict byte 004h                  ; 3c 04
    je short 07238h                           ; 74 26
    jmp short 0724ah                          ; eb 36
    cmp AL, strict byte 002h                  ; 3c 02
    je short 0722ch                           ; 74 14
    cmp AL, strict byte 001h                  ; 3c 01
    je short 07226h                           ; 74 0a
    test al, al                               ; 84 c0
    jne short 0724ah                          ; 75 2a
    mov byte [bp-008h], 00ah                  ; c6 46 f8 0a
    jmp short 0724eh                          ; eb 28
    mov byte [bp-008h], 014h                  ; c6 46 f8 14
    jmp short 0724eh                          ; eb 22
    mov byte [bp-008h], 028h                  ; c6 46 f8 28
    jmp short 0724eh                          ; eb 1c
    mov byte [bp-008h], 03ch                  ; c6 46 f8 3c
    jmp short 0724eh                          ; eb 16
    mov byte [bp-008h], 050h                  ; c6 46 f8 50
    jmp short 0724eh                          ; eb 10
    mov byte [bp-008h], 064h                  ; c6 46 f8 64
    jmp short 0724eh                          ; eb 0a
    mov byte [bp-008h], 0c8h                  ; c6 46 f8 c8
    jmp short 0724eh                          ; eb 04
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    cmp byte [bp-008h], 000h                  ; 80 7e f8 00
    jbe short 07283h                          ; 76 2f
    mov ax, 000f3h                            ; b8 f3 00
    call 06f55h                               ; e8 fb fc
    test al, al                               ; 84 c0
    jne short 07278h                          ; 75 1a
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f89h                               ; e8 23 fd
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    call 06f55h                               ; e8 e8 fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f89h                               ; e8 14 fd
    jmp near 0743fh                           ; e9 c7 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 0743fh                           ; e9 bc 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 002h                  ; c6 46 13 02
    jmp near 0743fh                           ; e9 b1 01
    cmp byte [bp+00dh], 004h                  ; 80 7e 0d 04
    jnc short 072f1h                          ; 73 5d
    mov ax, 000e8h                            ; b8 e8 00
    call 06f55h                               ; e8 bb fc
    test al, al                               ; 84 c0
    jne short 072e6h                          ; 75 48
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f89h                               ; e8 e3 fc
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je short 072bch                           ; 74 10
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    push ax                                   ; 50
    push 009cch                               ; 68 cc 09
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 69 a6
    add sp, strict byte 00006h                ; 83 c4 06
    movzx ax, byte [bp+00dh]                  ; 0f b6 46 0d
    call 06f55h                               ; e8 92 fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f89h                               ; e8 be fc
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je near 0743fh                            ; 0f 84 6c 01
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    push ax                                   ; 50
    push 009cch                               ; 68 cc 09
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 42 a6
    add sp, strict byte 00006h                ; 83 c4 06
    jmp near 0743fh                           ; e9 59 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 0743fh                           ; e9 4e 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 002h                  ; c6 46 13 02
    jmp near 0743fh                           ; e9 43 01
    mov ax, 000f2h                            ; b8 f2 00
    call 06f55h                               ; e8 53 fc
    test al, al                               ; 84 c0
    jne short 07319h                          ; 75 13
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f89h                               ; e8 7b fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f89h                               ; e8 73 fc
    jmp near 071f4h                           ; e9 db fe
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 0743fh                           ; e9 1b 01
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    test al, al                               ; 84 c0
    jbe short 07332h                          ; 76 07
    cmp AL, strict byte 002h                  ; 3c 02
    jbe short 0739bh                          ; 76 6c
    jmp near 073cfh                           ; e9 9d 00
    mov ax, 000e9h                            ; b8 e9 00
    call 06f55h                               ; e8 1d fc
    test al, al                               ; 84 c0
    jne near 073c5h                           ; 0f 85 87 00
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f89h                               ; e8 43 fc
    mov cl, al                                ; 88 c1
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je short 0735eh                           ; 74 10
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    push ax                                   ; 50
    push 009cch                               ; 68 cc 09
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 c7 a5
    add sp, strict byte 00006h                ; 83 c4 06
    test cl, cl                               ; 84 c9
    jne short 073c5h                          ; 75 63
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f89h                               ; e8 1f fc
    test al, al                               ; 84 c0
    jne short 073c5h                          ; 75 57
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 06f89h                               ; e8 13 fc
    test al, al                               ; 84 c0
    jne short 073c5h                          ; 75 4b
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 06f89h                               ; e8 07 fc
    test al, al                               ; 84 c0
    jne short 073c5h                          ; 75 3f
    mov al, byte [bp-008h]                    ; 8a 46 f8
    mov byte [bp+00ch], al                    ; 88 46 0c
    mov al, byte [bp-006h]                    ; 8a 46 fa
    mov byte [bp+010h], al                    ; 88 46 10
    mov al, byte [bp-004h]                    ; 8a 46 fc
    mov byte [bp+00eh], al                    ; 88 46 0e
    jmp near 0743fh                           ; e9 a4 00
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 073a4h                          ; 75 05
    mov ax, 000e6h                            ; b8 e6 00
    jmp short 073a7h                          ; eb 03
    mov ax, 000e7h                            ; b8 e7 00
    call 06f55h                               ; e8 ab fb
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    jne short 073bfh                          ; 75 0f
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 06f89h                               ; e8 d1 fb
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    db  00fh, 095h, 0c1h
    ; setne cl                                  ; 0f 95 c1
    test cl, cl                               ; 84 c9
    je near 0743fh                            ; 0f 84 7a 00
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp short 0743fh                          ; eb 70
    movzx ax, byte [bp+00dh]                  ; 0f b6 46 0d
    push ax                                   ; 50
    push 009f8h                               ; 68 f8 09
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 46 a5
    add sp, strict byte 00006h                ; 83 c4 06
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    jmp short 0743fh                          ; eb 56
    mov si, word [bp+00ch]                    ; 8b 76 0c
    mov bx, si                                ; 89 f3
    mov dx, strict word 00022h                ; ba 22 00
    mov ax, cx                                ; 89 c8
    call 0162ah                               ; e8 34 a2
    mov bx, word [bp+014h]                    ; 8b 5e 14
    mov dx, strict word 00024h                ; ba 24 00
    mov ax, cx                                ; 89 c8
    call 0162ah                               ; e8 29 a2
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01600h                               ; e8 f7 a1
    mov ah, al                                ; 88 c4
    test si, si                               ; 85 f6
    jne short 0741dh                          ; 75 0e
    cmp word [bp+014h], strict byte 00000h    ; 83 7e 14 00
    jne short 0741dh                          ; 75 08
    test AL, strict byte 080h                 ; a8 80
    je short 0741fh                           ; 74 06
    and AL, strict byte 07fh                  ; 24 7f
    jmp short 0741fh                          ; eb 02
    or AL, strict byte 080h                   ; 0c 80
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 0160eh                               ; e8 e4 a1
    jmp short 0743fh                          ; eb 13
    push 00a12h                               ; 68 12 0a
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 ee a4
    add sp, strict byte 00004h                ; 83 c4 04
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    mov ax, strict word 00047h                ; b8 47 00
    call 06fc4h                               ; e8 7f fb
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
_int17_function:                             ; 0xf744b LB 0xb3
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push ax                                   ; 50
    ...
    add dx, strict byte 00008h                ; 83 c2 08
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 bd a1
    mov bx, ax                                ; 89 c3
    mov si, ax                                ; 89 c6
    cmp byte [bp+013h], 003h                  ; 80 7e 13 03
    jnc near 074f4h                           ; 0f 83 89 00
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    cmp ax, strict word 00003h                ; 3d 03 00
    jnc near 074f4h                           ; 0f 83 7f 00
    test bx, bx                               ; 85 db
    jbe near 074f4h                           ; 0f 86 79 00
    mov dx, ax                                ; 89 c2
    add dx, strict byte 00078h                ; 83 c2 78
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 7a a1
    movzx cx, al                              ; 0f b6 c8
    sal cx, 008h                              ; c1 e1 08
    cmp byte [bp+013h], 000h                  ; 80 7e 13 00
    jne short 074bfh                          ; 75 2d
    mov al, byte [bp+012h]                    ; 8a 46 12
    mov dx, bx                                ; 89 da
    out DX, AL                                ; ee
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 040h                 ; a8 40
    je short 074bfh                           ; 74 07
    test cx, cx                               ; 85 c9
    je short 074bfh                           ; 74 03
    dec cx                                    ; 49
    jmp short 074aeh                          ; eb ef
    cmp byte [bp+013h], 001h                  ; 80 7e 13 01
    jne short 074dbh                          ; 75 16
    lea dx, [si+002h]                         ; 8d 54 02
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov byte [bp+013h], al                    ; 88 46 13
    test cx, cx                               ; 85 c9
    jne short 074eeh                          ; 75 04
    or byte [bp+013h], 001h                   ; 80 4e 13 01
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp short 074f8h                          ; eb 04
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
wait_:                                       ; 0xf74fe LB 0xb2
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 01638h                               ; e8 17 a1
    mov word [bp-00eh], ax                    ; 89 46 f2
    mov bx, dx                                ; 89 d3
    hlt                                       ; f4
    mov dx, 0046ch                            ; ba 6c 04
    xor ax, ax                                ; 31 c0
    call 01638h                               ; e8 09 a1
    mov word [bp-012h], ax                    ; 89 46 ee
    mov di, dx                                ; 89 d7
    cmp dx, bx                                ; 39 da
    jnbe short 0753fh                         ; 77 07
    jne short 07546h                          ; 75 0c
    cmp ax, word [bp-00eh]                    ; 3b 46 f2
    jbe short 07546h                          ; 76 07
    sub ax, word [bp-00eh]                    ; 2b 46 f2
    sbb dx, bx                                ; 19 da
    jmp short 07551h                          ; eb 0b
    cmp dx, bx                                ; 39 da
    jc short 07551h                           ; 72 07
    jne short 07555h                          ; 75 09
    cmp ax, word [bp-00eh]                    ; 3b 46 f2
    jnc short 07555h                          ; 73 04
    sub si, ax                                ; 29 c6
    sbb cx, dx                                ; 19 d1
    mov ax, word [bp-012h]                    ; 8b 46 ee
    mov word [bp-00eh], ax                    ; 89 46 f2
    ...
    int 016h                                  ; cd 16
    je near 0756bh                            ; 0f 84 05 00
    mov AL, strict byte 001h                  ; b0 01
    jmp near 0756dh                           ; e9 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    test al, al                               ; 84 c0
    je short 07595h                           ; 74 24
    db  033h, 0c0h
    ; xor ax, ax                                ; 33 c0
    int 016h                                  ; cd 16
    xchg ah, al                               ; 86 c4
    ...
    add sp, strict byte 00006h                ; 83 c4 06
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    je short 07595h                           ; 74 04
    mov al, dl                                ; 88 d0
    jmp short 075a7h                          ; eb 12
    test cx, cx                               ; 85 c9
    jnle short 07526h                         ; 7f 8d
    jne short 0759fh                          ; 75 04
    test si, si                               ; 85 f6
    jnbe short 07526h                         ; 77 87
    mov ax, word [bp-010h]                    ; 8b 46 f0
    push ax                                   ; 50
    popfw                                     ; 9d
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
read_logo_byte_:                             ; 0xf75b0 LB 0x16
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    xor ah, ah                                ; 30 e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
read_logo_word_:                             ; 0xf75c6 LB 0x14
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    xor ah, ah                                ; 30 e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
print_detected_harddisks_:                   ; 0xf75da LB 0x130
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 2f a0
    mov si, ax                                ; 89 c6
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    xor cl, cl                                ; 30 c9
    xor ch, ch                                ; 30 ed
    mov dx, 00304h                            ; ba 04 03
    call 01600h                               ; e8 03 a0
    mov byte [bp-00eh], al                    ; 88 46 f2
    xor bl, bl                                ; 30 db
    cmp bl, byte [bp-00eh]                    ; 3a 5e f2
    jnc near 076dch                           ; 0f 83 d3 00
    movzx dx, bl                              ; 0f b6 d3
    add dx, 00305h                            ; 81 c2 05 03
    mov ax, si                                ; 89 f0
    call 01600h                               ; e8 eb 9f
    mov bh, al                                ; 88 c7
    cmp AL, strict byte 00ch                  ; 3c 0c
    jc short 0763fh                           ; 72 24
    test cl, cl                               ; 84 c9
    jne short 0762ch                          ; 75 0d
    push 00a45h                               ; 68 45 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 fb a2
    add sp, strict byte 00004h                ; 83 c4 04
    mov CL, strict byte 001h                  ; b1 01
    movzx ax, bl                              ; 0f b6 c3
    inc ax                                    ; 40
    ...
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 e9 a2
    add sp, strict byte 00006h                ; 83 c4 06
    jmp near 076d7h                           ; e9 98 00
    cmp AL, strict byte 008h                  ; 3c 08
    jc short 07656h                           ; 72 13
    test ch, ch                               ; 84 ed
    jne short 07654h                          ; 75 0d
    push 00a6dh                               ; 68 6d 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 d3 a2
    add sp, strict byte 00004h                ; 83 c4 04
    mov CH, strict byte 001h                  ; b5 01
    jmp short 0762ch                          ; eb d6
    cmp AL, strict byte 004h                  ; 3c 04
    jnc short 07671h                          ; 73 17
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07671h                          ; 75 11
    push 00a82h                               ; 68 82 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 ba a2
    add sp, strict byte 00004h                ; 83 c4 04
    mov byte [bp-00ch], 001h                  ; c6 46 f4 01
    jmp short 07687h                          ; eb 16
    cmp bh, 004h                              ; 80 ff 04
    jc short 07687h                           ; 72 11
    test cl, cl                               ; 84 c9
    jne short 07687h                          ; 75 0d
    push 00a94h                               ; 68 94 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 a0 a2
    add sp, strict byte 00004h                ; 83 c4 04
    mov CL, strict byte 001h                  ; b1 01
    movzx ax, bl                              ; 0f b6 c3
    inc ax                                    ; 40
    ...
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 8e a2
    add sp, strict byte 00006h                ; 83 c4 06
    cmp bh, 004h                              ; 80 ff 04
    jc short 0769fh                           ; 72 03
    ...
    sar ax, 1                                 ; d1 f8
    test ax, ax                               ; 85 c0
    je short 076b0h                           ; 74 05
    push 00ab2h                               ; 68 b2 0a
    jmp short 076b3h                          ; eb 03
    ...
    idiv di                                   ; f7 ff
    test dx, dx                               ; 85 d2
    je short 076cdh                           ; 74 05
    push 00ac6h                               ; 68 c6 0a
    jmp short 076d0h                          ; eb 03
    push 00acch                               ; 68 cc 0a
    push di                                   ; 57
    call 01922h                               ; e8 4e a2
    add sp, strict byte 00004h                ; 83 c4 04
    db  0feh, 0c3h
    ; inc bl                                    ; fe c3
    jmp near 07602h                           ; e9 26 ff
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 076f5h                          ; 75 13
    test cl, cl                               ; 84 c9
    jne short 076f5h                          ; 75 0f
    test ch, ch                               ; 84 ed
    jne short 076f5h                          ; 75 0b
    push 00ad3h                               ; 68 d3 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 30 a2
    add sp, strict byte 00004h                ; 83 c4 04
    push 00ae7h                               ; 68 e7 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 25 a2
    add sp, strict byte 00004h                ; 83 c4 04
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
get_boot_drive_:                             ; 0xf770a LB 0x28
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    mov dx, 00304h                            ; ba 04 03
    call 01600h                               ; e8 e0 9e
    sub bl, 002h                              ; 80 eb 02
    cmp bl, al                                ; 38 c3
    jc short 07729h                           ; 72 02
...
show_logo_:                                  ; 0xf7732 LB 0x224
    ...
    out strict byte 040h, AL                  ; e6 40
    movzx ax, dl                              ; 0f b6 c2
    call 075c6h                               ; e8 68 fe
    cmp ax, 066bbh                            ; 3d bb 66
    jne near 07836h                           ; 0f 85 d1 00
    push SS                                   ; 16
    pop ES                                    ; 07
    ...
    cmp ax, strict word 0004fh                ; 3d 4f 00
    jne near 07836h                           ; 0f 85 bd 00
    mov al, dl                                ; 88 d0
    add AL, strict byte 004h                  ; 04 04
    xor ah, ah                                ; 30 e4
    call 075b0h                               ; e8 2e fe
    mov ch, al                                ; 88 c5
    mov byte [bp-00ch], al                    ; 88 46 f4
    mov al, dl                                ; 88 d0
    add AL, strict byte 005h                  ; 04 05
    xor ah, ah                                ; 30 e4
    call 075b0h                               ; e8 20 fe
    mov dh, al                                ; 88 c6
    mov byte [bp-010h], al                    ; 88 46 f0
    mov al, dl                                ; 88 d0
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 075c6h                               ; e8 28 fe
    mov bx, ax                                ; 89 c3
    mov word [bp-014h], ax                    ; 89 46 ec
    mov al, dl                                ; 88 d0
    add AL, strict byte 006h                  ; 04 06
    xor ah, ah                                ; 30 e4
    call 075b0h                               ; e8 04 fe
    mov byte [bp-012h], al                    ; 88 46 ee
    test ch, ch                               ; 84 ed
    jne short 077bdh                          ; 75 0a
    test dh, dh                               ; 84 f6
    jne short 077bdh                          ; 75 06
    test bx, bx                               ; 85 db
    je near 07836h                            ; 0f 84 79 00
    mov bx, 00142h                            ; bb 42 01
    mov ax, 04f02h                            ; b8 02 4f
    int 010h                                  ; cd 10
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    je short 077eeh                           ; 74 23
    xor bx, bx                                ; 31 db
    jmp short 077d5h                          ; eb 06
    inc bx                                    ; 43
    cmp bx, strict byte 00010h                ; 83 fb 10
    jnbe short 077f5h                         ; 77 20
    mov ax, bx                                ; 89 d8
    or ah, 002h                               ; 80 cc 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00001h                ; b8 01 00
    call 074feh                               ; e8 18 fd
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 077cfh                          ; 75 e5
    mov CL, strict byte 001h                  ; b1 01
    jmp short 077f5h                          ; eb 07
    mov ax, 00210h                            ; b8 10 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    test cl, cl                               ; 84 c9
    jne short 0780bh                          ; 75 12
    mov ax, word [bp-014h]                    ; 8b 46 ec
    shr ax, 004h                              ; c1 e8 04
    mov dx, strict word 00001h                ; ba 01 00
    call 074feh                               ; e8 f9 fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 0780bh                          ; 75 02
    mov CL, strict byte 001h                  ; b1 01
    cmp byte [bp-010h], 000h                  ; 80 7e f0 00
    je short 07836h                           ; 74 25
    test cl, cl                               ; 84 c9
    jne short 07836h                          ; 75 21
    mov bx, strict word 00010h                ; bb 10 00
    jmp short 0781fh                          ; eb 05
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 07836h                          ; 76 17
    mov ax, bx                                ; 89 d8
    or ah, 002h                               ; 80 cc 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00001h                ; b8 01 00
    call 074feh                               ; e8 ce fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 0781ah                          ; 75 e6
    mov CL, strict byte 001h                  ; b1 01
    xor bx, bx                                ; 31 db
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, si                                ; 89 f0
    call 0160eh                               ; e8 ce 9d
    mov AL, strict byte 003h                  ; b0 03
    mov AH, strict byte 000h                  ; b4 00
    int 010h                                  ; cd 10
    cmp byte [bp-012h], 000h                  ; 80 7e ee 00
    je near 07937h                            ; 0f 84 e9 00
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07884h                          ; 75 30
    cmp byte [bp-010h], 000h                  ; 80 7e f0 00
    jne short 07884h                          ; 75 2a
    cmp word [bp-014h], strict byte 00000h    ; 83 7e ec 00
    jne short 07884h                          ; 75 24
    cmp byte [bp-012h], 002h                  ; 80 7e ee 02
    jne short 07871h                          ; 75 0b
    push 00ae9h                               ; 68 e9 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 b4 a0
    add sp, strict byte 00004h                ; 83 c4 04
    test cl, cl                               ; 84 c9
    jne short 07884h                          ; 75 0f
    mov dx, strict word 00001h                ; ba 01 00
    mov ax, 000c0h                            ; b8 c0 00
    call 074feh                               ; e8 80 fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07884h                          ; 75 02
    mov CL, strict byte 001h                  ; b1 01
    test cl, cl                               ; 84 c9
    je near 07937h                            ; 0f 84 ad 00
    mov byte [bp-00eh], 000h                  ; c6 46 f2 00
    mov ax, 00100h                            ; b8 00 01
    ...
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 6f a0
    add sp, strict byte 00004h                ; 83 c4 04
    call 075dah                               ; e8 21 fd
    ...
    mov dx, strict word 00001h                ; ba 01 00
    mov ax, strict word 00040h                ; b8 40 00
    call 074feh                               ; e8 31 fc
    mov bl, al                                ; 88 c3
    test al, al                               ; 84 c0
    je short 078c4h                           ; 74 f1
    cmp AL, strict byte 030h                  ; 3c 30
    je short 07925h                           ; 74 4e
    cmp bl, 002h                              ; 80 fb 02
    jc short 078feh                           ; 72 22
    cmp bl, 009h                              ; 80 fb 09
    jnbe short 078feh                         ; 77 1d
    movzx ax, bl                              ; 0f b6 c3
    call 0770ah                               ; e8 23 fe
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 078edh                          ; 75 02
    jmp short 078c4h                          ; eb d7
    movzx bx, al                              ; 0f b6 d8
    mov dx, 0037ch                            ; ba 7c 03
    mov ax, si                                ; 89 f0
    call 0160eh                               ; e8 16 9d
    mov byte [bp-00eh], 002h                  ; c6 46 f2 02
    jmp short 07925h                          ; eb 27
    cmp bl, 02eh                              ; 80 fb 2e
    je short 07913h                           ; 74 10
    cmp bl, 026h                              ; 80 fb 26
    je short 07919h                           ; 74 11
    cmp bl, 021h                              ; 80 fb 21
    jne short 0791fh                          ; 75 12
    mov byte [bp-00eh], 001h                  ; c6 46 f2 01
    jmp short 07925h                          ; eb 12
    mov byte [bp-00eh], 003h                  ; c6 46 f2 03
    jmp short 07925h                          ; eb 0c
    mov byte [bp-00eh], 004h                  ; c6 46 f2 04
    jmp short 07925h                          ; eb 06
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    je short 078c4h                           ; 74 9f
    movzx bx, byte [bp-00eh]                  ; 0f b6 5e f2
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, si                                ; 89 f0
    call 0160eh                               ; e8 dd 9c
    mov AL, strict byte 003h                  ; b0 03
    mov AH, strict byte 000h                  ; b4 00
    int 010h                                  ; cd 10
    mov AL, strict byte 034h                  ; b0 34
...
delay_boot_:                                 ; 0xf7956 LB 0x67
    ...
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 ac 9f
    add sp, strict byte 00006h                ; 83 c4 06
    mov bx, dx                                ; 89 d3
    test bx, bx                               ; 85 db
    jbe short 07996h                          ; 76 17
    push bx                                   ; 53
    push 00bb7h                               ; 68 b7 0b
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 9a 9f
    add sp, strict byte 00006h                ; 83 c4 06
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00040h                ; b8 40 00
    call 074feh                               ; e8 6b fb
    dec bx                                    ; 4b
    jmp short 0797bh                          ; eb e5
    push 00ae7h                               ; 68 e7 0a
    push strict byte 00002h                   ; 6a 02
    call 01922h                               ; e8 84 9f
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 034h                  ; b0 34
    out strict byte 043h, AL                  ; e6 43
    db  033h, 0c0h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
scsi_cmd_data_in_:                           ; 0xf79bd LB 0xb7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 07a1ah                          ; eb ea
    mov dx, si                                ; 89 f2
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 07a30h                          ; 75 f7
    lea dx, [si+001h]                         ; 8d 54 01
    cmp word [bp+00ch], strict byte 00000h    ; 83 7e 0c 00
    jne short 07a48h                          ; 75 06
    cmp bx, 08000h                            ; 81 fb 00 80
    jbe short 07a62h                          ; 76 1a
    ...
    pop bp                                    ; 5d
    retn 0000ah                               ; c2 0a 00
scsi_cmd_data_out_:                          ; 0xf7a74 LB 0xb9
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 07ad1h                          ; eb ea
    lea dx, [di+001h]                         ; 8d 55 01
    cmp word [bp+00ch], strict byte 00000h    ; 83 7e 0c 00
    jne short 07af6h                          ; 75 06
    cmp bx, 08000h                            ; 81 fb 00 80
    jbe short 07b11h                          ; 76 1b
    mov cx, 08000h                            ; b9 00 80
...
swap_64_:                                    ; 0xf7b2d LB 0x63
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@scsi_read_sectors:                          ; 0xf7b90 LB 0xd3
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 004h                  ; 3c 04
    jbe short 07bbbh                          ; 76 10
    movzx ax, byte [bp-006h]                  ; 0f b6 46 fa
    push ax                                   ; 50
    push 00bbch                               ; 68 bc 0b
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 6a 9d
    add sp, strict byte 00006h                ; 83 c4 06
    mov es, [bp+006h]                         ; 8e 46 06
    mov di, word [es:si+00eh]                 ; 26 8b 7c 0e
    ...
    call 079bdh                               ; e8 81 fd
    mov ah, al                                ; 88 c4
    test al, al                               ; 84 c0
    jne short 07c57h                          ; 75 15
    mov es, [bp+006h]                         ; 8e 46 06
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@scsi_write_sectors:                         ; 0xf7c63 LB 0xd3
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 004h                  ; 3c 04
    jbe short 07c8eh                          ; 76 10
    movzx ax, byte [bp-006h]                  ; 0f b6 46 fa
    push ax                                   ; 50
    push 00beah                               ; 68 ea 0b
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 97 9c
    add sp, strict byte 00006h                ; 83 c4 06
    mov es, [bp+006h]                         ; 8e 46 06
    mov di, word [es:si+00eh]                 ; 26 8b 7c 0e
    ...
    mov cx, ss                                ; 8c d1
    lea bx, [bp-01ah]                         ; 8d 5e e6
    call 07a74h                               ; e8 65 fd
    mov ah, al                                ; 88 c4
    test al, al                               ; 84 c0
    jne short 07d2ah                          ; 75 15
    mov es, [bp+006h]                         ; 8e 46 06
    mov word [es:si+018h], di                 ; 26 89 7c 18
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    mov word [es:si+01ah], dx                 ; 26 89 54 1a
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
scsi_cmd_packet_:                            ; 0xf7d36 LB 0x166
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 ca 98
    mov si, 00122h                            ; be 22 01
    mov word [bp-00eh], ax                    ; 89 46 f2
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 07d7dh                          ; 75 1f
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 78 9b
    push 00c19h                               ; 68 19 0c
    push 00c29h                               ; 68 29 0c
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 ae 9b
    add sp, strict byte 00006h                ; 83 c4 06
    mov dx, strict word 00001h                ; ba 01 00
    jmp near 07e91h                           ; e9 14 01
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 07df6h                          ; eb ea
    mov dx, bx                                ; 89 da
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 07e0ch                          ; 75 f7
    test AL, strict byte 002h                 ; a8 02
    je short 07e27h                           ; 74 0e
    lea dx, [bx+003h]                         ; 8d 57 03
    xor al, al                                ; 30 c0
    out DX, AL                                ; ee
    in AL, DX                                 ; ec
    ...
    ; sub ah, ah                                ; 2a e4
    mov dx, strict word 00003h                ; ba 03 00
    jmp short 07e91h                          ; eb 6a
    mov ax, word [bp+004h]                    ; 8b 46 04
    test ax, ax                               ; 85 c0
    je short 07e36h                           ; 74 08
    lea dx, [bx+001h]                         ; 8d 57 01
    mov cx, ax                                ; 89 c1
    in AL, DX                                 ; ec
    loop 07e33h                               ; e2 fd
    ...
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
scsi_enumerate_attached_devices_:            ; 0xf7e9c LB 0x49e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov word [bp-03ah], ax                    ; 89 46 c6
    test dx, dx                               ; 85 d2
    jne short 07f76h                          ; 75 05
    cmp ax, 00200h                            ; 3d 00 02
    je short 07f96h                           ; 74 20
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 60 99
    push dx                                   ; 52
    push word [bp-03ah]                       ; ff 76 c6
    push word [bp-026h]                       ; ff 76 da
    push 00ca1h                               ; 68 a1 0c
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 92 99
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 082bfh                           ; e9 29 03
    mov es, [bp-01eh]                         ; 8e 46 e2
    mov al, byte [es:di+0022ch]               ; 26 8a 85 2c 02
    mov byte [bp-00ch], al                    ; 88 46 f4
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 07fb1h                           ; 72 0c
    jbe short 07fb9h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 07fc1h                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 07fbdh                           ; 74 0e
    jmp short 0800eh                          ; eb 5d
    test al, al                               ; 84 c0
    jne short 0800eh                          ; 75 59
    mov BL, strict byte 090h                  ; b3 90
    jmp short 07fc3h                          ; eb 0a
    mov BL, strict byte 098h                  ; b3 98
    jmp short 07fc3h                          ; eb 06
    mov BL, strict byte 0a0h                  ; b3 a0
    jmp short 07fc3h                          ; eb 02
    mov BL, strict byte 0a8h                  ; b3 a8
    mov al, bl                                ; 88 d8
    add AL, strict byte 007h                  ; 04 07
    movzx cx, al                              ; 0f b6 c8
    mov ax, cx                                ; 89 c8
    call 0165ch                               ; e8 8d 96
    test al, al                               ; 84 c0
    je short 0800eh                           ; 74 3b
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 80 96
    movzx dx, al                              ; 0f b6 d0
    sal dx, 008h                              ; c1 e2 08
    movzx ax, bl                              ; 0f b6 c3
    call 0165ch                               ; e8 74 96
    xor ah, ah                                ; 30 e4
    add ax, dx                                ; 01 d0
    cwd                                       ; 99
    mov word [bp-014h], ax                    ; 89 46 ec
    ...
    mov ax, word [bp-012h]                    ; 8b 46 ee
    test ax, ax                               ; 85 c0
    jnbe short 08049h                         ; 77 16
    jne near 080bah                           ; 0f 85 83 00
    cmp word [bp-030h], strict byte 00000h    ; 83 7e d0 00
    jnbe short 08049h                         ; 77 0c
    jne near 080bah                           ; 0f 85 79 00
    cmp word [bp-02eh], strict byte 00040h    ; 83 7e d2 40
    jnbe short 08049h                         ; 77 02
    jne short 080bah                          ; 75 71
    ...
    mov si, strict word 00010h                ; be 10 00
    call 09b40h                               ; e8 93 1a
    add dx, word [bp-02ch]                    ; 03 56 d4
    adc cx, word [bp-02ah]                    ; 13 4e d6
    mov ax, word [bp-028h]                    ; 8b 46 d8
    adc ax, bx                                ; 11 d8
    jmp short 080f5h                          ; eb 3b
    test ax, ax                               ; 85 c0
    jnbe short 080d0h                         ; 77 12
    jne short 080dch                          ; 75 1c
    cmp word [bp-030h], strict byte 00000h    ; 83 7e d0 00
    jnbe short 080d0h                         ; 77 0a
    jne short 080dch                          ; 75 14
    cmp word [bp-02eh], strict byte 00020h    ; 83 7e d2 20
    jnbe short 080d0h                         ; 77 02
    jne short 080dch                          ; 75 0c
    mov word [bp-020h], 00080h                ; c7 46 e0 80 00
    mov word [bp-034h], strict word 00020h    ; c7 46 cc 20 00
    jmp short 080f5h                          ; eb 19
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 ed 93
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 ed 93
    inc byte [bp-00ch]                        ; fe 46 f4
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    mov es, [bp-01eh]                         ; 8e 46 e2
    mov byte [es:di+0022ch], al               ; 26 88 85 2c 02
    jmp near 082bfh                           ; e9 8d 00
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 a4 96
    push word [bp-026h]                       ; ff 76 da
    movzx ax, byte [bp-00ch]                  ; 0f b6 46 f4
    push ax                                   ; 50
    push 00cfdh                               ; 68 fd 0c
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 d5 96
    add sp, strict byte 00008h                ; 83 c4 08
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    add AL, strict byte 008h                  ; 04 08
    mov byte [bp-00eh], al                    ; 88 46 f2
    ...
    lea bx, [bp-04ah]                         ; 8d 5e b6
    mov ax, word [bp-0024ch]                  ; 8b 86 b4 fd
    call 079bdh                               ; e8 c4 f6
    test al, al                               ; 84 c0
    je short 0830bh                           ; 74 0e
    push 00c49h                               ; 68 49 0c
    push 00c69h                               ; 68 69 0c
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 1a 96
    add sp, strict byte 00006h                ; 83 c4 06
    test byte [bp-0024ah], 0e0h               ; f6 86 b6 fd e0
    jne short 0831bh                          ; 75 09
    test byte [bp-0024ah], 01fh               ; f6 86 b6 fd 1f
    je near 07ec0h                            ; 0f 84 a5 fb
    test byte [bp-0024ah], 0e0h               ; f6 86 b6 fd e0
    jne short 082bfh                          ; 75 9d
    mov al, byte [bp-0024ah]                  ; 8a 86 b6 fd
    and AL, strict byte 01fh                  ; 24 1f
    cmp AL, strict byte 005h                  ; 3c 05
    je near 08232h                            ; 0f 84 04 ff
    jmp short 082bfh                          ; eb 8f
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop dx                                    ; 5a
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_scsi_init:                                  ; 0xf833a LB 0x66
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 d6 92
    ...
    ; sub ah, ah                                ; 2a e4
    cmp AL, strict byte 055h                  ; 3c 55
    jne short 0839ch                          ; 75 0c
    xor al, al                                ; 30 c0
    mov dx, 0043bh                            ; ba 3b 04
    out DX, AL                                ; ee
    mov ax, 00438h                            ; b8 38 04
    call 07e9ch                               ; e8 00 fb
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
high_bits_save_:                             ; 0xf83a0 LB 0x17
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
high_bits_restore_:                          ; 0xf83b7 LB 0x17
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_set_bits_:                         ; 0xf83ce LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_clear_bits_:                       ; 0xf8411 LB 0x47
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_is_bit_set_:                       ; 0xf8458 LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xchg dx, ax                               ; 92
    test dx, di                               ; 85 fa
    jne short 08484h                          ; 75 04
    test ax, bx                               ; 85 d8
    je short 08488h                           ; 74 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 0848ah                          ; eb 02
    xor al, al                                ; 30 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_extract_bits_:                     ; 0xf8491 LB 0x1b
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov si, bx                                ; 89 de
    ...
    pop si                                    ; 5e
    retn 00002h                               ; c2 02 00
ahci_addr_to_phys_:                          ; 0xf84ac LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
ahci_port_cmd_sync_:                         ; 0xf84ca LB 0xd5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov dx, si                                ; 89 f2
    mov ax, di                                ; 89 f8
    call 08458h                               ; e8 e2 fe
    test al, al                               ; 84 c0
    je short 08559h                           ; 74 df
    mov bx, strict word 00001h                ; bb 01 00
    xor cx, cx                                ; 31 c9
    mov dx, si                                ; 89 f2
    mov ax, di                                ; 89 f8
    call 083ceh                               ; e8 48 fe
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    add dx, 00118h                            ; 81 c2 18 01
    mov bx, strict word 00001h                ; bb 01 00
    xor cx, cx                                ; 31 c9
    mov ax, di                                ; 89 f8
    call 08411h                               ; e8 7a fe
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop cx                                    ; 59
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_cmd_data_:                              ; 0xf859f LB 0x22d
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_deinit_current_:                   ; 0xf87cc LB 0x144
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_init_:                             ; 0xf8910 LB 0x206
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, 0c011h                            ; bb 11 c0
    xor cx, cx                                ; 31 c9
    call 08458h                               ; e8 ff fa
    cmp AL, strict byte 001h                  ; 3c 01
    je short 0893eh                           ; 74 e1
    mov cx, strict word 00020h                ; b9 20 00
    xor bx, bx                                ; 31 db
    mov ax, si                                ; 89 f0
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09aaah                               ; e8 40 11
    lea ax, [si+00080h]                       ; 8d 84 80 00
    mov cx, strict word 00040h                ; b9 40 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09aaah                               ; e8 31 11
    mov ax, si                                ; 89 f0
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@ahci_read_sectors:                          ; 0xf8b16 LB 0x94
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ax, ax                                ; 31 c0
    call 08910h                               ; e8 b1 fd
    mov bx, strict word 00025h                ; bb 25 00
    mov ax, di                                ; 89 f8
    mov dx, word [bp+006h]                    ; 8b 56 06
    call 0859fh                               ; e8 35 fa
    mov es, [bp+006h]                         ; 8e 46 06
    mov bx, di                                ; 89 fb
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@ahci_write_sectors:                         ; 0xf8baa LB 0x70
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    mov si, word [bp+004h]                    ; 8b 76 04
...
ahci_cmd_packet_:                            ; 0xf8c1a LB 0x17c
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 e7 89
    mov si, 00122h                            ; be 22 01
    mov word [bp-008h], ax                    ; 89 46 f8
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 08c60h                          ; 75 1f
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 95 8c
    push 00d5ch                               ; 68 5c 0d
    push 00d6ch                               ; 68 6c 0d
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 cb 8c
    add sp, strict byte 00006h                ; 83 c4 06
    mov ax, strict word 00001h                ; b8 01 00
    jmp near 08d8dh                           ; e9 2d 01
    test byte [bp+004h], 001h                 ; f6 46 04 01
    jne short 08c5ah                          ; 75 f4
    mov ax, word [bp+006h]                    ; 8b 46 06
    ...
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    call 083b7h                               ; e8 3e f6
    les bx, [bp-00eh]                         ; c4 5e f2
    mov ax, word [es:bx+006h]                 ; 26 8b 47 06
    or ax, word [es:bx+004h]                  ; 26 0b 47 04
    jne short 08d8bh                          ; 75 05
    mov ax, strict word 00004h                ; b8 04 00
    jmp short 08d8dh                          ; eb 02
    xor ax, ax                                ; 31 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
ahci_port_detect_device_:                    ; 0xf8d96 LB 0x49e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, di                                ; 89 fb
    call 08910h                               ; e8 60 fb
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 63 88
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 08491h                               ; e8 2e f6
    test ax, ax                               ; 85 c0
    je near 0922ch                            ; 0f 84 c3 03
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    sal ax, 007h                              ; c1 e0 07
    mov word [bp-01ah], ax                    ; 89 46 e6
    add ax, 00128h                            ; 05 28 01
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 08491h                               ; e8 e2 f5
    cmp ax, strict word 00001h                ; 3d 01 00
    je short 08e69h                           ; 74 b5
    push strict byte 00000h                   ; 6a 00
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    mov ax, word [bp-020h]                    ; 8b 46 e0
    mov dx, di                                ; 89 fa
    call 08491h                               ; e8 ce f5
    cmp ax, strict word 00003h                ; 3d 03 00
    jne near 0922ch                           ; 0f 85 62 03
    mov ax, word [bp-01ah]                    ; 8b 46 e6
    ...
    test dx, dx                               ; 85 d2
    jne near 0917fh                           ; 0f 85 1c 02
    cmp ax, 00101h                            ; 3d 01 01
    jne near 0917fh                           ; 0f 85 15 02
    les bx, [bp-010h]                         ; c4 5e f0
    ...
    jne short 08ff9h                          ; 75 1e
    cmp di, strict byte 0ffffh                ; 83 ff ff
    jne short 08ff9h                          ; 75 19
    ...
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 09072h                           ; 72 0c
    jbe short 0907ah                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 09082h                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 0907eh                           ; 74 0e
    jmp short 090cbh                          ; eb 59
    test al, al                               ; 84 c0
    jne short 090cbh                          ; 75 55
    mov DL, strict byte 040h                  ; b2 40
    jmp short 09084h                          ; eb 0a
    mov DL, strict byte 048h                  ; b2 48
    jmp short 09084h                          ; eb 06
    mov DL, strict byte 050h                  ; b2 50
    jmp short 09084h                          ; eb 02
    ...
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 a2 85
    xor ah, ah                                ; 30 e4
    mov word [bp-02ah], ax                    ; 89 46 d6
    mov ax, bx                                ; 89 d8
    call 0165ch                               ; e8 98 85
    xor ah, ah                                ; 30 e4
    mov word [bp-026h], ax                    ; 89 46 da
    jmp short 090ddh                          ; eb 12
    push word [bp-014h]                       ; ff 76 ec
    push word [bp-018h]                       ; ff 76 e8
    push word [bp-016h]                       ; ff 76 ea
    push di                                   ; 57
    ...
    call 055fch                               ; e8 1f c5
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 f9 87
    push 01234h                               ; 68 34 12
    push 05678h                               ; 68 78 56
    push 090abh                               ; 68 ab 90
    push 0cdefh                               ; 68 ef cd
    push word [bp-014h]                       ; ff 76 ec
    push word [bp-018h]                       ; ff 76 e8
    push word [bp-016h]                       ; ff 76 ea
    push di                                   ; 57
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 fd 87
    add sp, strict byte 00024h                ; 83 c4 24
    movzx di, byte [bp-00ch]                  ; 0f b6 7e f4
    imul di, di, strict byte 0001ch           ; 6b ff 1c
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 92 84
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 92 84
    jmp near 0921eh                           ; e9 9f 00
    cmp dx, 0eb14h                            ; 81 fa 14 eb
    jne near 0921eh                           ; 0f 85 97 00
    cmp ax, 00101h                            ; 3d 01 01
    jne near 0921eh                           ; 0f 85 90 00
    les bx, [bp-010h]                         ; c4 5e f0
    db  066h, 026h, 0c7h, 047h, 004h, 000h, 000h, 000h, 000h
    ; mov dword [es:bx+004h], strict dword 000000000h ; 66 26 c7 47 04 00 00 00 00
    db  066h, 026h, 0c7h, 007h, 000h, 000h, 000h, 000h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_mem_alloc_:                             ; 0xf9234 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 0161ch                               ; e8 d8 83
    test ax, ax                               ; 85 c0
    je short 0926dh                           ; 74 25
    dec ax                                    ; 48
    mov bx, ax                                ; 89 c3
    xor dx, dx                                ; 31 d2
    mov cx, strict word 0000ah                ; b9 0a 00
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_hba_init_:                              ; 0xf9277 LB 0x125
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    shr eax, 010h                             ; 66 c1 e8 10
    xchg dx, ax                               ; 92
    call 09234h                               ; e8 82 ff
    mov di, ax                                ; 89 c7
    test ax, ax                               ; 85 c0
    je near 0937bh                            ; 0f 84 c1 00
    mov es, [bp-010h]                         ; 8e 46 f0
    ...
    xor cx, cx                                ; 31 c9
    call 08491h                               ; e8 5d f1
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    mov byte [bp-00eh], al                    ; 88 46 f2
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    jmp short 09348h                          ; eb 09
    inc byte [bp-00ch]                        ; fe 46 f4
    cmp byte [bp-00ch], 020h                  ; 80 7e f4 20
    jnc short 09379h                          ; 73 31
    movzx cx, byte [bp-00ch]                  ; 0f b6 4e f4
    mov ax, strict word 00001h                ; b8 01 00
    xor dx, dx                                ; 31 d2
    jcxz 09359h                               ; e3 06
    ...
    mov dx, strict word 0000ch                ; ba 0c 00
    mov ax, si                                ; 89 f0
    call 08458h                               ; e8 f3 f0
    test al, al                               ; 84 c0
    je short 0933fh                           ; 74 d6
    movzx bx, byte [bp-00ch]                  ; 0f b6 5e f4
    xor ax, ax                                ; 31 c0
    mov dx, di                                ; 89 fa
    call 08d96h                               ; e8 22 fa
    dec byte [bp-00eh]                        ; fe 4e f2
    jne short 0933fh                          ; 75 c6
    xor ax, ax                                ; 31 c0
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    db  00bh, 005h, 004h, 003h, 002h, 001h, 000h, 06bh, 094h, 049h, 094h, 04fh, 094h, 055h, 094h, 05bh
    db  094h, 061h, 094h, 067h, 094h, 06bh, 094h
_ahci_init:                                  ; 0xf939c LB 0xfe
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00001h                ; ba 01 00
    call 098bah                               ; e8 0d 05
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 0ffffh                ; 3d ff ff
    je near 09493h                            ; 0f 84 dd 00
    xor al, al                                ; 30 c0
    shr ax, 008h                              ; c1 e8 08
    mov byte [bp-00ah], al                    ; 88 46 f6
    mov byte [bp-008h], dl                    ; 88 56 f8
    ...
    xor ah, ah                                ; 30 e4
    mov bx, strict word 00034h                ; bb 34 00
    call 098e5h                               ; e8 1a 05
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    je short 093f4h                           ; 74 23
    movzx bx, cl                              ; 0f b6 d9
    movzx di, byte [bp-008h]                  ; 0f b6 7e f8
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 098e5h                               ; e8 02 05
    cmp AL, strict byte 012h                  ; 3c 12
    je short 093f4h                           ; 74 0d
    mov al, cl                                ; 88 c8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    jmp short 093c8h                          ; eb d4
    test cl, cl                               ; 84 c9
    je near 09493h                            ; 0f 84 99 00
    ...
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 098e5h                               ; e8 d6 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne near 09493h                           ; 0f 85 7e 00
    mov byte [bp-006h], 000h                  ; c6 46 fa 00
    mov al, cl                                ; 88 c8
    add AL, strict byte 002h                  ; 04 02
    movzx bx, al                              ; 0f b6 d8
    ...
    mov al, byte [bp-006h]                    ; 8a 46 fa
    test al, al                               ; 84 c0
    je short 09493h                           ; 74 19
    movzx bx, al                              ; 0f b6 d8
    movzx dx, byte [bp-008h]                  ; 0f b6 56 f8
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    call 0992bh                               ; e8 a3 04
    test AL, strict byte 001h                 ; a8 01
    je short 09493h                           ; 74 07
    and AL, strict byte 0f0h                  ; 24 f0
    add ax, si                                ; 01 f0
    call 09277h                               ; e8 e4 fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
apm_out_str_:                                ; 0xf949a LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    cmp byte [bx], 000h                       ; 80 3f 00
    je short 094afh                           ; 74 0a
    ...
    db  00ah, 0c0h
    ; or al, al                                 ; 0a c0
    jne short 094a7h                          ; 75 f8
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
    not byte [si-06a3eh]                      ; f6 94 c2 95
    or byte [di-06addh], dl                   ; 08 95 23 95
    retn 04e95h                               ; c2 95 4e
    xchg bp, ax                               ; 95
    retn 05395h                               ; c2 95 53
    xchg bp, ax                               ; 95
    xchg di, ax                               ; 97
    xchg bp, ax                               ; 95
    xchg di, ax                               ; 97
...
_apm_function:                               ; 0xf94d3 LB 0xf5
    ...
    jnbe near 09597h                          ; 0f 87 b0 00
    mov bx, ax                                ; 89 c3
    add bx, ax                                ; 01 c3
    mov dx, word [bp+018h]                    ; 8b 56 18
    or dl, 001h                               ; 80 ca 01
    jmp word [cs:bx-06b4bh]                   ; 2e ff a7 b5 94
    ...
    jmp near 095c2h                           ; e9 74 00
    sti                                       ; fb
    hlt                                       ; f4
    jmp near 095c2h                           ; e9 6f 00
    cmp word [bp+010h], strict byte 00003h    ; 83 7e 10 03
    je short 09578h                           ; 74 1f
    cmp word [bp+010h], strict byte 00002h    ; 83 7e 10 02
    je short 09570h                           ; 74 11
    cmp word [bp+010h], strict byte 00001h    ; 83 7e 10 01
    jne short 09580h                          ; 75 1b
    mov dx, 08900h                            ; ba 00 89
    mov ax, 00dcch                            ; b8 cc 0d
    call 0949ah                               ; e8 2c ff
    jmp short 095c2h                          ; eb 52
    mov dx, 08900h                            ; ba 00 89
    mov ax, 00dd4h                            ; b8 d4 0d
    jmp short 0956bh                          ; eb f3
    mov dx, 08900h                            ; ba 00 89
    mov ax, 00ddch                            ; b8 dc 0d
    jmp short 0956bh                          ; eb eb
    or ah, 00ah                               ; 80 cc 0a
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 095c2h                          ; eb 37
    mov word [bp+012h], 00102h                ; c7 46 12 02 01
    jmp short 095c2h                          ; eb 30
    or ah, 080h                               ; 80 cc 80
    jmp short 09583h                          ; eb ec
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 3f 83
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 00de5h                               ; 68 e5 0d
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 72 83
    add sp, strict byte 00008h                ; 83 c4 08
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_select_reg_:                           ; 0xf95c8 LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_find_device_:                          ; 0xf95ec LB 0xf7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 09634h                          ; 75 2d
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, bx                                ; 89 d8
    call 095c8h                               ; e8 b9 ff
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 09622h                          ; 75 06
    add bx, strict byte 00008h                ; 83 c3 08
    jmp near 096b5h                           ; e9 93 00
    test byte [bp-006h], 080h                 ; f6 46 fa 80
    je short 0962fh                           ; 74 07
    mov word [bp-00ah], strict word 00001h    ; c7 46 f6 01 00
    jmp short 09634h                          ; eb 05
    mov word [bp-00ah], strict word 00008h    ; c7 46 f6 08 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 007h                  ; 24 07
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 0965ch                          ; 75 1f
    mov ax, bx                                ; 89 d8
    shr ax, 008h                              ; c1 e8 08
    test ax, ax                               ; 85 c0
    jne short 0965ch                          ; 75 16
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, bx                                ; 89 d8
    call 095c8h                               ; e8 7a ff
    mov dx, 00cfeh                            ; ba fe 0c
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp al, byte [bp-008h]                    ; 3a 46 f8
    jbe short 0965ch                          ; 76 03
    mov byte [bp-008h], al                    ; 88 46 f8
    test di, di                               ; 85 ff
    je short 09665h                           ; 74 05
    mov dx, strict word 00008h                ; ba 08 00
    jmp short 09667h                          ; eb 02
    xor dx, dx                                ; 31 d2
    mov ax, bx                                ; 89 d8
    call 095c8h                               ; e8 5c ff
    ...
    jne short 096a6h                          ; 75 08
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    cmp ax, word [bp-012h]                    ; 3b 46 ee
    je short 096ach                           ; 74 06
    cmp word [bp-010h], strict byte 00000h    ; 83 7e f0 00
    je short 096b2h                           ; 74 06
    dec si                                    ; 4e
    cmp si, strict byte 0ffffh                ; 83 fe ff
    je short 096c4h                           ; 74 12
    add bx, word [bp-00ah]                    ; 03 5e f6
    mov dx, bx                                ; 89 da
    shr dx, 008h                              ; c1 ea 08
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    cmp dx, ax                                ; 39 c2
    jbe near 09602h                           ; 0f 86 3e ff
    cmp si, strict byte 0ffffh                ; 83 fe ff
    jne short 096cdh                          ; 75 04
    mov ax, bx                                ; 89 d8
    jmp short 096d0h                          ; eb 03
    mov ax, strict word 0ffffh                ; b8 ff ff
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
    lds dx, [bx-06821h]                       ; c5 97 df 97
    repne xchg di, ax                         ; f2 97
    pop ES                                    ; 07
    cbw                                       ; 98
    sbb bl, byte [bx+si-067d3h]               ; 1a 98 2d 98
_pci16_function:                             ; 0xf96e3 LB 0x1d7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ah, ah                                ; 30 e4
    cmp bx, strict byte 00003h                ; 83 fb 03
    jc short 0971ch                           ; 72 1a
    jbe short 09774h                          ; 76 70
    cmp bx, strict byte 0000eh                ; 83 fb 0e
    je near 09841h                            ; 0f 84 36 01
    cmp bx, strict byte 00008h                ; 83 fb 08
    jc near 09886h                            ; 0f 82 74 01
    cmp bx, strict byte 0000dh                ; 83 fb 0d
    jbe near 09799h                           ; 0f 86 80 00
    jmp near 09886h                           ; e9 6a 01
    cmp bx, strict byte 00002h                ; 83 fb 02
    je short 09744h                           ; 74 23
    cmp bx, strict byte 00001h                ; 83 fb 01
    jne near 09886h                           ; 0f 85 5e 01
    ...
    jmp near 098b3h                           ; e9 6f 01
    cmp word [bp+018h], strict byte 0ffffh    ; 83 7e 18 ff
    jne short 09750h                          ; 75 06
    or ah, 083h                               ; 80 cc 83
    jmp near 098ach                           ; e9 5c 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov dx, word [bp+01ch]                    ; 8b 56 1c
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor cx, cx                                ; 31 c9
    call 095ech                               ; e8 8e fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 0976eh                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 098ach                           ; e9 3e 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 098b3h                           ; e9 3f 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    mov dx, word [bp+01eh]                    ; 8b 56 1e
    mov cx, strict word 00001h                ; b9 01 00
    call 095ech                               ; e8 69 fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09793h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 098ach                           ; e9 19 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 098b3h                           ; e9 1a 01
    cmp word [bp+004h], 00100h                ; 81 7e 04 00 01
    jc short 097a6h                           ; 72 06
    or ah, 087h                               ; 80 cc 87
    jmp near 098ach                           ; e9 06 01
    mov dx, word [bp+004h]                    ; 8b 56 04
    mov ax, word [bp+014h]                    ; 8b 46 14
    call 095c8h                               ; e8 19 fe
    mov bx, word [bp+020h]                    ; 8b 5e 20
    xor bh, bh                                ; 30 ff
    sub bx, strict byte 00008h                ; 83 eb 08
    cmp bx, strict byte 00005h                ; 83 fb 05
    jnbe near 098b3h                          ; 0f 87 f5 00
    add bx, bx                                ; 01 db
    jmp word [cs:bx-06929h]                   ; 2e ff a7 d7 96
    ...
    mov word [es:bx], ax                      ; 26 89 07
    jmp short 098b3h                          ; eb 2d
    mov bx, 00e60h                            ; bb 60 0e
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 50 80
    mov ax, word [bp+014h]                    ; 8b 46 14
    push ax                                   ; 50
    mov ax, word [bp+020h]                    ; 8b 46 20
    push ax                                   ; 50
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_find_classcode_:                         ; 0xf98ba LB 0x2b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_byte_:                       ; 0xf98e5 LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_word_:                       ; 0xf9909 LB 0x22
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_dword_:                      ; 0xf992b LB 0x27
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
vds_is_present_:                             ; 0xf9952 LB 0x1d
    push bx                                   ; 53
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_real_to_lin_:                            ; 0xf996f LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_build_sg_list_:                          ; 0xf998d LB 0x79
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    call 09952h                               ; e8 93 ff
    test ax, ax                               ; 85 c0
    je short 099d6h                           ; 74 13
    mov es, si                                ; 8e c6
    mov ax, 08105h                            ; b8 05 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 099d3h                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    jmp short 099fdh                          ; eb 27
    mov es, si                                ; 8e c6
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
vds_free_sg_list_:                           ; 0xf9a06 LB 0x3a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push di                                   ; 57
    mov bx, ax                                ; 89 c3
    call 09952h                               ; e8 42 ff
    test ax, ax                               ; 85 c0
    je short 09a27h                           ; 74 13
    mov di, bx                                ; 89 df
    mov es, dx                                ; 8e c2
    mov ax, 08106h                            ; b8 06 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 09a26h                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    mov es, dx                                ; 8e c2
...
hard_drive_post:                             ; 0xfe2d2 LB 0x12c
    ...
    call 0939ch                               ; e8 75 b0
    call 0833ah                               ; e8 10 a0
...
font8x8:                                     ; 0xffa6e LB 0x421
    ...
    db  080h, 0fch, 0b1h, 075h, 00fh, 006h, 01eh, 00eh, 01fh, 0fch, 066h, 060h, 0e8h, 066h, 098h, 066h
    db  061h, 01fh, 007h, 0cfh, 006h, 01eh, 060h, 00eh, 01fh, 0fch, 0e8h, 002h, 06fh, 061h, 01fh, 007h
    db  0cfh
...
cpu_reset:                                   ; 0xffff0 LB 0x10
    jmp far 0f000h:0e05bh                     ; ea 5b e0 00 f0
    db  030h, 036h, 02fh, 032h, 033h, 02fh, 039h, 039h, 000h, 0fch, 06eh
