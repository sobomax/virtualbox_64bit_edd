...
_pktacc:                                     ; 0xf006a LB 0xc
    db  000h, 000h, 000h, 000h, 000h, 000h, 0f2h, 029h, 071h, 07dh, 05ah, 08eh
...
_dskacc:                                     ; 0xf0082 LB 0x2e
    ...
    db  055h, 07ah, 0e3h, 07bh, 056h, 08dh, 0eah, 08dh, 000h, 000h, 000h, 000h, 000h, 000h, 05fh, 033h
...
section _TEXT progbits vstart=0x1600 align=1 ; size=0x8770 class=CODE group=AUTO
...
_int13_cdemu:                                ; 0xf3e08 LB 0x434
    ...
    xor dl, dl                                ; 30 d2
    xor cx, cx                                ; 31 c9
    call 09c89h                               ; e8 dd 5c
    xor bx, bx                                ; 31 db
    add ax, si                                ; 01 f0
    adc dx, bx                                ; 11 da
    mov bx, di                                ; 89 fb
    xor cx, cx                                ; 31 c9
    call 09c89h                               ; e8 d0 5c
    mov bx, ax                                ; 89 c3
    mov ax, word [bp-010h]                    ; 8b 46 f0
    dec ax                                    ; 48
    xor cx, cx                                ; 31 c9
...
_int13_harddisk:                             ; 0xf557f LB 0x484
    ...
    mov bx, cx                                ; 89 cb
    xor cx, cx                                ; 31 c9
    call 09c89h                               ; e8 1b 45
    xor bx, bx                                ; 31 db
    add ax, word [bp-008h]                    ; 03 46 f8
    adc dx, bx                                ; 11 da
    mov bx, word [bp-00ch]                    ; 8b 5e f4
    xor cx, cx                                ; 31 c9
    call 09c89h                               ; e8 0c 45
    xor bx, bx                                ; 31 db
    ...
    xor cx, cx                                ; 31 c9
    call 09c89h                               ; e8 29 43
    mov bx, word [bp-006h]                    ; 8b 5e fa
    xor cx, cx                                ; 31 c9
    call 09c89h                               ; e8 21 43
    mov word [bp-010h], ax                    ; 89 46 f0
    mov word [bp-00eh], dx                    ; 89 56 f2
    mov word [bp+014h], dx                    ; 89 56 14
    mov word [bp+012h], ax                    ; 89 46 12
...
scsi_cmd_packet_:                            ; 0xf7d71 LB 0x222
    ...
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
scsi_enumerate_attached_devices_:            ; 0xf7f93 LB 0x53f
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    add sp, strict byte 00008h                ; 83 c4 08
    mov es, [bp-036h]                         ; 8e 46 ca
    cmp byte [es:di+0022ch], 004h             ; 26 80 bd 2c 02 04
    jnc near 084c8h                           ; 0f 83 e8 04
    mov cx, strict word 00010h                ; b9 10 00
    xor bx, bx                                ; 31 db
    mov dx, ss                                ; 8c d2
    lea ax, [bp-05ah]                         ; 8d 46 a6
    call 09cbah                               ; e8 cd 1c
    ...
    mov dx, si                                ; 89 f2
    mov si, strict word 00020h                ; be 20 00
    call 09d60h                               ; e8 0a 1d
    mov word [bp-03eh], ax                    ; 89 46 c2
    mov word [bp-048h], bx                    ; 89 5e b8
    ...
    mov dx, word [bp-022h]                    ; 8b 56 de
    mov si, strict word 00020h                ; be 20 00
    call 09d50h                               ; e8 dc 1c
    mov ax, dx                                ; 89 d0
    mov dx, cx                                ; 89 ca
    xchg ah, al                               ; 86 c4
    xchg dh, dl                               ; 86 d6
    xchg dx, ax                               ; 92
    or word [bp-042h], ax                     ; 09 46 be
    or word [bp-034h], dx                     ; 09 56 cc
    ...
    mov ax, word [bp-034h]                    ; 8b 46 cc
    mov word [bp-032h], ax                    ; 89 46 ce
    mov ax, word [bp-042h]                    ; 8b 46 be
    mov word [bp-02ah], ax                    ; 89 46 d6
    movzx ax, byte [bp-00252h]                ; 0f b6 86 ae fd
    sal ax, 008h                              ; c1 e0 08
    movzx si, byte [bp-00251h]                ; 0f b6 b6 af fd
    xor bx, bx                                ; 31 db
    or si, ax                                 ; 09 c6
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 34 98
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 08456h                           ; e9 62 03
    mov es, [bp-036h]                         ; 8e 46 ca
    mov al, byte [es:di+0022ch]               ; 26 8a 85 2c 02
    mov byte [bp-00ch], al                    ; 88 46 f4
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 0810fh                           ; 72 0c
    jbe short 08117h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 0811fh                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 0811bh                           ; 74 0e
    jmp short 0816dh                          ; eb 5e
    test al, al                               ; 84 c0
    jne short 0816dh                          ; 75 5a
    mov BL, strict byte 090h                  ; b3 90
    jmp short 08121h                          ; eb 0a
    mov BL, strict byte 098h                  ; b3 98
    jmp short 08121h                          ; eb 06
    mov BL, strict byte 0a0h                  ; b3 a0
    jmp short 08121h                          ; eb 02
    mov BL, strict byte 0a8h                  ; b3 a8
    mov al, bl                                ; 88 d8
    add AL, strict byte 007h                  ; 04 07
    movzx cx, al                              ; 0f b6 c8
    mov ax, cx                                ; 89 c8
    call 0165ch                               ; e8 2f 95
    test al, al                               ; 84 c0
    je short 0816dh                           ; 74 3c
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    ...
    mov word [bp-016h], ax                    ; 89 46 ea
    mov ax, cx                                ; 89 c8
    call 0165ch                               ; e8 f7 94
    xor ah, ah                                ; 30 e4
    mov word [bp-014h], ax                    ; 89 46 ec
    jmp near 08252h                           ; e9 e5 00
    mov ax, word [bp-028h]                    ; 8b 46 d8
    mov bx, word [bp-012h]                    ; 8b 5e ee
    mov cx, word [bp-032h]                    ; 8b 4e ce
    mov dx, word [bp-02ah]                    ; 8b 56 d6
    mov si, strict word 0000ch                ; be 0c 00
    call 09d50h                               ; e8 d1 1b
    mov word [bp-024h], ax                    ; 89 46 dc
    ...
    mov ax, word [bp-028h]                    ; 8b 46 d8
    test ax, ax                               ; 85 c0
    jnbe short 081a6h                         ; 77 14
    jne near 08215h                           ; 0f 85 7f 00
    cmp word [bp-012h], strict byte 00000h    ; 83 7e ee 00
    jnbe short 081a6h                         ; 77 0a
    jne short 08215h                          ; 75 77
    cmp word [bp-032h], strict byte 00040h    ; 83 7e ce 40
    jnbe short 081a6h                         ; 77 02
    jne short 08215h                          ; 75 6f
    mov dword [bp-016h], strict dword 0003f00ffh ; 66 c7 46 ea ff 00 3f 00
    mov bx, word [bp-012h]                    ; 8b 5e ee
    mov cx, word [bp-032h]                    ; 8b 4e ce
    mov dx, word [bp-02ah]                    ; 8b 56 d6
    mov si, strict word 00006h                ; be 06 00
    call 09d50h                               ; e8 93 1b
    mov si, word [bp-01ch]                    ; 8b 76 e4
    add si, dx                                ; 01 d6
    mov word [bp-046h], si                    ; 89 76 ba
    ...
    mov ax, dx                                ; 89 d0
    mov bx, word [bp-044h]                    ; 8b 5e bc
    mov cx, word [bp-030h]                    ; 8b 4e d0
    mov dx, si                                ; 89 f2
    mov si, strict word 00008h                ; be 08 00
    call 09d50h                               ; e8 63 1b
    ...
    mov si, strict word 00010h                ; be 10 00
    call 09d50h                               ; e8 48 1b
    add dx, word [bp-01eh]                    ; 03 56 e2
    adc cx, word [bp-03ah]                    ; 13 4e c6
    mov ax, word [bp-038h]                    ; 8b 46 c8
    adc ax, bx                                ; 11 d8
    jmp short 0824ch                          ; eb 37
    test ax, ax                               ; 85 c0
    jnbe short 0822bh                         ; 77 12
    jne short 08235h                          ; 75 1a
    cmp word [bp-012h], strict byte 00000h    ; 83 7e ee 00
    jnbe short 0822bh                         ; 77 0a
    jne short 08235h                          ; 75 12
    cmp word [bp-032h], strict byte 00020h    ; 83 7e ce 20
    jnbe short 0822bh                         ; 77 02
    jne short 08235h                          ; 75 0a
    mov dword [bp-016h], strict dword 000200080h ; 66 c7 46 ea 80 00 20 00
    jmp short 0824ch                          ; eb 17
    mov dword [bp-016h], strict dword 000200040h ; 66 c7 46 ea 40 00 20 00
    mov bx, word [bp-012h]                    ; 8b 5e ee
    mov cx, word [bp-032h]                    ; 8b 4e ce
    mov dx, word [bp-02ah]                    ; 8b 56 d6
    mov si, strict word 0000bh                ; be 0b 00
    call 09d50h                               ; e8 04 1b
    ...
    jne short 082b2h                          ; 75 07
    cmp word [bp-02ch], 00400h                ; 81 7e d4 00 04
    jbe short 082bah                          ; 76 08
    mov word [es:bx+02ch], 00400h             ; 26 c7 47 2c 00 04
    jmp short 082c1h                          ; eb 07
    mov ax, word [bp-02ch]                    ; 8b 46 d4
    mov word [es:bx+02ch], ax                 ; 26 89 47 2c
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 15 96
    push dword 000000000h                     ; 66 6a 00
    ...
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 20 96
    add sp, strict byte 0001eh                ; 83 c4 1e
    movzx ax, byte [bp-00eh]                  ; 0f b6 46 f2
    imul ax, ax, strict byte 0001ch           ; 6b c0 1c
    mov es, [bp-036h]                         ; 8e 46 ca
    mov bx, di                                ; 89 fb
    ...
    cmp word [bp-018h], strict byte 00000h    ; 83 7e e8 00
    jne short 0832eh                          ; 75 07
    cmp word [bp-02ch], 00400h                ; 81 7e d4 00 04
    jbe short 08336h                          ; 76 08
    mov word [es:bx+032h], 00400h             ; 26 c7 47 32 00 04
    jmp short 0833dh                          ; eb 07
    mov ax, word [bp-02ch]                    ; 8b 46 d4
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 76 92
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 76 92
    inc byte [bp-00ch]                        ; fe 46 f4
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    mov es, [bp-036h]                         ; 8e 46 ca
    mov byte [es:di+0022ch], al               ; 26 88 85 2c 02
    jmp near 08456h                           ; e9 ad 00
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 2d 95
    push word [bp-010h]                       ; ff 76 f0
    movzx ax, byte [bp-00ch]                  ; 0f b6 46 f4
    push ax                                   ; 50
    push 00ed5h                               ; 68 d5 0e
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 5e 95
    add sp, strict byte 00008h                ; 83 c4 08
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    add AL, strict byte 008h                  ; 04 08
    mov byte [bp-00eh], al                    ; 88 46 f2
    ...
    lea bx, [bp-05ah]                         ; 8d 5e a6
    mov ax, word [bp-0025ch]                  ; 8b 86 a4 fd
    call 0785bh                               ; e8 cb f3
    test al, al                               ; 84 c0
    je short 084a2h                           ; 74 0e
    push 00e07h                               ; 68 07 0e
    push 00e27h                               ; 68 27 0e
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 83 94
    add sp, strict byte 00006h                ; 83 c4 06
    test byte [bp-0025ah], 0e0h               ; f6 86 a6 fd e0
    jne short 084b2h                          ; 75 09
    test byte [bp-0025ah], 01fh               ; f6 86 a6 fd 1f
    je near 07fb7h                            ; 0f 84 05 fb
    test byte [bp-0025ah], 0e0h               ; f6 86 a6 fd e0
    jne short 0843ah                          ; 75 81
    mov al, byte [bp-0025ah]                  ; 8a 86 a6 fd
    and AL, strict byte 01fh                  ; 24 1f
    cmp AL, strict byte 005h                  ; 3c 05
    je near 083a9h                            ; 0f 84 e4 fe
    jmp near 0843ah                           ; e9 72 ff
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop dx                                    ; 5a
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_scsi_init:                                  ; 0xf84d2 LB 0xf0
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 3e 91
    ...
    jne short 0851ah                          ; 75 24
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 e0 93
    push 00f18h                               ; 68 18 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 19 94
    add sp, strict byte 00004h                ; 83 c4 04
    xor al, al                                ; 30 c0
    mov dx, 00433h                            ; ba 33 04
    out DX, AL                                ; ee
    mov ax, 00430h                            ; b8 30 04
    call 07f93h                               ; e8 7b fa
    jmp short 08530h                          ; eb 16
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 bc 93
    push 00f43h                               ; 68 43 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 f5 93
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 055h                  ; b0 55
    ...
    ; sub ah, ah                                ; 2a e4
    cmp AL, strict byte 055h                  ; 3c 55
    jne short 08561h                          ; 75 24
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 99 93
    push 00f72h                               ; 68 72 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 d2 93
    add sp, strict byte 00004h                ; 83 c4 04
    xor al, al                                ; 30 c0
    mov dx, 00437h                            ; ba 37 04
    out DX, AL                                ; ee
    mov ax, 00434h                            ; b8 34 04
    call 07f93h                               ; e8 34 fa
    jmp short 08577h                          ; eb 16
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 75 93
    push 00f9eh                               ; 68 9e 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 ae 93
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 055h                  ; b0 55
    ...
    ; sub ah, ah                                ; 2a e4
    cmp AL, strict byte 055h                  ; 3c 55
    jne short 085a8h                          ; 75 24
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 52 93
    push 00fceh                               ; 68 ce 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 8b 93
    add sp, strict byte 00004h                ; 83 c4 04
    xor al, al                                ; 30 c0
    mov dx, 0043bh                            ; ba 3b 04
    out DX, AL                                ; ee
    mov ax, 00438h                            ; b8 38 04
    call 07f93h                               ; e8 ed f9
    jmp short 085beh                          ; eb 16
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 2e 93
    push 00ff9h                               ; 68 f9 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 67 93
    add sp, strict byte 00004h                ; 83 c4 04
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
...
ahci_port_cmd_sync_:                         ; 0xf86ec LB 0xd5
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_cmd_data_:                              ; 0xf87c1 LB 0x24b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_deinit_current_:                   ; 0xf8a0c LB 0x144
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_init_:                             ; 0xf8b50 LB 0x206
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, 0c011h                            ; bb 11 c0
    xor cx, cx                                ; 31 c9
    call 0867ah                               ; e8 e1 fa
    cmp AL, strict byte 001h                  ; 3c 01
    je short 08b7eh                           ; 74 e1
    mov cx, strict word 00020h                ; b9 20 00
    xor bx, bx                                ; 31 db
    mov ax, si                                ; 89 f0
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09cbah                               ; e8 10 11
    lea ax, [si+00080h]                       ; 8d 84 80 00
    mov cx, strict word 00040h                ; b9 40 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09cbah                               ; e8 01 11
    mov ax, si                                ; 89 f0
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@ahci_read_sectors:                          ; 0xf8d56 LB 0x94
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ax, ax                                ; 31 c0
    call 08b50h                               ; e8 b1 fd
    mov bx, strict word 00025h                ; bb 25 00
    mov ax, di                                ; 89 f8
    mov dx, word [bp+006h]                    ; 8b 56 06
    call 087c1h                               ; e8 17 fa
    mov es, [bp+006h]                         ; 8e 46 06
    mov bx, di                                ; 89 fb
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@ahci_write_sectors:                         ; 0xf8dea LB 0x70
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    mov si, word [bp+004h]                    ; 8b 76 04
...
ahci_cmd_packet_:                            ; 0xf8e5a LB 0x17c
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 a7 87
    mov si, 00122h                            ; be 22 01
    mov word [bp-008h], ax                    ; 89 46 f8
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 08ea0h                          ; 75 1f
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 55 8a
    push 0106ch                               ; 68 6c 10
    push 0107ch                               ; 68 7c 10
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 8b 8a
    add sp, strict byte 00006h                ; 83 c4 06
    mov ax, strict word 00001h                ; b8 01 00
    jmp near 08fcdh                           ; e9 2d 01
    test byte [bp+004h], 001h                 ; f6 46 04 01
    jne short 08e9ah                          ; 75 f4
    mov ax, word [bp+006h]                    ; 8b 46 06
    ...
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    call 085d9h                               ; e8 20 f6
    les bx, [bp-00eh]                         ; c4 5e f2
    mov ax, word [es:bx+006h]                 ; 26 8b 47 06
    or ax, word [es:bx+004h]                  ; 26 0b 47 04
    jne short 08fcbh                          ; 75 05
    mov ax, strict word 00004h                ; b8 04 00
    jmp short 08fcdh                          ; eb 02
    xor ax, ax                                ; 31 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
ahci_port_detect_device_:                    ; 0xf8fd6 LB 0x46c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, di                                ; 89 fb
    call 08b50h                               ; e8 60 fb
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 23 86
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 086b3h                               ; e8 10 f6
    test ax, ax                               ; 85 c0
    je near 0943ah                            ; 0f 84 91 03
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    sal ax, 007h                              ; c1 e0 07
    mov word [bp-016h], ax                    ; 89 46 ea
    add ax, 00128h                            ; 05 28 01
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 086b3h                               ; e8 c4 f5
    cmp ax, strict word 00001h                ; 3d 01 00
    je short 090a9h                           ; 74 b5
    push strict byte 00000h                   ; 6a 00
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    mov ax, word [bp-01eh]                    ; 8b 46 e2
    mov dx, di                                ; 89 fa
    call 086b3h                               ; e8 b0 f5
    cmp ax, strict word 00003h                ; 3d 03 00
    jne near 0943ah                           ; 0f 85 30 03
    mov ax, word [bp-016h]                    ; 8b 46 ea
    ...
    test dx, dx                               ; 85 d2
    jne near 0938dh                           ; 0f 85 ea 01
    cmp ax, 00101h                            ; 3d 01 01
    jne near 0938dh                           ; 0f 85 e3 01
    les bx, [bp-010h]                         ; c4 5e f0
    ...
    jne short 09221h                          ; 75 10
    cmp dx, strict byte 0ffffh                ; 83 fa ff
    jne short 09221h                          ; 75 0b
    ...
    mov al, byte [bp-008h]                    ; 8a 46 f8
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 09295h                           ; 72 0c
    jbe short 0929dh                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 092a5h                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 092a1h                           ; 74 0e
    jmp short 092eeh                          ; eb 59
    test al, al                               ; 84 c0
    jne short 092eeh                          ; 75 55
    mov DL, strict byte 040h                  ; b2 40
    jmp short 092a7h                          ; eb 0a
    mov DL, strict byte 048h                  ; b2 48
    jmp short 092a7h                          ; eb 06
    ...
    movzx bx, al                              ; 0f b6 d8
    mov ax, bx                                ; 89 d8
    call 0165ch                               ; e8 a9 83
    test al, al                               ; 84 c0
    je short 092eeh                           ; 74 37
    mov al, dl                                ; 88 d0
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 9c 83
    xor ah, ah                                ; 30 e4
    mov si, ax                                ; 89 c6
    sal si, 008h                              ; c1 e6 08
    movzx ax, dl                              ; 0f b6 c2
    call 0165ch                               ; e8 8f 83
    xor ah, ah                                ; 30 e4
    add ax, si                                ; 01 f0
    mov word [bp-024h], ax                    ; 89 46 dc
    mov al, dl                                ; 88 d0
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 7f 83
    xor ah, ah                                ; 30 e4
    mov word [bp-026h], ax                    ; 89 46 da
    mov ax, bx                                ; 89 d8
    call 0165ch                               ; e8 75 83
    xor ah, ah                                ; 30 e4
    mov word [bp-022h], ax                    ; 89 46 de
    jmp short 092fbh                          ; eb 0d
    mov bx, word [bp-014h]                    ; 8b 5e ec
    mov cx, di                                ; 89 f9
    mov dx, ss                                ; 8c d2
    lea ax, [bp-026h]                         ; 8d 46 da
    call 054e1h                               ; e8 e6 c1
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 db 85
    push di                                   ; 57
    push word [bp-014h]                       ; ff 76 ec
    mov ax, word [bp-022h]                    ; 8b 46 de
    push ax                                   ; 50
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 84 82
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 84 82
    jmp near 0942ch                           ; e9 9f 00
    cmp dx, 0eb14h                            ; 81 fa 14 eb
    jne near 0942ch                           ; 0f 85 97 00
    cmp ax, 00101h                            ; 3d 01 01
    jne near 0942ch                           ; 0f 85 90 00
    les bx, [bp-010h]                         ; c4 5e f0
    db  066h, 026h, 0c7h, 047h, 004h, 000h, 000h, 000h, 000h
    ; mov dword [es:bx+004h], strict dword 000000000h ; 66 26 c7 47 04 00 00 00 00
    db  066h, 026h, 0c7h, 007h, 000h, 000h, 000h, 000h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_mem_alloc_:                             ; 0xf9442 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 0161ch                               ; e8 ca 81
    test ax, ax                               ; 85 c0
    je short 0947bh                           ; 74 25
    dec ax                                    ; 48
    mov bx, ax                                ; 89 c3
    xor dx, dx                                ; 31 d2
    mov cx, strict word 0000ah                ; b9 0a 00
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_hba_init_:                              ; 0xf9485 LB 0x125
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    shr eax, 010h                             ; 66 c1 e8 10
    xchg dx, ax                               ; 92
    call 09442h                               ; e8 82 ff
    mov di, ax                                ; 89 c7
    test ax, ax                               ; 85 c0
    je near 09589h                            ; 0f 84 c1 00
    mov es, [bp-010h]                         ; 8e 46 f0
    ...
    xor cx, cx                                ; 31 c9
    call 086b3h                               ; e8 71 f1
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    mov byte [bp-00eh], al                    ; 88 46 f2
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    jmp short 09556h                          ; eb 09
    inc byte [bp-00ch]                        ; fe 46 f4
    cmp byte [bp-00ch], 020h                  ; 80 7e f4 20
    jnc short 09587h                          ; 73 31
    movzx cx, byte [bp-00ch]                  ; 0f b6 4e f4
    mov ax, strict word 00001h                ; b8 01 00
    xor dx, dx                                ; 31 d2
    jcxz 09567h                               ; e3 06
    ...
    mov dx, strict word 0000ch                ; ba 0c 00
    mov ax, si                                ; 89 f0
    call 0867ah                               ; e8 07 f1
    test al, al                               ; 84 c0
    je short 0954dh                           ; 74 d6
    movzx bx, byte [bp-00ch]                  ; 0f b6 5e f4
    xor ax, ax                                ; 31 c0
    mov dx, di                                ; 89 fa
    call 08fd6h                               ; e8 54 fa
    dec byte [bp-00eh]                        ; fe 4e f2
    jne short 0954dh                          ; 75 c6
    xor ax, ax                                ; 31 c0
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    db  00bh, 005h, 004h, 003h, 002h, 001h, 000h, 079h, 096h, 057h, 096h, 05dh, 096h, 063h, 096h, 069h
    db  096h, 06fh, 096h, 075h, 096h, 079h, 096h
_ahci_init:                                  ; 0xf95aa LB 0xfe
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00001h                ; ba 01 00
    call 09ac8h                               ; e8 0d 05
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 0ffffh                ; 3d ff ff
    je near 096a1h                            ; 0f 84 dd 00
    xor al, al                                ; 30 c0
    shr ax, 008h                              ; c1 e8 08
    mov byte [bp-00ah], al                    ; 88 46 f6
    mov byte [bp-008h], dl                    ; 88 56 f8
    ...
    xor ah, ah                                ; 30 e4
    mov bx, strict word 00034h                ; bb 34 00
    call 09af3h                               ; e8 1a 05
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    je short 09602h                           ; 74 23
    movzx bx, cl                              ; 0f b6 d9
    movzx di, byte [bp-008h]                  ; 0f b6 7e f8
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 09af3h                               ; e8 02 05
    cmp AL, strict byte 012h                  ; 3c 12
    je short 09602h                           ; 74 0d
    mov al, cl                                ; 88 c8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    jmp short 095d6h                          ; eb d4
    test cl, cl                               ; 84 c9
    je near 096a1h                            ; 0f 84 99 00
    ...
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 09af3h                               ; e8 d6 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne near 096a1h                           ; 0f 85 7e 00
    mov byte [bp-006h], 000h                  ; c6 46 fa 00
    mov al, cl                                ; 88 c8
    add AL, strict byte 002h                  ; 04 02
    movzx bx, al                              ; 0f b6 d8
    ...
    mov al, byte [bp-006h]                    ; 8a 46 fa
    test al, al                               ; 84 c0
    je short 096a1h                           ; 74 19
    movzx bx, al                              ; 0f b6 d8
    movzx dx, byte [bp-008h]                  ; 0f b6 56 f8
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    call 09b39h                               ; e8 a3 04
    test AL, strict byte 001h                 ; a8 01
    je short 096a1h                           ; 74 07
    and AL, strict byte 0f0h                  ; 24 f0
    add ax, si                                ; 01 f0
    call 09485h                               ; e8 e4 fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
apm_out_str_:                                ; 0xf96a8 LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    cmp byte [bx], 000h                       ; 80 3f 00
    je short 096bdh                           ; 74 0a
    ...
    db  00ah, 0c0h
    ; or al, al                                 ; 0a c0
    jne short 096b5h                          ; 75 f8
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
    add AL, strict byte 097h                  ; 04 97
    rcl byte [bx-068eah], 1                   ; d0 97 16 97
    xor word [bx-06830h], dx                  ; 31 97 d0 97
    pop sp                                    ; 5c
    xchg di, ax                               ; 97
    rcl byte [bx-0689fh], 1                   ; d0 97 61 97
    movsw                                     ; a5
    xchg di, ax                               ; 97
    movsw                                     ; a5
    xchg di, ax                               ; 97
    movsw                                     ; a5
    xchg di, ax                               ; 97
    mov AL, byte [0a597h]                     ; a0 97 a5
    xchg di, ax                               ; 97
    movsw                                     ; a5
    xchg di, ax                               ; 97
    cwd                                       ; 99
    xchg di, ax                               ; 97
_apm_function:                               ; 0xf96e1 LB 0xf5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    ...
    jnbe near 097a5h                          ; 0f 87 b0 00
    mov bx, ax                                ; 89 c3
    add bx, ax                                ; 01 c3
    mov dx, word [bp+018h]                    ; 8b 56 18
    or dl, 001h                               ; 80 ca 01
    jmp word [cs:bx-0693dh]                   ; 2e ff a7 c3 96
    ...
    jmp near 097d0h                           ; e9 74 00
    sti                                       ; fb
    hlt                                       ; f4
    jmp near 097d0h                           ; e9 6f 00
    cmp word [bp+010h], strict byte 00003h    ; 83 7e 10 03
    je short 09786h                           ; 74 1f
    cmp word [bp+010h], strict byte 00002h    ; 83 7e 10 02
    je short 0977eh                           ; 74 11
    cmp word [bp+010h], strict byte 00001h    ; 83 7e 10 01
    jne short 0978eh                          ; 75 1b
    mov dx, 08900h                            ; ba 00 89
    mov ax, 010d4h                            ; b8 d4 10
    call 096a8h                               ; e8 2c ff
    jmp short 097d0h                          ; eb 52
    mov dx, 08900h                            ; ba 00 89
    mov ax, 010dch                            ; b8 dc 10
    jmp short 09779h                          ; eb f3
    mov dx, 08900h                            ; ba 00 89
    mov ax, 010e4h                            ; b8 e4 10
    jmp short 09779h                          ; eb eb
    or ah, 00ah                               ; 80 cc 0a
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 097d0h                          ; eb 37
    mov word [bp+012h], 00102h                ; c7 46 12 02 01
    jmp short 097d0h                          ; eb 30
    or ah, 080h                               ; 80 cc 80
    jmp short 09791h                          ; eb ec
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 31 81
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 010edh                               ; 68 ed 10
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 64 81
    add sp, strict byte 00008h                ; 83 c4 08
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_select_reg_:                           ; 0xf97d6 LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_find_device_:                          ; 0xf97fa LB 0xf7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 09842h                          ; 75 2d
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, bx                                ; 89 d8
    call 097d6h                               ; e8 b9 ff
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 09830h                          ; 75 06
    add bx, strict byte 00008h                ; 83 c3 08
    jmp near 098c3h                           ; e9 93 00
    test byte [bp-006h], 080h                 ; f6 46 fa 80
    je short 0983dh                           ; 74 07
    mov word [bp-00ah], strict word 00001h    ; c7 46 f6 01 00
    jmp short 09842h                          ; eb 05
    mov word [bp-00ah], strict word 00008h    ; c7 46 f6 08 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 007h                  ; 24 07
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 0986ah                          ; 75 1f
    mov ax, bx                                ; 89 d8
    shr ax, 008h                              ; c1 e8 08
    test ax, ax                               ; 85 c0
    jne short 0986ah                          ; 75 16
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, bx                                ; 89 d8
    call 097d6h                               ; e8 7a ff
    mov dx, 00cfeh                            ; ba fe 0c
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp al, byte [bp-008h]                    ; 3a 46 f8
    jbe short 0986ah                          ; 76 03
    mov byte [bp-008h], al                    ; 88 46 f8
    test di, di                               ; 85 ff
    je short 09873h                           ; 74 05
    mov dx, strict word 00008h                ; ba 08 00
    jmp short 09875h                          ; eb 02
    xor dx, dx                                ; 31 d2
    mov ax, bx                                ; 89 d8
    call 097d6h                               ; e8 5c ff
    ...
    jne short 098b4h                          ; 75 08
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    cmp ax, word [bp-012h]                    ; 3b 46 ee
    je short 098bah                           ; 74 06
    cmp word [bp-010h], strict byte 00000h    ; 83 7e f0 00
    je short 098c0h                           ; 74 06
    dec si                                    ; 4e
    cmp si, strict byte 0ffffh                ; 83 fe ff
    je short 098d2h                           ; 74 12
    add bx, word [bp-00ah]                    ; 03 5e f6
    mov dx, bx                                ; 89 da
    shr dx, 008h                              ; c1 ea 08
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    cmp dx, ax                                ; 39 c2
    jbe near 09810h                           ; 0f 86 3e ff
    cmp si, strict byte 0ffffh                ; 83 fe ff
    jne short 098dbh                          ; 75 04
    mov ax, bx                                ; 89 d8
    jmp short 098deh                          ; eb 03
    mov ax, strict word 0ffffh                ; b8 ff ff
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
    rcr word [bx+di-06613h], CL               ; d3 99 ed 99
    add byte [bp+si-065ebh], bl               ; 00 9a 15 9a
    sub byte [bp+si-065c5h], bl               ; 28 9a 3b 9a
_pci16_function:                             ; 0xf98f1 LB 0x1d7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ah, ah                                ; 30 e4
    cmp bx, strict byte 00003h                ; 83 fb 03
    jc short 0992ah                           ; 72 1a
    jbe short 09982h                          ; 76 70
    cmp bx, strict byte 0000eh                ; 83 fb 0e
    je near 09a4fh                            ; 0f 84 36 01
    cmp bx, strict byte 00008h                ; 83 fb 08
    jc near 09a94h                            ; 0f 82 74 01
    cmp bx, strict byte 0000dh                ; 83 fb 0d
    jbe near 099a7h                           ; 0f 86 80 00
    jmp near 09a94h                           ; e9 6a 01
    cmp bx, strict byte 00002h                ; 83 fb 02
    je short 09952h                           ; 74 23
    cmp bx, strict byte 00001h                ; 83 fb 01
    jne near 09a94h                           ; 0f 85 5e 01
    ...
    jmp near 09ac1h                           ; e9 6f 01
    cmp word [bp+018h], strict byte 0ffffh    ; 83 7e 18 ff
    jne short 0995eh                          ; 75 06
    or ah, 083h                               ; 80 cc 83
    jmp near 09abah                           ; e9 5c 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov dx, word [bp+01ch]                    ; 8b 56 1c
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor cx, cx                                ; 31 c9
    call 097fah                               ; e8 8e fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 0997ch                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09abah                           ; e9 3e 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09ac1h                           ; e9 3f 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    mov dx, word [bp+01eh]                    ; 8b 56 1e
    mov cx, strict word 00001h                ; b9 01 00
    call 097fah                               ; e8 69 fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 099a1h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09abah                           ; e9 19 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09ac1h                           ; e9 1a 01
    cmp word [bp+004h], 00100h                ; 81 7e 04 00 01
    jc short 099b4h                           ; 72 06
    or ah, 087h                               ; 80 cc 87
    jmp near 09abah                           ; e9 06 01
    mov dx, word [bp+004h]                    ; 8b 56 04
    mov ax, word [bp+014h]                    ; 8b 46 14
    call 097d6h                               ; e8 19 fe
    mov bx, word [bp+020h]                    ; 8b 5e 20
    xor bh, bh                                ; 30 ff
    sub bx, strict byte 00008h                ; 83 eb 08
    cmp bx, strict byte 00005h                ; 83 fb 05
    jnbe near 09ac1h                          ; 0f 87 f5 00
    add bx, bx                                ; 01 db
    jmp word [cs:bx-0671bh]                   ; 2e ff a7 e5 98
    ...
    mov word [es:bx], ax                      ; 26 89 07
    jmp short 09ac1h                          ; eb 2d
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 42 7e
    mov ax, word [bp+014h]                    ; 8b 46 14
    push ax                                   ; 50
    mov ax, word [bp+020h]                    ; 8b 46 20
    push ax                                   ; 50
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_find_classcode_:                         ; 0xf9ac8 LB 0x2b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_byte_:                       ; 0xf9af3 LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_word_:                       ; 0xf9b17 LB 0x22
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_dword_:                      ; 0xf9b39 LB 0x27
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
vds_is_present_:                             ; 0xf9b60 LB 0x1d
    push bx                                   ; 53
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_real_to_lin_:                            ; 0xf9b7d LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_build_sg_list_:                          ; 0xf9b9b LB 0x79
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    call 09b60h                               ; e8 93 ff
    test ax, ax                               ; 85 c0
    je short 09be4h                           ; 74 13
    mov es, si                                ; 8e c6
    mov ax, 08105h                            ; b8 05 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 09be1h                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    jmp short 09c0bh                          ; eb 27
    mov es, si                                ; 8e c6
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
vds_free_sg_list_:                           ; 0xf9c14 LB 0x3c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push di                                   ; 57
    mov bx, ax                                ; 89 c3
    call 09b60h                               ; e8 42 ff
    test ax, ax                               ; 85 c0
    je short 09c35h                           ; 74 13
    mov di, bx                                ; 89 df
    mov es, dx                                ; 8e c2
    mov ax, 08106h                            ; b8 06 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 09c34h                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    mov es, dx                                ; 8e c2
...
_fmemcpy_:                                   ; 0xf9cc7 LB 0x33
    ...
    popfw                                     ; 9d
    adc bl, byte [di-062eah]                  ; 12 9d 16 9d
    push SS                                   ; 16
    popfw                                     ; 9d
    push SS                                   ; 16
    popfw                                     ; 9d
    sbb byte [di-062e8h], bl                  ; 18 9d 18 9d
    sbb bl, byte [di-062e2h]                  ; 1a 9d 1e 9d
    push DS                                   ; 1e
    popfw                                     ; 9d
    and byte [di-062dbh], bl                  ; 20 9d 25 9d
    daa                                       ; 27
    popfw                                     ; 9d
apm_worker:                                  ; 0xf9cfa LB 0x3a
    sti                                       ; fb
    push ax                                   ; 50
    db  032h, 0e4h
    ; xor ah, ah                                ; 32 e4
    ...
    jnc short 09d30h                          ; 73 25
    jmp word [cs:bp-06320h]                   ; 2e ff a6 e0 9c
    jmp short 09d2eh                          ; eb 1c
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 09d2eh                          ; eb 18
    jmp short 09d2eh                          ; eb 16
    jmp short 09d30h                          ; eb 16
    mov AH, strict byte 080h                  ; b4 80
    jmp short 09d32h                          ; eb 14
    jmp short 09d30h                          ; eb 10
    mov ax, 00102h                            ; b8 02 01
    jmp short 09d2eh                          ; eb 09
    jmp short 09d2eh                          ; eb 07
    mov BL, strict byte 000h                  ; b3 00
    mov cx, strict word 00000h                ; b9 00 00
    jmp short 09d2eh                          ; eb 00
    clc                                       ; f8
    retn                                      ; c3
    mov AH, strict byte 009h                  ; b4 09
    stc                                       ; f9
    retn                                      ; c3
apm_pm16_entry:                              ; 0xf9d34 LB 0x1c
    ...
    mov ds, bp                                ; 8e dd
    call 09cfah                               ; e8 b8 ff
    pop bp                                    ; 5d
    pop DS                                    ; 1f
    retf                                      ; cb
    times 0xb db 0
__U8RS:                                      ; 0xf9d50 LB 0x10
    test si, si                               ; 85 f6
    ...
    retn                                      ; c3
__I8LS:                                      ; 0xf9d60 LB 0x10
    test si, si                               ; 85 f6
    je short 09d6fh                           ; 74 0b
    sal dx, 1                                 ; d1 e2
    rcl cx, 1                                 ; d1 d1
    rcl bx, 1                                 ; d1 d3
    rcl ax, 1                                 ; d1 d0
    dec si                                    ; 4e
    jne short 09d64h                          ; 75 f5
    retn                                      ; c3

  ; Padding 0x3c90 bytes at 0xf9d70
  times 15504 db 0
...
hard_drive_post:                             ; 0xfe2d2 LB 0x12c
    ...
    call 095aah                               ; e8 83 b2
    call 084d2h                               ; e8 a8 a1
...
font8x8:                                     ; 0xffa6e LB 0x421
    ...
    db  080h, 0fch, 0b1h, 075h, 00fh, 006h, 01eh, 00eh, 01fh, 0fch, 066h, 060h, 0e8h, 074h, 09ah, 066h
...
cpu_reset:                                   ; 0xffff0 LB 0x10
    jmp far 0f000h:0e05bh                     ; ea 5b e0 00 f0
    db  030h, 036h, 02fh, 032h, 033h, 02fh, 039h, 039h, 000h, 0fch, 084h
