...
_pktacc:                                     ; 0xf006a LB 0xc
    db  000h, 000h, 000h, 000h, 000h, 000h, 0f2h, 029h, 071h, 07dh, 031h, 08eh
...
_dskacc:                                     ; 0xf0082 LB 0x2e
    ...
    db  055h, 07ah, 0e3h, 07bh, 02dh, 08dh, 0c1h, 08dh, 000h, 000h, 000h, 000h, 000h, 000h, 05fh, 033h
...
section CONST progbits vstart=0xb0 align=1 ; size=0x109e class=DATA group=DGROUP
    ...
    db   'SCSI %d-ID#%d: LCHS=%u/%u/%u %llu sectors', 00ah, 000h
...
section _TEXT progbits vstart=0x1600 align=1 ; size=0x8740 class=CODE group=AUTO
...
_int13_cdemu:                                ; 0xf3e08 LB 0x434
    ...
    xor dl, dl                                ; 30 d2
    xor cx, cx                                ; 31 c9
    call 09c59h                               ; e8 ad 5c
    xor bx, bx                                ; 31 db
    add ax, si                                ; 01 f0
    adc dx, bx                                ; 11 da
    mov bx, di                                ; 89 fb
    xor cx, cx                                ; 31 c9
    call 09c59h                               ; e8 a0 5c
    mov bx, ax                                ; 89 c3
    mov ax, word [bp-010h]                    ; 8b 46 f0
    dec ax                                    ; 48
    xor cx, cx                                ; 31 c9
...
_int13_harddisk:                             ; 0xf557f LB 0x484
    ...
    mov bx, cx                                ; 89 cb
    xor cx, cx                                ; 31 c9
    call 09c59h                               ; e8 eb 44
    xor bx, bx                                ; 31 db
    add ax, word [bp-008h]                    ; 03 46 f8
    adc dx, bx                                ; 11 da
    mov bx, word [bp-00ch]                    ; 8b 5e f4
    xor cx, cx                                ; 31 c9
    call 09c59h                               ; e8 dc 44
    xor bx, bx                                ; 31 db
    ...
    xor cx, cx                                ; 31 c9
    call 09c59h                               ; e8 f9 42
    mov bx, word [bp-006h]                    ; 8b 5e fa
    xor cx, cx                                ; 31 c9
    call 09c59h                               ; e8 f1 42
    mov word [bp-010h], ax                    ; 89 46 f0
    mov word [bp-00eh], dx                    ; 89 56 f2
    mov word [bp+014h], dx                    ; 89 56 14
    mov word [bp+012h], ax                    ; 89 46 12
...
scsi_cmd_packet_:                            ; 0xf7d71 LB 0x222
    ...
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
scsi_enumerate_attached_devices_:            ; 0xf7f93 LB 0x516
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    jnc near 0849fh                           ; 0f 83 bf 04
    mov cx, strict word 00010h                ; b9 10 00
    xor bx, bx                                ; 31 db
    mov dx, ss                                ; 8c d2
    lea ax, [bp-056h]                         ; 8d 46 aa
    call 09c8ah                               ; e8 9d 1c
    mov byte [bp-056h], 09eh                  ; c6 46 aa 9e
    mov byte [bp-055h], 010h                  ; c6 46 ab 10
    push dword 000000020h                     ; 66 6a 20
    lea dx, [bp-00256h]                       ; 8d 96 aa fd
    push SS                                   ; 16
    push dx                                   ; 52
    push strict byte 00010h                   ; 6a 10
    movzx dx, byte [bp-022h]                  ; 0f b6 56 de
    mov cx, ss                                ; 8c d1
    lea bx, [bp-056h]                         ; 8d 5e aa
    ...
    mov dx, si                                ; 89 f2
    mov si, strict word 00020h                ; be 20 00
    call 09d30h                               ; e8 da 1c
    mov word [bp-012h], ax                    ; 89 46 ee
    mov word [bp-014h], bx                    ; 89 5e ec
    mov word [bp-046h], cx                    ; 89 4e ba
    ...
    mov si, strict word 00020h                ; be 20 00
    call 09d20h                               ; e8 ac 1c
    mov ax, dx                                ; 89 d0
    mov dx, cx                                ; 89 ca
    xchg ah, al                               ; 86 c4
    xchg dh, dl                               ; 86 d6
    xchg dx, ax                               ; 92
    or word [bp-038h], ax                     ; 09 46 c8
    or word [bp-046h], dx                     ; 09 56 ba
    mov ax, word [bp-012h]                    ; 8b 46 ee
    mov word [bp-024h], ax                    ; 89 46 dc
    mov ax, word [bp-014h]                    ; 8b 46 ec
    mov word [bp-026h], ax                    ; 89 46 da
    ...
    mov word [bp-028h], ax                    ; 89 46 d8
    movzx si, byte [bp-0024eh]                ; 0f b6 b6 b2 fd
    ...
    or ax, bx                                 ; 09 d8
    or dx, si                                 ; 09 f2
    movzx bx, byte [bp-0024bh]                ; 0f b6 9e b5 fd
    or ax, bx                                 ; 09 d8
    mov word [bp-02eh], ax                    ; 89 46 d2
    test dx, dx                               ; 85 d2
    jne short 080d3h                          ; 75 05
    cmp ax, 00200h                            ; 3d 00 02
    je short 080f3h                           ; 74 20
    mov bx, 01164h                            ; bb 64 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 03 98
    push dx                                   ; 52
    push word [bp-02eh]                       ; ff 76 d2
    push word [bp-022h]                       ; ff 76 de
    push 00e78h                               ; 68 78 0e
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 35 98
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 0842dh                           ; e9 3a 03
    mov es, [bp-020h]                         ; 8e 46 e0
    mov al, byte [es:di+0022ch]               ; 26 8a 85 2c 02
    mov byte [bp-00eh], al                    ; 88 46 f2
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 0810eh                           ; 72 0c
    jbe short 08116h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 0811eh                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 0811ah                           ; 74 0e
    jmp short 08167h                          ; eb 59
    test al, al                               ; 84 c0
    jne short 08167h                          ; 75 55
    mov BL, strict byte 090h                  ; b3 90
    jmp short 08120h                          ; eb 0a
    mov BL, strict byte 098h                  ; b3 98
    jmp short 08120h                          ; eb 06
    mov BL, strict byte 0a0h                  ; b3 a0
    jmp short 08120h                          ; eb 02
    mov BL, strict byte 0a8h                  ; b3 a8
    mov al, bl                                ; 88 d8
    add AL, strict byte 007h                  ; 04 07
    movzx cx, al                              ; 0f b6 c8
    mov ax, cx                                ; 89 c8
    call 0165ch                               ; e8 30 95
    test al, al                               ; 84 c0
    je short 08167h                           ; 74 37
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 23 95
    movzx dx, al                              ; 0f b6 d0
    sal dx, 008h                              ; c1 e2 08
    movzx ax, bl                              ; 0f b6 c3
    call 0165ch                               ; e8 17 95
    xor ah, ah                                ; 30 e4
    add ax, dx                                ; 01 d0
    cwd                                       ; 99
    mov si, ax                                ; 89 c6
    ...
    mov ax, word [bp-024h]                    ; 8b 46 dc
    test ax, ax                               ; 85 c0
    jnbe short 081a2h                         ; 77 16
    jne near 08215h                           ; 0f 85 85 00
    cmp word [bp-026h], strict byte 00000h    ; 83 7e da 00
    jnbe short 081a2h                         ; 77 0c
    jne near 08215h                           ; 0f 85 7b 00
    cmp word [bp-010h], strict byte 00040h    ; 83 7e f0 40
    jnbe short 081a2h                         ; 77 02
    jne short 08215h                          ; 75 73
    mov dword [bp-02ch], strict dword 000ff003fh ; 66 c7 46 d4 3f 00 ff 00
    mov bx, word [bp-026h]                    ; 8b 5e da
    mov cx, word [bp-010h]                    ; 8b 4e f0
    mov dx, word [bp-028h]                    ; 8b 56 d8
    mov si, strict word 00006h                ; be 06 00
    call 09d20h                               ; e8 67 1b
    ...
    cmp word [bp-010h], strict byte 00020h    ; 83 7e f0 20
    jnbe short 0822bh                         ; 77 02
    jne short 08235h                          ; 75 0a
    mov dword [bp-02ch], strict dword 000800020h ; 66 c7 46 d4 20 00 80 00
    jmp short 0824ch                          ; eb 17
    mov dword [bp-02ch], strict dword 000400020h ; 66 c7 46 d4 20 00 40 00
    mov bx, word [bp-026h]                    ; 8b 5e da
    mov cx, word [bp-010h]                    ; 8b 4e f0
    mov dx, word [bp-028h]                    ; 8b 56 d8
    mov si, strict word 0000bh                ; be 0b 00
    call 09d20h                               ; e8 d4 1a
    mov si, dx                                ; 89 d6
    mov dx, cx                                ; 89 ca
    mov al, byte [bp-00eh]                    ; 8a 46 f2
    ...
    test dx, dx                               ; 85 d2
    jne short 0830ch                          ; 75 06
    cmp si, 00400h                            ; 81 fe 00 04
    jbe short 08314h                          ; 76 08
    mov word [es:bx+032h], 00400h             ; 26 c7 47 32 00 04
    jmp short 08318h                          ; eb 04
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 99 92
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 99 92
    inc byte [bp-00eh]                        ; fe 46 f2
    mov al, byte [bp-00eh]                    ; 8a 46 f2
    mov es, [bp-020h]                         ; 8e 46 e0
    mov byte [es:di+0022ch], al               ; 26 88 85 2c 02
    jmp near 0842dh                           ; e9 a7 00
    mov bx, 01164h                            ; bb 64 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 50 95
    push word [bp-022h]                       ; ff 76 de
    movzx ax, byte [bp-00eh]                  ; 0f b6 46 f2
    push ax                                   ; 50
    push 00ed1h                               ; 68 d1 0e
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 81 95
    add sp, strict byte 00008h                ; 83 c4 08
    mov al, byte [bp-00eh]                    ; 8a 46 f2
    add AL, strict byte 008h                  ; 04 08
    mov byte [bp-00ch], al                    ; 88 46 f4
    test byte [bp-00255h], 080h               ; f6 86 ab fd 80
    db  00fh, 095h, 0c0h
    ; setne al                                  ; 0f 95 c0
    xor ah, ah                                ; 30 e4
    movzx bx, byte [bp-00eh]                  ; 0f b6 5e f2
    ...
    mov es, [bp-020h]                         ; 8e 46 e0
    add bx, di                                ; 01 fb
    mov dx, word [bp-00258h]                  ; 8b 96 a8 fd
    mov word [es:bx+0021ch], dx               ; 26 89 97 1c 02
    mov ah, byte [bp-022h]                    ; 8a 66 de
    ...
    inc byte [bp-00eh]                        ; fe 46 f2
    mov al, byte [bp-00eh]                    ; 8a 46 f2
    jmp near 0837eh                           ; e9 6d ff
    mov bx, 01164h                            ; bb 64 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 c5 94
    push word [bp-022h]                       ; ff 76 de
    push 00e07h                               ; 68 07 0e
    push 00eech                               ; 68 ec 0e
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 f8 94
    add sp, strict byte 00008h                ; 83 c4 08
    inc word [bp-022h]                        ; ff 46 de
    cmp word [bp-022h], strict byte 00010h    ; 83 7e de 10
    jnl short 0849fh                          ; 7d 69
    mov byte [bp-056h], 012h                  ; c6 46 aa 12
    xor al, al                                ; 30 c0
    mov byte [bp-055h], al                    ; 88 46 ab
    mov byte [bp-054h], al                    ; 88 46 ac
    mov byte [bp-053h], al                    ; 88 46 ad
    mov byte [bp-052h], 005h                  ; c6 46 ae 05
    ...
    lea bx, [bp-056h]                         ; 8d 5e aa
    mov ax, word [bp-00258h]                  ; 8b 86 a8 fd
    call 0785bh                               ; e8 f4 f3
    test al, al                               ; 84 c0
    je short 08479h                           ; 74 0e
    push 00e07h                               ; 68 07 0e
    push 00e27h                               ; 68 27 0e
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 ac 94
    add sp, strict byte 00006h                ; 83 c4 06
    test byte [bp-00256h], 0e0h               ; f6 86 aa fd e0
    jne short 08489h                          ; 75 09
    test byte [bp-00256h], 01fh               ; f6 86 aa fd 1f
    je near 07fb7h                            ; 0f 84 2e fb
    test byte [bp-00256h], 0e0h               ; f6 86 aa fd e0
    jne short 08411h                          ; 75 81
    mov al, byte [bp-00256h]                  ; 8a 86 aa fd
    and AL, strict byte 01fh                  ; 24 1f
    cmp AL, strict byte 005h                  ; 3c 05
    je near 08386h                            ; 0f 84 ea fe
    jmp near 08411h                           ; e9 72 ff
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop dx                                    ; 5a
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_scsi_init:                                  ; 0xf84a9 LB 0xf0
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 67 91
    ...
    jne short 084f1h                          ; 75 24
    mov bx, 01164h                            ; bb 64 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 09 94
    push 00f14h                               ; 68 14 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 42 94
    add sp, strict byte 00004h                ; 83 c4 04
    xor al, al                                ; 30 c0
    mov dx, 00433h                            ; ba 33 04
    out DX, AL                                ; ee
    mov ax, 00430h                            ; b8 30 04
    call 07f93h                               ; e8 a4 fa
    jmp short 08507h                          ; eb 16
    mov bx, 01164h                            ; bb 64 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 e5 93
    push 00f3fh                               ; 68 3f 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 1e 94
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 055h                  ; b0 55
    ...
    ; sub ah, ah                                ; 2a e4
    cmp AL, strict byte 055h                  ; 3c 55
    jne short 08538h                          ; 75 24
    mov bx, 01164h                            ; bb 64 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 c2 93
    push 00f6eh                               ; 68 6e 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 fb 93
    add sp, strict byte 00004h                ; 83 c4 04
    xor al, al                                ; 30 c0
    mov dx, 00437h                            ; ba 37 04
    out DX, AL                                ; ee
    mov ax, 00434h                            ; b8 34 04
    call 07f93h                               ; e8 5d fa
    jmp short 0854eh                          ; eb 16
    mov bx, 01164h                            ; bb 64 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 9e 93
    push 00f9ah                               ; 68 9a 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 d7 93
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 055h                  ; b0 55
    ...
    ; sub ah, ah                                ; 2a e4
    cmp AL, strict byte 055h                  ; 3c 55
    jne short 0857fh                          ; 75 24
    mov bx, 01164h                            ; bb 64 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 7b 93
    push 00fcah                               ; 68 ca 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 b4 93
    add sp, strict byte 00004h                ; 83 c4 04
    xor al, al                                ; 30 c0
    mov dx, 0043bh                            ; ba 3b 04
    out DX, AL                                ; ee
    mov ax, 00438h                            ; b8 38 04
    call 07f93h                               ; e8 16 fa
    jmp short 08595h                          ; eb 16
    mov bx, 01164h                            ; bb 64 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 57 93
    push 00ff5h                               ; 68 f5 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 90 93
    add sp, strict byte 00004h                ; 83 c4 04
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
high_bits_save_:                             ; 0xf8599 LB 0x17
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
high_bits_restore_:                          ; 0xf85b0 LB 0x17
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_set_bits_:                         ; 0xf85c7 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_clear_bits_:                       ; 0xf860a LB 0x47
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_is_bit_set_:                       ; 0xf8651 LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xchg dx, ax                               ; 92
    test dx, di                               ; 85 fa
    jne short 0867dh                          ; 75 04
    test ax, bx                               ; 85 d8
    je short 08681h                           ; 74 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 08683h                          ; eb 02
    xor al, al                                ; 30 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_extract_bits_:                     ; 0xf868a LB 0x1b
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov si, bx                                ; 89 de
    ...
    pop si                                    ; 5e
    retn 00002h                               ; c2 02 00
ahci_addr_to_phys_:                          ; 0xf86a5 LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
ahci_port_cmd_sync_:                         ; 0xf86c3 LB 0xd5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov dx, si                                ; 89 f2
    mov ax, di                                ; 89 f8
    call 08651h                               ; e8 e2 fe
    test al, al                               ; 84 c0
    je short 08752h                           ; 74 df
    mov bx, strict word 00001h                ; bb 01 00
    xor cx, cx                                ; 31 c9
    mov dx, si                                ; 89 f2
    mov ax, di                                ; 89 f8
    call 085c7h                               ; e8 48 fe
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    add dx, 00118h                            ; 81 c2 18 01
    mov bx, strict word 00001h                ; bb 01 00
    xor cx, cx                                ; 31 c9
    mov ax, di                                ; 89 f8
    call 0860ah                               ; e8 7a fe
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop cx                                    ; 59
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_cmd_data_:                              ; 0xf8798 LB 0x24b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_deinit_current_:                   ; 0xf89e3 LB 0x144
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_init_:                             ; 0xf8b27 LB 0x206
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, 0c011h                            ; bb 11 c0
    xor cx, cx                                ; 31 c9
    call 08651h                               ; e8 e1 fa
    cmp AL, strict byte 001h                  ; 3c 01
    je short 08b55h                           ; 74 e1
    mov cx, strict word 00020h                ; b9 20 00
    xor bx, bx                                ; 31 db
    mov ax, si                                ; 89 f0
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09c8ah                               ; e8 09 11
    lea ax, [si+00080h]                       ; 8d 84 80 00
    mov cx, strict word 00040h                ; b9 40 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09c8ah                               ; e8 fa 10
    mov ax, si                                ; 89 f0
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@ahci_read_sectors:                          ; 0xf8d2d LB 0x94
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ax, ax                                ; 31 c0
    call 08b27h                               ; e8 b1 fd
    mov bx, strict word 00025h                ; bb 25 00
    mov ax, di                                ; 89 f8
    mov dx, word [bp+006h]                    ; 8b 56 06
    call 08798h                               ; e8 17 fa
    mov es, [bp+006h]                         ; 8e 46 06
    mov bx, di                                ; 89 fb
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@ahci_write_sectors:                         ; 0xf8dc1 LB 0x70
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    mov si, word [bp+004h]                    ; 8b 76 04
...
ahci_cmd_packet_:                            ; 0xf8e31 LB 0x17c
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 d0 87
    mov si, 00122h                            ; be 22 01
    mov word [bp-008h], ax                    ; 89 46 f8
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 08e77h                          ; 75 1f
    mov bx, 01164h                            ; bb 64 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 7e 8a
    push 01068h                               ; 68 68 10
    push 01078h                               ; 68 78 10
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 b4 8a
    add sp, strict byte 00006h                ; 83 c4 06
    mov ax, strict word 00001h                ; b8 01 00
    jmp near 08fa4h                           ; e9 2d 01
    test byte [bp+004h], 001h                 ; f6 46 04 01
    jne short 08e71h                          ; 75 f4
    mov ax, word [bp+006h]                    ; 8b 46 06
    ...
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    call 085b0h                               ; e8 20 f6
    les bx, [bp-00eh]                         ; c4 5e f2
    mov ax, word [es:bx+006h]                 ; 26 8b 47 06
    or ax, word [es:bx+004h]                  ; 26 0b 47 04
    jne short 08fa2h                          ; 75 05
    mov ax, strict word 00004h                ; b8 04 00
    jmp short 08fa4h                          ; eb 02
    xor ax, ax                                ; 31 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
ahci_port_detect_device_:                    ; 0xf8fad LB 0x46c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, di                                ; 89 fb
    call 08b27h                               ; e8 60 fb
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 4c 86
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 0868ah                               ; e8 10 f6
    test ax, ax                               ; 85 c0
    je near 09411h                            ; 0f 84 91 03
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    sal ax, 007h                              ; c1 e0 07
    mov word [bp-016h], ax                    ; 89 46 ea
    add ax, 00128h                            ; 05 28 01
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 0868ah                               ; e8 c4 f5
    cmp ax, strict word 00001h                ; 3d 01 00
    je short 09080h                           ; 74 b5
    push strict byte 00000h                   ; 6a 00
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    mov ax, word [bp-01eh]                    ; 8b 46 e2
    mov dx, di                                ; 89 fa
    call 0868ah                               ; e8 b0 f5
    cmp ax, strict word 00003h                ; 3d 03 00
    jne near 09411h                           ; 0f 85 30 03
    mov ax, word [bp-016h]                    ; 8b 46 ea
    ...
    test dx, dx                               ; 85 d2
    jne near 09364h                           ; 0f 85 ea 01
    cmp ax, 00101h                            ; 3d 01 01
    jne near 09364h                           ; 0f 85 e3 01
    les bx, [bp-010h]                         ; c4 5e f0
    ...
    jne short 091f8h                          ; 75 10
    cmp dx, strict byte 0ffffh                ; 83 fa ff
    jne short 091f8h                          ; 75 0b
    ...
    mov al, byte [bp-008h]                    ; 8a 46 f8
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 0926ch                           ; 72 0c
    jbe short 09274h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 0927ch                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 09278h                           ; 74 0e
    jmp short 092c5h                          ; eb 59
    test al, al                               ; 84 c0
    jne short 092c5h                          ; 75 55
    mov DL, strict byte 040h                  ; b2 40
    jmp short 0927eh                          ; eb 0a
    mov DL, strict byte 048h                  ; b2 48
    jmp short 0927eh                          ; eb 06
    mov DL, strict byte 050h                  ; b2 50
    jmp short 0927eh                          ; eb 02
    mov DL, strict byte 058h                  ; b2 58
    mov al, dl                                ; 88 d0
    add AL, strict byte 007h                  ; 04 07
    movzx bx, al                              ; 0f b6 d8
    mov ax, bx                                ; 89 d8
    call 0165ch                               ; e8 d2 83
    test al, al                               ; 84 c0
    je short 092c5h                           ; 74 37
    mov al, dl                                ; 88 d0
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 c5 83
    xor ah, ah                                ; 30 e4
    mov si, ax                                ; 89 c6
    sal si, 008h                              ; c1 e6 08
    movzx ax, dl                              ; 0f b6 c2
    call 0165ch                               ; e8 b8 83
    xor ah, ah                                ; 30 e4
    add ax, si                                ; 01 f0
    mov word [bp-024h], ax                    ; 89 46 dc
    mov al, dl                                ; 88 d0
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 a8 83
    xor ah, ah                                ; 30 e4
    mov word [bp-026h], ax                    ; 89 46 da
    mov ax, bx                                ; 89 d8
    call 0165ch                               ; e8 9e 83
    xor ah, ah                                ; 30 e4
    mov word [bp-022h], ax                    ; 89 46 de
    jmp short 092d2h                          ; eb 0d
    mov bx, word [bp-014h]                    ; 8b 5e ec
    mov cx, di                                ; 89 f9
    mov dx, ss                                ; 8c d2
    lea ax, [bp-026h]                         ; 8d 46 da
    call 054e1h                               ; e8 0f c2
    mov bx, 01164h                            ; bb 64 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 04 86
    push di                                   ; 57
    push word [bp-014h]                       ; ff 76 ec
    mov ax, word [bp-022h]                    ; 8b 46 de
    push ax                                   ; 50
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 ad 82
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 ad 82
    jmp near 09403h                           ; e9 9f 00
    cmp dx, 0eb14h                            ; 81 fa 14 eb
    jne near 09403h                           ; 0f 85 97 00
    cmp ax, 00101h                            ; 3d 01 01
    jne near 09403h                           ; 0f 85 90 00
    les bx, [bp-010h]                         ; c4 5e f0
    db  066h, 026h, 0c7h, 047h, 004h, 000h, 000h, 000h, 000h
    ; mov dword [es:bx+004h], strict dword 000000000h ; 66 26 c7 47 04 00 00 00 00
    db  066h, 026h, 0c7h, 007h, 000h, 000h, 000h, 000h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_mem_alloc_:                             ; 0xf9419 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 0161ch                               ; e8 f3 81
    test ax, ax                               ; 85 c0
    je short 09452h                           ; 74 25
    dec ax                                    ; 48
    mov bx, ax                                ; 89 c3
    xor dx, dx                                ; 31 d2
    mov cx, strict word 0000ah                ; b9 0a 00
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_hba_init_:                              ; 0xf945c LB 0x125
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    shr eax, 010h                             ; 66 c1 e8 10
    xchg dx, ax                               ; 92
    call 09419h                               ; e8 82 ff
    mov di, ax                                ; 89 c7
    test ax, ax                               ; 85 c0
    je near 09560h                            ; 0f 84 c1 00
    mov es, [bp-010h]                         ; 8e 46 f0
    ...
    xor cx, cx                                ; 31 c9
    call 0868ah                               ; e8 71 f1
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    mov byte [bp-00eh], al                    ; 88 46 f2
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    jmp short 0952dh                          ; eb 09
    inc byte [bp-00ch]                        ; fe 46 f4
    cmp byte [bp-00ch], 020h                  ; 80 7e f4 20
    jnc short 0955eh                          ; 73 31
    movzx cx, byte [bp-00ch]                  ; 0f b6 4e f4
    mov ax, strict word 00001h                ; b8 01 00
    xor dx, dx                                ; 31 d2
    jcxz 0953eh                               ; e3 06
    ...
    mov dx, strict word 0000ch                ; ba 0c 00
    mov ax, si                                ; 89 f0
    call 08651h                               ; e8 07 f1
    test al, al                               ; 84 c0
    je short 09524h                           ; 74 d6
    movzx bx, byte [bp-00ch]                  ; 0f b6 5e f4
    xor ax, ax                                ; 31 c0
    mov dx, di                                ; 89 fa
    call 08fadh                               ; e8 54 fa
    dec byte [bp-00eh]                        ; fe 4e f2
    jne short 09524h                          ; 75 c6
    xor ax, ax                                ; 31 c0
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    db  00bh, 005h, 004h, 003h, 002h, 001h, 000h, 050h, 096h, 02eh, 096h, 034h, 096h, 03ah, 096h, 040h
    db  096h, 046h, 096h, 04ch, 096h, 050h, 096h
_ahci_init:                                  ; 0xf9581 LB 0xfe
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00001h                ; ba 01 00
    call 09a9fh                               ; e8 0d 05
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 0ffffh                ; 3d ff ff
    je near 09678h                            ; 0f 84 dd 00
    xor al, al                                ; 30 c0
    shr ax, 008h                              ; c1 e8 08
    mov byte [bp-00ah], al                    ; 88 46 f6
    mov byte [bp-008h], dl                    ; 88 56 f8
    ...
    xor ah, ah                                ; 30 e4
    mov bx, strict word 00034h                ; bb 34 00
    call 09acah                               ; e8 1a 05
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    je short 095d9h                           ; 74 23
    movzx bx, cl                              ; 0f b6 d9
    movzx di, byte [bp-008h]                  ; 0f b6 7e f8
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 09acah                               ; e8 02 05
    cmp AL, strict byte 012h                  ; 3c 12
    je short 095d9h                           ; 74 0d
    mov al, cl                                ; 88 c8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    jmp short 095adh                          ; eb d4
    test cl, cl                               ; 84 c9
    je near 09678h                            ; 0f 84 99 00
    ...
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 09acah                               ; e8 d6 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne near 09678h                           ; 0f 85 7e 00
    mov byte [bp-006h], 000h                  ; c6 46 fa 00
    mov al, cl                                ; 88 c8
    add AL, strict byte 002h                  ; 04 02
    movzx bx, al                              ; 0f b6 d8
    ...
    mov al, byte [bp-006h]                    ; 8a 46 fa
    test al, al                               ; 84 c0
    je short 09678h                           ; 74 19
    movzx bx, al                              ; 0f b6 d8
    movzx dx, byte [bp-008h]                  ; 0f b6 56 f8
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    call 09b10h                               ; e8 a3 04
    test AL, strict byte 001h                 ; a8 01
    je short 09678h                           ; 74 07
    and AL, strict byte 0f0h                  ; 24 f0
    add ax, si                                ; 01 f0
    call 0945ch                               ; e8 e4 fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
apm_out_str_:                                ; 0xf967f LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    cmp byte [bx], 000h                       ; 80 3f 00
    je short 09694h                           ; 74 0a
    ...
    db  00ah, 0c0h
    ; or al, al                                 ; 0a c0
    jne short 0968ch                          ; 75 f8
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
    fist dword [bp-06859h]                    ; db 96 a7 97
    in ax, DX                                 ; ed
    xchg si, ax                               ; 96
    or byte [bx-06859h], dl                   ; 08 97 a7 97
    xor dx, word [bx-06859h]                  ; 33 97 a7 97
    cmp byte [bx-06884h], dl                  ; 38 97 7c 97
    jl short 09645h                           ; 7c 97
    jl short 09647h                           ; 7c 97
    jnbe short 09649h                         ; 77 97
    jl short 0964bh                           ; 7c 97
    jl short 0964dh                           ; 7c 97
    jo short 0964fh                           ; 70 97
_apm_function:                               ; 0xf96b8 LB 0xf5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    ...
    jnbe near 0977ch                          ; 0f 87 b0 00
    mov bx, ax                                ; 89 c3
    add bx, ax                                ; 01 c3
    mov dx, word [bp+018h]                    ; 8b 56 18
    or dl, 001h                               ; 80 ca 01
    jmp word [cs:bx-06966h]                   ; 2e ff a7 9a 96
    ...
    jmp near 097a7h                           ; e9 74 00
    sti                                       ; fb
    hlt                                       ; f4
    jmp near 097a7h                           ; e9 6f 00
    cmp word [bp+010h], strict byte 00003h    ; 83 7e 10 03
    je short 0975dh                           ; 74 1f
    cmp word [bp+010h], strict byte 00002h    ; 83 7e 10 02
    je short 09755h                           ; 74 11
    cmp word [bp+010h], strict byte 00001h    ; 83 7e 10 01
    jne short 09765h                          ; 75 1b
    mov dx, 08900h                            ; ba 00 89
    mov ax, 010d0h                            ; b8 d0 10
    call 0967fh                               ; e8 2c ff
    jmp short 097a7h                          ; eb 52
    mov dx, 08900h                            ; ba 00 89
    mov ax, 010d8h                            ; b8 d8 10
    jmp short 09750h                          ; eb f3
    mov dx, 08900h                            ; ba 00 89
    mov ax, 010e0h                            ; b8 e0 10
    jmp short 09750h                          ; eb eb
    or ah, 00ah                               ; 80 cc 0a
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 097a7h                          ; eb 37
    mov word [bp+012h], 00102h                ; c7 46 12 02 01
    jmp short 097a7h                          ; eb 30
    or ah, 080h                               ; 80 cc 80
    jmp short 09768h                          ; eb ec
    mov bx, 01164h                            ; bb 64 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 5a 81
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 010e9h                               ; 68 e9 10
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 8d 81
    add sp, strict byte 00008h                ; 83 c4 08
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_select_reg_:                           ; 0xf97ad LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_find_device_:                          ; 0xf97d1 LB 0xf7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 09819h                          ; 75 2d
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, bx                                ; 89 d8
    call 097adh                               ; e8 b9 ff
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 09807h                          ; 75 06
    add bx, strict byte 00008h                ; 83 c3 08
    jmp near 0989ah                           ; e9 93 00
    test byte [bp-006h], 080h                 ; f6 46 fa 80
    je short 09814h                           ; 74 07
    mov word [bp-00ah], strict word 00001h    ; c7 46 f6 01 00
    jmp short 09819h                          ; eb 05
    mov word [bp-00ah], strict word 00008h    ; c7 46 f6 08 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 007h                  ; 24 07
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 09841h                          ; 75 1f
    mov ax, bx                                ; 89 d8
    shr ax, 008h                              ; c1 e8 08
    test ax, ax                               ; 85 c0
    jne short 09841h                          ; 75 16
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, bx                                ; 89 d8
    call 097adh                               ; e8 7a ff
    mov dx, 00cfeh                            ; ba fe 0c
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp al, byte [bp-008h]                    ; 3a 46 f8
    jbe short 09841h                          ; 76 03
    mov byte [bp-008h], al                    ; 88 46 f8
    test di, di                               ; 85 ff
    je short 0984ah                           ; 74 05
    mov dx, strict word 00008h                ; ba 08 00
    jmp short 0984ch                          ; eb 02
    xor dx, dx                                ; 31 d2
    mov ax, bx                                ; 89 d8
    call 097adh                               ; e8 5c ff
    ...
    jne short 0988bh                          ; 75 08
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    cmp ax, word [bp-012h]                    ; 3b 46 ee
    je short 09891h                           ; 74 06
    cmp word [bp-010h], strict byte 00000h    ; 83 7e f0 00
    je short 09897h                           ; 74 06
    dec si                                    ; 4e
    cmp si, strict byte 0ffffh                ; 83 fe ff
    je short 098a9h                           ; 74 12
    add bx, word [bp-00ah]                    ; 03 5e f6
    mov dx, bx                                ; 89 da
    shr dx, 008h                              ; c1 ea 08
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    cmp dx, ax                                ; 39 c2
    jbe near 097e7h                           ; 0f 86 3e ff
    cmp si, strict byte 0ffffh                ; 83 fe ff
    jne short 098b2h                          ; 75 04
    mov ax, bx                                ; 89 d8
    jmp short 098b5h                          ; eb 03
    mov ax, strict word 0ffffh                ; b8 ff ff
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    stosb                                     ; aa
    cwd                                       ; 99
    les bx, [bx+di-06629h]                    ; c4 99 d7 99
    in AL, DX                                 ; ec
    cwd                                       ; 99
    call far [bx+di-065eeh]                   ; ff 99 12 9a
_pci16_function:                             ; 0xf98c8 LB 0x1d7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ah, ah                                ; 30 e4
    cmp bx, strict byte 00003h                ; 83 fb 03
    jc short 09901h                           ; 72 1a
    jbe short 09959h                          ; 76 70
    cmp bx, strict byte 0000eh                ; 83 fb 0e
    je near 09a26h                            ; 0f 84 36 01
    cmp bx, strict byte 00008h                ; 83 fb 08
    jc near 09a6bh                            ; 0f 82 74 01
    cmp bx, strict byte 0000dh                ; 83 fb 0d
    jbe near 0997eh                           ; 0f 86 80 00
    jmp near 09a6bh                           ; e9 6a 01
    cmp bx, strict byte 00002h                ; 83 fb 02
    je short 09929h                           ; 74 23
    cmp bx, strict byte 00001h                ; 83 fb 01
    jne near 09a6bh                           ; 0f 85 5e 01
    ...
    jmp near 09a98h                           ; e9 6f 01
    cmp word [bp+018h], strict byte 0ffffh    ; 83 7e 18 ff
    jne short 09935h                          ; 75 06
    or ah, 083h                               ; 80 cc 83
    jmp near 09a91h                           ; e9 5c 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov dx, word [bp+01ch]                    ; 8b 56 1c
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor cx, cx                                ; 31 c9
    call 097d1h                               ; e8 8e fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09953h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09a91h                           ; e9 3e 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09a98h                           ; e9 3f 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    mov dx, word [bp+01eh]                    ; 8b 56 1e
    mov cx, strict word 00001h                ; b9 01 00
    call 097d1h                               ; e8 69 fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09978h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09a91h                           ; e9 19 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09a98h                           ; e9 1a 01
    cmp word [bp+004h], 00100h                ; 81 7e 04 00 01
    jc short 0998bh                           ; 72 06
    or ah, 087h                               ; 80 cc 87
    jmp near 09a91h                           ; e9 06 01
    mov dx, word [bp+004h]                    ; 8b 56 04
    mov ax, word [bp+014h]                    ; 8b 46 14
    call 097adh                               ; e8 19 fe
    mov bx, word [bp+020h]                    ; 8b 5e 20
    xor bh, bh                                ; 30 ff
    sub bx, strict byte 00008h                ; 83 eb 08
    cmp bx, strict byte 00005h                ; 83 fb 05
    jnbe near 09a98h                          ; 0f 87 f5 00
    add bx, bx                                ; 01 db
    jmp word [cs:bx-06744h]                   ; 2e ff a7 bc 98
    ...
    mov word [es:bx], ax                      ; 26 89 07
    jmp short 09a98h                          ; eb 2d
    mov bx, 01164h                            ; bb 64 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 6b 7e
    mov ax, word [bp+014h]                    ; 8b 46 14
    push ax                                   ; 50
    mov ax, word [bp+020h]                    ; 8b 46 20
    push ax                                   ; 50
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_find_classcode_:                         ; 0xf9a9f LB 0x2b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_byte_:                       ; 0xf9aca LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_word_:                       ; 0xf9aee LB 0x22
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_dword_:                      ; 0xf9b10 LB 0x27
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
vds_is_present_:                             ; 0xf9b37 LB 0x1d
    push bx                                   ; 53
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_real_to_lin_:                            ; 0xf9b54 LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_build_sg_list_:                          ; 0xf9b72 LB 0x79
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    call 09b37h                               ; e8 93 ff
    test ax, ax                               ; 85 c0
    je short 09bbbh                           ; 74 13
    mov es, si                                ; 8e c6
    mov ax, 08105h                            ; b8 05 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 09bb8h                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    jmp short 09be2h                          ; eb 27
    mov es, si                                ; 8e c6
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
vds_free_sg_list_:                           ; 0xf9beb LB 0x35
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push di                                   ; 57
    mov bx, ax                                ; 89 c3
    call 09b37h                               ; e8 42 ff
    test ax, ax                               ; 85 c0
    je short 09c0ch                           ; 74 13
    mov di, bx                                ; 89 df
    mov es, dx                                ; 8e c2
    mov ax, 08106h                            ; b8 06 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 09c0bh                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    mov es, dx                                ; 8e c2
...
_fmemcpy_:                                   ; 0xf9c97 LB 0x33
    ...
    pushfw                                    ; 9c
    loop 09c50h                               ; e2 9c
    out strict byte 09ch, AL                  ; e6 9c
    out strict byte 09ch, AL                  ; e6 9c
    out strict byte 09ch, AL                  ; e6 9c
    call 08559h                               ; e8 9c e8
    pushfw                                    ; 9c
    jmp far 0ee9ch:0ee9ch                     ; ea 9c ee 9c ee
    pushfw                                    ; 9c
    db 0f0h, 09ch
    cmc                                       ; f5
    pushfw                                    ; 9c
...
apm_worker:                                  ; 0xf9cca LB 0x3a
    ...
    jnc short 09d00h                          ; 73 25
    jmp word [cs:bp-06350h]                   ; 2e ff a6 b0 9c
    jmp short 09cfeh                          ; eb 1c
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 09cfeh                          ; eb 18
    jmp short 09cfeh                          ; eb 16
    jmp short 09d00h                          ; eb 16
    mov AH, strict byte 080h                  ; b4 80
    jmp short 09d02h                          ; eb 14
    jmp short 09d00h                          ; eb 10
    mov ax, 00102h                            ; b8 02 01
    jmp short 09cfeh                          ; eb 09
    jmp short 09cfeh                          ; eb 07
    mov BL, strict byte 000h                  ; b3 00
    mov cx, strict word 00000h                ; b9 00 00
    jmp short 09cfeh                          ; eb 00
    clc                                       ; f8
    retn                                      ; c3
    mov AH, strict byte 009h                  ; b4 09
    stc                                       ; f9
    retn                                      ; c3
apm_pm16_entry:                              ; 0xf9d04 LB 0x1c
    ...
    mov ds, bp                                ; 8e dd
    call 09ccah                               ; e8 b8 ff
    pop bp                                    ; 5d
    pop DS                                    ; 1f
    retf                                      ; cb
    times 0xb db 0
__U8RS:                                      ; 0xf9d20 LB 0x10
    test si, si                               ; 85 f6
    je short 09d2fh                           ; 74 0b
    shr ax, 1                                 ; d1 e8
    rcr bx, 1                                 ; d1 db
    rcr cx, 1                                 ; d1 d9
    rcr dx, 1                                 ; d1 da
    dec si                                    ; 4e
    jne short 09d24h                          ; 75 f5
    retn                                      ; c3
__I8LS:                                      ; 0xf9d30 LB 0x10
    test si, si                               ; 85 f6
    je short 09d3fh                           ; 74 0b
    sal dx, 1                                 ; d1 e2
    rcl cx, 1                                 ; d1 d1
    rcl bx, 1                                 ; d1 d3
    rcl ax, 1                                 ; d1 d0
    dec si                                    ; 4e
    jne short 09d34h                          ; 75 f5
    retn                                      ; c3

  ; Padding 0x3cc0 bytes at 0xf9d40
  times 15552 db 0
...
hard_drive_post:                             ; 0xfe2d2 LB 0x12c
    ...
    call 09581h                               ; e8 5a b2
    call 084a9h                               ; e8 7f a1
...
font8x8:                                     ; 0xffa6e LB 0x421
    ...
    db  080h, 0fch, 0b1h, 075h, 00fh, 006h, 01eh, 00eh, 01fh, 0fch, 066h, 060h, 0e8h, 04bh, 09ah, 066h
