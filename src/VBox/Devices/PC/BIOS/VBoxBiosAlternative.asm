...
_pktacc:                                     ; 0xf006a LB 0xc
    db  000h, 000h, 000h, 000h, 000h, 000h, 0f2h, 029h, 071h, 07dh, 01ah, 08fh
...
_dskacc:                                     ; 0xf0082 LB 0x2e
    ...
    db  055h, 07ah, 0e3h, 07bh, 016h, 08eh, 0aah, 08eh, 000h, 000h, 000h, 000h, 000h, 000h, 05fh, 033h
...
scsi_cmd_packet_:                            ; 0xf7d71 LB 0x222
    ...
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
scsi_enumerate_attached_devices_:            ; 0xf7f93 LB 0x5ff
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    jnc near 08588h                           ; 0f 83 a8 05
    mov cx, strict word 00010h                ; b9 10 00
    xor bx, bx                                ; 31 db
    mov dx, ss                                ; 8c d2
    lea ax, [bp-04eh]                         ; 8d 46 b2
    call 09d7ah                               ; e8 8d 1d
    mov byte [bp-04eh], 09eh                  ; c6 46 b2 9e
    mov byte [bp-04dh], 010h                  ; c6 46 b3 10
    push dword 000000020h                     ; 66 6a 20
    lea dx, [bp-0024eh]                       ; 8d 96 b2 fd
    push SS                                   ; 16
    push dx                                   ; 52
    push strict byte 00010h                   ; 6a 10
    movzx dx, byte [bp-010h]                  ; 0f b6 56 f0
    mov cx, ss                                ; 8c d1
    lea bx, [bp-04eh]                         ; 8d 5e b2
    mov ax, word [bp-00250h]                  ; 8b 86 b0 fd
    call 0785bh                               ; e8 4b f8
    test al, al                               ; 84 c0
    je short 08022h                           ; 74 0e
    push 00e07h                               ; 68 07 0e
    push 00e59h                               ; 68 59 0e
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 03 99
    add sp, strict byte 00006h                ; 83 c4 06
    ...
    or dx, ax                                 ; 09 c2
    mov word [bp-020h], dx                    ; 89 56 e0
    movzx dx, byte [bp-00249h]                ; 0f b6 96 b7 fd
    xor ax, ax                                ; 31 c0
    xor bx, bx                                ; 31 db
    xor cx, cx                                ; 31 c9
    mov si, strict word 00010h                ; be 10 00
    call 09e20h                               ; e8 0c 1d
    mov si, word [bp-03eh]                    ; 8b 76 c2
    or si, dx                                 ; 09 d6
    mov word [bp-034h], si                    ; 89 76 cc
    mov dx, word [bp-022h]                    ; 8b 56 de
    or dx, cx                                 ; 09 ca
    mov word [bp-022h], dx                    ; 89 56 de
    mov dx, word [bp-03ah]                    ; 8b 56 c6
    ...
    or dx, ax                                 ; 09 c2
    mov word [bp-020h], dx                    ; 89 56 e0
    movzx dx, byte [bp-00248h]                ; 0f b6 96 b8 fd
    xor ax, ax                                ; 31 c0
    xor bx, bx                                ; 31 db
    xor cx, cx                                ; 31 c9
    mov si, strict word 00008h                ; be 08 00
    call 09e20h                               ; e8 db 1c
    or dx, word [bp-034h]                     ; 0b 56 cc
    or cx, word [bp-022h]                     ; 0b 4e de
    or bx, word [bp-03ah]                     ; 0b 5e c6
    ...
    sal ax, 008h                              ; c1 e0 08
    movzx si, byte [bp-00245h]                ; 0f b6 b6 bb fd
    xor bx, bx                                ; 31 db
    or si, ax                                 ; 09 c6
    movzx ax, byte [bp-00244h]                ; 0f b6 86 bc fd
    xor dx, dx                                ; 31 d2
    mov cx, strict word 00008h                ; b9 08 00
    sal ax, 1                                 ; d1 e0
    rcl dx, 1                                 ; d1 d2
    ...
    or ax, bx                                 ; 09 d8
    or dx, si                                 ; 09 f2
    movzx bx, byte [bp-00243h]                ; 0f b6 9e bd fd
    or ax, bx                                 ; 09 d8
    mov word [bp-01ah], ax                    ; 89 46 e6
    test dx, dx                               ; 85 d2
    jne short 0819eh                          ; 75 05
    cmp ax, 00200h                            ; 3d 00 02
    je short 081beh                           ; 74 20
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 38 97
    push dx                                   ; 52
    push word [bp-01ah]                       ; ff 76 e6
    push word [bp-010h]                       ; ff 76 f0
    ...
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 08516h                           ; e9 58 03
    mov es, [bp-018h]                         ; 8e 46 e8
    mov al, byte [es:di+0022ch]               ; 26 8a 85 2c 02
    mov byte [bp-00ch], al                    ; 88 46 f4
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 081d9h                           ; 72 0c
    jbe short 081e1h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 081e9h                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 081e5h                           ; 74 0e
    jmp short 08236h                          ; eb 5d
    test al, al                               ; 84 c0
    jne short 08236h                          ; 75 59
    mov BL, strict byte 090h                  ; b3 90
    jmp short 081ebh                          ; eb 0a
    mov BL, strict byte 098h                  ; b3 98
    jmp short 081ebh                          ; eb 06
    mov BL, strict byte 0a0h                  ; b3 a0
    jmp short 081ebh                          ; eb 02
    mov BL, strict byte 0a8h                  ; b3 a8
    mov al, bl                                ; 88 d8
    add AL, strict byte 007h                  ; 04 07
    movzx cx, al                              ; 0f b6 c8
    mov ax, cx                                ; 89 c8
    call 0165ch                               ; e8 65 94
    test al, al                               ; 84 c0
    je short 08236h                           ; 74 3b
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 58 94
    movzx dx, al                              ; 0f b6 d0
    sal dx, 008h                              ; c1 e2 08
    movzx ax, bl                              ; 0f b6 c3
    call 0165ch                               ; e8 4c 94
    xor ah, ah                                ; 30 e4
    add ax, dx                                ; 01 d0
    cwd                                       ; 99
    mov word [bp-02ah], ax                    ; 89 46 d6
    ...
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 38 94
    xor ah, ah                                ; 30 e4
    mov word [bp-014h], ax                    ; 89 46 ec
    mov ax, cx                                ; 89 c8
    call 0165ch                               ; e8 2e 94
    xor ah, ah                                ; 30 e4
    mov word [bp-012h], ax                    ; 89 46 ee
    jmp near 0831bh                           ; e9 e5 00
    mov ax, word [bp-024h]                    ; 8b 46 dc
    mov bx, word [bp-026h]                    ; 8b 5e da
    mov cx, word [bp-01eh]                    ; 8b 4e e2
    mov dx, word [bp-028h]                    ; 8b 56 d8
    mov si, strict word 0000ch                ; be 0c 00
    call 09e10h                               ; e8 c8 1b
    mov word [bp-030h], ax                    ; 89 46 d0
    ...
    mov ax, word [bp-024h]                    ; 8b 46 dc
    test ax, ax                               ; 85 c0
    jnbe short 0826fh                         ; 77 14
    jne near 082deh                           ; 0f 85 7f 00
    cmp word [bp-026h], strict byte 00000h    ; 83 7e da 00
    jnbe short 0826fh                         ; 77 0a
    jne short 082deh                          ; 75 77
    cmp word [bp-01eh], strict byte 00040h    ; 83 7e e2 40
    jnbe short 0826fh                         ; 77 02
    jne short 082deh                          ; 75 6f
    mov dword [bp-014h], strict dword 0003f00ffh ; 66 c7 46 ec ff 00 3f 00
    mov bx, word [bp-026h]                    ; 8b 5e da
    mov cx, word [bp-01eh]                    ; 8b 4e e2
    mov dx, word [bp-028h]                    ; 8b 56 d8
    mov si, strict word 00006h                ; be 06 00
    call 09e10h                               ; e8 8a 1b
    ...
    mov si, strict word 00010h                ; be 10 00
    call 09e10h                               ; e8 3f 1b
    add dx, word [bp-034h]                    ; 03 56 cc
    adc cx, word [bp-020h]                    ; 13 4e e0
    mov ax, word [bp-022h]                    ; 8b 46 de
    adc ax, bx                                ; 11 d8
    jmp short 08315h                          ; eb 37
    test ax, ax                               ; 85 c0
    jnbe short 082f4h                         ; 77 12
    jne short 082feh                          ; 75 1a
    cmp word [bp-026h], strict byte 00000h    ; 83 7e da 00
    jnbe short 082f4h                         ; 77 0a
    jne short 082feh                          ; 75 12
    cmp word [bp-01eh], strict byte 00020h    ; 83 7e e2 20
    jnbe short 082f4h                         ; 77 02
    jne short 082feh                          ; 75 0a
    mov dword [bp-014h], strict dword 000200080h ; 66 c7 46 ec 80 00 20 00
    jmp short 08315h                          ; eb 17
    mov dword [bp-014h], strict dword 000200040h ; 66 c7 46 ec 40 00 20 00
    mov bx, word [bp-026h]                    ; 8b 5e da
    mov cx, word [bp-01eh]                    ; 8b 4e e2
    mov dx, word [bp-028h]                    ; 8b 56 d8
    mov si, strict word 0000bh                ; be 0b 00
    call 09e10h                               ; e8 fb 1a
    mov word [bp-02ah], dx                    ; 89 56 d6
    mov word [bp-016h], cx                    ; 89 4e ea
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    ...
    cmp word [bp-016h], strict byte 00000h    ; 83 7e ea 00
    jne short 083f2h                          ; 75 07
    cmp word [bp-02ah], 00400h                ; 81 7e d6 00 04
    jbe short 083fah                          ; 76 08
    mov word [es:bx+032h], 00400h             ; 26 c7 47 32 00 04
    jmp short 08401h                          ; eb 07
    mov ax, word [bp-02ah]                    ; 8b 46 d6
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 b0 91
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 b0 91
    inc byte [bp-00ch]                        ; fe 46 f4
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    mov es, [bp-018h]                         ; 8e 46 e8
    mov byte [es:di+0022ch], al               ; 26 88 85 2c 02
    jmp near 08516h                           ; e9 a7 00
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 67 94
    push word [bp-010h]                       ; ff 76 f0
    movzx ax, byte [bp-00ch]                  ; 0f b6 46 f4
    push ax                                   ; 50
    push 00ed5h                               ; 68 d5 0e
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 98 94
    add sp, strict byte 00008h                ; 83 c4 08
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    add AL, strict byte 008h                  ; 04 08
    mov byte [bp-00eh], al                    ; 88 46 f2
    test byte [bp-0024dh], 080h               ; f6 86 b3 fd 80
    db  00fh, 095h, 0c0h
    ; setne al                                  ; 0f 95 c0
    xor ah, ah                                ; 30 e4
    movzx bx, byte [bp-00ch]                  ; 0f b6 5e f4
    ...
    mov es, [bp-018h]                         ; 8e 46 e8
    add bx, di                                ; 01 fb
    mov dx, word [bp-00250h]                  ; 8b 96 b0 fd
    ...
    inc byte [bp-00ch]                        ; fe 46 f4
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    jmp near 08467h                           ; e9 6d ff
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 dc 93
    push word [bp-010h]                       ; ff 76 f0
    push 00e07h                               ; 68 07 0e
    push 00ef0h                               ; 68 f0 0e
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 0f 94
    add sp, strict byte 00008h                ; 83 c4 08
    inc word [bp-010h]                        ; ff 46 f0
    cmp word [bp-010h], strict byte 00010h    ; 83 7e f0 10
    jnl short 08588h                          ; 7d 69
    mov byte [bp-04eh], 012h                  ; c6 46 b2 12
    xor al, al                                ; 30 c0
    mov byte [bp-04dh], al                    ; 88 46 b3
    mov byte [bp-04ch], al                    ; 88 46 b4
    mov byte [bp-04bh], al                    ; 88 46 b5
    mov byte [bp-04ah], 005h                  ; c6 46 b6 05
    ...
    lea bx, [bp-04eh]                         ; 8d 5e b2
    mov ax, word [bp-00250h]                  ; 8b 86 b0 fd
    call 0785bh                               ; e8 0b f3
    test al, al                               ; 84 c0
    je short 08562h                           ; 74 0e
    push 00e07h                               ; 68 07 0e
    push 00e27h                               ; 68 27 0e
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 c3 93
    add sp, strict byte 00006h                ; 83 c4 06
    test byte [bp-0024eh], 0e0h               ; f6 86 b2 fd e0
    jne short 08572h                          ; 75 09
    test byte [bp-0024eh], 01fh               ; f6 86 b2 fd 1f
    je near 07fb7h                            ; 0f 84 45 fa
    test byte [bp-0024eh], 0e0h               ; f6 86 b2 fd e0
    jne short 084fah                          ; 75 81
    mov al, byte [bp-0024eh]                  ; 8a 86 b2 fd
    and AL, strict byte 01fh                  ; 24 1f
    cmp AL, strict byte 005h                  ; 3c 05
    je near 0846fh                            ; 0f 84 ea fe
    jmp near 084fah                           ; e9 72 ff
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop dx                                    ; 5a
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_scsi_init:                                  ; 0xf8592 LB 0xf0
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 7e 90
    ...
    jne short 085dah                          ; 75 24
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 20 93
    push 00f18h                               ; 68 18 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 59 93
    add sp, strict byte 00004h                ; 83 c4 04
    xor al, al                                ; 30 c0
    mov dx, 00433h                            ; ba 33 04
    out DX, AL                                ; ee
    mov ax, 00430h                            ; b8 30 04
    call 07f93h                               ; e8 bb f9
    jmp short 085f0h                          ; eb 16
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 fc 92
    push 00f43h                               ; 68 43 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 35 93
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 055h                  ; b0 55
    ...
    ; sub ah, ah                                ; 2a e4
    cmp AL, strict byte 055h                  ; 3c 55
    jne short 08621h                          ; 75 24
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 d9 92
    push 00f72h                               ; 68 72 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 12 93
    add sp, strict byte 00004h                ; 83 c4 04
    xor al, al                                ; 30 c0
    mov dx, 00437h                            ; ba 37 04
    out DX, AL                                ; ee
    mov ax, 00434h                            ; b8 34 04
    call 07f93h                               ; e8 74 f9
    jmp short 08637h                          ; eb 16
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 b5 92
    push 00f9eh                               ; 68 9e 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 ee 92
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 055h                  ; b0 55
    ...
    ; sub ah, ah                                ; 2a e4
    cmp AL, strict byte 055h                  ; 3c 55
    jne short 08668h                          ; 75 24
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 92 92
    push 00fceh                               ; 68 ce 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 cb 92
    add sp, strict byte 00004h                ; 83 c4 04
    xor al, al                                ; 30 c0
    mov dx, 0043bh                            ; ba 3b 04
    out DX, AL                                ; ee
    mov ax, 00438h                            ; b8 38 04
    call 07f93h                               ; e8 2d f9
    jmp short 0867eh                          ; eb 16
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 6e 92
    push 00ff9h                               ; 68 f9 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 a7 92
    add sp, strict byte 00004h                ; 83 c4 04
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
high_bits_save_:                             ; 0xf8682 LB 0x17
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
high_bits_restore_:                          ; 0xf8699 LB 0x17
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_set_bits_:                         ; 0xf86b0 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_clear_bits_:                       ; 0xf86f3 LB 0x47
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_is_bit_set_:                       ; 0xf873a LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xchg dx, ax                               ; 92
    test dx, di                               ; 85 fa
    jne short 08766h                          ; 75 04
    test ax, bx                               ; 85 d8
    je short 0876ah                           ; 74 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 0876ch                          ; eb 02
    xor al, al                                ; 30 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_extract_bits_:                     ; 0xf8773 LB 0x1b
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov si, bx                                ; 89 de
    ...
    pop si                                    ; 5e
    retn 00002h                               ; c2 02 00
ahci_addr_to_phys_:                          ; 0xf878e LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
ahci_port_cmd_sync_:                         ; 0xf87ac LB 0xd5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov dx, si                                ; 89 f2
    mov ax, di                                ; 89 f8
    call 0873ah                               ; e8 e2 fe
    test al, al                               ; 84 c0
    je short 0883bh                           ; 74 df
    mov bx, strict word 00001h                ; bb 01 00
    xor cx, cx                                ; 31 c9
    mov dx, si                                ; 89 f2
    mov ax, di                                ; 89 f8
    call 086b0h                               ; e8 48 fe
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    add dx, 00118h                            ; 81 c2 18 01
    mov bx, strict word 00001h                ; bb 01 00
    xor cx, cx                                ; 31 c9
    mov ax, di                                ; 89 f8
    call 086f3h                               ; e8 7a fe
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop cx                                    ; 59
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_cmd_data_:                              ; 0xf8881 LB 0x24b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_deinit_current_:                   ; 0xf8acc LB 0x144
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_init_:                             ; 0xf8c10 LB 0x206
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, 0c011h                            ; bb 11 c0
    xor cx, cx                                ; 31 c9
    call 0873ah                               ; e8 e1 fa
    cmp AL, strict byte 001h                  ; 3c 01
    je short 08c3eh                           ; 74 e1
    mov cx, strict word 00020h                ; b9 20 00
    xor bx, bx                                ; 31 db
    mov ax, si                                ; 89 f0
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09d7ah                               ; e8 10 11
    lea ax, [si+00080h]                       ; 8d 84 80 00
    mov cx, strict word 00040h                ; b9 40 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09d7ah                               ; e8 01 11
    mov ax, si                                ; 89 f0
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@ahci_read_sectors:                          ; 0xf8e16 LB 0x94
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ax, ax                                ; 31 c0
    call 08c10h                               ; e8 b1 fd
    mov bx, strict word 00025h                ; bb 25 00
    mov ax, di                                ; 89 f8
    mov dx, word [bp+006h]                    ; 8b 56 06
    call 08881h                               ; e8 17 fa
    mov es, [bp+006h]                         ; 8e 46 06
    mov bx, di                                ; 89 fb
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@ahci_write_sectors:                         ; 0xf8eaa LB 0x70
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    mov si, word [bp+004h]                    ; 8b 76 04
...
ahci_cmd_packet_:                            ; 0xf8f1a LB 0x17c
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 e7 86
    mov si, 00122h                            ; be 22 01
    mov word [bp-008h], ax                    ; 89 46 f8
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 08f60h                          ; 75 1f
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 95 89
    push 0106ch                               ; 68 6c 10
    push 0107ch                               ; 68 7c 10
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 cb 89
    add sp, strict byte 00006h                ; 83 c4 06
    mov ax, strict word 00001h                ; b8 01 00
    jmp near 0908dh                           ; e9 2d 01
    test byte [bp+004h], 001h                 ; f6 46 04 01
    jne short 08f5ah                          ; 75 f4
    mov ax, word [bp+006h]                    ; 8b 46 06
    ...
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    call 08699h                               ; e8 20 f6
    les bx, [bp-00eh]                         ; c4 5e f2
    mov ax, word [es:bx+006h]                 ; 26 8b 47 06
    or ax, word [es:bx+004h]                  ; 26 0b 47 04
    jne short 0908bh                          ; 75 05
    mov ax, strict word 00004h                ; b8 04 00
    jmp short 0908dh                          ; eb 02
    xor ax, ax                                ; 31 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
ahci_port_detect_device_:                    ; 0xf9096 LB 0x46c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, di                                ; 89 fb
    call 08c10h                               ; e8 60 fb
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 63 85
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 08773h                               ; e8 10 f6
    test ax, ax                               ; 85 c0
    je near 094fah                            ; 0f 84 91 03
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    sal ax, 007h                              ; c1 e0 07
    mov word [bp-016h], ax                    ; 89 46 ea
    add ax, 00128h                            ; 05 28 01
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 08773h                               ; e8 c4 f5
    cmp ax, strict word 00001h                ; 3d 01 00
    je short 09169h                           ; 74 b5
    push strict byte 00000h                   ; 6a 00
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    mov ax, word [bp-01eh]                    ; 8b 46 e2
    mov dx, di                                ; 89 fa
    call 08773h                               ; e8 b0 f5
    cmp ax, strict word 00003h                ; 3d 03 00
    jne near 094fah                           ; 0f 85 30 03
    mov ax, word [bp-016h]                    ; 8b 46 ea
    ...
    test dx, dx                               ; 85 d2
    jne near 0944dh                           ; 0f 85 ea 01
    cmp ax, 00101h                            ; 3d 01 01
    jne near 0944dh                           ; 0f 85 e3 01
    les bx, [bp-010h]                         ; c4 5e f0
    ...
    jne short 092e1h                          ; 75 10
    cmp dx, strict byte 0ffffh                ; 83 fa ff
    jne short 092e1h                          ; 75 0b
    ...
    mov al, byte [bp-008h]                    ; 8a 46 f8
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 09355h                           ; 72 0c
    jbe short 0935dh                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 09365h                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 09361h                           ; 74 0e
    jmp short 093aeh                          ; eb 59
    test al, al                               ; 84 c0
    jne short 093aeh                          ; 75 55
    mov DL, strict byte 040h                  ; b2 40
    jmp short 09367h                          ; eb 0a
    mov DL, strict byte 048h                  ; b2 48
    jmp short 09367h                          ; eb 06
    mov DL, strict byte 050h                  ; b2 50
    jmp short 09367h                          ; eb 02
    mov DL, strict byte 058h                  ; b2 58
    mov al, dl                                ; 88 d0
    add AL, strict byte 007h                  ; 04 07
    movzx bx, al                              ; 0f b6 d8
    mov ax, bx                                ; 89 d8
    call 0165ch                               ; e8 e9 82
    test al, al                               ; 84 c0
    je short 093aeh                           ; 74 37
    mov al, dl                                ; 88 d0
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 dc 82
    xor ah, ah                                ; 30 e4
    mov si, ax                                ; 89 c6
    sal si, 008h                              ; c1 e6 08
    movzx ax, dl                              ; 0f b6 c2
    call 0165ch                               ; e8 cf 82
    xor ah, ah                                ; 30 e4
    add ax, si                                ; 01 f0
    mov word [bp-024h], ax                    ; 89 46 dc
    mov al, dl                                ; 88 d0
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 bf 82
    xor ah, ah                                ; 30 e4
    mov word [bp-026h], ax                    ; 89 46 da
    mov ax, bx                                ; 89 d8
    call 0165ch                               ; e8 b5 82
    xor ah, ah                                ; 30 e4
    mov word [bp-022h], ax                    ; 89 46 de
    jmp short 093bbh                          ; eb 0d
    mov bx, word [bp-014h]                    ; 8b 5e ec
    mov cx, di                                ; 89 f9
    mov dx, ss                                ; 8c d2
    lea ax, [bp-026h]                         ; 8d 46 da
    call 054e1h                               ; e8 26 c1
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 1b 85
    push di                                   ; 57
    push word [bp-014h]                       ; ff 76 ec
    mov ax, word [bp-022h]                    ; 8b 46 de
    push ax                                   ; 50
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 c4 81
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 c4 81
    jmp near 094ech                           ; e9 9f 00
    cmp dx, 0eb14h                            ; 81 fa 14 eb
    jne near 094ech                           ; 0f 85 97 00
    cmp ax, 00101h                            ; 3d 01 01
    jne near 094ech                           ; 0f 85 90 00
    les bx, [bp-010h]                         ; c4 5e f0
    db  066h, 026h, 0c7h, 047h, 004h, 000h, 000h, 000h, 000h
    ; mov dword [es:bx+004h], strict dword 000000000h ; 66 26 c7 47 04 00 00 00 00
    db  066h, 026h, 0c7h, 007h, 000h, 000h, 000h, 000h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_mem_alloc_:                             ; 0xf9502 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 0161ch                               ; e8 0a 81
    test ax, ax                               ; 85 c0
    je short 0953bh                           ; 74 25
    dec ax                                    ; 48
    mov bx, ax                                ; 89 c3
    xor dx, dx                                ; 31 d2
    mov cx, strict word 0000ah                ; b9 0a 00
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_hba_init_:                              ; 0xf9545 LB 0x125
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    shr eax, 010h                             ; 66 c1 e8 10
    xchg dx, ax                               ; 92
    call 09502h                               ; e8 82 ff
    mov di, ax                                ; 89 c7
    test ax, ax                               ; 85 c0
    je near 09649h                            ; 0f 84 c1 00
    mov es, [bp-010h]                         ; 8e 46 f0
    ...
    xor cx, cx                                ; 31 c9
    call 08773h                               ; e8 71 f1
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    mov byte [bp-00eh], al                    ; 88 46 f2
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    jmp short 09616h                          ; eb 09
    inc byte [bp-00ch]                        ; fe 46 f4
    cmp byte [bp-00ch], 020h                  ; 80 7e f4 20
    jnc short 09647h                          ; 73 31
    movzx cx, byte [bp-00ch]                  ; 0f b6 4e f4
    mov ax, strict word 00001h                ; b8 01 00
    xor dx, dx                                ; 31 d2
    jcxz 09627h                               ; e3 06
    ...
    mov dx, strict word 0000ch                ; ba 0c 00
    mov ax, si                                ; 89 f0
    call 0873ah                               ; e8 07 f1
    test al, al                               ; 84 c0
    je short 0960dh                           ; 74 d6
    movzx bx, byte [bp-00ch]                  ; 0f b6 5e f4
    xor ax, ax                                ; 31 c0
    mov dx, di                                ; 89 fa
    call 09096h                               ; e8 54 fa
    dec byte [bp-00eh]                        ; fe 4e f2
    jne short 0960dh                          ; 75 c6
    xor ax, ax                                ; 31 c0
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    db  00bh, 005h, 004h, 003h, 002h, 001h, 000h, 039h, 097h, 017h, 097h, 01dh, 097h, 023h, 097h, 029h
    db  097h, 02fh, 097h, 035h, 097h, 039h, 097h
_ahci_init:                                  ; 0xf966a LB 0xfe
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00001h                ; ba 01 00
    call 09b88h                               ; e8 0d 05
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 0ffffh                ; 3d ff ff
    je near 09761h                            ; 0f 84 dd 00
    xor al, al                                ; 30 c0
    shr ax, 008h                              ; c1 e8 08
    mov byte [bp-00ah], al                    ; 88 46 f6
    mov byte [bp-008h], dl                    ; 88 56 f8
    ...
    xor ah, ah                                ; 30 e4
    mov bx, strict word 00034h                ; bb 34 00
    call 09bb3h                               ; e8 1a 05
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    je short 096c2h                           ; 74 23
    movzx bx, cl                              ; 0f b6 d9
    movzx di, byte [bp-008h]                  ; 0f b6 7e f8
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 09bb3h                               ; e8 02 05
    cmp AL, strict byte 012h                  ; 3c 12
    je short 096c2h                           ; 74 0d
    mov al, cl                                ; 88 c8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    jmp short 09696h                          ; eb d4
    test cl, cl                               ; 84 c9
    je near 09761h                            ; 0f 84 99 00
    ...
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 09bb3h                               ; e8 d6 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne near 09761h                           ; 0f 85 7e 00
    mov byte [bp-006h], 000h                  ; c6 46 fa 00
    mov al, cl                                ; 88 c8
    add AL, strict byte 002h                  ; 04 02
    movzx bx, al                              ; 0f b6 d8
    ...
    mov al, byte [bp-006h]                    ; 8a 46 fa
    test al, al                               ; 84 c0
    je short 09761h                           ; 74 19
    movzx bx, al                              ; 0f b6 d8
    movzx dx, byte [bp-008h]                  ; 0f b6 56 f8
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    call 09bf9h                               ; e8 a3 04
    test AL, strict byte 001h                 ; a8 01
    je short 09761h                           ; 74 07
    and AL, strict byte 0f0h                  ; 24 f0
    add ax, si                                ; 01 f0
    call 09545h                               ; e8 e4 fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
apm_out_str_:                                ; 0xf9768 LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    cmp byte [bx], 000h                       ; 80 3f 00
    je short 0977dh                           ; 74 0a
    ...
    db  00ah, 0c0h
    ; or al, al                                 ; 0a c0
    jne short 09775h                          ; 75 f8
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
    les dx, [bx-06770h]                       ; c4 97 90 98
    db  0d6h
    xchg di, ax                               ; 97
    db  0f1h
    xchg di, ax                               ; 97
    nop                                       ; 90
    cbw                                       ; 98
    sbb AL, strict byte 098h                  ; 1c 98
    nop                                       ; 90
    cbw                                       ; 98
    and word [bx+si-0679bh], bx               ; 21 98 65 98
    db  065h, 098h
    ; gs cbw                                    ; 65 98
    db  065h, 098h
    ; gs cbw                                    ; 65 98
...
_apm_function:                               ; 0xf97a1 LB 0xf5
    ...
    jnbe near 09865h                          ; 0f 87 b0 00
    mov bx, ax                                ; 89 c3
    add bx, ax                                ; 01 c3
    mov dx, word [bp+018h]                    ; 8b 56 18
    or dl, 001h                               ; 80 ca 01
    jmp word [cs:bx-0687dh]                   ; 2e ff a7 83 97
    ...
    jmp near 09890h                           ; e9 74 00
    sti                                       ; fb
    hlt                                       ; f4
    jmp near 09890h                           ; e9 6f 00
    cmp word [bp+010h], strict byte 00003h    ; 83 7e 10 03
    je short 09846h                           ; 74 1f
    cmp word [bp+010h], strict byte 00002h    ; 83 7e 10 02
    je short 0983eh                           ; 74 11
    cmp word [bp+010h], strict byte 00001h    ; 83 7e 10 01
    jne short 0984eh                          ; 75 1b
    mov dx, 08900h                            ; ba 00 89
    mov ax, 010d4h                            ; b8 d4 10
    call 09768h                               ; e8 2c ff
    jmp short 09890h                          ; eb 52
    mov dx, 08900h                            ; ba 00 89
    mov ax, 010dch                            ; b8 dc 10
    jmp short 09839h                          ; eb f3
    mov dx, 08900h                            ; ba 00 89
    mov ax, 010e4h                            ; b8 e4 10
    jmp short 09839h                          ; eb eb
    or ah, 00ah                               ; 80 cc 0a
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 09890h                          ; eb 37
    mov word [bp+012h], 00102h                ; c7 46 12 02 01
    jmp short 09890h                          ; eb 30
    or ah, 080h                               ; 80 cc 80
    jmp short 09851h                          ; eb ec
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 71 80
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 010edh                               ; 68 ed 10
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 a4 80
    add sp, strict byte 00008h                ; 83 c4 08
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_select_reg_:                           ; 0xf9896 LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_find_device_:                          ; 0xf98ba LB 0xf7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 09902h                          ; 75 2d
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, bx                                ; 89 d8
    call 09896h                               ; e8 b9 ff
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 098f0h                          ; 75 06
    add bx, strict byte 00008h                ; 83 c3 08
    jmp near 09983h                           ; e9 93 00
    test byte [bp-006h], 080h                 ; f6 46 fa 80
    je short 098fdh                           ; 74 07
    mov word [bp-00ah], strict word 00001h    ; c7 46 f6 01 00
    jmp short 09902h                          ; eb 05
    mov word [bp-00ah], strict word 00008h    ; c7 46 f6 08 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 007h                  ; 24 07
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 0992ah                          ; 75 1f
    mov ax, bx                                ; 89 d8
    shr ax, 008h                              ; c1 e8 08
    test ax, ax                               ; 85 c0
    jne short 0992ah                          ; 75 16
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, bx                                ; 89 d8
    call 09896h                               ; e8 7a ff
    mov dx, 00cfeh                            ; ba fe 0c
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp al, byte [bp-008h]                    ; 3a 46 f8
    jbe short 0992ah                          ; 76 03
    mov byte [bp-008h], al                    ; 88 46 f8
    test di, di                               ; 85 ff
    je short 09933h                           ; 74 05
    mov dx, strict word 00008h                ; ba 08 00
    jmp short 09935h                          ; eb 02
    xor dx, dx                                ; 31 d2
    mov ax, bx                                ; 89 d8
    call 09896h                               ; e8 5c ff
    ...
    jne short 09974h                          ; 75 08
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    cmp ax, word [bp-012h]                    ; 3b 46 ee
    je short 0997ah                           ; 74 06
    cmp word [bp-010h], strict byte 00000h    ; 83 7e f0 00
    je short 09980h                           ; 74 06
    dec si                                    ; 4e
    cmp si, strict byte 0ffffh                ; 83 fe ff
    je short 09992h                           ; 74 12
    add bx, word [bp-00ah]                    ; 03 5e f6
    mov dx, bx                                ; 89 da
    shr dx, 008h                              ; c1 ea 08
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    cmp dx, ax                                ; 39 c2
    jbe near 098d0h                           ; 0f 86 3e ff
    cmp si, strict byte 0ffffh                ; 83 fe ff
    jne short 0999bh                          ; 75 04
    mov ax, bx                                ; 89 d8
    jmp short 0999eh                          ; eb 03
    mov ax, strict word 0ffffh                ; b8 ff ff
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    aad 09ah                                  ; d5 9a
    call 0954ah                               ; e8 9a fb
    db  09ah
_pci16_function:                             ; 0xf99b1 LB 0x1d7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ah, ah                                ; 30 e4
    cmp bx, strict byte 00003h                ; 83 fb 03
    jc short 099eah                           ; 72 1a
    jbe short 09a42h                          ; 76 70
    cmp bx, strict byte 0000eh                ; 83 fb 0e
    je near 09b0fh                            ; 0f 84 36 01
    cmp bx, strict byte 00008h                ; 83 fb 08
    jc near 09b54h                            ; 0f 82 74 01
    cmp bx, strict byte 0000dh                ; 83 fb 0d
    jbe near 09a67h                           ; 0f 86 80 00
    jmp near 09b54h                           ; e9 6a 01
    cmp bx, strict byte 00002h                ; 83 fb 02
    je short 09a12h                           ; 74 23
    cmp bx, strict byte 00001h                ; 83 fb 01
    jne near 09b54h                           ; 0f 85 5e 01
    ...
    jmp near 09b81h                           ; e9 6f 01
    cmp word [bp+018h], strict byte 0ffffh    ; 83 7e 18 ff
    jne short 09a1eh                          ; 75 06
    or ah, 083h                               ; 80 cc 83
    jmp near 09b7ah                           ; e9 5c 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov dx, word [bp+01ch]                    ; 8b 56 1c
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor cx, cx                                ; 31 c9
    call 098bah                               ; e8 8e fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09a3ch                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09b7ah                           ; e9 3e 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09b81h                           ; e9 3f 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    mov dx, word [bp+01eh]                    ; 8b 56 1e
    mov cx, strict word 00001h                ; b9 01 00
    call 098bah                               ; e8 69 fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09a61h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09b7ah                           ; e9 19 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09b81h                           ; e9 1a 01
    cmp word [bp+004h], 00100h                ; 81 7e 04 00 01
    jc short 09a74h                           ; 72 06
    or ah, 087h                               ; 80 cc 87
    jmp near 09b7ah                           ; e9 06 01
    mov dx, word [bp+004h]                    ; 8b 56 04
    mov ax, word [bp+014h]                    ; 8b 46 14
    call 09896h                               ; e8 19 fe
    mov bx, word [bp+020h]                    ; 8b 5e 20
    xor bh, bh                                ; 30 ff
    sub bx, strict byte 00008h                ; 83 eb 08
    cmp bx, strict byte 00005h                ; 83 fb 05
    jnbe near 09b81h                          ; 0f 87 f5 00
    add bx, bx                                ; 01 db
    jmp word [cs:bx-0665bh]                   ; 2e ff a7 a5 99
    ...
    mov word [es:bx], ax                      ; 26 89 07
    jmp short 09b81h                          ; eb 2d
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 82 7d
    mov ax, word [bp+014h]                    ; 8b 46 14
    push ax                                   ; 50
    mov ax, word [bp+020h]                    ; 8b 46 20
    push ax                                   ; 50
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_find_classcode_:                         ; 0xf9b88 LB 0x2b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_byte_:                       ; 0xf9bb3 LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_word_:                       ; 0xf9bd7 LB 0x22
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_dword_:                      ; 0xf9bf9 LB 0x27
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
vds_is_present_:                             ; 0xf9c20 LB 0x1d
    push bx                                   ; 53
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_real_to_lin_:                            ; 0xf9c3d LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_build_sg_list_:                          ; 0xf9c5b LB 0x79
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    call 09c20h                               ; e8 93 ff
    test ax, ax                               ; 85 c0
    je short 09ca4h                           ; 74 13
    mov es, si                                ; 8e c6
    mov ax, 08105h                            ; b8 05 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 09ca1h                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    jmp short 09ccbh                          ; eb 27
    mov es, si                                ; 8e c6
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
vds_free_sg_list_:                           ; 0xf9cd4 LB 0x3c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push di                                   ; 57
    mov bx, ax                                ; 89 c3
    call 09c20h                               ; e8 42 ff
    test ax, ax                               ; 85 c0
    je short 09cf5h                           ; 74 13
    mov di, bx                                ; 89 df
    mov es, dx                                ; 8e c2
    mov ax, 08106h                            ; b8 06 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 09cf4h                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    mov es, dx                                ; 8e c2
...
hard_drive_post:                             ; 0xfe2d2 LB 0x12c
    ...
    call 0966ah                               ; e8 43 b3
    call 08592h                               ; e8 68 a2
...
font8x8:                                     ; 0xffa6e LB 0x421
    ...
    db  080h, 0fch, 0b1h, 075h, 00fh, 006h, 01eh, 00eh, 01fh, 0fch, 066h, 060h, 0e8h, 034h, 09bh, 066h
...
cpu_reset:                                   ; 0xffff0 LB 0x10
    jmp far 0f000h:0e05bh                     ; ea 5b e0 00 f0
    db  030h, 036h, 02fh, 032h, 033h, 02fh, 039h, 039h, 000h, 0fch, 063h
