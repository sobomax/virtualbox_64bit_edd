...
_pktacc:                                     ; 0xf006a LB 0xc
    db  000h, 000h, 000h, 000h, 000h, 000h, 0f2h, 029h, 071h, 07dh, 04fh, 08eh
...
_dskacc:                                     ; 0xf0082 LB 0x2e
    ...
    db  055h, 07ah, 0e3h, 07bh, 04bh, 08dh, 0dfh, 08dh, 000h, 000h, 000h, 000h, 000h, 000h, 05fh, 033h
...
section _TEXT progbits vstart=0x1600 align=1 ; size=0x8760 class=CODE group=AUTO
...
_int13_cdemu:                                ; 0xf3e08 LB 0x434
    ...
    xor dl, dl                                ; 30 d2
    xor cx, cx                                ; 31 c9
    call 09c79h                               ; e8 cd 5c
    xor bx, bx                                ; 31 db
    add ax, si                                ; 01 f0
    adc dx, bx                                ; 11 da
    mov bx, di                                ; 89 fb
    xor cx, cx                                ; 31 c9
    call 09c79h                               ; e8 c0 5c
    mov bx, ax                                ; 89 c3
    mov ax, word [bp-010h]                    ; 8b 46 f0
    dec ax                                    ; 48
    xor cx, cx                                ; 31 c9
...
_int13_harddisk:                             ; 0xf557f LB 0x484
    ...
    mov bx, cx                                ; 89 cb
    xor cx, cx                                ; 31 c9
    call 09c79h                               ; e8 0b 45
    xor bx, bx                                ; 31 db
    add ax, word [bp-008h]                    ; 03 46 f8
    adc dx, bx                                ; 11 da
    mov bx, word [bp-00ch]                    ; 8b 5e f4
    xor cx, cx                                ; 31 c9
    call 09c79h                               ; e8 fc 44
    xor bx, bx                                ; 31 db
    ...
    xor cx, cx                                ; 31 c9
    call 09c79h                               ; e8 19 43
    mov bx, word [bp-006h]                    ; 8b 5e fa
    xor cx, cx                                ; 31 c9
    call 09c79h                               ; e8 11 43
    mov word [bp-010h], ax                    ; 89 46 f0
    mov word [bp-00eh], dx                    ; 89 56 f2
    mov word [bp+014h], dx                    ; 89 56 14
    mov word [bp+012h], ax                    ; 89 46 12
...
scsi_cmd_packet_:                            ; 0xf7d71 LB 0x222
    ...
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
scsi_enumerate_attached_devices_:            ; 0xf7f93 LB 0x534
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov di, 00122h                            ; bf 22 01
    mov word [bp-010h], ax                    ; 89 46 f0
    mov word [bp-038h], strict word 00000h    ; c7 46 c8 00 00
    jmp near 08454h                           ; e9 9d 04
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    ...
    jnc near 084bdh                           ; 0f 83 dd 04
    mov cx, strict word 00010h                ; b9 10 00
    xor bx, bx                                ; 31 db
    mov dx, ss                                ; 8c d2
    lea ax, [bp-05ah]                         ; 8d 46 a6
    call 09caah                               ; e8 bd 1c
    ...
    push dx                                   ; 52
    push strict byte 00010h                   ; 6a 10
    movzx dx, byte [bp-038h]                  ; 0f b6 56 c8
    mov cx, ss                                ; 8c d1
    ...
    sal ax, 008h                              ; c1 e0 08
    movzx bx, byte [bp-00251h]                ; 0f b6 9e af fd
    xor si, si                                ; 31 f6
    or bx, ax                                 ; 09 c3
    ...
    or si, ax                                 ; 09 c6
    mov word [bp-028h], si                    ; 89 76 d8
    test dx, dx                               ; 85 d2
    jne short 080d4h                          ; 75 06
    cmp si, 00200h                            ; 81 fe 00 02
    je short 080f2h                           ; 74 1e
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 02 98
    push dx                                   ; 52
    push si                                   ; 56
    push word [bp-038h]                       ; ff 76 c8
    push 00e78h                               ; 68 78 0e
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 36 98
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 0844bh                           ; e9 59 03
    mov es, [bp-010h]                         ; 8e 46 f0
    mov al, byte [es:di+0022ch]               ; 26 8a 85 2c 02
    mov byte [bp-00ch], al                    ; 88 46 f4
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 0810dh                           ; 72 0c
    jbe short 08115h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 0811dh                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 08119h                           ; 74 0e
    jmp short 0816ah                          ; eb 5d
    test al, al                               ; 84 c0
    jne short 0816ah                          ; 75 59
    mov BL, strict byte 090h                  ; b3 90
    jmp short 0811fh                          ; eb 0a
    mov BL, strict byte 098h                  ; b3 98
    jmp short 0811fh                          ; eb 06
    mov BL, strict byte 0a0h                  ; b3 a0
    jmp short 0811fh                          ; eb 02
    mov BL, strict byte 0a8h                  ; b3 a8
    mov al, bl                                ; 88 d8
    add AL, strict byte 007h                  ; 04 07
    movzx cx, al                              ; 0f b6 c8
    mov ax, cx                                ; 89 c8
    call 0165ch                               ; e8 31 95
    test al, al                               ; 84 c0
    je short 0816ah                           ; 74 3b
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 24 95
    movzx dx, al                              ; 0f b6 d0
    sal dx, 008h                              ; c1 e2 08
    movzx ax, bl                              ; 0f b6 c3
    call 0165ch                               ; e8 18 95
    xor ah, ah                                ; 30 e4
    add ax, dx                                ; 01 d0
    cwd                                       ; 99
    mov word [bp-012h], ax                    ; 89 46 ee
    ...
    mov ax, word [bp-03ah]                    ; 8b 46 c6
    test ax, ax                               ; 85 c0
    jnbe short 081a3h                         ; 77 14
    jne near 08212h                           ; 0f 85 7f 00
    cmp word [bp-026h], strict byte 00000h    ; 83 7e da 00
    jnbe short 081a3h                         ; 77 0a
    jne short 08212h                          ; 75 77
    cmp word [bp-046h], strict byte 00040h    ; 83 7e ba 40
    jnbe short 081a3h                         ; 77 02
    jne short 08212h                          ; 75 6f
    mov dword [bp-016h], strict dword 0003f00ffh ; 66 c7 46 ea ff 00 3f 00
    mov bx, word [bp-026h]                    ; 8b 5e da
    mov cx, word [bp-046h]                    ; 8b 4e ba
    mov dx, word [bp-02eh]                    ; 8b 56 d2
    mov si, strict word 00006h                ; be 06 00
    call 09d40h                               ; e8 86 1b
    mov si, word [bp-02ch]                    ; 8b 76 d4
    add si, dx                                ; 01 d6
    mov word [bp-048h], si                    ; 89 76 b8
    ...
    mov cx, word [bp-042h]                    ; 8b 4e be
    mov dx, si                                ; 89 f2
    mov si, strict word 00008h                ; be 08 00
    call 09d40h                               ; e8 56 1b
    ...
    mov bx, word [bp-024h]                    ; 8b 5e dc
    mov cx, word [bp-042h]                    ; 8b 4e be
    mov dx, word [bp-048h]                    ; 8b 56 b8
    mov si, strict word 00010h                ; be 10 00
    call 09d40h                               ; e8 3b 1b
    add dx, word [bp-036h]                    ; 03 56 ca
    adc cx, word [bp-034h]                    ; 13 4e cc
    mov ax, word [bp-032h]                    ; 8b 46 ce
    adc ax, bx                                ; 11 d8
    jmp short 08249h                          ; eb 37
    test ax, ax                               ; 85 c0
    jnbe short 08228h                         ; 77 12
    jne short 08232h                          ; 75 1a
    cmp word [bp-026h], strict byte 00000h    ; 83 7e da 00
    jnbe short 08228h                         ; 77 0a
    jne short 08232h                          ; 75 12
    cmp word [bp-046h], strict byte 00020h    ; 83 7e ba 20
    jnbe short 08228h                         ; 77 02
    jne short 08232h                          ; 75 0a
    mov dword [bp-016h], strict dword 000200080h ; 66 c7 46 ea 80 00 20 00
    jmp short 08249h                          ; eb 17
    mov dword [bp-016h], strict dword 000200040h ; 66 c7 46 ea 40 00 20 00
    mov bx, word [bp-026h]                    ; 8b 5e da
    mov cx, word [bp-046h]                    ; 8b 4e ba
    mov dx, word [bp-02eh]                    ; 8b 56 d2
    mov si, strict word 0000bh                ; be 0b 00
    call 09d40h                               ; e8 f7 1a
    mov word [bp-012h], dx                    ; 89 56 ee
    mov word [bp-018h], cx                    ; 89 4e e8
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    ...
    jbe short 082b5h                          ; 76 08
    mov word [es:bx+02ch], 00400h             ; 26 c7 47 2c 00 04
    jmp short 082bch                          ; eb 07
    mov ax, word [bp-012h]                    ; 8b 46 ee
    mov word [es:bx+02ch], ax                 ; 26 89 47 2c
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 1a 96
    push word [bp-046h]                       ; ff 76 ba
    ...
    cmp word [bp-018h], strict byte 00000h    ; 83 7e e8 00
    jne short 08322h                          ; 75 07
    cmp word [bp-012h], 00400h                ; 81 7e ee 00 04
    jbe short 0832ah                          ; 76 08
    mov word [es:bx+032h], 00400h             ; 26 c7 47 32 00 04
    jmp short 08331h                          ; eb 07
    mov ax, word [bp-012h]                    ; 8b 46 ee
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 80 92
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 80 92
    inc byte [bp-00ch]                        ; fe 46 f4
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    mov es, [bp-010h]                         ; 8e 46 f0
    mov byte [es:di+0022ch], al               ; 26 88 85 2c 02
    jmp near 0844bh                           ; e9 ac 00
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 37 95
    push word [bp-038h]                       ; ff 76 c8
    movzx ax, byte [bp-00ch]                  ; 0f b6 46 f4
    push ax                                   ; 50
    push 00ed5h                               ; 68 d5 0e
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 68 95
    add sp, strict byte 00008h                ; 83 c4 08
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    add AL, strict byte 008h                  ; 04 08
    mov byte [bp-00eh], al                    ; 88 46 f2
    ...
    inc byte [bp-00ch]                        ; fe 46 f4
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    jmp near 08397h                           ; e9 68 ff
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 a7 94
    push word [bp-038h]                       ; ff 76 c8
    push 00e07h                               ; 68 07 0e
    push 00ef0h                               ; 68 f0 0e
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 da 94
    add sp, strict byte 00008h                ; 83 c4 08
    inc word [bp-038h]                        ; ff 46 c8
    cmp word [bp-038h], strict byte 00010h    ; 83 7e c8 10
    jnl short 084bdh                          ; 7d 69
    ...
    lea bx, [bp-05ah]                         ; 8d 5e a6
    mov ax, word [bp-0025ch]                  ; 8b 86 a4 fd
    call 0785bh                               ; e8 d6 f3
    test al, al                               ; 84 c0
    je short 08497h                           ; 74 0e
    push 00e07h                               ; 68 07 0e
    push 00e27h                               ; 68 27 0e
    push strict byte 00007h                   ; 6a 07
    call 01922h                               ; e8 8e 94
    add sp, strict byte 00006h                ; 83 c4 06
    test byte [bp-0025ah], 0e0h               ; f6 86 a6 fd e0
    jne short 084a7h                          ; 75 09
    test byte [bp-0025ah], 01fh               ; f6 86 a6 fd 1f
    je near 07fb7h                            ; 0f 84 10 fb
    test byte [bp-0025ah], 0e0h               ; f6 86 a6 fd e0
    jne short 0842fh                          ; 75 81
    mov al, byte [bp-0025ah]                  ; 8a 86 a6 fd
    and AL, strict byte 01fh                  ; 24 1f
    cmp AL, strict byte 005h                  ; 3c 05
    je near 0839fh                            ; 0f 84 e5 fe
    jmp near 0842fh                           ; e9 72 ff
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop dx                                    ; 5a
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_scsi_init:                                  ; 0xf84c7 LB 0xf0
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 49 91
    ...
    jne short 0850fh                          ; 75 24
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 eb 93
    push 00f18h                               ; 68 18 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 24 94
    add sp, strict byte 00004h                ; 83 c4 04
    xor al, al                                ; 30 c0
    mov dx, 00433h                            ; ba 33 04
    out DX, AL                                ; ee
    mov ax, 00430h                            ; b8 30 04
    call 07f93h                               ; e8 86 fa
    jmp short 08525h                          ; eb 16
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 c7 93
    push 00f43h                               ; 68 43 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 00 94
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 055h                  ; b0 55
    ...
    ; sub ah, ah                                ; 2a e4
    cmp AL, strict byte 055h                  ; 3c 55
    jne short 08556h                          ; 75 24
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 a4 93
    ...
    call 07f93h                               ; e8 3f fa
    jmp short 0856ch                          ; eb 16
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 80 93
    push 00f9eh                               ; 68 9e 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 b9 93
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 055h                  ; b0 55
    ...
    ; sub ah, ah                                ; 2a e4
    cmp AL, strict byte 055h                  ; 3c 55
    jne short 0859dh                          ; 75 24
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 5d 93
    push 00fceh                               ; 68 ce 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 96 93
    add sp, strict byte 00004h                ; 83 c4 04
    xor al, al                                ; 30 c0
    mov dx, 0043bh                            ; ba 3b 04
    out DX, AL                                ; ee
    mov ax, 00438h                            ; b8 38 04
    call 07f93h                               ; e8 f8 f9
    jmp short 085b3h                          ; eb 16
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 39 93
    push 00ff9h                               ; 68 f9 0f
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 72 93
    add sp, strict byte 00004h                ; 83 c4 04
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
high_bits_save_:                             ; 0xf85b7 LB 0x17
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
high_bits_restore_:                          ; 0xf85ce LB 0x17
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_set_bits_:                         ; 0xf85e5 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_clear_bits_:                       ; 0xf8628 LB 0x47
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_is_bit_set_:                       ; 0xf866f LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xchg dx, ax                               ; 92
    test dx, di                               ; 85 fa
    jne short 0869bh                          ; 75 04
    test ax, bx                               ; 85 d8
    je short 0869fh                           ; 74 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 086a1h                          ; eb 02
    xor al, al                                ; 30 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_ctrl_extract_bits_:                     ; 0xf86a8 LB 0x1b
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov si, bx                                ; 89 de
    ...
    pop si                                    ; 5e
    retn 00002h                               ; c2 02 00
ahci_addr_to_phys_:                          ; 0xf86c3 LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
ahci_port_cmd_sync_:                         ; 0xf86e1 LB 0xd5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov dx, si                                ; 89 f2
    mov ax, di                                ; 89 f8
    call 0866fh                               ; e8 e2 fe
    test al, al                               ; 84 c0
    je short 08770h                           ; 74 df
    mov bx, strict word 00001h                ; bb 01 00
    xor cx, cx                                ; 31 c9
    mov dx, si                                ; 89 f2
    mov ax, di                                ; 89 f8
    call 085e5h                               ; e8 48 fe
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    add dx, 00118h                            ; 81 c2 18 01
    mov bx, strict word 00001h                ; bb 01 00
    xor cx, cx                                ; 31 c9
    mov ax, di                                ; 89 f8
    call 08628h                               ; e8 7a fe
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop cx                                    ; 59
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_cmd_data_:                              ; 0xf87b6 LB 0x24b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov ax, word [bp-010h]                    ; 8b 46 f0
    mov dx, word [bp-014h]                    ; 8b 56 ec
    call 086e1h                               ; e8 f4 fc
    mov ax, word [bp-010h]                    ; 8b 46 f0
    add ax, 0026ah                            ; 05 6a 02
    mov dx, word [bp-014h]                    ; 8b 56 ec
    call 09c09h                               ; e8 10 12
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop cx                                    ; 59
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_deinit_current_:                   ; 0xf8a01 LB 0x144
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_init_:                             ; 0xf8b45 LB 0x206
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, 0c011h                            ; bb 11 c0
    xor cx, cx                                ; 31 c9
    call 0866fh                               ; e8 e1 fa
    cmp AL, strict byte 001h                  ; 3c 01
    je short 08b73h                           ; 74 e1
    mov cx, strict word 00020h                ; b9 20 00
    xor bx, bx                                ; 31 db
    mov ax, si                                ; 89 f0
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09caah                               ; e8 0b 11
    lea ax, [si+00080h]                       ; 8d 84 80 00
    mov cx, strict word 00040h                ; b9 40 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 09caah                               ; e8 fc 10
    mov ax, si                                ; 89 f0
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
@ahci_read_sectors:                          ; 0xf8d4b LB 0x94
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ax, ax                                ; 31 c0
    call 08b45h                               ; e8 b1 fd
    mov bx, strict word 00025h                ; bb 25 00
    mov ax, di                                ; 89 f8
    mov dx, word [bp+006h]                    ; 8b 56 06
    call 087b6h                               ; e8 17 fa
    mov es, [bp+006h]                         ; 8e 46 06
    mov bx, di                                ; 89 fb
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@ahci_write_sectors:                         ; 0xf8ddf LB 0x70
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    mov si, word [bp+004h]                    ; 8b 76 04
...
ahci_cmd_packet_:                            ; 0xf8e4f LB 0x17c
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 b2 87
    mov si, 00122h                            ; be 22 01
    mov word [bp-008h], ax                    ; 89 46 f8
    cmp byte [bp+00ah], 002h                  ; 80 7e 0a 02
    jne short 08e95h                          ; 75 1f
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 60 8a
    push 0106ch                               ; 68 6c 10
    push 0107ch                               ; 68 7c 10
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 96 8a
    add sp, strict byte 00006h                ; 83 c4 06
    mov ax, strict word 00001h                ; b8 01 00
    jmp near 08fc2h                           ; e9 2d 01
    test byte [bp+004h], 001h                 ; f6 46 04 01
    jne short 08e8fh                          ; 75 f4
    mov ax, word [bp+006h]                    ; 8b 46 06
    ...
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    call 085ceh                               ; e8 20 f6
    les bx, [bp-00eh]                         ; c4 5e f2
    mov ax, word [es:bx+006h]                 ; 26 8b 47 06
    or ax, word [es:bx+004h]                  ; 26 0b 47 04
    jne short 08fc0h                          ; 75 05
    mov ax, strict word 00004h                ; b8 04 00
    jmp short 08fc2h                          ; eb 02
    xor ax, ax                                ; 31 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
ahci_port_detect_device_:                    ; 0xf8fcb LB 0x46c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov bx, di                                ; 89 fb
    call 08b45h                               ; e8 60 fb
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0161ch                               ; e8 2e 86
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 086a8h                               ; e8 10 f6
    test ax, ax                               ; 85 c0
    je near 0942fh                            ; 0f 84 91 03
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    sal ax, 007h                              ; c1 e0 07
    mov word [bp-016h], ax                    ; 89 46 ea
    add ax, 00128h                            ; 05 28 01
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 086a8h                               ; e8 c4 f5
    cmp ax, strict word 00001h                ; 3d 01 00
    je short 0909eh                           ; 74 b5
    push strict byte 00000h                   ; 6a 00
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    mov ax, word [bp-01eh]                    ; 8b 46 e2
    mov dx, di                                ; 89 fa
    call 086a8h                               ; e8 b0 f5
    cmp ax, strict word 00003h                ; 3d 03 00
    jne near 0942fh                           ; 0f 85 30 03
    mov ax, word [bp-016h]                    ; 8b 46 ea
    ...
    test dx, dx                               ; 85 d2
    jne near 09382h                           ; 0f 85 ea 01
    cmp ax, 00101h                            ; 3d 01 01
    jne near 09382h                           ; 0f 85 e3 01
    les bx, [bp-010h]                         ; c4 5e f0
    ...
    jne short 09216h                          ; 75 10
    cmp dx, strict byte 0ffffh                ; 83 fa ff
    jne short 09216h                          ; 75 0b
    ...
    mov al, byte [bp-008h]                    ; 8a 46 f8
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 0928ah                           ; 72 0c
    jbe short 09292h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 0929ah                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 09296h                           ; 74 0e
    jmp short 092e3h                          ; eb 59
    test al, al                               ; 84 c0
    jne short 092e3h                          ; 75 55
    mov DL, strict byte 040h                  ; b2 40
    jmp short 0929ch                          ; eb 0a
    mov DL, strict byte 048h                  ; b2 48
    jmp short 0929ch                          ; eb 06
    mov DL, strict byte 050h                  ; b2 50
    jmp short 0929ch                          ; eb 02
    mov DL, strict byte 058h                  ; b2 58
    mov al, dl                                ; 88 d0
    add AL, strict byte 007h                  ; 04 07
    movzx bx, al                              ; 0f b6 d8
    mov ax, bx                                ; 89 d8
    call 0165ch                               ; e8 b4 83
    test al, al                               ; 84 c0
    je short 092e3h                           ; 74 37
    mov al, dl                                ; 88 d0
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 a7 83
    xor ah, ah                                ; 30 e4
    mov si, ax                                ; 89 c6
    sal si, 008h                              ; c1 e6 08
    movzx ax, dl                              ; 0f b6 c2
    call 0165ch                               ; e8 9a 83
    xor ah, ah                                ; 30 e4
    add ax, si                                ; 01 f0
    mov word [bp-024h], ax                    ; 89 46 dc
    mov al, dl                                ; 88 d0
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 0165ch                               ; e8 8a 83
    xor ah, ah                                ; 30 e4
    mov word [bp-026h], ax                    ; 89 46 da
    mov ax, bx                                ; 89 d8
    call 0165ch                               ; e8 80 83
    xor ah, ah                                ; 30 e4
    mov word [bp-022h], ax                    ; 89 46 de
    jmp short 092f0h                          ; eb 0d
    mov bx, word [bp-014h]                    ; 8b 5e ec
    mov cx, di                                ; 89 f9
    mov dx, ss                                ; 8c d2
    lea ax, [bp-026h]                         ; 8d 46 da
    call 054e1h                               ; e8 f1 c1
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 e6 85
    push di                                   ; 57
    push word [bp-014h]                       ; ff 76 ec
    mov ax, word [bp-022h]                    ; 8b 46 de
    push ax                                   ; 50
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01600h                               ; e8 8f 82
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0160eh                               ; e8 8f 82
    jmp near 09421h                           ; e9 9f 00
    cmp dx, 0eb14h                            ; 81 fa 14 eb
    jne near 09421h                           ; 0f 85 97 00
    cmp ax, 00101h                            ; 3d 01 01
    jne near 09421h                           ; 0f 85 90 00
    les bx, [bp-010h]                         ; c4 5e f0
    db  066h, 026h, 0c7h, 047h, 004h, 000h, 000h, 000h, 000h
    ; mov dword [es:bx+004h], strict dword 000000000h ; 66 26 c7 47 04 00 00 00 00
    db  066h, 026h, 0c7h, 007h, 000h, 000h, 000h, 000h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_mem_alloc_:                             ; 0xf9437 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 0161ch                               ; e8 d5 81
    test ax, ax                               ; 85 c0
    je short 09470h                           ; 74 25
    dec ax                                    ; 48
    mov bx, ax                                ; 89 c3
    xor dx, dx                                ; 31 d2
    mov cx, strict word 0000ah                ; b9 0a 00
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_hba_init_:                              ; 0xf947a LB 0x125
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    shr eax, 010h                             ; 66 c1 e8 10
    xchg dx, ax                               ; 92
    call 09437h                               ; e8 82 ff
    mov di, ax                                ; 89 c7
    test ax, ax                               ; 85 c0
    je near 0957eh                            ; 0f 84 c1 00
    mov es, [bp-010h]                         ; 8e 46 f0
    ...
    xor cx, cx                                ; 31 c9
    call 086a8h                               ; e8 71 f1
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    mov byte [bp-00eh], al                    ; 88 46 f2
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    jmp short 0954bh                          ; eb 09
    inc byte [bp-00ch]                        ; fe 46 f4
    cmp byte [bp-00ch], 020h                  ; 80 7e f4 20
    jnc short 0957ch                          ; 73 31
    movzx cx, byte [bp-00ch]                  ; 0f b6 4e f4
    mov ax, strict word 00001h                ; b8 01 00
    xor dx, dx                                ; 31 d2
    jcxz 0955ch                               ; e3 06
    ...
    mov dx, strict word 0000ch                ; ba 0c 00
    mov ax, si                                ; 89 f0
    call 0866fh                               ; e8 07 f1
    test al, al                               ; 84 c0
    je short 09542h                           ; 74 d6
    movzx bx, byte [bp-00ch]                  ; 0f b6 5e f4
    xor ax, ax                                ; 31 c0
    mov dx, di                                ; 89 fa
    call 08fcbh                               ; e8 54 fa
    dec byte [bp-00eh]                        ; fe 4e f2
    jne short 09542h                          ; 75 c6
    xor ax, ax                                ; 31 c0
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    db  00bh, 005h, 004h, 003h, 002h, 001h, 000h, 06eh, 096h, 04ch, 096h, 052h, 096h, 058h, 096h, 05eh
    db  096h, 064h, 096h, 06ah, 096h, 06eh, 096h
_ahci_init:                                  ; 0xf959f LB 0xfe
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00001h                ; ba 01 00
    call 09abdh                               ; e8 0d 05
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 0ffffh                ; 3d ff ff
    je near 09696h                            ; 0f 84 dd 00
    xor al, al                                ; 30 c0
    shr ax, 008h                              ; c1 e8 08
    mov byte [bp-00ah], al                    ; 88 46 f6
    mov byte [bp-008h], dl                    ; 88 56 f8
    ...
    xor ah, ah                                ; 30 e4
    mov bx, strict word 00034h                ; bb 34 00
    call 09ae8h                               ; e8 1a 05
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    je short 095f7h                           ; 74 23
    movzx bx, cl                              ; 0f b6 d9
    movzx di, byte [bp-008h]                  ; 0f b6 7e f8
    movzx si, byte [bp-00ah]                  ; 0f b6 76 f6
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 09ae8h                               ; e8 02 05
    cmp AL, strict byte 012h                  ; 3c 12
    je short 095f7h                           ; 74 0d
    mov al, cl                                ; 88 c8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    movzx bx, al                              ; 0f b6 d8
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    jmp short 095cbh                          ; eb d4
    test cl, cl                               ; 84 c9
    je near 09696h                            ; 0f 84 99 00
    ...
    mov dx, di                                ; 89 fa
    mov ax, si                                ; 89 f0
    call 09ae8h                               ; e8 d6 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne near 09696h                           ; 0f 85 7e 00
    mov byte [bp-006h], 000h                  ; c6 46 fa 00
    mov al, cl                                ; 88 c8
    add AL, strict byte 002h                  ; 04 02
    movzx bx, al                              ; 0f b6 d8
    ...
    mov al, byte [bp-006h]                    ; 8a 46 fa
    test al, al                               ; 84 c0
    je short 09696h                           ; 74 19
    movzx bx, al                              ; 0f b6 d8
    movzx dx, byte [bp-008h]                  ; 0f b6 56 f8
    movzx ax, byte [bp-00ah]                  ; 0f b6 46 f6
    call 09b2eh                               ; e8 a3 04
    test AL, strict byte 001h                 ; a8 01
    je short 09696h                           ; 74 07
    and AL, strict byte 0f0h                  ; 24 f0
    add ax, si                                ; 01 f0
    call 0947ah                               ; e8 e4 fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
apm_out_str_:                                ; 0xf969d LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    cmp byte [bx], 000h                       ; 80 3f 00
    je short 096b2h                           ; 74 0a
    ...
    stc                                       ; f9
    xchg si, ax                               ; 96
    lds dx, [bx-068f5h]                       ; c5 97 0b 97
    db  026h, 097h
    ; es xchg di, ax                            ; 26 97
    lds dx, [bx-068afh]                       ; c5 97 51 97
    lds dx, [bx-068aah]                       ; c5 97 56 97
    call far 09a97h:09a97h                    ; 9a 97 9a 97 9a
    xchg di, ax                               ; 97
    xchg bp, ax                               ; 95
    xchg di, ax                               ; 97
    call far 08e97h:09a97h                    ; 9a 97 9a 97 8e
    xchg di, ax                               ; 97
_apm_function:                               ; 0xf96d6 LB 0xf5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    ...
    jnbe near 0979ah                          ; 0f 87 b0 00
    mov bx, ax                                ; 89 c3
    add bx, ax                                ; 01 c3
    mov dx, word [bp+018h]                    ; 8b 56 18
    or dl, 001h                               ; 80 ca 01
    jmp word [cs:bx-06948h]                   ; 2e ff a7 b8 96
    ...
    jmp near 097c5h                           ; e9 74 00
    sti                                       ; fb
    hlt                                       ; f4
    jmp near 097c5h                           ; e9 6f 00
    cmp word [bp+010h], strict byte 00003h    ; 83 7e 10 03
    je short 0977bh                           ; 74 1f
    cmp word [bp+010h], strict byte 00002h    ; 83 7e 10 02
    je short 09773h                           ; 74 11
    cmp word [bp+010h], strict byte 00001h    ; 83 7e 10 01
    jne short 09783h                          ; 75 1b
    mov dx, 08900h                            ; ba 00 89
    mov ax, 010d4h                            ; b8 d4 10
    call 0969dh                               ; e8 2c ff
    jmp short 097c5h                          ; eb 52
    mov dx, 08900h                            ; ba 00 89
    mov ax, 010dch                            ; b8 dc 10
    jmp short 0976eh                          ; eb f3
    mov dx, 08900h                            ; ba 00 89
    mov ax, 010e4h                            ; b8 e4 10
    jmp short 0976eh                          ; eb eb
    or ah, 00ah                               ; 80 cc 0a
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 097c5h                          ; eb 37
    mov word [bp+012h], 00102h                ; c7 46 12 02 01
    jmp short 097c5h                          ; eb 30
    or ah, 080h                               ; 80 cc 80
    jmp short 09786h                          ; eb ec
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 3c 81
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    push 010edh                               ; 68 ed 10
    push strict byte 00004h                   ; 6a 04
    call 01922h                               ; e8 6f 81
    add sp, strict byte 00008h                ; 83 c4 08
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_select_reg_:                           ; 0xf97cb LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_find_device_:                          ; 0xf97ef LB 0xf7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 09837h                          ; 75 2d
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, bx                                ; 89 d8
    call 097cbh                               ; e8 b9 ff
    ...
    mov byte [bp-006h], al                    ; 88 46 fa
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 09825h                          ; 75 06
    add bx, strict byte 00008h                ; 83 c3 08
    jmp near 098b8h                           ; e9 93 00
    test byte [bp-006h], 080h                 ; f6 46 fa 80
    je short 09832h                           ; 74 07
    mov word [bp-00ah], strict word 00001h    ; c7 46 f6 01 00
    jmp short 09837h                          ; eb 05
    mov word [bp-00ah], strict word 00008h    ; c7 46 f6 08 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 007h                  ; 24 07
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 0985fh                          ; 75 1f
    mov ax, bx                                ; 89 d8
    shr ax, 008h                              ; c1 e8 08
    test ax, ax                               ; 85 c0
    jne short 0985fh                          ; 75 16
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, bx                                ; 89 d8
    call 097cbh                               ; e8 7a ff
    mov dx, 00cfeh                            ; ba fe 0c
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp al, byte [bp-008h]                    ; 3a 46 f8
    jbe short 0985fh                          ; 76 03
    mov byte [bp-008h], al                    ; 88 46 f8
    test di, di                               ; 85 ff
    je short 09868h                           ; 74 05
    mov dx, strict word 00008h                ; ba 08 00
    jmp short 0986ah                          ; eb 02
    xor dx, dx                                ; 31 d2
    mov ax, bx                                ; 89 d8
    call 097cbh                               ; e8 5c ff
    ...
    jne short 098a9h                          ; 75 08
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    cmp ax, word [bp-012h]                    ; 3b 46 ee
    je short 098afh                           ; 74 06
    cmp word [bp-010h], strict byte 00000h    ; 83 7e f0 00
    je short 098b5h                           ; 74 06
    dec si                                    ; 4e
    cmp si, strict byte 0ffffh                ; 83 fe ff
    je short 098c7h                           ; 74 12
    add bx, word [bp-00ah]                    ; 03 5e f6
    mov dx, bx                                ; 89 da
    shr dx, 008h                              ; c1 ea 08
    movzx ax, byte [bp-008h]                  ; 0f b6 46 f8
    cmp dx, ax                                ; 39 c2
    jbe near 09805h                           ; 0f 86 3e ff
    cmp si, strict byte 0ffffh                ; 83 fe ff
    jne short 098d0h                          ; 75 04
    mov ax, bx                                ; 89 d8
    jmp short 098d3h                          ; eb 03
    mov ax, strict word 0ffffh                ; b8 ff ff
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
    enter 0e299h, 099h                        ; c8 99 e2 99
    cmc                                       ; f5
    cwd                                       ; 99
    or bl, byte [bp+si-065e3h]                ; 0a 9a 1d 9a
    db  030h
    db  09ah
_pci16_function:                             ; 0xf98e6 LB 0x1d7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ah, ah                                ; 30 e4
    cmp bx, strict byte 00003h                ; 83 fb 03
    jc short 0991fh                           ; 72 1a
    jbe short 09977h                          ; 76 70
    cmp bx, strict byte 0000eh                ; 83 fb 0e
    je near 09a44h                            ; 0f 84 36 01
    cmp bx, strict byte 00008h                ; 83 fb 08
    jc near 09a89h                            ; 0f 82 74 01
    cmp bx, strict byte 0000dh                ; 83 fb 0d
    jbe near 0999ch                           ; 0f 86 80 00
    jmp near 09a89h                           ; e9 6a 01
    cmp bx, strict byte 00002h                ; 83 fb 02
    je short 09947h                           ; 74 23
    cmp bx, strict byte 00001h                ; 83 fb 01
    jne near 09a89h                           ; 0f 85 5e 01
    ...
    jmp near 09ab6h                           ; e9 6f 01
    cmp word [bp+018h], strict byte 0ffffh    ; 83 7e 18 ff
    jne short 09953h                          ; 75 06
    or ah, 083h                               ; 80 cc 83
    jmp near 09aafh                           ; e9 5c 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov dx, word [bp+01ch]                    ; 8b 56 1c
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor cx, cx                                ; 31 c9
    call 097efh                               ; e8 8e fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09971h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09aafh                           ; e9 3e 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09ab6h                           ; e9 3f 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    mov dx, word [bp+01eh]                    ; 8b 56 1e
    mov cx, strict word 00001h                ; b9 01 00
    call 097efh                               ; e8 69 fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09996h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09aafh                           ; e9 19 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09ab6h                           ; e9 1a 01
    cmp word [bp+004h], 00100h                ; 81 7e 04 00 01
    jc short 099a9h                           ; 72 06
    or ah, 087h                               ; 80 cc 87
    jmp near 09aafh                           ; e9 06 01
    mov dx, word [bp+004h]                    ; 8b 56 04
    mov ax, word [bp+014h]                    ; 8b 46 14
    call 097cbh                               ; e8 19 fe
    mov bx, word [bp+020h]                    ; 8b 5e 20
    xor bh, bh                                ; 30 ff
    sub bx, strict byte 00008h                ; 83 eb 08
    cmp bx, strict byte 00005h                ; 83 fb 05
    jnbe near 09ab6h                          ; 0f 87 f5 00
    add bx, bx                                ; 01 db
    jmp word [cs:bx-06726h]                   ; 2e ff a7 da 98
    ...
    mov word [es:bx], ax                      ; 26 89 07
    jmp short 09ab6h                          ; eb 2d
    mov bx, 01168h                            ; bb 68 11
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 018e1h                               ; e8 4d 7e
    mov ax, word [bp+014h]                    ; 8b 46 14
    push ax                                   ; 50
    mov ax, word [bp+020h]                    ; 8b 46 20
    push ax                                   ; 50
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_find_classcode_:                         ; 0xf9abd LB 0x2b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_byte_:                       ; 0xf9ae8 LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_word_:                       ; 0xf9b0c LB 0x22
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_dword_:                      ; 0xf9b2e LB 0x27
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
vds_is_present_:                             ; 0xf9b55 LB 0x1d
    push bx                                   ; 53
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_real_to_lin_:                            ; 0xf9b72 LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_build_sg_list_:                          ; 0xf9b90 LB 0x79
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    call 09b55h                               ; e8 93 ff
    test ax, ax                               ; 85 c0
    je short 09bd9h                           ; 74 13
    mov es, si                                ; 8e c6
    mov ax, 08105h                            ; b8 05 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc near 09bd6h                            ; 0f 82 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    jmp short 09c00h                          ; eb 27
    mov es, si                                ; 8e c6
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
vds_free_sg_list_:                           ; 0xf9c09 LB 0x37
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push di                                   ; 57
    mov bx, ax                                ; 89 c3
    call 09b55h                               ; e8 42 ff
    test ax, ax                               ; 85 c0
...
_fmemcpy_:                                   ; 0xf9cb7 LB 0x33
    ...
    popfw                                     ; 9d
    add bl, byte [di-062fah]                  ; 02 9d 06 9d
    push ES                                   ; 06
    popfw                                     ; 9d
    push ES                                   ; 06
    popfw                                     ; 9d
    or byte [di-062f8h], bl                   ; 08 9d 08 9d
    or bl, byte [di-062f2h]                   ; 0a 9d 0e 9d
    push CS                                   ; 0e
    popfw                                     ; 9d
    adc byte [di-062ebh], bl                  ; 10 9d 15 9d
    pop SS                                    ; 17
    popfw                                     ; 9d
apm_worker:                                  ; 0xf9cea LB 0x3a
    sti                                       ; fb
    push ax                                   ; 50
    db  032h, 0e4h
    ; xor ah, ah                                ; 32 e4
    ...
    jnc short 09d20h                          ; 73 25
    jmp word [cs:bp-06330h]                   ; 2e ff a6 d0 9c
    jmp short 09d1eh                          ; eb 1c
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 09d1eh                          ; eb 18
    jmp short 09d1eh                          ; eb 16
    jmp short 09d20h                          ; eb 16
    mov AH, strict byte 080h                  ; b4 80
    jmp short 09d22h                          ; eb 14
    jmp short 09d20h                          ; eb 10
    mov ax, 00102h                            ; b8 02 01
    jmp short 09d1eh                          ; eb 09
    jmp short 09d1eh                          ; eb 07
    mov BL, strict byte 000h                  ; b3 00
    mov cx, strict word 00000h                ; b9 00 00
    jmp short 09d1eh                          ; eb 00
    clc                                       ; f8
    retn                                      ; c3
    mov AH, strict byte 009h                  ; b4 09
    stc                                       ; f9
    retn                                      ; c3
apm_pm16_entry:                              ; 0xf9d24 LB 0x1c
    ...
    mov ds, bp                                ; 8e dd
    call 09ceah                               ; e8 b8 ff
    pop bp                                    ; 5d
    pop DS                                    ; 1f
    retf                                      ; cb
    times 0xb db 0
__U8RS:                                      ; 0xf9d40 LB 0x10
    test si, si                               ; 85 f6
    je short 09d4fh                           ; 74 0b
    shr ax, 1                                 ; d1 e8
    rcr bx, 1                                 ; d1 db
    rcr cx, 1                                 ; d1 d9
    rcr dx, 1                                 ; d1 da
    dec si                                    ; 4e
    jne short 09d44h                          ; 75 f5
    retn                                      ; c3
__I8LS:                                      ; 0xf9d50 LB 0x10
    test si, si                               ; 85 f6
    je short 09d5fh                           ; 74 0b
    sal dx, 1                                 ; d1 e2
    rcl cx, 1                                 ; d1 d1
    rcl bx, 1                                 ; d1 d3
    rcl ax, 1                                 ; d1 d0
    dec si                                    ; 4e
    jne short 09d54h                          ; 75 f5
    retn                                      ; c3

  ; Padding 0x3ca0 bytes at 0xf9d60
  times 15520 db 0
...
hard_drive_post:                             ; 0xfe2d2 LB 0x12c
    ...
    call 0959fh                               ; e8 78 b2
    call 084c7h                               ; e8 9d a1
...
font8x8:                                     ; 0xffa6e LB 0x421
    ...
    db  080h, 0fch, 0b1h, 075h, 00fh, 006h, 01eh, 00eh, 01fh, 0fch, 066h, 060h, 0e8h, 069h, 09ah, 066h
